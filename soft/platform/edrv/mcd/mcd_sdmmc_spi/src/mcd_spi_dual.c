...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURLsvn://atlas/SVN_MIRROR/dev_mirror/modem2G/trunk/platform/edrv/mcd/mcd_spi/src/mcd_spi.c$//
//  $Author: andri $                                                          //
//  $Date$                                                                    //
//  $Revision$                                                                //
//                                                                            //
...
PUBLIC MCD_ERR_T mcd_spi_Write_s(UINT32 startAddr, CONST UINT8* blockWr, UINT32 blockLength)
{
   ...
   // g_dmaBusy=hal_SpiGetData(g_mcdSpiId, g_mcdSpiCs, (UINT8*) tmpRdBuff, g_writeBlockLen[g_mcdSpiCs] + 64);
    ...
    {
        g_dmaBusy=hal_SpiGetData(g_mcdSpiId, g_mcdSpiCs, (UINT8*) tmpRdBuff,512+16+64);
    }
    else
    {
        g_dmaBusy=hal_SpiGetData(g_mcdSpiId, g_mcdSpiCs, (UINT8*) tmpRdBuff,515+16);
    }
    if (g_dmaBusy == 0)
    {
        MCD_PROFILE_FUNCTION_EXIT(mcd_Write);
