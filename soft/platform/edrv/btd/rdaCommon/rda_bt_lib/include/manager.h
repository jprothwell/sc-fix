...
APIDECL1 int APIDECL2 MGR_SetLocalName(u_int8 *outBuffer, u_int8 bufLen, u_int8 nameLen);
...
/* Device Discovery */
APIDECL1 int APIDECL2 MGR_InitDeviceDiscovery(u_int8 IsNameNeeded, u_int32 classOfdevice,   u_int8 discoveryLength, u_int32 accessCode, u_int8 maxResults, void (*callbackFunc)(t_MGR_DeviceEntry *newDevice, int status));
APIDECL1 int APIDECL2 MGR_SetDeviceInfo(t_bdaddr address, u_int8 *linkKey,  u_int8 keyType);

APIDECL1 int APIDECL2 MGR_SetBondingCallBack(t_bdaddr address,  void (*callbackfunc)(t_bdaddr address, int status));
