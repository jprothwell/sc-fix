...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/aud/tv/src/aud_tv.c $ //
//	$Author: huazeng $                                                        // 
...
#ifdef TV_USING_I2S
PRIVATE HAL_AIF_SERIAL_CFG_T g_audTvAifSerialCfg;
PRIVATE HAL_AIF_CONFIG_T     g_audTvAifCfg;
#endif
...
/// @return
// =============================================================================
PRIVATE VOID aud_TvPopulateAifCfg(CONST HAL_AIF_STREAM_T* stream)
{
    ...
    g_audTvAifCfg.channelNb=(stream->channelNb==HAL_AIF_MONO)?HAL_AIF_MONO:HAL_AIF_STEREO;
                        ...
                        CONST AUD_DEVICE_CFG_T *       cfg)
{
    ...
    ret = aud_CodecCommonSetConfig(FALSE, HAL_AUD_USER_CODEC, &g_audTvAifCfg);
#else
                        ...
                        CONST AUD_DEVICE_CFG_T *       cfg)
{
	...
	aud_TvPopulateAifCfg(stream);
    if (!aud_CodecCommonSetConfig(TRUE, HAL_AUD_USER_CODEC, &g_audTvAifCfg))
    {
        AUD_TRACE(AUD_INFO_TRC, 0,
            "AUD: " __FILE__ ", line:%d, Resource Busy",__LINE__);
        return AUD_ERR_RESOURCE_BUSY;
