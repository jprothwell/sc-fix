...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/aud/ti/src/aud_ti.c $ //
//	$Author: huazeng $                                                        // 
//	$Date: 2010-07-07 17:32:45 +0800 (Wed, 07 Jul 2010) $                     //   
//	$Revision: 242 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
#define TI_WR(reg,val)   \
   halErr = HAL_ERR_RESOURCE_BUSY; \
	...
	{   \
		halErr = hal_I2cSendByte(TI_ADDR, ((reg)<<1)|(((val)&0x100)>>8), (val)&0xff); \
	} \
    \
