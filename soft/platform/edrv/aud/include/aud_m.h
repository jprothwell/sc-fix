...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/aud/include/aud_m.h $ //
//	$Author: huazeng $                                                        // 
//	$Date: 2010-09-17 15:08:59 +0800 (Fri, 17 Sep 2010) $                     //   
//	$Revision: 2321 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
typedef enum
{
    /// Output on the receiver port
    /// This output can only use voice quality streams (Mono, 8kHz, 
    /// voiceQuality field set to TRUE).
    AUD_SPK_RECEIVER = 0,
    /// Output on the ear-piece port
    AUD_SPK_EAR_PIECE,
    /// Hand-free loud speaker, physically plugged on the same interface as
    /// the auxiliary speaker, but through the polyphonics. The polyponics has
...
DEPRECATED PUBLIC VOID aud_Init(VOID);
