...
typedef enum {
    ...
    RDA_ADDR_SIM_INTERFACE1                    = 0x00000026,
    RDA_ADDR_SIM_INTERFACE2                    = 0x00000027,
    RDA_ADDR_SIM_INTERFACE3                    = 0x00000028,
    RDA_ADDR_SIM_INTERFACE4                    = 0x00000029,
    RDA_ADDR_SIM_INTERFACE5                    = 0x0000002a,
    RDA_ADDR_SIM_INTERFACE6                    = 0x0000002b,
...
#define RDA1203_CHR_DISABLE           (1<<1)
...
//LDO settings 0x02
#define RDA1203_LDO_SETTINGS(n)          (((n)&0xfe7f)<<0)
#define RDA1203_LDO_MASK                 (0xfe7f<<0)
...
#define RDA1203_LDO_MEM                  (1<<11)
#define RDA1203_LDO_SIM4                 (1<<12)
#define RDA1203_LDO_SIM3                 (1<<13)
#define RDA1203_LDO_SIM2                 (1<<14)
#define RDA1203_LDO_SIM1                 (1<<15)
#define RDA1203_LDO_SIMMASK                 (0xf<<12)
// end LDO settings

//LDO active setting1 0x03
...
#define RDA1203_ACT_PFM_CORE             (1<<14)
#define RDA1203_ACT_RTC_SEL1V6           (1<<15)

#define OPAL_LDO_EN(n)              (((n)&0xFFF9)<<0)
#define OPAL_LDO_EN_MASK            (0xFFF9<<0)
#define OPAL_LDO_EN_SHIFT           (0)
// end LDO active setting1


// LDO active setting2  0x04
...
#define RDA1203_ACT_MIC_SEL(n)      (((n)&7)<<4)
#define RDA1203_ACT_MIC_SEL_MASK    (7<<4)
#define RDA1203_ACT_MIC_SEL_SHIFT   (4)
#define RDA1203_ACT_MIC_SEL2V8   (4<<4)
#define RDA1203_ACT_MIC_SEL1V8   (6<<4)
#define RDA1203_ACT_MIC_SEL1V57   (0<<4)
#define RDA1203_ACT_MIC_SEL2V2   (4<<4)
#define RDA1203_ACT_MIC_SEL2V0   (2<<4)
 #define RDA1203_ACT_MIC_SEL1V5   (5<<4)

#define RDA1203_ACT_VIBRATE_SEL_MASK   (1<<7)
#define RDA1203_ACT_VIBRATE_SEL1V8   (1<<7)
#define RDA1203_ACT_VIBRATE_SEL2V8   (0<<7)

#define RDA1203_ACT_MMC_SEL_MASK   (1<<8)
#define RDA1203_ACT_MMC_SEL1V8   (1<<8)
#define RDA1203_ACT_MMC_SEL2V8   (0<<8)

#define RDA1203_ACT_LCD_SEL_MASK   (1<<9)
#define RDA1203_ACT_LCD_SEL1V8   (1<<9)
#define RDA1203_ACT_LCD_SEL2V8   (0<<9)

#define RDA1203_ACT_CAMERA_SEL_MASK   (1<<10)
#define RDA1203_ACT_CAMERA_SEL1V8   (1<<10)
#define RDA1203_ACT_CAMERA_SEL2V8   (0<<10)

#define RDA1203_ACT_RF_SEL_MASK   (1<<11)
#define RDA1203_ACT_RF_SEL1V8   (1<<11)
#define RDA1203_ACT_RF_SEL2V8   (0<<11)

#define RDA1203_ACT_PAD_SEL_MASK   (1<<12)
#define RDA1203_ACT_PAD_SEL1V8   (1<<12)
#define RDA1203_ACT_PAD_SEL2V8   (0<<12)

#define RDA1203_LDO_VCORE_CURRENT_SHIFT    (13)
#define RDA1203_LDO_VCORE_CURRENT_MASK     (7<<13)
#define RDA1203_LDO_VCORE_CURRENT(n)       (((n)&7)<<13)

//#define RDA1203_ACT_CORE_SEL(n)      (((n)&7)<<13)
//#define RDA1203_ACT_CORE_SEL_MASK    (7<<13)
//#define RDA1203_ACT_CORE_SEL_SHIFT   (13)
//#define RDA1203_ACT_CORE_SEL1V5   (1<<13)
//#define RDA1203_ACT_CORE_SEL1V3   (2<<13)

// end LDO active setting2
...
#define RDA1203_LDO_PAD_CURRENT_SHIFT       (3)
#define RDA1203_LDO_PAD_CURRENT_MASK        (7<<3)
#define RDA1203_LDO_PAD_CURRENT(n)          (((n)&7)<<3)
...
#define RDA1203_LDO_VBACKUP_CURRENT_SHIFT    (12)
#define RDA1203_LDO_VBACKUP_CURRENT_MASK     (7<<12)
#define RDA1203_LDO_VBACKUP_CURRENT(n)       (((n)&7)<<12)
// end LDO ACT/LP setting3

// LDO LP  setting5  0x7
#define RDA1203_ACT_SIM4_SEL1V8      (1<<12)
#define RDA1203_ACT_SIM3_SEL1V8      (1<<13)
#define RDA1203_ACT_SIM4_SEL2V8      (0<<12)
#define RDA1203_ACT_SIM3_SEL2V8      (0<<13)
#define RDA1203_ACT_SIM4_SEL_MASK      (1<<12)
#define RDA1203_ACT_SIM3_SEL_MASK      (1<<13)
#define RDA1203_ACT_SIM2_SEL1V8      (1<<14)
#define RDA1203_ACT_SIM1_SEL1V8      (1<<15)
#define RDA1203_ACT_SIM2_SEL2V8      (0<<14)
#define RDA1203_ACT_SIM1_SEL2V8      (0<<15)
#define RDA1203_ACT_SIM2_SEL_MASK      (1<<14)
#define RDA1203_ACT_SIM1_SEL_MASK      (1<<15)
// end LDO ACT/LP setting5
...
#define RDA1203_LP_LDO_PFM_CORE             (1<<14)
...
#define RDA1203_LP_MIC_SEL(n)      (((n)&7)<<4)
#define RDA1203_LP_MIC_SEL_MASK    (7<<4)
#define RDA1203_LP_MIC_SEL_SHIFT   (4)
#define RDA1203_LP_MIC_SEL2V8   (1<<4)
#define RDA1203_LP_MIC_SEL1V8   (2<<5)
#define RDA1203_LP_VIBRATE_SEL   (1<<7)
#define RDA1203_LP_MEMO_SEL   (1<<8)
#define RDA1203_LP_LCD_SEL   (1<<9)
#define RDA1203_LP_CAMERA_SEL   (1<<10)
#define RDA1203_LP_RF_SEL   (1<<11)
#define RDA1203_LP_PAD_SEL   (1<<12)
//end LDO LP setting2

// LDO LP SETTING5  0x0ch
#define RDA1203_LP_SIM4_SEL      (1<<12)
#define RDA1203_LP_SIM3_SEL      (1<<13)
#define RDA1203_LP_SIM2_SEL      (1<<14)
#define RDA1203_LP_SIM1_SEL      (1<<15)
//end LDO LP setting5
...
#define RDA1203_CHG_CUR_SEL_800MA (7<<13)
#define RDA1203_CHG_CUR_SEL_650MA (6<<13)
#define RDA1203_CHG_CUR_SEL_450MA (5<<13)
...
#define RDA1203_BYPASS_BB_READ               (1<<14)
#define RDA1203_MEAS_WAIT_CLR_PENIRQ               (1<<15)
...
#define RDA1203_TSC_XP_XN_INV               (1<<14)
#define RDA1203_TSC_YP_YN_INV                (1<<15)
...
// sim interface2 0x27
//#define RDA1203_SIM_SELECT(n)          (((n)&0x3)<<14)
#define RDA1203_SIM_SELECT                      (1<<14)
#define RDA1203_SIM_SELECT_MASK           (3<<14)
#define RDA1203_SIM_SELECT_SHIFT          (14)
#define RDA1203_SIM_SELECT_SIM1            (0<<14)
#define RDA1203_SIM_SELECT_SIM2            (1<<14)
#define RDA1203_SIM_SELECT_SIM3            (2<<14)
#define RDA1203_SIM_SELECT_SIM4            (3<<14)
#define RDA1203_PULLUP_ENABLE_1            (1<<11)
#define RDA1203_UNSEL_CLK_VAL_1            (1<<10)
#define RDA1203_UNSEL_RST_VAL_1            (1<<9)
#define RDA1203_PULLUP_ENABLE_2            (1<<8)
#define RDA1203_UNSEL_CLK_VAL_2            (1<<7)
#define RDA1203_UNSEL_RST_VAL_2            (1<<6)
#define RDA1203_PULLUP_ENABLE_3            (1<<5)
#define RDA1203_UNSEL_CLK_VAL_3            (1<<4)
#define RDA1203_UNSEL_RST_VAL_3            (1<<3)
#define RDA1203_PULLUP_ENABLE_4            (1<<2)
#define RDA1203_UNSEL_CLK_VAL_4            (1<<1)
#define RDA1203_UNSEL_RST_VAL_4            (1<<0)
// end sim interface2 

// sim interface3 0x28
#define RDA1203_ACT_VSIM4                (1<<12)
#define RDA1203_ACT_VSIM3                (1<<13)
#define RDA1203_ACT_VSIM2                (1<<14)
#define RDA1203_ACT_VSIM1                (1<<15)
#define RDA1203_ACT_SIM2                 (1<<14)
#define RDA1203_ACT_SIM1                 (1<<15)
// end sim interface3 

// sim interface4 0x29
#define RDA1203_LP_LDO_VSIM4                (1<<12)
#define RDA1203_LP_LDO_VSIM3                (1<<13)
#define RDA1203_LP_LDO_VSIM2                (1<<14)
#define RDA1203_LP_LDO_VSIM1                (1<<15)
// end sim interface4 

// sim interface5 0x2a
#define RDA1203_PON_VSIM4                (1<<12)
#define RDA1203_PON_VSIM3                (1<<13)
#define RDA1203_PON_VSIM2                (1<<14)
#define RDA1203_PON_VSIM1                (1<<15)
// end sim interface5 

// sim interface6 0x2b
#define RDA1203_POFF_VSIM4                (1<<12)
#define RDA1203_POFF_VSIM3                (1<<13)
#define RDA1203_POFF_VSIM2                (1<<14)
#define RDA1203_POFF_VSIM1                (1<<15)
// end sim interface6 

// thermal calibration 0x36
#define RDA1203_ACT_LDO_CORE             (1<<15)
