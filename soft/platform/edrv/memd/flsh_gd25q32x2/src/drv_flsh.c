...
#define FLASH_SIZE  8*MBYTES // 4MB
...
#define GET_PAGE_PHYS(PhysAddr)  (UINT8)(((UINT32)PhysAddr >> 23) & 0x7)
...
//    addr_tmp = SPI_FLASH_REG_BASE + DUAL_SPI_OFFSET;
    addr_tmp = SPI_FLASH_REG_BASE + MODE_BLOCKSIZE_OFFSET;
//    data_tmp_32 = 0x10;   
    data_tmp_32 = 0x100;   
...
{//use 2 chips 32MBit flash
      MWRITE_32(SPI_CS_SIZE_REG, (1 << SPI_FLASH_NUMS_USED_BIT));
}
...
PUBLIC VOID memd_FlashWakeup(VOID)
{
    ...
    start_flash_operation(OPCODE_RDI, 0x400000, 0, 0);
    start_flash_operation(OPCODE_ReadReset, 0x400000, 0, 0);
    start_flash_operation(OPCODE_HPM, 0x400000, 0, 0);
