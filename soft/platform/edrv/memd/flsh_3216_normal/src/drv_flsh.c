...
PROTECTED CONST MEMD_RAM_CONFIG_T g_tgtMemdRamCfg_en71gl032a0 = TGT_MEMD_RAM_CONFIG_EN71GL032A0;
PROTECTED CONST MEMD_RAM_CONFIG_T g_tgtMemdRamCfg_en71pl032a0 = TGT_MEMD_RAM_CONFIG_EN71PL032A0;
PROTECTED CONST MEMD_RAM_CONFIG_T g_tgtMemdRamCfg_m36cow5040tozsp = TGT_MEMD_RAM_CONFIG_M36COW5040TOZSP;
PROTECTED CONST MEMD_RAM_CONFIG_T g_tgtMemdRamCfg_fm91l03216ua = TGT_MEMD_RAM_CONFIG_FM91L03216UA;
PROTECTED CONST MEMD_RAM_CONFIG_T g_tgtMemdRamCfg_svme3216uta = TGT_MEMD_RAM_CONFIG_SVME3216UTA;

// flash timing
PROTECTED CONST MEMD_FLASH_CONFIG_T g_tgtMemdFlashCfg_en71gl032a0 = TGT_MEMD_FLASH_CONFIG_EN71GL032A0;
PROTECTED CONST MEMD_FLASH_CONFIG_T g_tgtMemdFlashCfg_en71pl032a0 = TGT_MEMD_FLASH_CONFIG_EN71PL032A0;
PROTECTED CONST MEMD_FLASH_CONFIG_T g_tgtMemdFlashCfg_m36cow5040tozsp = TGT_MEMD_FLASH_CONFIG_M36COW5040TOZSP;
PROTECTED CONST MEMD_FLASH_CONFIG_T g_tgtMemdFlashCfg_fm91l03216ua = TGT_MEMD_FLASH_CONFIG_FM91L03216UA;
PROTECTED CONST MEMD_FLASH_CONFIG_T g_tgtMemdFlashCfg_svme3216uta = TGT_MEMD_FLASH_CONFIG_SVME3216UTA;
...
BOOL  __attribute__((section(".ram"))) memd_FlashID_match(FLASH_AUTOSELECTOR_ID flash_ID)
{
    ...
    for (i = 0;i<FLASH_NAME_QTY;i++)
    {
        ...
        if (g_flashID == FLASH_EN71GL032A0 || g_flashID == FLASH_EN71PL032A0)
            {
                #if 1
                g_memdFlashLayout = &g_memdFlashLayout_en71pl032a0;
                g_MemdRamCfg = &g_tgtMemdRamCfg_en71pl032a0;
                g_MemdFlashCfg = &g_tgtMemdFlashCfg_en71pl032a0;
                g_flash_bank_maks = 0x3<<19;
                 FLASH_DEBUG_HST(0x5556789);
                #else
                g_memdFlashLayout = &g_memdFlashLayout_en71gl032a0;
                g_MemdRamCfg = &g_tgtMemdRamCfg_en71gl032a0;
                g_MemdFlashCfg = &g_tgtMemdFlashCfg_en71gl032a0;
                g_flash_bank_maks = 0x3<<22;
               FLASH_DEBUG_HST(0x987654);
                #endif
            }
            else if (g_flashID == FLASH_EN71PL032A0)
            {
                g_memdFlashLayout = &g_memdFlashLayout_en71gl032a0;
                g_MemdRamCfg = &g_tgtMemdRamCfg_en71gl032a0;
                g_MemdFlashCfg = &g_tgtMemdFlashCfg_en71gl032a0;
            ...
            else if (g_flashID == FLASH_M36COW5040TOZSP)
            {
                g_memdFlashLayout = &g_memdFlashLayout_m36cow5040tozsp;
                g_MemdRamCfg = &g_tgtMemdRamCfg_m36cow5040tozsp;
                g_MemdFlashCfg = &g_tgtMemdFlashCfg_m36cow5040tozsp;
                FLASH_DEBUG_HST(0x98765432);

            }
            else if (g_flashID == FLASH_SVME3216UTA)
            {
                g_memdFlashLayout = &g_memdFlashLayout_m36cow5040tozsp;
                g_MemdRamCfg = &g_tgtMemdRamCfg_m36cow5040tozsp;
                g_MemdFlashCfg = &g_tgtMemdFlashCfg_m36cow5040tozsp;
            ...
            else if (g_flashID == FLASH_FM91L03216UA)
            {
                g_memdFlashLayout = &g_memdFlashLayout_m36cow5040tozsp;
                g_MemdRamCfg = &g_tgtMemdRamCfg_fm91l03216ua;
                g_MemdFlashCfg = &g_tgtMemdFlashCfg_fm91l03216ua;
...
PUBLIC HAL_FUNC_INTERNAL MEMD_ERR_T memd_FlashErase_First(UINT8 *startFlashAddress, UINT8 *endFlashAddress,UINT32 time)
{
    ...
    if (g_flashID == FLASH_EN71GL032A0 || g_flashID == FLASH_EN71PL032A0 ||g_flashID == FLASH_SVME3216UTA||g_flashID ==FLASH_FM91L03216UA)
    {
...
///            FLASH_DEBUG_HST((UINT32)g_memdFlashLayout->bankLayout[bank_num].sectorLayoutTable[0][0]);
//           FLASH_DEBUG_HST(0x4225);
//           FLASH_DEBUG_HST((UINT32)g_memdFlashLayout->bankLayout[bank_num].sectorLayoutTable[0][1]);
//           FLASH_DEBUG_HST((UINT32)g_memdFlashLayout->bankLayout[bank_num].sectorLayoutTable[1][0]);
//           FLASH_DEBUG_HST(0x4226); 
//           FLASH_DEBUG_HST((UINT32)g_memdFlashLayout->bankLayout[bank_num].sectorLayoutTable[1][1]);
//           FLASH_DEBUG_HST((UINT32)g_memdFlashLayout->bankLayout[bank_num].sectorLayoutTable[2][0]);
//           FLASH_DEBUG_HST(0x4227); 
 //          FLASH_DEBUG_HST((UINT32)g_memdFlashLayout->bankLayout[bank_num].sectorLayoutTable[2][1]);
