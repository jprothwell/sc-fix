...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/memd/flsh_k5l2731caa_d770/src/drv_flsh_map.c $ //
//	$Author: huazeng $                                                        // 
...
PUBLIC CONST MEMD_BANK_LAYOUT_T g_memdFlashBankLayout [NUMBER_OF_BANKS]
     =
{
    { BANK0_BASE, { {8 ,   8*KBYTES}, {31 , 64*KBYTES}, {0 , 0*KBYTES} } },
    { BANK1_BASE, { {96 , 64*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK2_BASE, { {96 , 64*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK3_BASE, { {31 , 64*KBYTES}, {8 , 8*KBYTES}, {0 , 0*KBYTES} } }
};
