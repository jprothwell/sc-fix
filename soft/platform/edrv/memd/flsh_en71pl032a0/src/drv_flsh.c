...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/memd/flsh_en71pl032a0/src/drv_flsh.c $ //
...
/* for eon 4M */
#define FLASHBANK_MASK      (0xF<<19)     // Actually only need 3 bits, but have to use 4 due to shift
