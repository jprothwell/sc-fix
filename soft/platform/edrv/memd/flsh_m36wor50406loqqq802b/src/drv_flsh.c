...
/// flash.   flsh_m36wor50406loqqq802b                                                                   //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
#define FLASHBANK_MASK      (0x1f<<(19))     // Actually only need 1 bits, but have to use 2 due to shift
...
// memd_FlashRead_ID
// -----------------------------------------------------------------------------
/// This function read the flash id . 
//@param index : 0 for Manufactruer ID (result value = x020) ); 1 for Device code (result value = 0x882e)
// =============================================================================
