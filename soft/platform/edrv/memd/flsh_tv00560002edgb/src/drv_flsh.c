...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/memd/flsh_tv00560002edgb/src/drv_flsh.c $ //
//	$Author: huazeng $                                                        // 
...
//                                                                            //
/// @file drv_flsh.c                                                          //
/// That file provides the driver implementation for the flsh_tv00560002edgb      //
/// flash.                                                                    //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
/* for Toshiba 8M */
#define FLASHBANK_MASK      (0x1F<<(21))     // Actually only need 2 bits, but have to use 3 due to shift

#define KBYTES 1024
#define MBYTES (1024*KBYTES)

// Get the page number from the _physical_ flash address
#define GET_PAGE_PHYS(PhysAddr)  (UINT8)(((UINT32)PhysAddr >> 21) & 0x7)
