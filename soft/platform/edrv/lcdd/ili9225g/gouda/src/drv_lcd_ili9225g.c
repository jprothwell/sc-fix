...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/lcdd/ili9225br/gouda/src/drv_lcd_ili9225br.c $ //
//	$Author: qiff $                                                        // 
//	$Date: 2011-01-07 11:31:25 +0800 (Fri, 07 Jan 2011) $                     //   
//	$Revision: 5159 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
LCM_WR_REG(0x0014, 0x0000);  
LCM_WR_REG(0x0011, 0x0041); 
LCM_WR_REG(0x0012, 0x5011); 
LCM_WR_REG(0x0013, 0x0062);  
LCM_WR_REG(0x0014, 0x4959);  
LCM_WR_REG(0x00C7, 0x0303); 

LCM_WR_REG(0x0010, 0x0200);
LCM_WR_REG(0x0011, 0x1041); 
LCM_WR_REG(0x0001, 0x011C); 
LCM_WR_REG(0x0002, 0x0100); 
LCM_WR_REG(0x0003, 0x1030); 
LCM_WR_REG(0x0033, 0x1030); 
LCM_WR_REG(0x0007, 0x0000);
LCM_WR_REG(0x0008, 0x0808);
LCM_WR_REG(0x000B, 0x3100);
...
LCM_WR_REG(0x0050, 0x0001);
LCM_WR_REG(0x0051, 0x030A);
LCM_WR_REG(0x0052, 0x0C04);
LCM_WR_REG(0x0053, 0x0804);
LCM_WR_REG(0x0054, 0x040C);
LCM_WR_REG(0x0055, 0x0A03);
LCM_WR_REG(0x0056, 0x0100);
LCM_WR_REG(0x0057, 0x0408);
LCM_WR_REG(0x0058, 0x0000);
LCM_WR_REG(0x0059, 0x0000);

LCM_WR_REG(0x000F, 0x0701);
...
PRIVATE LCDD_ERR_T lcddp_Sleep(VOID)
{
    ...
    sxr_Sleep(50 MS_WAITING);
    LCM_WR_REG(0x0010, 0x0201); // Enter Standby mode
...
PRIVATE LCDD_ERR_T lcddp_WakeUp(VOID)
{
    ...
    LCM_WR_REG(0x0010, 0x0200); // Exit Sleep/ Standby mode
    sxr_Sleep(50 MS_WAITING);
...
{
   static char ili9225g_id_str[] = "ili9225g\n"; 
   return ili9225g_id_str; 
}
PRIVATE BOOL lcddp_CheckProductId()
{
    ...
    SXS_TRACE(TSTDOUT, "ili9225g(0x%x): lcd read id is 0x%x ", LCD_ILI9225G_ID, productId);

	hal_HstSendEvent(0x1cd00009);
    hal_HstSendEvent(productId);
    

    if(productId == LCD_ILI9225G_ID)
        return TRUE;
    else
        return FALSE;
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL  lcdd_ili9225g_RegInit(LCDD_REG_T *pLcdDrv)
{  
