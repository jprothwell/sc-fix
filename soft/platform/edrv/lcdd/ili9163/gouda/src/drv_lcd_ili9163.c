...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/lcdd/ili9163/gouda/src/drv_lcd_ili9163.c $ //
//	$Author: pengzg $                                                        // 
...
{
   static char ili9163_id_str[] = "ili9163\n"; 
   return ili9163_id_str; 
}
PRIVATE BOOL lcddp_CheckProductId()
{
    ...
    SXS_TRACE(TSTDOUT, "ili9163(0x%x): lcd read id is 0x%x ", LCD_ILI9163_ID, productId);

return TRUE;

    if(productId == LCD_ILI9163_ID)
        return TRUE;
    else
        return FALSE;
}
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL  lcdd_ili9163_RegInit(LCDD_REG_T *pLcdDrv)
{  
