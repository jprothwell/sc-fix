...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/lcdd/ili9163/ebc/src/drv_lcd_ili9163.c $ //
//	$Author: pengzg $                                                        // 
...
PUBLIC LCDD_ERR_T lcdd_FillRect16(CONST LCDD_ROI_T* regionOfInterrest, UINT16 bgColor)
{
    ...
    {        
	    ...
	    LCM_WR_CMD(0x2c); //WRITE ram Data display 
            ...
            lcdd_MutexFree(&g_lcddLock);
#else
#error 16 bits mode without DMA is not valid in this driver now!
#endif
