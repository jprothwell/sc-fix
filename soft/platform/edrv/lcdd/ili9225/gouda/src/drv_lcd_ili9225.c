...
PRIVATE VOID lcddp_Init(VOID)
{
    ...
    if (g_lcddRotate)
    {
        LCM_WR_REG(0x0003, 0x1030);  // 0x1030 ?
    }
    else
    {
        LCM_WR_REG(0x0003, 0x1018);  // set GRAM write direction and BGR=1
    }        
...
PRIVATE LCDD_ERR_T lcddp_SetPixel16(UINT16 x, UINT16 y, UINT16 pixelData)
{
    ...
    else
    {
        ...
        LCM_WR_REG(0x0037,y);
        LCM_WR_REG(0x0036,y);
        LCM_WR_REG(0x0039,LCDD_DISP_X-x-1);
        LCM_WR_REG(0x0038,LCDD_DISP_X-x-1);

            LCM_WR_REG(0x0020,y);
            LCM_WR_REG(0x0021,LCDD_DISP_X-x-1);
...
{
   static char ili9225_id_str[] = "ili9225\n"; 
   return ili9225_id_str; 
}
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL  lcdd_ili9225_RegInit(LCDD_REG_T *pLcdDrv)
{  
