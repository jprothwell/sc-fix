...
////////////////////////////////////////////////////////////////////////////////
//
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/lcdd/lgdp4532/lcdc/src/drv_lcd_lgdp4532.c $
...
PUBLIC LCDD_ERR_T lcdd_Open(VOID)
{
  ...
  LCM_WR_REG(0x0007,0x0000);
	LCM_WR_REG(0x0012,0x0000);	//Power Control 3 (R12h) VRH PON=0
	LCM_WR_REG(0x0013,0x0000);	//Power Control 4 (R13h) VCOMG=0
	hal_TimDelay(40 MS_WAITING);
	
	// Power Set
	LCM_WR_REG(0x0010,0x0600); //Power Control 1 (R10h) BT	
	LCM_WR_REG(0x0011,0x0040); //Power Control 2 (R11h) DC1, DC0, VC
	LCM_WR_REG(0x0012,0x0010); //Power Control 3 (R12h) VRH	
	LCM_WR_REG(0x0013,0x1049); //Power Control 4 (R13h) VDV, VCM	
	LCM_WR_REG(0x0015,0x0030); //RV		

	LCM_WR_REG(0x0010,0x1628); //Power Control 1 (R10h) SAP, AP
	LCM_WR_REG(0x0012,0x0013); //Power Control 4 (R13h) PON=1
	hal_TimDelay(40 MS_WAITING);
  	     	
	LCM_WR_REG(0x0010,0x2620); //Power Control 1 (R10h) DK=0
	LCM_WR_REG(0x0013,0x3052); //Power Control 4 (R13h) VCOMG=1
	hal_TimDelay(100 MS_WAITING);
	
	// Gamma Set
	LCM_WR_REG(0x0030,0x0201);
	LCM_WR_REG(0x0031,0x0007);
	LCM_WR_REG(0x0032,0x0101);
	LCM_WR_REG(0x0033,0x0000);
	LCM_WR_REG(0x0034,0x0004);
	LCM_WR_REG(0x0035,0x0002);
	LCM_WR_REG(0x0036,0x0604);
	LCM_WR_REG(0x0037,0x0000);
	LCM_WR_REG(0x0038,0x0718);
	LCM_WR_REG(0x0039,0x0000);
	LCM_WR_REG(0x003A,0x0200);
	LCM_WR_REG(0x003B,0x0000);
	LCM_WR_REG(0x003C,0x0300);
	LCM_WR_REG(0x003D,0x0002); 
	LCM_WR_REG(0x003E,0x0001); 
	LCM_WR_REG(0x003F,0x0000);  
	hal_TimDelay(40 MS_WAITING);

	// Other Set
	LCM_WR_REG(0x0001,0x0100);//Driver output control (R01h)
	LCM_WR_REG(0x0002,0x0300);//LCD Driving Wave Control (R02h)
	LCM_WR_REG(0x0003,0x1030);//Entry Mode (R03h)
	LCM_WR_REG(0x0008,0x0604);//Display Control 2 (R08h)
	LCM_WR_REG(0x000A,0x0008);//Display Control 4 (R0Ah)
	LCM_WR_REG(0x0041,0x0002);//EPROM Control Register 2 (R41h)
	LCM_WR_REG(0x0060,0x2700);//Driver Output Control (R60h)
	LCM_WR_REG(0x0061,0x0001);//Base Image Display Control (R61h)
	
	LCM_WR_REG(0x0090,0x0184);//Panel Interface Control 1 (R90h)
	LCM_WR_REG(0x0092,0x0105);//Panel Interface Control 2 (R92h)
	LCM_WR_REG(0x0093,0x0101);//Panel Interface Control 3 (R93h)
	LCM_WR_REG(0x00A3,0x0010);//Test Register 4 (RA3h)
	hal_TimDelay(100 MS_WAITING);
...
PUBLIC LCDD_ERR_T lcdd_WakeUp(VOID)
{
		...
		LCM_WR_REG(0x0010,0x0008);
		hal_TimDelay(20 MS_WAITING);
		LCM_WR_REG(0x0011,0x0040);
		LCM_WR_REG(0x0012,0x0010);
		LCM_WR_REG(0x0013,0x1049);
		LCM_WR_REG(0x0015,0x0030);
		
		LCM_WR_REG(0x0010,0x1628);
		LCM_WR_REG(0x0012,0x0013);
		hal_TimDelay(40 MS_WAITING);
		
		LCM_WR_REG(0x0010,0x2620);
		LCM_WR_REG(0x0013,0x3052);
		hal_TimDelay(100 MS_WAITING);
