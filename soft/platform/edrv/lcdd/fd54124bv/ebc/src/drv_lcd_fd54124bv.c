...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/lcdd/fd54124bv/ebc/src/drv_lcd_fd54124bv.c $ //
//	$Author: pengzg $                                                        // 
...
//                                                                            //
/// @file drv_lcd.c                                                           //
/// That file provides an implementation for the fd54124bv LCD screen.         //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
LCM_WR_CMD(0xC5);  // set VcomH
LCM_WR_DATA(0xD1);

LCM_WR_CMD(0xC6);  //set VcomAC
LCM_WR_DATA(0x17);

LCM_WR_CMD(0xE0);  //GAMMA 2.2
        LCM_WR_DATA(0x00);
        LCM_WR_DATA(0x01);
        LCM_WR_DATA(0x0c);
        LCM_WR_DATA(0x29);
...
LCM_WR_CMD(0x35); //Tearing effect line off
LCM_WR_DATA(0x00);
LCM_WR_CMD(0x13);

LCM_WR_CMD(0x3a); // color format seting
LCM_WR_DATA(0x05);

LCM_WR_CMD(0x2a); // Column address set 
LCM_WR_DATA(0x00);
LCM_WR_DATA(0x00);
LCM_WR_DATA(0x00);
LCM_WR_DATA(0x7f);

LCM_WR_CMD(0x2b); //Row address set
LCM_WR_DATA(0x00);
LCM_WR_DATA(0x00);
LCM_WR_DATA(0x00);
LCM_WR_DATA(0x9F); 
...
PUBLIC LCDD_ERR_T lcdd_FillRect16(CONST LCDD_ROI_T* regionOfInterrest, UINT16 bgColor)
{
    ...
    {        
	    ...
	    LCM_WR_CMD(0x2c); //WRITE ram Data display 
            ...
            lcdd_MutexFree(&g_lcddLock);
#else
#error "This driver doesn't support 16 bits transfering without DMA now!"
#endif
