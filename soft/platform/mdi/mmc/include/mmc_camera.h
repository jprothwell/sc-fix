...
#define  CameraAWB_Day					12 /*ÇçÌìÌ«Ñô¹â*/
#define  CameraAWB_Auto				13 
#define  CameraAWB_Office				14 /*ÈÕ¹âµÆ*/
#define  CameraAWB_Cloudy				15 /*ÒõÌì*/
#define  CameraAWB_Alight				16 /*ÎÙË¿µÆ*/
...
#define CameraEffect_Antique				19  /*¸´¹Å*/
#define CameraEffect_Redish				20  /*Æ«ºì*/
#define CameraEffect_Greenish			21  /*Æ«ÂÌ*/
#define CameraEffect_Blueish				22  /*Æ«À¶*/
#define CameraEffect_BlackWhite			23  /*ºÚ°×*/
#define CameraEffect_Negative			24  /*¸ºÆ¬*/
#define CameraEffect_BlackWhite_Negative 25 /*ºÚ°×¸ºÆ¬*/
