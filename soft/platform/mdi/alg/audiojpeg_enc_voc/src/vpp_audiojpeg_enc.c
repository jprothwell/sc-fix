...
#include "vpp_audiojpeg_enc_asm.h"
...
HAL_ERR_T vpp_AudioJpegEncOpen(HAL_VOC_IRQ_HANDLER_T vocIrqHandler) 
{
   ...
   diag_printf("[vpp_AudioJpeg_ENC]Opening VPP AUDIO_ENC\n"); 
    ...
    cfg.vocCodeSize        = vpp_AudioJpeg_ENC_CODE_SIZE;
    cfg.pcVal                   = vpp_AudioJpeg_ENC_CODE_ENTRY;
    cfg.pcValCriticalSecMin  = vpp_AudioJpeg_ENC_CRITICAL_SECTION_MIN;
    cfg.pcValCriticalSecMax  = vpp_AudioJpeg_ENC_CRITICAL_SECTION_MAX;
...
//=============================================================================
// vpp_AudioJpegEncSetMicDigitalGain function
//-----------------------------------------------------------------------------
/// 
//=============================================================================
PUBLIC   VOID vpp_AudioJpegEncSetMicDigitalGain(UINT16 DigitalGain)
{
        
    * ( UINT16 *) hal_VocGetPointer(VPP_GLOBAL_MIC_DIGITAL_GAIN_ADDR_addr)=DigitalGain;
