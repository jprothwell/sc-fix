...
typedef struct
{
	...
	INT16 reset;				 //Global VPP AUDIO_ENC reset, active ¡®1¡¯. It should be automatically cleared by the VPP code.
...
VOID vpp_AudioJpegEncSetMicDigitalGain(UINT16 DigitalGain);
