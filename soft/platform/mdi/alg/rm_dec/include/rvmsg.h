/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: rvmsg.h,v 1.9 2005/04/27 19:35:00 hubbe Exp $
 * 
...
/* $Header: /cvsroot/rarvcode-video/codec/rv89combo/rv89combo_c/cdeclib/rvmsg.h,v 1.9 2005/04/27 19:35:00 hubbe Exp $ */
...
typedef U32     RV_Custom_Message_ID;
...
#define RV_MSG_ID_ExtGetMaxSize		58
typedef struct {

    RV_Custom_Message_ID          message_id;
    INT32                         cmd;
    INT32                         size;
} RV_MSG_ExtGetMaxSize;

#define RV_MSG_ID_ExtGetIndex		59
typedef struct {
...
#define RV_MSG_ID_ExtGetSize_Idx	60
typedef struct {
	...
	INT32						  idx;
    INT32                         size;
} RV_MSG_ExtGetSize_Idx;

#define RV_MSG_ID_ExtSetPtr_Idx		61
typedef struct {
    ...
    INT32                         idx;
    void*                         ptr;
} RV_MSG_ExtSetPtr_Idx;

#define RV_MSG_ID_GetDisplayed_Image_Info 62
typedef struct {
...
} RV_MSG_GetDisplayed_Image_Info;

#define RV_MSG_ID_SetExtVBuf_Size 63
typedef struct {
    RV_Custom_Message_ID          message_id;
    INT32                         cmd;
    UINT32                        usWidth;
    UINT32                        usHeight;
} RV_MSG_SetExtVBuf_Size;
