...
--------------------------------------------------------------------------------
  ...
  Mar 23 05  |  ADA  | sxr_NewCluster: size the memory to be able to allocate
             |       | the requested number of cluster.
  Aug 15 05  |  ADA  | Function sxr_GetClusterInfo.
  Mar 22 06  |  ADA  | Check when cluster size is beyond 64k.
             |       | Check heap functions: not more aborting raise.
  Mar 27 06  |  ADA  | Function: sxr_MemoryAlertDispatchRegistration.
