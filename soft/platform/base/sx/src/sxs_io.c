...
// =============================================================================
// g_sxExternalTraceEnable
// -----------------------------------------------------------------------------
/// Flag holding the state of "We are using another mechanism than SX to output
/// traces so disable the processing on UART please/
/// FIXME Shouldn't this feature be removed as a proper implementation would pass 
/// through a new port index in HAL trace ?
// =============================================================================
PUBLIC UINT32 g_sxExternalTraceEnable = TRUE;
...
void sxs_Raise (u32 Id, const ascii *Fmt, ...)
{
 ...
 u32 oldExtnalTraceFlag = sxs_getExternalTraceFlag();
...
{
	return g_sxExternalTraceEnable;
}
