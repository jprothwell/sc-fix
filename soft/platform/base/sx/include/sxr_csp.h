...
#define SXS_BOOT_DIAG_AREA PAL_HEAP_START(0)

#define SECOND                  * PAL_TICK1S

#define pal_SleepSerial()      
#define pal_WakeUpSerial()      1

#define sxr_Reset(a) hal_SoftReset()
