...
INT32 REG_SetValue(HKEY hKey, PCSTR pcValueName, UINT8 iType, PVOID pvData, UINT8 iDataSize);


INT32 REG_GetValue(HKEY hKey, PCSTR pcValueName, UINT8 *pcType, PVOID pvData, UINT8 *pDataSize);
