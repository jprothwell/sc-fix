...
//
//modify record:
//hameina 2006.8.21 modify the default value to make sure the event is reported by default
//      CNMI_DEFAULT_VALUE        0->1
//      NEW_SMS_DEFAULT_VALUE     0->1
//      AT_REG_DEDAULT            0->1
//hameina 2006.9.1 SMS_OPTION_RANGE    "0-255"->"4-28"
//hameina 2006.9.29. PBK_STORAGE_RANGE add value 32,64
///**************************************************************

/************************************************************************/
/* The ranges for every parameter of configuration.                     */
/************************************************************************/
