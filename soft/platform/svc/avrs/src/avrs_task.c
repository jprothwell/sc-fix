...
////////////////////////////////////////////////////////////////////////////////
//
//  $HeadURL: http://10.10.100.14/svn/developing/Sources/svc/branches/Total_BJ/avrs/src/avrs_task.c $
//  $Author: romuald $
//  $Date: 2009-03-06 20:18:27 +0800 (Fri, 06 Mar 2009) $
//  $Revision: 22658 $
//
////////////////////////////////////////////////////////////////////////////////
//
/// @file avrs_task.c
///
/// This file implements the task of the AVRS service.
/// The picture stream mode handles the video things.
/// The capture mode, taking only one shot, handles the photography things.
//
////////////////////////////////////////////////////////////////////////////////
            ...
            switch (msg->headerId)
            {
                case AVRS_OP_ID_START_PICTURE_STREAM:
                    ...
                    if (!pictureStreamMode)
                    {
                        ...
                        hal_SysRequestFreq(HAL_SYS_FREQ_AVRS, HAL_SYS_FREQ_104M, NULL);
                        stopPictureStreamRequested = FALSE;
                    ...
                    else
                    {
                        ...
                        if (camdMsg->status == CAMD_STATUS_CAPTURE_DONE)
                        {
                            ...
                            else
                            {
                                ...
                                hal_SysRequestFreq(HAL_SYS_FREQ_AVRS, HAL_SYS_FREQ_32K, NULL);
