...
PUBLIC ARS_ERR_T ars_Setup(AUD_ITF_T itf, CONST ARS_AUDIO_CFG_T* cfg)
{
    ...
    g_arsDigitalGain=calibPtr->bb->audio[itf].audioParams.MicDigitalGainInVoC/0x60;
...
{    
    ...
    ARS_TRACE(_PAL| TLEVEL (1), 0, "ARS Start");
    ARS_TRACE(_PAL| TLEVEL (1), 0, "ARS Stream - buffer %#x  %d codec %#x",
