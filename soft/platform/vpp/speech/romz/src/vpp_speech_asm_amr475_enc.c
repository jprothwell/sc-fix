...
//	VoC_lw16_d(REG4,STATIC_CONST_mode_dep_parm_MR475_ADDR);	// REG4 for max_frac_lag
...
AMR_PITCH_FR105:
//	VoC_lw32_d(RL6,STATIC_CONST_mode_dep_parm_MR475_ADDR+2);
...
//	VoC_lw16i_set_inc(REG1,STATIC_trackTable_ADDR,2);
	...
	VoC_loop_i_short(2,DEFAULT);
	VoC_lw16i_short(REG5, 0, IN_PARALLEL); // k
	VoC_startloop0
		...
		VoC_push16(REG1, DEFAULT);
		VoC_lw16_p(REG1, REG3,IN_PARALLEL);
     //REG1    first
...
build_code_M475_100:
		...
		VoC_bez16_r(build_code_M475_100_end, REG1)
...
SEARCH_M475_LOOP_I0:
   ...
   VoC_add16_rd		(REG0,REG4,SEARCH_CODE_DN_ADDR_ADDR);
	...
	VoC_multf32_pd	(ACC0,REG1,CONST_1_4_ADDR);
	VoC_push16		(REG6,DEFAULT);
