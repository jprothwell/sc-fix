...
SEARCH_M59_LOOP_TRACK2:
	...
	VoC_lw16i		(REG0,STATIC_CONST_startPos1_ADDR);
	VoC_lw16i		(REG1,STATIC_CONST_startPos2_ADDR);
	VoC_add16_rd		(REG0,REG0,SEARCH_M74_TRACK_ADDR);
...
code_MR59_400:
 	        ...
 	        VoC_lw16i_short(REG3,1,DEFAULT);
    		VoC_add16_rd(REG6, REG6, CONST_48_ADDR);
