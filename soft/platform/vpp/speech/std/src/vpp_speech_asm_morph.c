...
voc_short gInFIFO_ADDR[256],y
voc_short gOutFIFO_ADDR[256],y
voc_short ingLastPhase_ADDR[130],y
voc_short ingOutputAccum_ADDR[512],y
...
void CII_smbPitchShift(void)
{
	...
	//morph voice const
	VoC_lw32_d(REG45,GLOBAL_MORPH_CONSTY_ADDR);
