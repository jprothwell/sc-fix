...
/*INT16 ADD(INT16 var1, INT16 var2)
{
    ...
    else if (L_sum < (INT32) 0xffff8000L)
    {
        Overflow = 1;
        var_out = MIN_16;
    }
...
/*INT16 SUB (INT16 var1, INT16 var2)
{
	...
	if (L_diff > 0X00007fffL)
    {
        printf("saturation\n");
    }
    else if (L_diff < (INT32) 0xffff8000L)
    {
       printf("saturation\n");
    }
...
/*INT16 mult (INT16 var1, INT16 var2)
{
    ...
    L_product = (L_product & (INT32) 0xffff8000L) >> 15;
...
/*INT16 round (INT32 L_var1)
{
    INT16 var_out;
    INT32 L_rounded;

    //L_rounded = L_add (L_var1, (INT32) 0x00008000L);
	L_ADD(L_var1, (INT32) 0x00008000L, L_rounded);
...
INT32 L_macNs (INT32 L_var3, INT16 var1, INT16 var2)
{
    INT32 L_var_out;
...
INT32 L_msuNs (INT32 L_var3, INT16 var1, INT16 var2)
{
    INT32 L_var_out;
...
/*___________________________________________________________________________
 ...
 |___________________________________________________________________________|
*/
INT32 L_add_c (INT32 L_var1, INT32 L_var2)
{
    INT32 L_var_out;
    INT32 L_test;
    INT32 carry_int = 0;
...
INT32 L_sub_c (INT32 L_var1, INT32 L_var2)
{
    INT32 L_var_out;
    INT32 L_test;
    INT32 carry_int = 0;
    ...
    {
        L_var_out = L_var1 - L_var2 - (INT32) 0X00000001L;
        L_test = L_var1 - L_var2;
...
{
    INT16 var_out;
    register INT32 var3_hi=0;
    register UINT32 var3_lo=0;

    //L_var3 = L_mac (L_var3, var1, var2);
	//L_var3 = L_MAC(L_var3, var1, var2);
    VPP_MLA16 ( var3_hi, var3_lo,  var1, var2);
    L_var3 = VPP_SCALE64_TO_16( var3_hi, var3_lo);
...
INT32 L_shr_r (INT32 L_var1, INT16 var2)
{
    INT32 L_var_out;
...
INT16 div_s (INT16 var1, INT16 var2)
{
    INT16 var_out = 0;
    INT16 iteration;
    INT32 L_num;
