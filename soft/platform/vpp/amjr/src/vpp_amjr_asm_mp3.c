...
// --------------------------
// MP3 global vars in RAM_X
// --------------------------

voc_short OUTPUT_MP3_BUFFER_ADDR,1024,x
voc_short GLOBAL_XW_begine_ADDR, 1024,x

voc_struct VPP_AMJR_MP3_CONST_X_STRUCT,x

    voc_short TABLE_ca_encode_tab_ADDR[16]
    voc_short TABLE_cs_encode_tab_ADDR[16]
    voc_word  TABLE_ew_tab_compressed_ADDR[113]
    voc_short TABLE_t1HB_tab_ADDR[2]
    voc_short TABLE_t2HB_tab_ADDR[5]
    voc_short TABLE_t3HB_tab_ADDR[5]
    voc_short TABLE_t5HB_tab_ADDR[8]
    voc_short TABLE_t6HB_tab_ADDR[8]
    voc_short TABLE_t7HB_tab_ADDR[18]
    voc_short TABLE_t8HB_tab_ADDR[18]
    voc_short TABLE_t9HB_tab_ADDR[18]
    voc_short TABLE_t10HB_tab_ADDR[32]
    voc_short TABLE_t11HB_tab_ADDR[32]
    voc_short TABLE_t12HB_tab_ADDR[32]
    voc_short TABLE_t13HB_tab_ADDR[128]
    voc_short TABLE_t15HB_tab_ADDR[128]
    voc_short TABLE_t16HB_tab_ADDR[256]
    voc_short TABLE_t24HB_tab_ADDR[256]
    voc_short TABLE_t32HB_tab_ADDR[8]
    voc_short TABLE_t33HB_tab_ADDR[8]
    voc_short TABLE_ht_tab_ADDR[170]
    voc_short TABLE_sfBandIndex_tab_ADDR[222]
    voc_short TABLE_subdv_table_tab_ADDR[24]
    voc_short TABLE_coef_tab_ADDR[72]
    voc_short TABLE_encodeSideInfo_tab_ADDR[12]
    voc_short MP3_CONST_inverse_Zig_Zag_ADDR[78]
    voc_short MP3_CONST_1152_ADDR
    voc_short MP3_CONST_NEG7_ADDR
    voc_word  MP3_CONST_1_WORD32_ADDR
    voc_short MP3_CONST_neg1_ADDR
    voc_short MP3_CONST_NEG31_ADDR
    voc_word  MP3_CONST_0x90d0614_ADDR
    voc_word  MP3_CONST_0X28514_165140_ADDR
    voc_word  MP3_CONST_10000_WORD32_ADDR
    voc_word  MP3_CONST_0X33E40_212544_ADDR
    voc_word  MP3_CONST_0X186A0_100000_ADDR
    voc_word  MP3_CONST_8192_WORD32_ADDR
    voc_word  MP3_CONST_0X40000000_ADDR

voc_struct_end

voc_alias   MP3_CONST_0_ADDR           (0 + TABLE_ht_tab_ADDR),x
voc_alias   MP3_CONST_1_ADDR           (1 + MP3_CONST_inverse_Zig_Zag_ADDR),x
...
voc_struct SHINE_GLOBAL_VARS_X_START_ADDR,x
    voc_short STATIC_PartHoldersInitialized_ADDR
    voc_short STATIC_buf_bit_idx_ADDR
    voc_short STATIC_buf_short_idx_ADDR
    voc_short STATIC_buf_long_idx_ADDR
    voc_word  STATIC_buf_chache_ADDR
    voc_word  STATIC_BitCount_ADDR
    voc_word  STATIC_ThisFrameSize_ADDR
    voc_word  STATIC_BitsRemaining_ADDR
    voc_word  GLOBAL_OFF_ADDR
    voc_short STATIC_FIRSTCALL_ADDR
    voc_short GLOBAL_main_data_begin_ADDR
    voc_word  GLOBAL_xrmax_ADDR
    voc_short STATIC_ResvSize_ADDR
    voc_short STATIC_scalefac_band_long_ADDR
    voc_short STATIC_change_ADDR
    voc_short STATIC_nGranules_ADDR
    voc_word  STRUCT_frameData_frameLength_ADDR
    voc_word  GLOBLE_channel_ADDR
voc_struct_end

voc_struct STRUCT_frameData_ADDR,x
    voc_word  STRUCT_frameData_STRUCT_header_ADDR
    voc_word  STRUCT_frameData_STRUCT_frameSI_ADDR
    voc_word  STRUCT_frameData_STRUCT_channelSI_ADDR[2]
    voc_word  STRUCT_frameData_STRUCT_spectrumSI_ADDR[4]
voc_struct_end

// --------------------------
// MP3 global vars in RAM_Y
// --------------------------

voc_struct VPP_AMJR_MP3_CONST_Y_STRUCT,y

    voc_short  STATIC_RQ_ADDR[100]
    voc_short  TABLE_fl_tab_ADDR[992]
    voc_short  TABLE_w_tab_ADDR[36]
    voc_short  TABLE_w2_tab_ADDR[18]
    voc_short  TABLE_win_tab_ADDR[72]
    voc_short  TABLE_pow075_tab_tab_ADDR[24]
    voc_short  TABLE_putmask_tab_ADDR[10]
    voc_short  TABLE_t1l_tab_ADDR[2]
    voc_short  TABLE_t2l_tab_ADDR[5]
    voc_short  TABLE_t3l_tab_ADDR[5]
    voc_short  TABLE_t5l_tab_ADDR[8]
    voc_short  TABLE_t6l_tab_ADDR[8]
    voc_short  TABLE_t7l_tab_ADDR[18]
    voc_short  TABLE_t8l_tab_ADDR[18]
    voc_short  TABLE_t9l_tab_ADDR[18]
    voc_short  TABLE_t10l_tab_ADDR[32]
    voc_short  TABLE_t11l_tab_ADDR[32]
    voc_short  TABLE_t12l_tab_ADDR[32]
    voc_short  TABLE_t13l_tab_ADDR[128]
    voc_short  TABLE_t15l_tab_ADDR[128]
    voc_short  TABLE_t16l_tab_ADDR[128]
    voc_short  TABLE_t24l_tab_ADDR[128]
    voc_short  TABLE_t32l_tab_ADDR[8]
    voc_short  TABLE_t33l_tab_ADDR[8]
...
voc_struct GLOBAL_l3_sb_sample_ADDR,y
    voc_short l3_sb_sample_0_0_0_0_ADDR[1152]
    voc_short l3_sb_sample_0_1_0_0_ADDR[1152]
    voc_short l3_sb_sample_1_0_0_0_ADDR[1152]
    voc_short l3_sb_sample_1_1_0_0_ADDR[1152]
voc_struct_end

voc_struct STRUCT_CONFIG_ADDR,y
    voc_short STRUCT_CONFIG_mpeg_bitrate_index_ADDR
    voc_short STRUCT_CONFIG_mpeg_samplerate_index_ADDR
    voc_short STRUCT_CONFIG_mpeg_padding_ADDR
    voc_short STRUCT_CONFIG_mpeg_type_ADDR
    voc_short STRUCT_CONFIG_mpeg_crc_ADDR
    voc_short STRUCT_CONFIG_mpeg_mode_ADDR
    voc_short STRUCT_CONFIG_mpeg_emph_ADDR
    voc_short STRUCT_CONFIG_mpeg_ext_ADDR
    voc_short STRUCT_CONFIG_mpeg_mode_ext_ADDR
    voc_short STRUCT_CONFIG_mpeg_copyright_ADDR
    voc_word  STRUCT_CONFIG_mpeg_original_ADDR
voc_struct_end

voc_struct STRUCT_SIDEINFO_ADDR,y
    voc_word  STRUCT_SIDEINFO_main_data_begin_ADDR
    voc_word  STRUCT_SIDEINFO_private_bits_ADDR
    voc_word  STRUCT_SIDEINFO_resvDrain_ADDR
    voc_short STRUCT_SIDEINFO_scfsi_ADDR[16]
    voc_short STRUCT_SIDEINFO_gr0_ch0_part2_3_length_ADDR[92]
    voc_short STRUCT_SIDEINFO_gr1_ch0_part2_3_length_ADDR[92]
voc_struct_end
...
void vpp_AmjrMp3Encode(void)
{
    ...
    // --------------------------
    // MP3 local vars in RAM_X
    // --------------------------

    voc_struct GLOBAL_MDCT_FREQ_00_ADDR,x
        voc_short GLOBAL_Z_ADDR[1024]
        voc_short GLOBAL_Y_ADDR[140]
    voc_struct_end

    voc_struct IN_MP3_BUFFER,x
        voc_short IN_MP3_BUFFER_10[576]
        voc_short IN_MP3_BUFFER_11[576]
        voc_short IN_MP3_BUFFER_20[576]
        voc_short IN_MP3_BUFFER_21[576]
    voc_struct_end

    voc_alias GLOBAL_L3ENC_gr1 IN_MP3_BUFFER,x
    voc_short GLOBAL_L3ENC_gr0[2304],x

    voc_short MP3ENC_MP3_CONST_bitrate_map_ADDR[16],x
    voc_word  TABLE_ew_tab_ADDR[250],x

    voc_alias TEMP_MDCT_ADDR        (  0 + GLOBAL_Y_ADDR),x
    voc_alias GLOBAL_mdct_in_ADDR   (  0 + TEMP_MDCT_ADDR),x
    ...
    // --------------------------
    // MP3 local vars in RAM_Y
    // --------------------------

    voc_struct STRUCT_GRINFO_ADDR,y

        voc_word STRUCT_GRINFO_part2_3_length_ADDR
        voc_word STRUCT_GRINFO_big_values_ADDR
        voc_word STRUCT_GRINFO_count1_ADDR
        voc_word STRUCT_GRINFO_global_gain_ADDR
        voc_word STRUCT_GRINFO_scalefac_compress_ADDR
        voc_word STRUCT_GRINFO_table_select_ADDR
        voc_word STRUCT_GRINFO_table_select1_ADDR
        voc_word STRUCT_GRINFO_table_select2_ADDR
        voc_word STRUCT_GRINFO_region0_count_ADDR
        voc_word STRUCT_GRINFO_region1_count_ADDR
        voc_word STRUCT_GRINFO_preflag_ADDR
        voc_word STRUCT_GRINFO_scalefac_scale_ADDR
        voc_word STRUCT_GRINFO_count1table_select_ADDR
        voc_word STRUCT_GRINFO_part2_length_ADDR
        voc_word STRUCT_GRINFO_sfb_lmax_ADDR
        voc_word STRUCT_GRINFO_address1_ADDR
        voc_word STRUCT_GRINFO_address2_ADDR
        voc_word STRUCT_GRINFO_address3_ADDR
        voc_word STRUCT_GRINFO_quantizerStepSize_ADDR
	...
	VoC_bez16_d(LABLE_AFTER_MP3INIT,GLOBAL_RESET);
    VoC_jal(MP3_reset);
LABLE_AFTER_MP3INIT:
...
L3_compress_L0:
	    ...
	    VoC_bne16_rd(LABLE_MP3_MONO,REG2,GLOBAL_IN_STRM_NB_CHAN);
		VoC_jump(LABLE_MP3_STERO);
LABLE_MP3_MONO:
        ///dmai  read data////////////////////
	    VoC_lw32_d(ACC1,GLOBAL_IN_STRM_BUF_START);
...
LABLE_MP3_ENC_BEGIN:
        ...
        //                REG4-> step;
        //                REG5-> size/step;
        //                REG6-> vss mode (0 -> 4,8,32; 1 -> 8,16,32);
        //   Outputs:
        //
        //   Used :       REG01234567
        //
        ...
        VoC_lw16i_set_inc(REG0,TABLE_ew_tab_ADDR,2);
        VoC_lw16i_set_inc(REG1,TABLE_ew_tab_compressed_ADDR,1);
        VoC_lw16i_set_inc(REG2,250,-1);
        VoC_lw16i_set_inc(REG3,3,-1);
...
LABLE_COMPILE_10:
		  ...
		  VoC_jal(CS_L3_format_bitstream);
		   ...
		   VoC_lw32_d(ACC1,GLOBAL_OUT_STRM_BUF_START);//VoC_lw16i(ACC1_HI,0X4000);
		   VoC_sw32_d(REG23,CFG_DMA_SIZE);
	       VoC_sw32_d(ACC1,CFG_DMA_EADDR);
		   ...
		   VoC_lw16i_short(REG2,2,DEFAULT);
		   VoC_bne16_rd(LABLE_CONSUME_LEN,REG2,GLOBAL_IN_STRM_NB_CHAN);
              VoC_shru32_ri(REG45,-1,DEFAULT);
LABLE_CONSUME_LEN:
           VoC_sw32_d(REG67,GLOBAL_STRM_OUT_LEN);
...
void MP3_reset(void)
{
	...
	VoC_bne32_rd(MP3_reset_L0,ACC0,GLOBAL_IN_STRM_SAMPLE_RATE);
...
MP3_reset_L0:
	...
	VoC_bne32_rd(MP3_reset_L1,ACC1,GLOBAL_IN_STRM_SAMPLE_RATE);

    //4800Hz

	VoC_lw16i_short(REG1,1,DEFAULT);
	VoC_lw16_d(REG6,GLOBAL_OUT_STRM_BIT_RATE);
	...
	VoC_jump(MP3_reset_L2);
MP3_reset_L1:
	VoC_bne32_rd(MP3_reset_L2,ACC0,GLOBAL_IN_STRM_SAMPLE_RATE);
...
MP3_reset_L2:
	...
	VoC_lw16i_set_inc(REG0,MP3ENC_MP3_CONST_bitrate_map_ADDR,1);
	VoC_lw16_d(REG1,GLOBAL_OUT_STRM_BIT_RATE);
...
void L3_window_filter_subband(void)
{
	...
	//xw:  k*512 + i + off[k]     //xw[2][512]ÊÇ16-bit
	...
	VoC_lw16inc_p(REG7,REG2,DEFAULT);//xw[k][i+off[k]]
...
void quantize(void)
{
    ...
    voc_word  steptabi_tab_ADDR[128],y

#endif


    // **************************************************************************************
    //   Function:    vpp_AmjrGenerateStepTabi
    //
    //   Description: generate the stepi table used in quantization
    //
    //   Inputs:      REG0-> destination, inrc0=2
    //                REG1-> destination+16, inrc1=2
    //
    //   Outputs:
    //
    //   Used :       REG01, RL67
    ...
    VoC_push16(RA,DEFAULT);
  	...
  	VoC_lw16i_set_inc(REG0,steptabi_tab_ADDR,2);
  	VoC_lw16i_set_inc(REG1,steptabi_tab_ADDR+16,2);

    VoC_jal(vpp_AmjrGenerateStepTabi);

    VoC_pop16(RA,DEFAULT);

	VoC_lw16i(REG0,steptabi_tab_ADDR);//long
...
//	  VoC_lw32_d(ACC1,GLOBAL_OUT_STRM_BUF_START);
...
{
    /* TABLE_steptabi_tab_ADDR
    0x7fffffff ,0x7fffffff ,0x7fffffff ,0x7fffffff ,0x7fffffff ,0x7fffffff ,0x7fffffff ,0x7fffffff ,
    0x6ba27e65 ,0x5a82799a ,0x4c1bf829 ,0x40000000 ,0x35d13f33 ,0x2d413ccd ,0x260dfc14 ,0x20000000 ,
    0x1ae89f99 ,0x16a09e66 ,0x1306fe0a ,0x10000000 ,0x0d744fcd ,0x0b504f33 ,0x09837f05 ,0x08000000 ,
    0x06ba27e6 ,0x05a8279a ,0x04c1bf83 ,0x04000000 ,0x035d13f3 ,0x02d413cd ,0x0260dfc1 ,0x02000000 ,
    0x01ae89fa ,0x016a09e6 ,0x01306fe1 ,0x01000000 ,0x00d744fd ,0x00b504f3 ,0x009837f0 ,0x00800000 ,
    0x006ba27e ,0x005a827a ,0x004c1bf8 ,0x00400000 ,0x0035d13f ,0x002d413d ,0x00260dfc ,0x00200000 ,
    0x001ae8a0 ,0x0016a09e ,0x001306fe ,0x00100000 ,0x000d7450 ,0x000b504f ,0x0009837f ,0x00080000 ,
    0x0006ba28 ,0x0005a828 ,0x0004c1c0 ,0x00040000 ,0x00035d14 ,0x0002d414 ,0x000260e0 ,0x00020000 ,
    0x0001ae8a ,0x00016a0a ,0x00013070 ,0x00010000 ,0x0000d745 ,0x0000b505 ,0x00009838 ,0x00008000 ,
    0x00006ba2 ,0x00005a82 ,0x00004c1c ,0x00004000 ,0x000035d1 ,0x00002d41 ,0x0000260e ,0x00002000 ,
    0x00001ae9 ,0x000016a1 ,0x00001307 ,0x00001000 ,0x00000d74 ,0x00000b50 ,0x00000983 ,0x00000800 ,
    0x000006ba ,0x000005a8 ,0x000004c2 ,0x00000400 ,0x0000035d ,0x000002d4 ,0x00000261 ,0x00000200 ,
    0x000001af ,0x0000016a ,0x00000130 ,0x00000100 ,0x000000d7 ,0x000000b5 ,0x00000098 ,0x00000080 ,
    0x0000006c ,0x0000005b ,0x0000004c ,0x00000040 ,0x00000036 ,0x0000002d ,0x00000026 ,0x00000020 ,
    0x0000001b ,0x00000017 ,0x00000013 ,0x00000010 ,0x0000000d ,0x0000000b ,0x0000000a ,0x00000008 ,
    0x00000007 ,0x00000006 ,0x00000005 ,0x00000004 ,0x00000003 ,0x00000003 ,0x00000002 ,0x00000002 */

    // 0x7fffffff
    VoC_lw16i(RL6_HI,0x7fff);
    ...
    // second line
    VoC_lw16i(RL6_HI,0x6ba2);
    VoC_lw16i(RL6_LO,0x7e65);

    VoC_lw16i(RL6_HI,0x5a82);
    VoC_sw32inc_p(RL6,REG0,DEFAULT);
    VoC_lw16i(RL6_LO,0x799a);

    VoC_lw16i(RL6_HI,0x4c1b);
    VoC_sw32inc_p(RL6,REG0,DEFAULT);
    VoC_lw16i(RL6_LO,0xf829);

    VoC_lw16i(RL6_HI,0x4000);
    VoC_sw32inc_p(RL6,REG0,DEFAULT);
    VoC_lw16i_short(RL6_LO,0x0,IN_PARALLEL);

    VoC_lw16i(RL6_HI,0x35d1);
    VoC_sw32inc_p(RL6,REG0,DEFAULT);
    VoC_lw16i(RL6_LO,0x3f33);

    VoC_lw16i(RL6_HI,0x2d41);
    VoC_sw32inc_p(RL6,REG0,DEFAULT);
    VoC_lw16i(RL6_LO,0x3ccd);

    VoC_lw16i(RL6_HI,0x260d);
    VoC_sw32inc_p(RL6,REG0,DEFAULT);
    VoC_lw16i(RL6_LO,0xfc14);

    VoC_lw16i(RL6_HI,0x2000);
    VoC_sw32inc_p(RL6,REG0,DEFAULT);
    VoC_lw16i_short(RL6_LO,0x0,IN_PARALLEL);

    VoC_lw16i_short(RL7_HI,0,DEFAULT);
    VoC_lw16i_short(RL7_LO,2,IN_PARALLEL);
    ...
    VoC_startloop0
        ...
        // tab[i] = (tab[i-8] + 2) >> 2;
        VoC_add32inc_rp(RL6,RL7,REG1,DEFAULT);
    ...
    VoC_pop16(REG1,DEFAULT);
    VoC_lw16i_short(RL7_HI,0,DEFAULT);
    VoC_lw16i_short(RL7_LO,8,IN_PARALLEL);
    ...
    // correct 4 values (indexes : 17, 72, 73, 86)
    VoC_pop16(REG0,DEFAULT);
    VoC_lw16i_short(REG1,17*2,IN_PARALLEL);
    ...
    // tab[17]--
    VoC_sub32_pr(RL6,REG0,RL7,DEFAULT);
    VoC_lw16i_short(REG1,(72-17)*2,IN_PARALLEL);
    ...
    // store tab[72], increment
    VoC_sw32inc_p(RL6,REG0,DEFAULT);

    // tab[73]--
    VoC_sub32_pr(RL6,REG0,RL7,DEFAULT);
    VoC_lw16i_short(REG1,(86-73)*2,IN_PARALLEL);
