...
// Deadlock counter for BCPU Handshake
#define PAL_DEADLOCK_COUNTER            0x7FFU
...
#define PAL_STACK_SYS_FREQ_DEFAULT      HAL_SYS_FREQ_39M //HAL_SYS_FREQ_26M
#define PAL_STACK_SYS_FREQ_GPRS         HAL_SYS_FREQ_78M

#define PAL_BCPU_SYS_FREQ_DEFAULT       HAL_SYS_FREQ_39M //HAL_SYS_FREQ_26M
#define PAL_BCPU_SYS_FREQ_HIGH_ACTIVITY HAL_SYS_FREQ_39M
#define PAL_BCPU_SYS_FREQ_DUMMY_PCH     HAL_SYS_FREQ_39M
...
typedef struct
{
    INT16  Freq; // Asked Freq correction
    UINT16  Arfcn;
...
typedef struct
{
    ...
    UINT8   MonGain[MBOX_CTX_SNAP_QTY][MBOX_MONIT_WIN_QTY+MBOX_MONIT_EXT_WIN_QTY]; // Monitoring Gain buffer
