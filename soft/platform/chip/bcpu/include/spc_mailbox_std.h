...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/bcpu/include/spc_mailbox_std.h $                                                                   
//  $Author: kongdq $                                                                    
//  $Date: 2011-04-14 12:11:10 +0800 (Thu, 14 Apr 2011) $                                                                      
//  $Revision: 7071 $                                                                  
//                                                                              
//==============================================================================
//
...
#ifndef _SPC_MAILBOX_STD_H_
#define _SPC_MAILBOX_STD_H_
...
} SPC_MBOX_PAL_TO_SPC_T; //Size : 0xDC
...
typedef struct
{
    ...
    /// structure used to exchange BCPU processing results
    SPC_MBOX_SPC_TO_PAL_T          spc2pal;                      //0x000000DC
    /// external reference for extra windows
    SPC_MBX_EXT_T*                 extRef;                       //0x0000020C
    UINT32                         rxOnTcoSettings;              //0x00000210
    UINT16                         dummyPchResult;               //0x00000214
    UINT16                         dummyPchThresh;               //0x00000216
