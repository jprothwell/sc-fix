...
PROTECTED SPP_EGPRS_IR_CTX_T g_Egprs_Ir_Ctx __attribute__((section("BB_SPC_CTX_SECTION")));
PROTECTED UINT32 g_Egprs_Softbit_Buff[87*2] __attribute__((section("BB_SPC_CTX_SECTION")));
#endif
...
//=============================================================================
PRIVATE VOID spc_FcchProcess(VOID)
{
...
//=============================================================================
PRIVATE VOID spc_MonitoringProcess(UINT8 rxCount, UINT8 winIdx)
{
    UINT32 Power;
...
//=============================================================================
PRIVATE VOID spc_SetFacch(SPC_RX_LOCALS_T *spRx)
{
    UINT8 i,j,k,l,itlv;
    itlv=22;
...
//=============================================================================
PRIVATE VOID spc_BfiFilter(VOID)
{
...
//=============================================================================
PRIVATE VOID spc_VocBfiFilter(SPC_RX_LOCALS_T *spRx)
{
...
/// encMode & decMode
//=============================================================================
PRIVATE UINT16 spc_SppToMboxSpeechMode(SPP_SPEECH_MODE_T enc, SPP_SPEECH_MODE_T dec)   
{
...
//=============================================================================
PRIVATE VOID spc_UpdateSpeechDec(SPC_RX_LOCALS_T *spRx)
{
    UINT16 *Addr16;
    UINT8 voc_bfi;
    UINT8 i;
...
//=============================================================================
PRIVATE VOID spc_CheckLoopMode(SPC_RX_LOCALS_T *spRx)
{
    UINT8 i;
...
//=============================================================================
PRIVATE VOID spc_CCHRxProcess(SPC_RX_LOCALS_T *spRx)
{
...
//=============================================================================
PROTECTED VOID spc_EgprsBlockDecode(UINT8 bufferindex, UINT8 slot)
{
    UINT32* SoftBitAddress=g_spcCtx->ItlvBufRxCtrl;
...
/// This function processes the Normal Burst Equalization for Control Channel
//=============================================================================
PRIVATE VOID spc_EgprsCCHRxProcess(SPC_RX_LOCALS_T *spRx)
{
...
/// This function processes the Normal Burst Equalization for Control Channel
//=============================================================================
PRIVATE VOID spc_TCHRxProcess(SPC_RX_LOCALS_T *spRx)
{
...
//=============================================================================
PRIVATE VOID spc_NBurstProcess(SPC_RX_LOCALS_T *spRx)
{
