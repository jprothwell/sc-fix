...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/halp_usb_monitor.h $                                                                   
//    $Author: admin $                                                                    
...
typedef enum {
    ...
    HAL_HOST_USB_STATE_SXS_DATA                 = 0x00000005,
    HAL_HOST_USB_STATE_SXS_RID                  = 0x00000006,
    HAL_HOST_USB_STATE_SXS_READ_SIZE            = 0x00000007
