...
////////////////////////////////////////////////////////////////////////////////
//                                                                            
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_debug.c $
//    $Author: admin $                                                       
...
// FIXME: Implement that through a real IOmuxing driver
    ...
    hwp_extApb->Alt_mux_select &= ~REGS_DEBUG_PORT_MASK;
...
#if (CHIP_DEBUG_PORT_PXTS_EXL_CLK_INV_POL == 1)
...
#else
    hwp_debugPort->Signal_Spy_Cfg = 
        (rxOn?DEBUG_PORT_DBG_BUS_RXTX_SEL0_RX_ON:DEBUG_PORT_DBG_BUS_RXTX_SEL0_GMSK_ON)
      | (txOn?DEBUG_PORT_DBG_BUS_RXTX_SEL1_TX_ON:DEBUG_PORT_DBG_BUS_RXTX_SEL1_RX_DEC_ON)
      | DEBUG_PORT_DBG_BUS_MODE(busMode)
      | DEBUG_PORT_DBG_BUS_SIG_SEL0(irqSel1)
      | DEBUG_PORT_DBG_BUS_SIG_SEL1(irqSel2);
