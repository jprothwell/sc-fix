...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_ispi.c $
//  $Author: huazeng $                                                      
...
PRIVATE HAL_ISPI_PROP_T g_halIspiProperties
         =
{
...
PROTECTED VOID hal_IspiUpdateDivider(HAL_SYS_FREQ_T sysFreq)
{
    ...
    // Apply change
     cfg = hwp_spi3->cfg &  ~SPI_CLOCK_DIVIDER_MASK;
     hwp_spi3->cfg = cfg | SPI_CLOCK_DIVIDER(clkDivider);  
}
