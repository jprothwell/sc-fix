...
////////////////////////////////////////////////////////////////////////////////
//
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/halp_sys.h $
//  $Author: admin $
...
typedef enum
{
    ...
    HAL_SYS_FREQ_SDMMC,
    HAL_SYS_FREQ_LCD,
    HAL_SYS_FREQ_CLK_OUT, // 15
    HAL_SYS_FREQ_STEREO,
    HAL_SYS_FREQ_CAMCLK,
    HAL_SYS_FREQ_USB,
    HAL_SYS_FREQ_DMA,
    HAL_SYS_FREQ_SYS_LAST_USER=HAL_SYS_FREQ_DMA,
    
// Count exactly, but here we are at about 20
// This is checked in hal_SysSetupSystemClock, PROTECTED function
// called only once during hal_init().
    HAL_SYS_USER_START = HAL_SYS_FREQ_PAL ,
...
// ============================================================================
PROTECTED EXPORT UINT32 g_sysCtrlSelPll;
#endif
...
{
    hwp_sysCtrl->Cfg_Clk_PWM = (divider-1);
}
