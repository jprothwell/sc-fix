...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_uart.c $ //
//    $Author: huazeng $                                                        // 
//    $Date: 2010-07-26 11:28:09 +0800 (Mon, 26 Jul 2010) $                     //   
//    $Revision: 743 $                                                        //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
PUBLIC VOID hal_UartClose(HAL_UART_ID_T id)
{
...

    {
        ...
        {
            if(g_halUartPropArray[id-1].opened)
            {
                enable = TRUE;
                break;
            }
...
PUBLIC UINT32 hal_UartGetData(HAL_UART_ID_T id, UINT8* destAddress, UINT32 length)
{
    ...
    else
    {
        ...
        {
            g_halUartHwpArray[id-1]->irq_cause = HAL_UART_IRQ_STATUS_RXDMATIMEOUT;
            g_halUartHwpArray[id-1]->irq_mask |= HAL_UART_IRQ_STATUS_RXDMATIMEOUT;
        }
...
PUBLIC VOID hal_UartAllowSleep(HAL_UART_ID_T id, BOOL allow)
{
    ...
    // TODO: implement.
    HAL_ASSERT(FALSE, "This function is not implemented yet");
}
