...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_profile.c $ //
//    $Author: huazeng $                                                        // 
...
//                                                                            //
/// @file hal_profile.c                                                       //
/// That file provides the profiling functions implementation.                //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
PUBLIC UINT32 g_pxts_buffer[PXTX_BUF_SIZE];
...
PUBLIC VOID hal_DbgPxtsProfileTask(HAL_DBG_PXTS_LEVEL_T level,
                                   UINT16 taskId)
{
    hal_DbgPxtsSendCode(level, CPTASKSPACESTART|((taskId) & CPTASKSPACEMASK));
}
...
PUBLIC VOID hal_DbgPxtsProfileJobEnter(HAL_DBG_PXTS_LEVEL_T level,
                                       UINT16 jobId)
{
    hal_DbgPxtsSendCode(level, CPJOBPACESTART + (jobId & CPMASK));
}
...
PUBLIC VOID hal_DbgPxtsProfileJobExit(HAL_DBG_PXTS_LEVEL_T level,
                                      UINT16 jobId)
{
    hal_DbgPxtsSendCode(level, (CPJOBPACESTART + (jobId & CPMASK))|CPEXITFLAG);
}
                                                      ...
                                                      UINT16 maskLevel)
{
    ...
    *pConfig = 0;
    ...
    if (ramMode == TRUE)
    {
        *pConfig |= HAL_PROFILE_CONTROL_GLOBAL_ENABLE_RAM;
    }
    else
    {
        *pConfig |= HAL_PROFILE_CONTROL_GLOBAL_ENABLE_TRACE;
    }
}
