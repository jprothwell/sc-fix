...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_sys_ifc.c $ //
//    $Author: admin $                                                        // 
...
PROTECTED VOID hal_IfcChannelRelease(HAL_IFC_REQUEST_ID_T requestId, UINT8 channel)
{
    ...
    if (g_halModuleIfcChannelOwner[channel] == requestId)
    {
        ...
        hwp_sysIfc->std_ch[channel].control = (SYS_IFC_REQ_SRC(requestId) | SYS_IFC_DISABLE);
