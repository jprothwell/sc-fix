...
////////////////////////////////////////////////////////////////////////////////
//
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_usb_monitor.c $
//  $Author: admin $
...
PRIVATE HAL_HOST_USB_MONITOR_VAR_T** g_HalHostUsbVar =
    (HAL_HOST_USB_MONITOR_VAR_T**)0x80e00ffc;
#elif (CHIP_ASIC_ID == CHIP_ASIC_ID_GALLITE)
PRIVATE HAL_HOST_USB_MONITOR_VAR_T** g_HalHostUsbVar =
    (HAL_HOST_USB_MONITOR_VAR_T**)0x81e00ffc;
...
PRIVATE HAL_HOST_USB_MONITOR_CTX_T  g_halHostUsbContext;
...
PRIVATE UINT8 hal_HostUsbDecode(UINT8 *data, UINT32 size)
{
    ...
    while(pos + (*g_HalHostUsbVar)->Residue < size)
    {
        ...
        case HAL_HOST_USB_STATE_SXS_ADDR:
            ...
            else
            {
                ...
                case HAL_HOST_USB_CMD_RW_WRITE:
                    (*g_HalHostUsbVar)->State     = HAL_HOST_USB_STATE_SXS_DATA;
        ...
        case HAL_HOST_USB_STATE_SXS_DATA:
...
// =============================================================================
PUBLIC HAL_USB_DEVICE_DESCRIPTOR_T* hal_HostUsbDeviceCallback(VOID)
{
...
#else // HAL_USB_DRIVER_DONT_USE_ROMED_CODE == 1
...
PUBLIC HAL_USB_INTERFACE_DESCRIPTOR_T* hal_HostUsbOpen(VOID)
{
    ...
    // FIXME: check this
    boot_HostUsbOpen(&g_halHostUsbContext, hal_TraceUsbCallback,
