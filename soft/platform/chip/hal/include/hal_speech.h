...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/include/hal_speech.h $                                                                   
//  $Author: admin $                                                                    
...
/// side to acoustic world. PAL accesses this FIFO through #hal_SpeechPushRxPopTx,
/// which puts received audio data in the Fifo and takes out audio data to send.
/// 
///  @par On the other side, #hal_SpeechPopRxPushTx is aimed to be used by the VOIS
