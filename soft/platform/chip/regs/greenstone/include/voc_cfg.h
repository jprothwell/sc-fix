...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/greenstone/include/voc_cfg.h $                                                                   
//    $Author: admin $                                                                    
...
/// 
// =============================================================================
#define REG_VOC_CFG_BASE            0x00B1FF80
...
typedef volatile struct
{
    ...
    REG32 Reserved_00000010[2];                 //0x00000010
    ...
    /// Logical AND of Wakeup_Status and Wakeup_Mask (show only the enabled events).
...
//DMA_EAddr
#define VOC_CFG_DMA_EADDR(n)        (((n)&0x7FFFFF)<<2)
#define VOC_CFG_DMA_EADDR_MASK      (0x7FFFFF<<2)
