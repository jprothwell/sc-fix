...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/greenstone/include/sys_irq.h $                                                                   
//    $Author: admin $                                                                    
...
/// 
// =============================================================================
#define REG_SYS_IRQ_BASE            0x00B81000
...
#define SYS_IRQ_SYS_IRQ_DMA_TX_SDMMC (1<<3)
#define SYS_IRQ_SYS_IRQ_DMA_RX_SDMMC (1<<4)
#define SYS_IRQ_SYS_IRQ_DMA_TX_LCDC (1<<5)
#define SYS_IRQ_SYS_IRQ_DMA_RX_CAMERA (1<<6)
#define SYS_IRQ_SYS_IRQ_COM0        (1<<7)
#define SYS_IRQ_SYS_IRQ_COM1        (1<<8)
#define SYS_IRQ_SYS_IRQ_VOC         (1<<9)
#define SYS_IRQ_SYS_IRQ_DMA         (1<<10)
#define SYS_IRQ_SYS_IRQ_GPIO        (1<<11)
#define SYS_IRQ_SYS_IRQ_KEYPAD      (1<<12)
#define SYS_IRQ_SYS_IRQ_TIMERS      (1<<13)
#define SYS_IRQ_SYS_IRQ_OS_TIMER    (1<<14)
#define SYS_IRQ_SYS_IRQ_CALENDAR    (1<<15)
#define SYS_IRQ_SYS_IRQ_SPI         (1<<16)
#define SYS_IRQ_SYS_IRQ_SPI2        (1<<17)
#define SYS_IRQ_SYS_IRQ_DEBUG_UART  (1<<18)
#define SYS_IRQ_SYS_IRQ_UART        (1<<19)
#define SYS_IRQ_SYS_IRQ_UART2       (1<<20)
#define SYS_IRQ_SYS_IRQ_I2C         (1<<21)
#define SYS_IRQ_SYS_IRQ_SCI         (1<<22)
#define SYS_IRQ_SYS_IRQ_RF_SPI      (1<<23)
#define SYS_IRQ_SYS_IRQ_LPS         (1<<24)
#define SYS_IRQ_SYS_IRQ_BBIFC0      (1<<25)
#define SYS_IRQ_SYS_IRQ_BBIFC1      (1<<26)
#define SYS_IRQ_SYS_IRQ_USBC        (1<<27)
#define SYS_IRQ_SYS_IRQ_LCDC        (1<<28)
#define SYS_IRQ_SYS_IRQ_SDMMC       (1<<29)
#define SYS_IRQ_SYS_IRQ_CAMERA      (1<<30)
#define SYS_IRQ_SYS_IRQ_EXTAPB      (1<<31)
...
//#define SYS_IRQ_SYS_IRQ_DMA_TX_LCDC (1<<5)
//#define SYS_IRQ_SYS_IRQ_DMA_RX_CAMERA (1<<6)
#define SYS_IRQ_PULSE_MASK_SET(n)   (((n)&0x7F)<<0)
#define SYS_IRQ_PULSE_MASK_SET_MASK (0x7F<<0)
...
//#define SYS_IRQ_SYS_IRQ_DMA_TX_LCDC (1<<5)
//#define SYS_IRQ_SYS_IRQ_DMA_RX_CAMERA (1<<6)
#define SYS_IRQ_PULSE_MASK_CLR(n)   (((n)&0x7F)<<0)
#define SYS_IRQ_PULSE_MASK_CLR_MASK (0x7F<<0)
...
//#define SYS_IRQ_SYS_IRQ_DMA_TX_LCDC (1<<5)
//#define SYS_IRQ_SYS_IRQ_DMA_RX_CAMERA (1<<6)
#define SYS_IRQ_PULSE_CLR(n)        (((n)&0x7F)<<0)
#define SYS_IRQ_PULSE_CLR_MASK      (0x7F<<0)
