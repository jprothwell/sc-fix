...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/greenstone/include/mem_bridge.h $                                                                   
//    $Author: admin $                                                                    
...
typedef volatile struct
{
    ...
    REG32 Reserved_00000128[54];                //0x00000128
...
typedef volatile struct
{
    ...
    /// read would do anyway) but this does not access external controller.
    REG32                          Flush;                        //0x00000000
    REG32                          EBC_CRE;                      //0x00000004
    REG32                          EBC_Flash_Block_Remap;        //0x00000008
...
typedef volatile struct
{
    UINT8 ram_array[1048576];                   //0x00000000
} HWP_EBC_CS2_T;

#define hwp_cs2                     ((HWP_EBC_CS2_T*) KSEG1(REG_CS2_BASE))
...
#define hwp_cs3                     ((HWP_EBC_CS3_T*) KSEG1(REG_CS3_BASE))
...
#define hwp_cs4                     ((HWP_EBC_CS4_T*) KSEG1(REG_CS4_BASE))
