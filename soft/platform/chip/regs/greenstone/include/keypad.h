...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/greenstone/include/keypad.h $                                                                   
//    $Author: admin $                                                                    
...
/// 
// =============================================================================
#define REG_KEYPAD_BASE             0x00B85000
...
typedef volatile struct
{
    ...
    REG32                          KP_CTRL;                      //0x00000008
    REG32                          KP_IRQ_CAUSE;                 //0x0000000C
    REG32                          KP_IRQ_CLR;                   //0x00000010
} HWP_KEYPAD_T;
...
//KP_DATA_L
#define KEYPAD_KP_DATA_L(n)         (((n)&0x3FFFFFFF)<<0)
#define KEYPAD_KP_DATA_L_MASK       (0x3FFFFFFF<<0)
...
//KP_DATA_H
#define KEYPAD_KP_DATA_H(n)         (((n)&0x3F)<<0)
#define KEYPAD_KP_DATA_H_MASK       (0x3F<<0)
#define KEYPAD_KP_DATA_H_SHIFT      (0)

//KP_CTRL
#define KEYPAD_KP_EN                (1<<0)
#define KEYPAD_KP_EVT0_IRQ_MASK     (1<<1)
#define KEYPAD_KP_EVT1_IRQ_MASK     (1<<2)
#define KEYPAD_KP_ITV_IRQ_MASK      (1<<3)
#define KEYPAD_KP_DBN_TIME(n)       (((n)&0xFF)<<4)
#define KEYPAD_KP_ITV_TIME(n)       (((n)&0x3F)<<12)
#define KEYPAD_KP_IN_MASK(n)        (((n)&0x3F)<<18)
#define KEYPAD_KP_OUT_MASK(n)       (((n)&0x3F)<<24)
