...
#define TCO_GMSK_ON                              (10)
#define TCO_TX_OEN                               (11)
#define TCO_TX_ON                                (12)
#define TCO_RX_ON                                (13)
#define TCO_RX_DEC_ON                            (14)
...
#define BCPU_TCU_IRQ0                            (41)
/// Trigger BCPU TCU irq 1
#define BCPU_TCU_IRQ1                            (42)
/// Trigger XCPU TCU irq 0
#define XCPU_TCU_IRQ0                            (43)
/// Trigger XCPU TCU irq 1
#define XCPU_TCU_IRQ1                            (44)
/// End of the WakeUp Mode
#define WAKEUP_DONE                              (45)
#define NO_EVENT                                 (63)
