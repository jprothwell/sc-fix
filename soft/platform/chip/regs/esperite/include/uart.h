...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/esperite/include/uart.h $                                                                   
//  $Author: admin $                                                                    
...
typedef volatile struct
{
    ...
    REG32                          CMD_Set;                      //0x0000001C
    REG32                          CMD_Clr;                      //0x00000020
} HWP_UART_T;
