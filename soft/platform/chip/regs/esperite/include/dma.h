...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/esperite/include/dma.h $                                                                   
//  $Author: admin $                                                                    
...
#define DMA_GEA_ALGORITHM(n)        (((n)&3)<<13)
#define DMA_GEA_ALGORITHM_GEA1      (0<<13)
#define DMA_GEA_ALGORITHM_GEA2      (1<<13)
#define DMA_GEA_ALGORITHM_GEA3      (2<<13)
#define DMA_GEA_DIRECTION           (1<<15)
#define DMA_GEA_DIRECTION_SHIFT     (15)
...
//xfer_size
#define DMA_TRANSFER_SIZE(n)        (((n)&0x1FFFF)<<0)
