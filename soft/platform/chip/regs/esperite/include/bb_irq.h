...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/esperite/include/bb_irq.h $                                                                   
//  $Author: admin $                                                                    
...
/// 
// =============================================================================
#define REG_BB_IRQ_BASE             0x01903000
...
#define BB_IRQ_BB_IRQ_DMASC         (1<<14)
#define BB_IRQ_CAUSE(n)             (((n)&0x7FFF)<<0)
#define BB_IRQ_CAUSE_MASK           (0x7FFF<<0)
...
//#define BB_IRQ_BB_IRQ_XCOR        (1<<13)
//#define BB_IRQ_BB_IRQ_DMASC       (1<<14)
#define BB_IRQ_STATUS(n)            (((n)&0x7FFF)<<0)
#define BB_IRQ_STATUS_MASK          (0x7FFF<<0)
...
//#define BB_IRQ_BB_IRQ_XCOR        (1<<13)
//#define BB_IRQ_BB_IRQ_DMASC       (1<<14)
#define BB_IRQ_MASK_SET(n)          (((n)&0x7FFF)<<0)
#define BB_IRQ_MASK_SET_MASK        (0x7FFF<<0)
...
//#define BB_IRQ_BB_IRQ_XCOR        (1<<13)
//#define BB_IRQ_BB_IRQ_DMASC       (1<<14)
#define BB_IRQ_MASK_CLR(n)          (((n)&0x7FFF)<<0)
#define BB_IRQ_MASK_CLR_MASK        (0x7FFF<<0)
...
//#define BB_IRQ_BB_IRQ_XCOR        (1<<13)
//#define BB_IRQ_BB_IRQ_DMASC       (1<<14)
#define BB_IRQ_WAKEUP_MASK(n)       (((n)&0x7FFF)<<0)
#define BB_IRQ_WAKEUP_MASK_MASK     (0x7FFF<<0)
...
//#define BB_IRQ_BB_IRQ_TCU1        (1<<1)
//#define BB_IRQ_BB_IRQ_FRAME       (1<<2)
//#define BB_IRQ_STATUS(n)          (((n)&7)<<0)
//#define BB_IRQ_STATUS_MASK        (7<<0)
//#define BB_IRQ_STATUS_SHIFT       (0)
