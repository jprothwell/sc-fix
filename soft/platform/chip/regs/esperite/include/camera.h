...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/esperite/include/camera.h $                                                                   
//  $Author: admin $                                                                    
...
/// 
// =============================================================================
#define REG_CAMERA_BASE             0x01A17000
...
#define CAMERA_DATAFORMAT_JPEG      (10<<4)
#define CAMERA_DATAFORMAT_RESERVE   (1<<4)
...
#define CAMERA_DECIMFRM_DIV_3       (10<<16)
#define CAMERA_DECIMFRM_DIV_4       (11<<16)
#define CAMERA_DECIMCOL(n)          (((n)&3)<<18)
#define CAMERA_DECIMCOL_ORIGINAL    (0<<18)
#define CAMERA_DECIMCOL_DIV_2       (1<<18)
#define CAMERA_DECIMCOL_DIV_3       (10<<18)
#define CAMERA_DECIMCOL_DIV_4       (11<<18)
#define CAMERA_DECIMROW(n)          (((n)&3)<<20)
#define CAMERA_DECIMROW_ORIGINAL    (0<<20)
#define CAMERA_DECIMROW_DIV_2       (1<<20)
#define CAMERA_DECIMROW_DIV_3       (10<<20)
#define CAMERA_DECIMROW_DIV_4       (11<<20)
