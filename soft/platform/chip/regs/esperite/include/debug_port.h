...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/esperite/include/debug_port.h $                                                                   
//  $Author: admin $                                                                    
...
typedef enum
{
    ...
    DBG_SEL_RF_SPI                              = 0x00000005,
    DBG_SEL_TCU                                 = 0x00000006,
    DBG_SEL_SYSD_OSC                            = 0x00000007,
    DBG_SEL_SYSD_PWM                            = 0x00000008,
    DBG_SEL_XCPU                                = 0x00000009,
    DBG_SEL_BBD_DAIS_208K                       = 0x0000000A,
    DBG_SEL_HOST                                = 0x0000000B,
    DBG_SEL_AUDIO_PLL                           = 0x0000000C,
    DBG_SEL_AUDIO_BCK                           = 0x0000000D,
    DBG_SEL_CLK_DBG_PLL                         = 0x0000000E,
    DBG_SEL_CLK_DBG                             = 0x0000000F,
    DBG_SEL_UART                                = 0x00000010,
    DBG_SEL_UART2                               = 0x00000011,
    DBG_SEL_RF_RX                               = 0x00000012,
    DBG_SEL_RF_TX                               = 0x00000013,
    DBG_SEL_MEM_BRIDGE                          = 0x00000014,
    DBG_SEL_VOC                                 = 0x00000015,
    DBG_SEL_32K                                 = 0x00000016,
    DBG_SEL_USBPHY                              = 0x00000017,
    DBG_SEL_CAMERA                              = 0x00000018,
    DBG_SEL_PIX                                 = 0x00000019,
    DBG_SEL_GPADC                               = 0x0000001A,
/// this clock is taken before clock root
    DBG_SEL_OSC                                 = 0x0000001B,
/// this clock is taken before clock root
    DBG_SEL_REF                                 = 0x0000001C,
/// this clock is taken before clock root
    DBG_SEL_SLOW                                = 0x0000001D,
/// this clock is taken before clock root
    DBG_SEL_FAST_PLL                            = 0x0000001E,
/// this clock is taken before clock root
    DBG_SEL_VOC_PLL                             = 0x0000001F,
/// this clock is taken before clock root
    DBG_SEL_SYS_156M_PLL                        = 0x00000020
} DEBUG_MUX_CLOCKS_T;

#define NB_CLK_DBG_SEL                           (33)
...
typedef enum
{
    ...
    DBG_SYS_IRQ_GPADC                           = 0x0000001E,
    DBG_SYS_IRQ_PMU                             = 0x0000001F,
...
/// 
// =============================================================================
#define REG_DEBUG_PORT_BASE         0x01A0C000
...
#define DEBUG_PORT_DBG_BUS_SIG_SEL1_DBG_SYS_IRQ_GPADC (0x1E<<16)
#define DEBUG_PORT_DBG_BUS_SIG_SEL1_DBG_SYS_IRQ_PMU (0x1F<<16)
...
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_RF_SPI (0x5<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_TCU (0x6<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_SYSD_OSC (0x7<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_SYSD_PWM (0x8<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_XCPU (0x9<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_BBD_DAIS_208K (0xA<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_HOST (0xB<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_AUDIO_PLL (0xC<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_AUDIO_BCK (0xD<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_CLK_DBG_PLL (0xE<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_CLK_DBG (0xF<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_UART (0x10<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_UART2 (0x11<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_RF_RX (0x12<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_RF_TX (0x13<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_MEM_BRIDGE (0x14<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_VOC (0x15<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_32K (0x16<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_USBPHY (0x17<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_CAMERA (0x18<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_PIX (0x19<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_GPADC (0x1A<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_OSC (0x1B<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_REF (0x1C<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_SLOW (0x1D<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_FAST_PLL (0x1E<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_VOC_PLL (0x1F<<0)
#define DEBUG_PORT_SEL_SOURCE_DBG_SEL_SYS_156M_PLL (0x20<<0)
