...
#define DBG_SEL_RF_SPI                           (5)
#define DBG_SEL_TCU                              (6)
#define DBG_SEL_SYSD_OSC                         (7)
#define DBG_SEL_SYSD_PWM                         (8)
#define DBG_SEL_XCPU                             (9)
#define DBG_SEL_BBD_DAIS_208K                    (10)
#define DBG_SEL_HOST                             (11)
#define DBG_SEL_AUDIO_PLL                        (12)
#define DBG_SEL_AUDIO_BCK                        (13)
#define DBG_SEL_CLK_DBG_PLL                      (14)
#define DBG_SEL_CLK_DBG                          (15)
#define DBG_SEL_UART                             (16)
#define DBG_SEL_UART2                            (17)
#define DBG_SEL_RF_RX                            (18)
#define DBG_SEL_RF_TX                            (19)
#define DBG_SEL_MEM_BRIDGE                       (20)
#define DBG_SEL_VOC                              (21)
#define DBG_SEL_32K                              (22)
#define DBG_SEL_USBPHY                           (23)
#define DBG_SEL_CAMERA                           (24)
#define DBG_SEL_PIX                              (25)
#define DBG_SEL_GPADC                            (26)
/// this clock is taken before clock root
#define DBG_SEL_OSC                              (27)
/// this clock is taken before clock root
#define DBG_SEL_REF                              (28)
/// this clock is taken before clock root
#define DBG_SEL_SLOW                             (29)
/// this clock is taken before clock root
#define DBG_SEL_FAST_PLL                         (30)
/// this clock is taken before clock root
#define DBG_SEL_VOC_PLL                          (31)
/// this clock is taken before clock root
#define DBG_SEL_SYS_156M_PLL                     (32)
...
#define DBG_SYS_IRQ_GPADC                        (30)
#define DBG_SYS_IRQ_PMU                          (31)
