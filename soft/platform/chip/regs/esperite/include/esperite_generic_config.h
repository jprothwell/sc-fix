...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/esperite/include/esperite_generic_config.h $                                                                   
//  $Author: admin $                                                                    
...
#ifndef _ESPERITE_GENERIC_CONFIG_H_
#define _ESPERITE_GENERIC_CONFIG_H_

#ifdef CT_ASM
#error "You are trying to use in an assembly code the normal H description of 'esperite_generic_config'."
#endif
...
/// 0= no debug host sel register as on test chip; 1=debug host sel register included
