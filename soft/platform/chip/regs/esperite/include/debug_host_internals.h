...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/esperite/include/debug_host_internals.h $                                                                   
//  $Author: admin $                                                                    
...
#define DEBUG_HOST_INTERNAL_REGISTERS_SYS_MASK_SPLIT(n) (((n)&0x7F)<<1)
#define DEBUG_HOST_INTERNAL_REGISTERS_SYS_MASK_SPLIT_MASK (0x7F<<1)
...
#define DEBUG_HOST_INTERNAL_REGISTERS_MASK_SPLIT_BB_MID_DMASC (1<<6)
#define DEBUG_HOST_INTERNAL_REGISTERS_BB_MASK_SPLIT(n) (((n)&0x3F)<<1)
#define DEBUG_HOST_INTERNAL_REGISTERS_BB_MASK_SPLIT_MASK (0x3F<<1)
