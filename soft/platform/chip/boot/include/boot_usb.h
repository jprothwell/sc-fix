...
////////////////////////////////////////////////////////////////////////////////
//
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/boot/include/boot_usb.h $
//  $Author: admin $
...
#define BOOT_USB_PRODUCT_ID(usbMode)  ((CHIP_ASIC_ID << 8) | (((usbMode)&0x07) << 5) | GET_BITFIELD(hwp_extApb->CHIP_ID, REGS_BOND_ID))
...
// =============================================================================
#if (CHIP_ASIC_ID == CHIP_ASIC_ID_GREENSTONE && CHIP_ROM_ID < 2)
#ifdef HAL_USB_DRIVER_DONT_USE_ROMED_CODE
#define BOOT_USB_REVISION_ID (HAL_VERSION_REVISION)
#else
#define BOOT_USB_REVISION_ID (BOOT_VERSION_REVISION)
#endif // HAL_USB_DRIVER_DONT_USE_ROMED_CODE

#elif (CHIP_ASIC_ID == CHIP_ASIC_ID_GREENSTONE && CHIP_ROM_ID == 2)
#define BOOT_USB_REVISION_ID (BOOT_VERSION_REVISION)
