...
#define L1_SIZ_RSSI  548  // Max Number of Arfcn = PGSM + EGSM + DCS
...
{
 u8 BandMap;
 bool TotalInit; // 1 indicates that xcv reset is requested, otherwise, no xcv reset shall be done. added by zhanghy.20110307 
} l1_InitReq_t;
