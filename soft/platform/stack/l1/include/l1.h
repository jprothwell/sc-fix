...
#define L1_DUMMY_DETECT_MAX_QBOF PAL_DUMMY_DETECT_MAX_QBOF // less than [5000 - 1000(equ+dummy detect)-625-450 = 2900]
#endif
...
u32 AimFn [STK_MAX_SIM][2]; // the next PCH Position.
