...
WITHOUT_WERROR=1 CT_USER=ADMIN make -C platform 1>com.log
echo ======== start compile platform for debug lib ========== 
WITHOUT_WERROR=1 CT_USER=ADMIN CT_RELEASE=debug make -C platform 1>com.log
echo ======== start compile platform for release lib ========== 
WITHOUT_WERROR=1 CT_USER=ADMIN CT_RELEASE=release make -C platform 1>com.log

echo ======== start compile mdi for cool_profile lib ========== 
WITHOUT_WERROR=1 CT_USER=ADMIN make CT_APP=coolmmi -C mdi 1>com.log
echo ======== start compile mdi for debug lib ========== 
WITHOUT_WERROR=1 CT_USER=ADMIN CT_RELEASE=debug make CT_APP=coolmmi -C mdi 1>com.log
echo ======== start compile mdi for release lib ========== 
WITHOUT_WERROR=1 CT_USER=ADMIN CT_RELEASE=release make CT_APP=coolmmi -C mdi 1>com.log
