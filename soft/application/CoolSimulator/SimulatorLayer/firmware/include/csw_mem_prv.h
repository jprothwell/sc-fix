...
#define CSW_SUL_MALLOC(size)    CSW_MALLOC(BASE_SUL_TS_ID, size)
...
#define CSW_TMS_MALLOC(size)    CSW_MALLOC(TMS_TS_ID, size)
#define CSW_AT_MALLOC(size)     CSW_MALLOC(AT_TS_ID, size)
