...
#include "soc_api.h"
int NULL_handel(int a, int b,int c,int d,int e)
{
   return 0;
}

#define accept(a,b,c)  NULL_handel(a,b,c,0,0)          
#define bind(a,b,c)   NULL_handel(a,b,c,0,0)         
#define shutdown(a,b)       NULL_handel(a,b,0,0,0)   
#define closesocket(s)       NULL_handel(s,0,0,0,0) 
#define connect(a,b,c)   NULL_handel(a,b,c,0,0)        
#define getsockname(a,b,c)   NULL_handel(a,b,c,0,0)     
#define getpeername(a,b,c)   NULL_handel(a,b,c,0,0)    
#define setsockopt(a,b,c,d,e) NULL_handel(a,b,c,d,e) 
#define getsockopt(a,b,c,d,e) NULL_handel(a,b,c,d,e) 
#define listen(a,b)     NULL_handel(a,b,0,0,0)     
#define recv(a,b,c,d)      NULL_handel(a,b,c,d,0)   
#define read(a,b,c)      NULL_handel(a,b,c,0,0)          
#define recvfrom(a,b,c,d,e,f) NULL_handel(a,b,c,d,e) 
#define send(a,b,c,d)        NULL_handel(a,b,c,d,0) 
#define sendto(a,b,c,d,e,f)   NULL_handel(a,b,c,d,e) 
#define socket(a,b,c)  NULL_handel(a,b,c,0,0)      
#define write(a,b,c)      NULL_handel(a,b,c,0,0)    
#define select(a,b,c,d,e)    NULL_handel(a,b,c,d,e) 
#define ioctlsocket(a,b,c)    NULL_handel(a,b,c,0,0) 
...
int soc_reselect(int socketId, int eventType)
{
	...
	case SOC_CONNECT:
            ...
            if (FD_ISSET(socketId, &write_fd))
            {
                soc_notify_app(socketId, SOC_CONNECT, KAL_TRUE, 0);
                return 1;
            }
...
kal_int8 soc_setsockopt_win32(kal_int8 s, kal_uint16 option, kal_uint8 *val, kal_uint8 val_size)
{
    ...
    else if (option == SOC_ASYNC)
    {
        ...
        soc_evnet = (int)(*(kal_uint8 *)val);

	 if(soc_evnet&SOC_WRITE)socketSelect(socketid, SOC_WRITE);
	 if(soc_evnet&SOC_READ)socketSelect(socketid, SOC_READ);
 	 if(soc_evnet&SOC_CONNECT)socketSelect(socketid, SOC_CONNECT);
 	 if(soc_evnet&SOC_CLOSE)socketSelect(socketid, SOC_CLOSE);
  	 if(soc_evnet&SOC_ACCEPT)socketSelect(socketid, SOC_ACCEPT);
    }
