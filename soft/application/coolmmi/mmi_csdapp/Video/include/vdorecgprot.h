...
extern BOOL mmi_vdorec_check_and_restore_valid_drv(void);
extern BOOL mmi_vdorec_get_storage_file_path(PS8 path_buf);
extern S32	mmi_vdorec_create_file_dir(PS8 filepath);
