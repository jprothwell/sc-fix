 ...
 *  void
 *****************************************************************************/
void gdi_2d_fill_rectangle(int x1, int y1, int x2, int y2, gdi_color color_t)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
        ...
        gdi_color src_key)
{
    ...
    g2d.src_color_mode = G2D_SRC_16BPP_RGB565_MODE;
    g2d.dest_color_mode = G2D_DEST_16BPP_RGB565_MODE;
#else   
 ...
 *  void
 *****************************************************************************/
void gdi_2d_line(S16 x1, S16 y1, S16 x2, S16 y2, gdi_color color_t, BOOL is_dotted)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void gdi_2d_engine_init(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gdi_2d_is_used = FALSE;
    gdi_mutex_init(&gdi_2d_mutex);
...
void gdi_2d_begin(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gdi_2d_is_used = (BOOL) g2d_begin(G2D_OWNER_GDI, NULL);
    if (gdi_2d_is_used)
    {
        gdi_mutex_lock(&gdi_2d_mutex);
 ...
 *  void
 *****************************************************************************/
void gdi_2d_fill_triangle(S32 x1, S32 y1, S32 x2, S32 y2, S32 x3, S32 y3, gdi_color color_t)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (gdi_2d_is_used)
    {
        ...
        gdi_2d_fill_polygon(point, 6, color_t);
    }
}
 ...
 *  void
 *****************************************************************************/
void gdi_2d_fill_polygon(S16 point[], U16 point_sum, gdi_color color_t)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void gdi_2d_draw_line(S32 x1, S32 y1, S32 x2, S32 y2, gdi_color color_t, BOOL is_antialias, BOOL is_dotted)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void gdi_2d_draw_polygon(S16 point[], U16 point_sum, gdi_color color_t, BOOL is_antialias, BOOL is_dotted)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void gdi_2d_fill_rect(S32 x, S32 y, S32 width, S32 height, gdi_color color_t)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void gdi_2d_draw_arc(S32 x, S32 y, S32 radius, gdi_color color_t, U32 start_angle, U32 end_angle)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
        ...
        kal_uint16 list_count)
{
    ...
    ///NOTE!!!: 
    /// When trasnform direction is RB, your src_x,src_y,dest,x,dest_y MUST at RB corner 
 ...
 *  void
 *****************************************************************************/
void gdi_2d_draw_curve(S32 x1, S32 y1, S32 x2, S32 y2, S32 x3, S32 y3, gdi_color color_t)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
