...
#else   /* default is 16 bits palette */
...
#define GDI_COLOR_DARK_GRAY           gdi_act_color_from_rgb(255,64,64,64)
#endif
#ifdef GDI_USING_LAYER
#define GDI_COLOR_TRANSPARENT    gdi_act_color_from_rgb(255,    0,     0, 255)
#else
#define GDI_COLOR_TRANSPARENT    gdi_act_color_from_rgb(255,    0,     0, 255/*255,    255,     255, 255*/)
#endif
...
extern GDI_RESULT gdi_layers_free(void);//cuijian's modify
...
extern U8 gdi_layer_get_actual_rotate(void);
...
extern GDI_RESULT gdi_image_draw(S32 offset_x, S32 offset_y, U8 *image_ptr);
extern GDI_RESULT gdi_image_draw_ext(S32 offset_x, S32 offset_y, U8 *image_ptr, U8 image_identifier, S32 image_length);
extern GDI_RESULT gdi_image_draw_id(S32 offset_x, S32 offset_y, U16 image_id);
extern GDI_RESULT gdi_image_draw_file(S32 offset_x, S32 offset_y, S8 *image_name);
...
extern GDI_RESULT gdi_image_draw_resized(
                    ...
                    S32 resized_height,
                    U8 *image_ptr);
extern GDI_RESULT gdi_image_draw_resized_ext(
                    S32 offset_x,
                    S32 offset_y,
                    S32 resized_width,
                    S32 resized_height,
...
extern U16 gdi_image_get_type_from_id(U16 image_id);
extern S32 gdi_image_get_buf_len_from_id(U16 image_id);
extern U8 *gdi_image_get_buf_ptr_from_id(U16 image_id);
...
extern GDI_RESULT gdi_image_draw_id_with_transparent_color(S32 offset_x, S32 offset_y, U16 image_id);
...
extern GDI_RESULT gdi_image_draw_animation_single_frame(S32 offset_x, S32 offset_y, U8 *image_ptr, U16 start_frame);
extern GDI_RESULT gdi_image_draw_animation_single_frame_id(S32 offset_x, S32 offset_y, U16 image_id, U16 start_frame);
...
extern GDI_RESULT gdi_anim_set_callback(void (*last_frame_callback_ptr)(GDI_RESULT result), void (*blt_before_callback_ptr)(GDI_RESULT result), void (*blt_after_callback_ptr)(GDI_RESULT result));
