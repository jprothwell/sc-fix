...
extern void gdi_2d_fill_rectangle(int x1, int y1, int x2, int y2, gdi_color color_t);
extern void gdi_2d_line(S16 x1, S16 y1, S16 x2, S16 y2, gdi_color color_t, BOOL is_dotted);
...
extern void gdi_2d_set_dest_buffer(
                ...
                S32 clipy2,
                gdi_color_format cf);
extern void gdi_2d_fill_triangle(S32 x1, S32 y1, S32 x2, S32 y2, S32 x3, S32 y3, gdi_color color_t);
extern void gdi_2d_fill_polygon(S16 point[], U16 point_sum, gdi_color color_t);
...
extern void gdi_2d_draw_line(S32 x1, S32 y1, S32 x2, S32 y2, gdi_color color_t, BOOL is_antialias, BOOL is_dotted);
extern void gdi_2d_draw_polygon(S16 point[], U16 point_sum, gdi_color color_t, BOOL is_antialias, BOOL is_dotted);
extern void gdi_2d_fill_rect(S32 x, S32 y, S32 width, S32 height, gdi_color color_t);
...
extern void gdi_2d_draw_arc(S32 x, S32 y, S32 radius, gdi_color color_t, U32 start_angle, U32 end_angle);
...
extern void gdi_2d_draw_curve(S32 x1, S32 y1, S32 x2, S32 y2, S32 x3, S32 y3, gdi_color color_t);
...
extern BOOL gdi_2d_is_available(void);
