...
#include "mmiapi_enum.h"
	...
	{
		LOCAL_PARA_HDR
		mmiapi_remote_proc_call_enum	type;
	...
	{
		LOCAL_PARA_HDR
		int result; // 0: TEXT_MSG  1:BIN_MSG  -1: no message	
	...
	{
		LOCAL_PARA_HDR
		l4_addr_bcd_struct incoming_address;
	...
	{
		LOCAL_PARA_HDR
		kal_uint8 *message; // this field should be free by free_ctrl_buffer
		int		   message_len;
	...
	{
		LOCAL_PARA_HDR
		l4_addr_bcd_struct host_address;
