 ...
 * Miscellaneous
 *************************************************************************/
#define CTK_LOG_GROUP	(MMI_TRACE_G2_GUI)
...
#define CTK_LOG(x_)						Trace2(MMI_TRACE_G2_GUI, "[CTK] " x_ "\n")
...
#undef CTK_EXPERIMENTAL_FEATURE
...
extern void ctk_remote_execute_in_UA_h(ctk_object_handle container, void (*fp)(ctk_object_handle ), ctk_object_handle arg, kal_bool is_blocking);
extern void ctk_remote_execute_in_MMI_h(ctk_object_handle container, void (*fp)(ctk_object_handle ), ctk_object_handle arg, kal_bool is_blocking);
...
extern void ctk_screen_addLSK(
	...
	ctk_string_id				label,
	ctk_image_id				image,
	ctk_screen_callback_hdlr	softkey_fp, /*MMI layer */
	kal_bool 					onetime
	);
...
extern void ctk_inline_set_item_copy(ctk_layout_handle layoutid, int index, U16 icon, ctk_string_id str_title,
				ctk_inline_item_type_enum type, void *copy_struct);
...
extern void ctk_inline_get_result(ctk_layout_handle layoutid, int index, ctk_inline_item_type_enum *type_p, ctk_inline_result_union* result_p);
