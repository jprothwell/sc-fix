 ...
 *------------------------------------------------------------------------------
 * $Log:   O:/PSI_MMI/archives/2___work/soft/mmi_CSDapp/include/DataMgr.h-arc  $
 * 
...
S32 mmi_data_check_record( mmi_data_record_store_type* context, U16 record_id, BOOL check_db_file ); // return 0 means it's found!
