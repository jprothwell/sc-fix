...
#define APP_MAX_ENC_LINE_LIMIT ((size_t) 75) /* 76th position only used by continuation = */
#define APP_QP_BUF_LEN    128
/* encode option mask */
...
extern kal_uint8 applib_decode_number(kal_uint8 *src_num, kal_uint8 *des_num, kal_uint8 ton);

/* DOM-NOT_FOR_SDK-END */
extern
kal_int32 applib_qprint_decode(kal_char *src, 
                               kal_uint32 srcl, 
                               kal_char *dest,
                               kal_uint32 destl);
...
extern
kal_int32 applib_qprint_encode(kal_char *src, 
                               kal_uint32 srcl, 
                               kal_char *dest,
                               kal_uint32 destl);
                               
extern
kal_int32 applib_qprint_encode_ext(kal_char *src,
                                   kal_uint32 srcl,                              
                                   kal_char *dest,
                                   kal_uint32 destl,
								           kal_bool encode_crlf);
