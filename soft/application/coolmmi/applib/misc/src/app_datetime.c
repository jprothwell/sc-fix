...
kal_bool applib_dt_rfc1123_rfc850_asctime_dateString2Time(const kal_char *date, kal_uint32 *time)
{
    ...
    else
    {
        ...
        /* Retrieve weekday */
        if (NULL == (str2 = strtok_r(date_str, " ", &pp)))
        {
            return KAL_FALSE;
        }
        for (i = 0; i < 7; i++)
