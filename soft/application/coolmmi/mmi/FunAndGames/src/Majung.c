...
*
*
* $Id: Majung.c,v 1.7 2007/08/29 06:18:37 liugang Exp $
*
* $Date: 2007/08/29 06:18:37 $
*
* $Name: 1.7 $
*
* $Locker$
...
*----------------------------------------------------------------------------
* $Log: Majung.c,v $
* Revision 1.7  2007/08/29 06:18:37  liugang
* UNI@liugang_20070829 U808W all 麻将连连看的改动
*
* Revision 1.6  2007/08/22 10:08:54  liugang
* UNI@liugang_20070817 808 2.6寸屏 游戏
*
* Revision 1.5  2007/08/16 06:24:23  liugang
* UNI@liugang_20070816 808 all 2.6寸屏的改动 __MMI_UNI_MAINLCD_240X400__
*
* Revision 1.4  2007/05/29 09:10:06  duyipin
* UNI@duyipin_20070529 14:48:37移植游戏
*
* Revision 1.3  2007/05/29 06:53:03  duyipin
* UNI@duyipin_20070529 14:48:37移植游戏 
*
* Revision 1.2  2007/05/28 05:42:02  baiyanjun
* UNI@baiyanjun_20070528h 13:41:01 增加游戏.
*
...
#include "filesystemdef.h"		/* for level generation - pc only*/
...
#define MAJUNGBACKGROUND		2479
 ...
 __align(2) const U8 MAJUNGBackground[MAJUNGBACKGROUND] = {
...
#define MAJUNGMOVE		138
 __align(2) const U8 MAJUNGMove[MAJUNGMOVE] = {
 0x4D, 0x54, 0x68, 0x64, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x01, 0x03, 0xC0, 0x4D, 0x54, 0x72, 
 ...
 #ifdef __MMI_GAME_MAJUNG_128x96__

#define LEVEL_ROW_COUNT_EASY (6)
#define LEVEL_COLUMN_COUNT_EASY (3)
#define LEVEL_ROW_COUNT_NORMAL (8)
#define LEVEL_COLUMN_COUNT_NORMAL (4)
#define LEVEL_ROW_COUNT_HARD (10)
#define LEVEL_COLUMN_COUNT_HARD (5)

#define MAJUNG_LEVEL_COUNT (50)
#define ENERGYBAR_POS_X	(115)
#define ENERGYBAR_POS_Y (7)
#define MAJUNG_BRICK_WIDTH				(10)
#define MAJUNG_BRICK_HEIGHT			(14)

#define MAJUNG_BLOCK_ROW_COUNT		(7)
#define MAJUNG_BLOCK_COLUMN_COUNT	(12)  /* actual count */
#define MAJUNG_THICK_BRICK_Y_MARGIN (2)  /*the y difference btw thick img top and
														 brick img buttom */
#define UNIT_ENERGY_INCREASE_PER_SCORE (6)
#define MAJUNG_ENERGY_LIMIT			(20)
#define MAJUNG_ENERGY_INIT		(15)

#define MAJUNG_SCORE_X 			(0)
#define MAJUNG_SCORE_Y 			(0)
#define MAJUNG_EXIT_X		   (0)
#define MAJUNG_EXIT_Y  			(0)
#define MAJUNG_EXIT_WIDTH	 	(0)
#define MAJUNG_EXIT_HEIGHT		(0)

#define MAJUNG_DIGIT_WIDTH 	(0)
...
#if defined (__MMI_UNI_MAINLCD_240X400__)   /*UNI@liugang_20070816 808 all 2.6寸屏的改动*/
#define __MAJUNG_DRAW_SCORE__
#define __MAJUNG_DRAW_EXIT__
#define LEVEL_ROW_COUNT_EASY			(8)
#define LEVEL_COLUMN_COUNT_EASY (10)
#define LEVEL_ROW_COUNT_NORMAL		(10)
#define LEVEL_COLUMN_COUNT_NORMAL (12)
#define LEVEL_ROW_COUNT_HARD			(12)
#define LEVEL_COLUMN_COUNT_HARD		(12)	/*UNI@liugang_20070829 U808W all 麻将连连看的改动*/
...
#define MAJUNG_BLOCK_ROW_COUNT		(15)
#define MAJUNG_BLOCK_COLUMN_COUNT	(14)
...
#define MAJUNG_SCORE_Y 			(370)
#define MAJUNG_EXIT_X  (185)
#define MAJUNG_EXIT_Y  			(375)
...
#define ENERGYBAR_POS_X	(225) 
#define ENERGYBAR_POS_Y (30)
#define ENERGYBAR_TEXT_X (215) 
#define ENERGYBAR_TEXT_Y (120)
...
#define UNIT_ENERGY_INCREASE_PER_SCORE (8)
#define MAJUNG_ENERGY_LIMIT			(20)
#define MAJUNG_ENERGY_INIT		(19)

#define MAJUNG_SCORE_X 			(10)
#define MAJUNG_SCORE_Y 			(290)
#define MAJUNG_SCORE_TEXT_X 			(82)
#define MAJUNG_SCORE_TEXT_Y 			(295)
...
#ifdef __MMI_GAME_MAJUNG_128x96__
U16		majung_lcd_width	= 128;
U16		majung_lcd_height	= 96;
#elif defined(__MMI_GAME_MAJUNG_176x220__)
...
void Majung_Draw_Score(void)
{
	...
	S32										tmp_tick;
#ifdef __MMI_GAME_PUZZLE_240x320__
        gui_move_text_cursor(MAJUNG_SCORE_TEXT_X,MAJUNG_SCORE_TEXT_Y);
	...
	do
	{
		...
		gdi_image_draw_id(MAJUNG_SCORE_X + position_shift,
								MAJUNG_SCORE_Y+1, 
								image_id);
    #elif defined(__MMI_GAME_MAJUNG_240x320__)
		gdi_image_draw_id(MAJUNG_SCORE_X + position_shift - 5,
								MAJUNG_SCORE_Y +5, 
								image_id);
    #endif 
...
void Majung_Enter_GFX(void)
{
	...
	TRACE_EF(g_sw_GAME, "MMI_GAME: Majung_Enter_GFX");
...
{
//	GFX_PLAY_AUDIO_GAMEOVER();     //deleted by kecx for fixing bug 13979 on 20090825
	mmi_gfx_draw_gameover_screen(IMG_GX_MAJUNG_GAMEOVER, IMG_GX_MAJUNG_GRADESMAP, IMG_GX_MAJUNG_COUNT, majung_game_grade);
...
/* test
	...
	coolsand_UI_show_transparent_image(6, 10,get_image(IMG_GX_MAJUNG_GAMEOVER),	0);
	coolsand_UI_show_transparent_image(29, 35,get_image(IMG_GX_MAJUNG_GRADESMAP),0);

	sprintf((PS8)buffer, "%d", majung_game_grade );
	AnsiiToUnicodeString((PS8) buffer_UCS2, (PS8)buffer);


	str_width = coolsand_UI_get_string_width((UI_string_type)buffer_UCS2);

	if(r2lMMIFlag)
		coolsand_UI_move_text_cursor(((majung_lcd_width-str_width)>>1)+str_width,41);
	else
		coolsand_UI_move_text_cursor((majung_lcd_width-str_width)>>1,41);		
...
void Majung_Enter_Game(void)
{
	...
	register_keyboard_key_handler((void (*)(S32, S32))Majung_Keyboard_Key_Handler);
	...
	UI_start_timer(majung_timer_elapse, Majung_CountDown_Timer);
	...
	{
		UI_start_timer(100, Majung_Draw_Connection);
	}
	else
	/* start game loop */
	Majung_Render();
		...
		GFX_PLAY_BACKGROUND_SOUND(MAJUNGBackground,MAJUNGBACKGROUND, &majung_background_midi,DEVICE_AUDIO_PLAY_INFINITE);
...
#endif
	UI_cancel_timer(Majung_CountDown_Timer);
	UI_cancel_timer(Majung_Draw_Connection);
}
...
void Majung_Load_New_Stage(void)
{
	...
	/*UNI@liugang_20070829 U808W all 麻将连连看的改动*/
	#if defined (__MMI_UNI_MAINLCD_240X400__) 
	majung_timer_elapse += 200;
	#endif
	...
	for(i = 0 ; i < MAJUNG_BLOCK_ROW_COUNT; i++)
	{
		for( j = 0 ; j < MAJUNG_BLOCK_COLUMN_COUNT; j++)
		{
			...
			if(	(j >= level_idx_shift_x)
			&&	(j < level_idx_shift_x + level_col_count)
			&&	(i >= level_idx_shift_y)
			&&	(i < level_idx_shift_y + level_row_count) ) /* the pos has brick */
			{
				idx = i*MAJUNG_BLOCK_COLUMN_COUNT+j;
...
void Majung_Render(void)
{
	gdi_color	bg_color		= GDI_RGB_TO_BUFFER_FORMAT(30,150,30);
	gdi_color	hilight_color	= GDI_RGB_TO_BUFFER_FORMAT(255,0,0);
	S16	pos_x;
	S16	pos_y;
	S16	i,j;
	S16	idx;
	...
	for( i = 0; i < MAJUNG_BLOCK_ROW_COUNT; i++)
	{
		for(j = 0 ; j < MAJUNG_BLOCK_COLUMN_COUNT; j++)
		{
			...
			if(majung_block_list[idx].need_redraw == TRUE)
			{
				...
				gdi_draw_solid_rect(pos_x+shift_x1,
										 pos_y+shift_y1,
										 pos_x+MAJUNG_BRICK_WIDTH+shift_x2-1,
										 pos_y+MAJUNG_BRICK_HEIGHT+shift_y2-1, bg_color);
			}
		}
	}
		...
		for(j = 0 ; j < MAJUNG_BLOCK_COLUMN_COUNT; j++)
		{
			...
			if(majung_block_list[idx].need_redraw == TRUE)
			{
				if(majung_block_list[idx].block_type == BLOCK_TYPE_BRICK)
				{
                    ...
                    TRACE_EF(g_sw_GAME, "MMI_GAME: Majung Render, IMG_GX_MAJUNG_BRICK_1W=%d",img_id);
					...
					{
						pos_x	= majung_brick_start_offset_x+j*MAJUNG_BRICK_WIDTH;
						pos_y	= majung_brick_start_offset_y+(i+1)*MAJUNG_BRICK_HEIGHT-MAJUNG_THICK_BRICK_Y_MARGIN;
...
void Majung_Render_Energy(void)
{
	S16 i;
#ifdef __MMI_GAME_PUZZLE_240x320__
       	gdi_image_draw_id(ENERGYBAR_TEXT_X,ENERGYBAR_TEXT_Y,IMG_GX_MAJUNG_TIME);
#endif
...
void Majung_CountDown_Timer(void)
{
	...
	{	
		...
		UI_BLT_double_buffer(114,0,UI_device_width-1,UI_device_height-1);	
...
void Manjung_Calc_Connection()
{
	...
	else if(majung_pair_type == PAIR_ONE_TURN)
	{
		...
		Manjung_Connet_Join(src_idx_x, src_idx_y, 
							majung_pair_turn_list[0].x, majung_pair_turn_list[0].y,
							dest_idx_x, dest_idx_y);
	...
	else if(majung_pair_type == PAIR_TWO_TURN)
	{
		...
		Manjung_Connet_Join(src_idx_x, src_idx_y, 
							majung_pair_turn_list[0].x, majung_pair_turn_list[0].y,
							majung_pair_turn_list[1].x, majung_pair_turn_list[1].y);

		Majung_Connect_Zero_Turn(	majung_pair_turn_list[0].x, majung_pair_turn_list[0].y, 
									majung_pair_turn_list[1].x, majung_pair_turn_list[1].y);

		Manjung_Connet_Join(majung_pair_turn_list[0].x, majung_pair_turn_list[0].y,
							majung_pair_turn_list[1].x, majung_pair_turn_list[1].y,
							dest_idx_x, dest_idx_y);
...
//		pos_y = majung_brick_start_offset_y+idx_y*MAJUNG_BRICK_HEIGHT;
//
//		coolsand_UI_draw_rectangle(pos_x, pos_y, pos_x + 5, pos_y + 5, coolsand_UI_color(0,255,255));
//	}



//	coolsand_UI_BLT_double_buffer(0,0, majung_lcd_width - 1, majung_lcd_height -1);
...
// beginning--modified by kecx for fixing bug 13693 on 20090814
            if(majung_game_level == LEVEL_EASY)
            {
                if(idx_x < LEVEL_COLUMN_COUNT_EASY + 1)
                idx_x++;
            }
            else if (majung_game_level == LEVEL_NORMAL)
            {
                if(idx_x < LEVEL_COLUMN_COUNT_NORMAL)
                idx_x++;
            }
            else if (majung_game_level == LEVEL_HARD)
            {
                if(idx_x < LEVEL_COLUMN_COUNT_HARD)
                idx_x++;
            }
// end--modified by kecx for fixing bug 13693 on 20090814
...
// beginning--modified by kecx for fixing bug 13693 on 20090814
            if(majung_game_level == LEVEL_EASY)
            {
                if(idx_y < LEVEL_ROW_COUNT_EASY + 1)
                idx_y++;
            }
            else if (majung_game_level == LEVEL_NORMAL)
            {
                if(idx_y < LEVEL_ROW_COUNT_NORMAL)
                idx_y++;
            }
            else if (majung_game_level == LEVEL_HARD)
            {
                if(idx_y < LEVEL_ROW_COUNT_HARD)
                idx_y++;
            }
// end--modified by kecx for fixing bug 13693 on 20090814
...
//		coolsand_UI_BLT_double_buffer(114,0,majung_lcd_width,majung_lcd_height);
		UI_start_timer(majung_timer_elapse, Majung_CountDown_Timer);
	...
	else
	{
            ...
            gui_show_transparent_image(pos_x, pos_y, (UI_image_type)GetImage((U16)(IMG_GX_MAJUNG_CONNECT_HOR+type)),0);
            UI_BLT_double_buffer(pos_x, pos_y, pos_x+MAJUNG_BRICK_WIDTH, pos_y+MAJUNG_BRICK_HEIGHT);
...
void Majung_Keyboard_Key_Handler(s32 vkey_code,s32 key_state)
{
		...
		{ 
			...
			{	
				case 37:	Majung_Move_Left(); //left
							break;
				case 38:	Majung_Move_Up();	//up
							break;
				case 39:	Majung_Move_Right(); //right
							break;
				case 40:	Majung_Move_Down(); //down
							break;
			}
		}
	#else
...
/*****************************************************************************
* FUNCTION mmi_majung_pen_down_hdlr
*	Majung_Keyboard_pen_Handler
* DESCRIPTION
*	Allow to use keyboard in PC_sumulator	
* PARAMETERS
*	void
...
void mmi_majung_pen_down_hdlr(mmi_pen_point_struct pos)
{
	...
	{
		Majung_Update_Block(majung_hilight_idx);
		majung_hilight_idx= (pos.y-majung_brick_start_offset_y)/MAJUNG_BRICK_HEIGHT*MAJUNG_BLOCK_COLUMN_COUNT+(pos.x-majung_brick_start_offset_x)/MAJUNG_BRICK_WIDTH;
		if(majung_block_list[majung_hilight_idx].block_type == BLOCK_TYPE_EMPTY)
			return; //P_6226_M07_lizongzheng_Z10001 没有麻将,触笔不应该能选中
		Majung_Select();
	}
}
#endif
/*****************************************************************************
* FUNCTION mmi_majung_pen_up_hdlr
*	Majung_Keyboard_pen_Handler
* DESCRIPTION
*	Allow to use keyboard in PC_sumulator	
* PARAMETERS
