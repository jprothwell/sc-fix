 ...
 ***************************************************************************/
 ...
 /** 
 * @file		jmms_objectpicker.h
 * @ingroup		jMMS
 * @brief		Describes the MMS Media picker API's.
 *
 **/ 
#ifndef __JMMS_OBJECTPICKER
#define __JMMS_OBJECTPICKER
