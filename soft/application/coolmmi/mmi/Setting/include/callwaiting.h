...
#ifndef _COOLSAND_CALLWAITING_H
#define _COOLSAND_CALLWAITING_H


void InitCallWaiting(void);
void HighlightCALLSETCallWaiting(void);
void EntryCALLSETWaitingMain(void);
void HighlightCALLSETCallWaitingOn(void);
void EntryScrCallWaitingOnreq(void);
void HighlightCALLSETCallWaitingOff(void);
void EntryScrCallWaitingOffreq(void);
