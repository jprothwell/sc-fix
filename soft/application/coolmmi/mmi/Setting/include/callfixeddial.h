...
#ifndef _COOLSAND_CALLFIXEDDIALLIST_H
#define _COOLSAND_CALLFIXEDDIALLIST_H


void HighlighSrcAddFDL(void);
void HighlightScrEditFDL(void);
...
void ExitSECSETFDNDelConfirm(void);
...
void SECSETSetFdlEntryRsp(void * );
void SECSETDelFdlReq(void);
void SECSETDelFdlRsp(void *);


void GetActiveIndex(S32 );
