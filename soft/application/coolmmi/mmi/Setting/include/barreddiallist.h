...
#ifndef _COOLSAND_CALLBARREDDIALLIST_H
#define _COOLSAND_CALLBARREDIALLIST_H
...
void ExitSECSETBDNDelConfirm(void);


void SECSETGetBdlEntriesReq(void);
void SECSETGetBdlEntriesRsp(void *);
void SECSETSetBdlEntryReq(void);
void SECSETSetBdlEntryRsp(void *);
void SECSETDelBdlReq(void);
void SECSETDelBdlRsp(void *);


void InitBarredDialList(void);
void ViewBDList(void);
void GetActiveBDLIndex(S32 );
void CheckServiceBDLOnOff(void);
