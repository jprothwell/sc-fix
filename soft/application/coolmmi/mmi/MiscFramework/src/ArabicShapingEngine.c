 ...
 * Description:
 * ------------
 *   This file is intends for Arabic shaping.
 *
 * Author:
 * -------
 * -------
...
void ArabicShapeEngine2(U8 language, PU16 length, PU16 text_buffer, PU16 pOrgToSha, PU16 pShaToOrg)
{
	...
	{
        arabic_ligature_rules(language, text_buffer, length, pOrgToSha, pShaToOrg);
	}
 ...
 *  void
 *****************************************************************************/
void arabic_ligature_rules(U8 language, PU16 text_buffer, PU16 length, PU16 pOrgToSha, PU16 pShaToOrg)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
