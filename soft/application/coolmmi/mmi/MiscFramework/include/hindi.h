...
#define IRE_HINDI_LANG_END_RANGE       		0x097F
...
extern UI_string_type get_hindi_multitap_string(S32 index);
...
#define  UI_HINDI_SIGN_RANGE(ch)  ((HF_HINDI_RANGE((ch)) &&  g_hindi_character_sign_array[UNI2HINDI((ch))]) || ( ((U16)(ch)>59647 && (U16)(ch)<59828) && g_hindi_character_extended_sign_array[(ch)-59648]))
