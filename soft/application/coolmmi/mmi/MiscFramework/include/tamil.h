...
extern UI_string_type get_tamil_multitap_string(S32 index);
/* MTI IRE OPTIMIZATION END */
extern UI_string_type get_tamil_single_line_multitap_string(S32);

#endif /* defined (__MMI_MULTITAP_TAMIL__) */ /* #if defined (__MMI_MULTITAP_TAMIL__)  */
#endif /* defined (__MMI_LANG_TAMIL__) */ /* MMI_LANG_TAMIL */
