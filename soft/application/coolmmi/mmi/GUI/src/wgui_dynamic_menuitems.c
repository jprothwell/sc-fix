 ...
 * DESCRIPTION
 *  Used internally by init_dynamic_item_buffer()
 * PARAMETERS
 *  n_items     [IN]        total number of items
 * RETURNS
 *  void
 ...
 * DESCRIPTION
 *  a convenient function to get the pointer of a item in the buffer
 * PARAMETERS
 *  index       [IN]        index of the item to be retrieved
 * RETURNS
 ...
 * DESCRIPTION
 *  a convenient function to check whether a item is loaded in buffer
 * PARAMETERS
 *  index       [IN]        index of the item to be checked
 * RETURNS
 *  pBOOL : TRUE / FALSE
 *****************************************************************************/
 ...
 * DESCRIPTION
 *  Used before load_chunk_dynamic_item_buffer to flush all cached data.
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 ...
 *  the loading machnism will try to maintain the contiguous buffer as big as possible
 * IMPACT
 *  this function may unload some other items in the buffer
 * PARAMETERS
 *  start_index     [IN]        the starting index of requested items
 *  n_items         [IN]        the number of items to be loaded
 * RETURNS
 *  S32 : the number of items that are loaded successfully
 *****************************************************************************/
 ...
 * DESCRIPTION
 *  adjust the menu width if needed
 * PARAMETERS
 *  void
 * RETURNS
 *  void
