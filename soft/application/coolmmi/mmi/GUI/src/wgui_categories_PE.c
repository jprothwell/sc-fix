...
static color_t cat91_highlight_color = {122, 211, 255, 100};
static cat91_color_slider_enum cat91_highlighted_slider = RED_COLOR;
...
static color_t red_color_slider_gc_colors[] = 
{
    {0, 0, 0, 100},
    {255, 0, 0, 100},
};
...
static color_t green_color_slider_gc_colors[] = 
{
    {0, 0, 0, 100},
    {0, 255, 0, 100},
};
...
static color_t blue_color_slider_gc_colors[] = 
{
    {0, 0, 0, 100},
...
void cat91_redraw_content_area(void)
{
    ...
    color_t hc = gui_color(196, 196, 196);
        ...
        U8 *history_buffer)
{
    ...
    {
        color_t *cColor = (color_t*) history_buffer;
...
U8 *GetCategory91History(U8 *history_buffer)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    cColor->r = *cat91_color_value[RED_COLOR];
    cColor->g = *cat91_color_value[GREEN_COLOR];
    cColor->b = *cat91_color_value[BLUE_COLOR];
