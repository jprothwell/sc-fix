...
/**********************************************************************************
   Filename:      gui_custom_menus.c
   Date Created:  Mar-07-2003
   Contains:      UI routines for custom menus
**********************************************************************************/
 ...
 * DESCRIPTION
 *  Sets the current theme for the 3D circular menu object
 * PARAMETERS
 *  m       [IN]        Is the 3D circular menu object
 * RETURNS
 *  void
 *****************************************************************************/
 ...
 * DESCRIPTION
 *  Sets the given theme for the 3D circular menu object
 * PARAMETERS
 *  m       [IN]        Is the 3D circular menu object
 *  t       [IN]        Is the 3D circular menu theme
 * RETURNS
 *  void
 *****************************************************************************/
 ...
 * DESCRIPTION
 *  Creates a 3D circular menu object
 *  
 ...
 * DESCRIPTION
 *  Sets the item strings
 * PARAMETERS
 *  m           [IN]        Is the 3D circular menu object
 *  n_items     [IN]        Is the number of items in the menu
 *  items       [IN]        Is an array of strings. Each string is assigned to one item.
 * RETURNS
 *  void
 *****************************************************************************/
 ...
 * DESCRIPTION
 *  Resizes a 3D circular menu object
 * PARAMETERS
 *  m           [IN]        Is the 3D circular menu object
 ...
 * DESCRIPTION
 *  Moves a 3D circular menu object
 * PARAMETERS
 *  m       [IN]        Is the 3D circular menu object
 ...
 * PARAMETERS
 *  m       [IN]        Is the 3D circular menu object
 *  i       [IN]        Is the zero based index of the item to be highlighted
 * RETURNS
 *  void
 *****************************************************************************/
 ...
 * DESCRIPTION
 *  Displays the 3D circular menu object
 * PARAMETERS
 *  m       [IN]        Is the 3D circular menu object
 * RETURNS
 *  void
...
void gui_show_3D_circular_menu(UI_3D_circular_menu *m)
{
    ...
    {   /* gui_draw_filled_area(x1,y1,x2,y2,m->bg_filler);//filled arae with bkg color */
        if ((gui_is_entry_new_screen() == MMI_TRUE) && (gui_get_multilayer_mask() & UI_MUL_BKG_MAINMENU))
        {
             
        #if (defined(__MMI_SUBMENU_USE_MM_IMAGE__) || (!defined(__MMI_MAINMENU_CIRCULAR_SUPPORT__) && !defined(__MMI_MAINMENU_ROTATE_SUPPORT__)) || !defined(__MMI_MAINMENU_STYLE_CHANGE_EN__))  
    ...
    if (m->n_items > 0)
    {                                       /* nr=m->n_displayed_items-ni-2-2; */
         
        nr = m->n_displayed_items - 2 - ni; /* -2 because of 2 off-screen */
         
        /* nr = WGUI_CM3D_N_COMMON_IMAGES; */
