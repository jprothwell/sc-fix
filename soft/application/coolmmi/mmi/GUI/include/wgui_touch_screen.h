...
extern MMI_BOOL wgui_general_pen_calendar_hdlr(mmi_pen_point_struct point, mmi_pen_event_type_enum pen_event);
...
extern void wgui_general_SK_pen_down_hdlr(mmi_pen_point_struct point);
extern void wgui_general_SK_pen_up_hdlr(mmi_pen_point_struct point);
