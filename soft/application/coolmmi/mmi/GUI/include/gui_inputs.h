...
/**********************************************************************************
   ...
   Contains:      UI routines header for Input related objects
**********************************************************************************/
...
#define UI_MULTITAP_INPUT_CENTER_Y                 0x00000020
    ...
    typedef enum
    {
	 ...
	 GUI_DIALING_KEYPAD_PEN_INSERT_PHB_SAVE,
...
#define UI_MULTI_LINE_INPUT_BOX_TRANSPARENT_BACKGROUND      0x80000000   
...
/**** ritesh ended*****/
    typedef struct _multi_line_input_box
    {
        ...
        color_t default_bg_color;
        color_t underline_color;
        color_t border_color;
        S8 text_gap;
        UI_font_type text_font;
        U32 flags;
        U32 ext_flags;                                  /* added by ritesh sinha as existing flag is nto available */
        UI_buffer_type text;
        S32 text_length;
        S32 allocated_length;
        S32 available_length;
        ...
        void (*header_callback) (S32 yoffset, S32 clip_x1, S32 clip_y1, S32 clip_x2, S32 clip_y2);
        /* Customized footer draw function */
        void (*footer_callback) (S32 yoffset, S32 clip_x1, S32 clip_y1, S32 clip_x2, S32 clip_y2);
        /* Customized header draw function */
   ...
   //barcode
    ...
    typedef enum
    {
        ...
        FONT_ITALIC,
        FONT_BOLD
    } gui_paging_font_style_t;
    extern void gui_paging_multiline_input_box_get_page(U32 start_id, U32 end_id, PU8 buffer);
...
#define UI_DIALER_INPUT_BOX_SHOW_BORDER               0x00000800
    ...
    extern color_t gui_get_dialing_font_color(UI_character_type c);
    /* CSD end */
    ...
    extern void UI_inputbox_show_cursor(S32 x1, S32 y1, S32 x2, S32 y2, color_t c);
    ...
    extern BOOL gui_multi_line_input_box_test_cursor_pos(multi_line_input_box *b, S32 cursor_offset);
    extern void gui_show_multi_line_input_box_new(multi_line_input_box *b);
