...
#define  UI_EMS_INPUT_BOX_INCLUDE_INFO_AREA           0x00800000      
#define UI_EMS_INPUT_BOX_TRANSPARENT_BACKGROUND    0x01000000    
...
//qiff change define to 612 lines for memory will overflow if support 612 chars sms #define  MAX_EMS_EDITOR_LINES       MMI_SMS_MAX_MSG_SEG * 153 /2
#define  MAX_EMS_EDITOR_LINES       MMI_SMS_MAX_MSG_SEG * 153 
    ...
    typedef struct _UI_EMS_input_box
    {
        ...
        color_t strikethrough_color;
        color_t paragraph_color;
    #if defined(__MMI_TOUCH_SCREEN__) || defined(__MMI_HANDWRITING_PAD__)
