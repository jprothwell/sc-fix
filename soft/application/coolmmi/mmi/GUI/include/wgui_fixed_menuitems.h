 ...
 * Description:
 * ------------
 *  fixed menu items related funtions
 * Author:
 * -------
 * -------
 *------------------------------------------------------------------------------
...
/**********************************************************************************
   Filename:      wgui_fixed_menuitems.h
   Date Created:  August-07-2002
   Contains:      UI wrapper routines header for Fixed Menuitems
**********************************************************************************/
...
#define MAX_FIXED_TEXT_MENU_ITEMS            100        /* depends upon phone book entries */
...
#define MAX_FIXED_ICONTEXT_MENU_ITEMS              90/* 100 */  /* <== For SIM=200, PHONE=100 */
...
#define MAX_FIXED_ICONTEXT_LIST_MENU_ITEMS      72
    ...
    /*  Hard limit of WAP option group items */
#define MAX_FIXED_TWOSTATE_MENU_ITEMS        45 /* 45 */
    ...
    extern void add_fixed_icontext_items_200(S32 n_items, UI_string_type *s, PU8 *img);
