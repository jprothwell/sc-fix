 ...
 */
javacall_result javacall_input_get_locale(/*OUT*/ char locale[6]){mmi_trace(1,"current function : %s\n",__FUNCTION__);
    //set to "en-US"
    locale[0]='e';
    locale[1]='n';
    locale[2]='-';
...
javacall_textfield_status javacall_input_textfield_launch(
        ...
        /*IN*/ int					            modifiers,
        /*IN*/ int                              keyCode){mmi_trace(1,"current function : %s\n",__FUNCTION__);
 ...
 */
javacall_result /* OPTIONAL */ javacall_textfield_display_phonebook(){mmi_trace(1,"current function : %s\n",__FUNCTION__);
...
javacall_textfield_initiate_voicecall(const char* phoneNumber){mmi_trace(1,"current function : %s\n",__FUNCTION__);
    return JAVACALL_FAIL;
}
