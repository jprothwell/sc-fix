 ...
 *                
 */
javacall_result javacall_annunciator_vibrate(javacall_bool enableVibrate){mmi_trace(1,"current function : %s\n",__FUNCTION__);
    return JAVACALL_OK;
}
 ...
 *                
 */
javacall_result javacall_annunciator_flash_backlight(javacall_bool enableBrightBack){mmi_trace(1,"current function : %s\n",__FUNCTION__);
    return JAVACALL_OK;
}
 ...
 *                
 * @return <tt>JAVACALL_OK</tt> operation was supported by the device
 *         <tt>JAVACALL_OK</tt> or negative value on failure, or if not 
 *         supported on device
 */
javacall_result javacall_annunciator_display_trusted_icon(javacall_bool enableTrustedIcon){mmi_trace(1,"current function : %s\n",__FUNCTION__);
    return JAVACALL_OK;
}
 ...
 *         supported on device
 */
javacall_result javacall_annunciator_display_network_icon(javacall_bool enableNetworkIndicator){mmi_trace(1,"current function : %s\n",__FUNCTION__);
    return JAVACALL_OK;
}
 ...
 *         supported on device
 */
javacall_result javacall_annunciator_display_home_icon(javacall_bool enableHomeIndicator){mmi_trace(1,"current function : %s\n",__FUNCTION__);
    return JAVACALL_OK;
}
 ...
 *         <tt>JAVACALL_OK</tt> or negative value if error occured 
 *         or device is in mute mode 
 */
javacall_result javacall_annunciator_play_audible_tone(javacall_audible_tone_type soundType){mmi_trace(1,"current function : %s\n",__FUNCTION__);
    return JAVACALL_OK;
}
