...
javacall_result javacall_datagram_open(
	int port,
  javacall_handle *pHandle){mmi_trace(1,"current function : %s\n",__FUNCTION__);
...
int javacall_datagram_recvfrom_start(
    ...
    int length,
    int *pBytesRead,
    void **pContext){mmi_trace(1,"current function : %s\n",__FUNCTION__);
      return JAVACALL_FAIL;
    }
...
int javacall_datagram_recvfrom_finish(
    ...
    int length,
    int *pBytesRead,
    void *context){mmi_trace(1,"current function : %s\n",__FUNCTION__);
      return JAVACALL_FAIL;
    }
...
int javacall_datagram_close(
  javacall_handle handle){mmi_trace(1,"current function : %s\n",__FUNCTION__);
    return JAVACALL_FAIL;
}
