...
* ----------------
*
* Purpose			:	Implimentation for pictogram control
*						
* Created By		:
* Created Date		:
*
 ...
 */
jddex_pictogram::jddex_pictogram()
{
 ...
 * class members
 */
jddex_pictogram::jddex_pictogram(jddex_widget *poParentHwnd,JC_RECT *pstRect, JC_CONTROL_PROPERTIES* pstCtrlProperty)
				:jddex_widget(poParentHwnd,pstRect, pstCtrlProperty)
{
	m_eControlType = E_PICTOGRAM;

	m_stPictogram = pstCtrlProperty->typeOfControl.pictogram ;
}
...
void jddex_pictogram::Show()
{
	JC_RECT stAbsRect;
	GetAbsRect(&stAbsRect);

	//jddex_PlatformDrawPictogram( m_stPictogram, &stAbsRect );
}
