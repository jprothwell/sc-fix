...
extern "C" {
	...
	*/
	 ...
	 * \date 2011-03-04
	 */
	GBAPI GBRETURN GBAlpGetValidInputStr(pGBInputStruct pGBIS, GBUINT8 nInputMethod, GBUINT8 nCandType, GBPCCHAR *validStr);
	/*@}*/
	...
	* \date 2010-4-27
	*/
	GBAPI GBRETURN GBTransFormat(pGBInputStruct pGBIS, GBWCHAR * pCand);
...
#define GBUninstallEngineWrapper(pGBIS)		GBInstallEngineWrapper((pGBIS), NULL, NULL)
	...
	* \date 2010-10-14
	*/
	GBAPI GBRETURN GBALPSetAbbreviateWordTreeEnable(pGBInputStruct pGBIS, int enable);
#ifdef __cplusplus
};
#endif
#endif/*__MMI_GB_V5__*/
