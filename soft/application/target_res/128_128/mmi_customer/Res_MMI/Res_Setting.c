...
#if !((defined(__MMI_MULTI_SIM__))&&(defined( __MMI_MAINLCD_128X160__)))                              
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_BARRING_ACIVATE_CAP, CUST_IMG_BASE_PATH "/NoImage.gif", "IMG_BARRING_ACIVATE_CAP ");
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_BARING_CAP, CUST_IMG_BASE_PATH "/NoImage.gif", "IMG_BARING_CAP ");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_BARING_CAP, "Barring", "STR_OLD_BARRINGPASS_CAP");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_MENU8238_MNGCALL_CALLFWD_FAX, "Fax Calls", " CALL FORWARD MAIN SCREEN FAX CALL OPTION");
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_SCR8107_CAPTION, CUST_IMG_BASE_PATH "/NoImage.gif", "CALL FORWARD ON FAIL CAPTION ");
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_SCR8095_TEXT, CUST_IMG_BASE_PATH "/NoImage.gif", "CALL WAITING SCR TEXT IMAGE ");
...
#endif /* __BW_MMI__ */ 
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_REQ_ABORT_TEXT, "Abort Req", "STR_REQ_ABORT_TEXT");
}
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_CALLER_ID_TITLE_ICN, CUST_IMG_BASE_PATH "/NoImage.gif", "Manage Calls Caller Id ");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_CLIP_STATUS_TITLE, "CLIP Status", "CLIP Status Title");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_CLIP_STATUS_TITLE, CUST_IMG_BASE_PATH "/NoImage.gif", "CLIP Status Title Icon");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_CLIR_STATUS_TITLE, "CLIR Status", "CLIR Status Title");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_CLIR_STATUS_TITLE, CUST_IMG_BASE_PATH "/NoImage.gif", "CLIR Status Title Icon");
    ...
    ADD_APPLICATION_STRING2(
        ...
        "Message Text for CLIR Status");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_COLP_STATUS_TITLE, "COLP Status", "COLP Status Title");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_COLR_STATUS_TITLE, "COLR Status", "COLR Status Title");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_CNAP_STATUS_TITLE, "CNAP Status", "CNAP Status Title");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_CCBS_STATUS_TITLE, "CCBS Status", "CCBS Status Title");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_CLIP_SETUP_REQ_LSK_ERR, "Invalid Command", "CLIR/CLIP Status Error Message");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_CLIP_SETUP_REQ_LSK_ERR, CUST_IMG_BASE_PATH "/NoImage.gif", "CLIR Status Title Icon");
}
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_LANGUAGESCR_AUTO_SEL, "Auto Language selected", "English selected");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_LANGUAGESCR_ENG, "English selected", "English selected");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_LANGUAGESCR_TRCH, "Traditional Chinese selected", "Traditional Chinese selected");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_LANGUAGESCR_SICH, "Simplified Chinese selected", "Simplified Chinese selected");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MULTITAP_MARATHI, "Multitap Marathi", "Input methods Option Marathi");
#endif 

#if defined(__MMI_MULTITAP_HEBREW__)
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MULTITAP_HEBREW, "Multitap Hebrew", "Input methods Option HEBREW");
#endif 
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MULTITAP_U_POLISH, "Multitap PO","Input methods list Option Multitap POLISH");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MULTITAP_L_POLISH, "Multitap po", "Input methods list Option Multitap polish");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_U_POLISH, "Smart PO", "Input methods list Option Smart POLISH");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_L_POLISH, "Smart po", "Input methods list Option Smart polish");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_HEBREW, "Smart Hebrew", "Input methods list Option Smart Hebrew");
#endif 
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_U_CZECH, "Smart CZECH", "Input methods list Option Smart CZECH");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_L_CZECH, "Smart czech", "Input methods list Option Smart czech");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_U_FINNISH, "Smart FI", "Input methods list Option Smart FINNISH");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_L_FINNISH, "Smart fi", "Input methods list Option Smart finnish");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_U_SLOVAK, "Smart SK", "Input methods list Option Smart SLOVAK");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_L_SLOVAK, "Smart sk", "Input methods list Option Smart slovak");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_U_DUTCH, "Smart NL", "Input methods list Option Smart DUTCH");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_L_DUTCH, "Smart nl", "Input methods list Option Smart dutch");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_U_CROATIAN, "Smart HR", "Input methods list Option Smart CROATIAN");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_L_CROATIAN, "Smart hr", "Input methods list Option Smart croatian");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_U_ROMANIAN, "Smart RO", "Input methods list Option Smart ROMANIAN");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_L_ROMANIAN, "Smart ro", "Input methods list Option Smart romanian");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_U_GREEK, "Smart EL", "Input methods list Option Smart GREEK");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_L_GREEK, "Smart el", "Input methods list Option Smart greek");
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_MENU_LANGUAGE, CUST_IMG_BASE_PATH "/NoImage.gif", "Language Menu String");
}
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_FONT_SIZE_THEME_DEFAULT, "Theme Default", "Theme Default - option");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_FONT_SIZE_SMALL, "Small", "Small - option");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_FONT_SIZE_MEDIUM, "Medium", "Medium - option");

#ifndef __MMI_DIALLING_FONT__
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_FONT_SIZE_LARGE, "Large", "Large - option");
#endif 
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_MENU_FLIGHT_MODE, CUST_IMG_BASE_PATH "/NoImage.gif", "Flight Mode Menu Icon");
    ADD_APPLICATION_IMAGE2(
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_LSW_TITLE, "Line Switching", "Title of Screen for Line Switching");
    ADD_APPLICATION_IMAGE2(
        IMG_LSW_TITLE,
        CUST_IMG_BASE_PATH "/NoImage.bmp",
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_LINE1_SET, "Line 1 Selected", "Line 1 Success Message ");
    ADD_APPLICATION_STRING2(STR_LINE1_SET_ERR, "Unknown Error", "Line 1 Failure Message ");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_LINE2_SET, "Line 2 Selected", "Line 2 Success Message ");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_LINE2_SET_ERR, "Unknown Error", "Line 2 Failure Message ");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SCR8093_MNGCALL_MENU_FRWD, "Call Divert", "MANAGE CALLS MENU CALL FORWARDING OPTION ");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_TWIN_A_ID_SIM2_AUTO_REDIAL_NOT_SUPPORTED,"Function Not Supported","Function Not Supported");
#endif
...
//    ADD_APPLICATION_STRING2(STR_ID_NETSET_CHANGE, "Change", "LSK Display for Change");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_NETSET_OP_NAME_CAPTION, "Operator Name", "Operator Name");
    ADD_APPLICATION_STRING2(
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_NETSET_PREFERRED_MODE_GSM_ONLY, "GSM Only", "GSM Only");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_NETSET_PREFERRED_MODE_WLAN_ONLY, "WLAN Only", "WLAN Only");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_NETSET_PREFERRED_MODE_GSM_PREFERRED, "GSM Preferred", "GSM Preferred");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_NETSET_PREFERRED_MODE_WLAN_PREFERRED, "WLAN Preferred", "WLAN Preferred");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_NETSET_SELECTION_NEW_SEARCH, "New Search", "New Search");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_NETSET_SELECTION_SELECT_NETWORK, "Select Network", "Select Network");
...
void PopulatePhoneSetupResData(void)
{
    ...
    ADD_APPLICATION_MENUITEM((MENU_ID_SPEED_DIAL_OP_DEL, MENU_ID_SPEED_DIAL_OPERATION, 0,
		...
		ADD_APPLICATION_MENUITEM((MENU_SETTING_2D_SENSOR_SWITCH,MENU9102_INITIAL_SETUP,2,
						SHOW, NONMOVEABLE , DISP_LIST,STR_SETTING_2D_SENSOR,0));
		ADD_APPLICATION_MENUITEM((MENU_SETTING_2D_SENSOR_ON,MENU_SETTING_2D_SENSOR_SWITCH,0,
						SHOW, NONMOVEABLE , DISP_LIST,STR_GLOBAL_ON,IMG_GLOBAL_L1));
		ADD_APPLICATION_MENUITEM((MENU_SETTING_2D_SENSOR_OFF,MENU_SETTING_2D_SENSOR_SWITCH,0,
						SHOW, NONMOVEABLE , DISP_LIST,STR_GLOBAL_OFF,IMG_GLOBAL_L2));

		ADD_APPLICATION_STRING2(STR_SETTING_2D_SENSOR, "2D Sensor", "2D Sensor Setting");
#endif
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SETTING_POWER_SAVING_CAPTION, "Power Saving", "Power Saving Menu Caption.");

    ADD_APPLICATION_STRING2(STR_MENU_SETTING_CONTRAST_LEVEL, "Contrast", "Contrast Level Menu Caption.");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SETTING_CONTRAST_LEVEL_CAPTION, "Contrast Level", "Contrast Level Caption.");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_POWER_SAVE_TIMER_CAPTION, "Power Save Timer", "Power Save Timer Caption.");
    ...
    ADD_APPLICATION_IMAGE2(
        ...
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/Common/ST_STATU.gif",
        "Setting Submenu image for Greeting text status.");
    ADD_APPLICATION_IMAGE2(
        IMG_SETTING_GREET_TEXT,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/Greeting/ST_NOTE.gif",
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_EQUALIZER_CAPTION, "Equalizer", "Title string for the Equalizer Menu");
    ADD_APPLICATION_STRING2(
    ...
    ADD_APPLICATION_IMAGE2(
        IMG_ID_SETTING_SOUND_EFFECT,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/SB_SNDEFT.gif",
        "Menu item image for Sound Effect");
#endif
    ADD_APPLICATION_IMAGE2(
        IMG_ID_SETTING_AUDIO_EQUALIZER,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/SoundEffect/ST_AUDIO_EQ.gif",
    ...
    /* Add string resources */
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_REVERB_EFFECT, "Reverb Effect", "Menu item string for Audio Reverb Effect");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_REVERB_EFFECT_SET1, "Concert", "Menu item string for Audio Reverb Effect");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_REVERB_EFFECT_SET2, "Shower", "Menu item string for Audio Reverb Effect");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_REVERB_EFFECT_SET3, "Church", "Menu item string for Audio Reverb Effect");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_REVERB_EFFECT_SET4, "Small Room", "Menu item string for Audio Reverb Effect");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_REVERB_EFFECT_SET5, "Opera", "Menu item string for Audio Reverb Effect");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_REVERB_EFFECT_SET6, "Bath Room", "Menu item string for Audio Reverb Effect");
    ...
    /* Add string resources */
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_SURROUND_EFFECT, "3D Surround Effect", "Menu item string for Audio Surround Effect");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_SURROUND_PLUG_EAPHONE, "Plug earphone for the effect", "Menu item string for Audio Surround Effect");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_SURROUND_MODE1, "Mode 1", "Menu item string for Audio Surround Effect");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_SURROUND_MODE2, "Mode 2", "Menu item string for Audio Surround Effect");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_AUDIO_EFFECT_NO_COEXIST, "Reverb and surround can't turn on together", "Menu item string for Audio Surround Effect");
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_NETSET_LSK_ABORT, CUST_IMG_BASE_PATH "/NoImage.gif", "LSK Button Image for Abort");
    ADD_APPLICATION_IMAGE2(
    ...
    ADD_APPLICATION_IMAGE2(
        ...
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/ST_HOME.gif",
        "home img");
#endif
    ADD_APPLICATION_IMAGE2(
        IMG_ID_NETSET_PRF_ADDNEW_MMC,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/preferredNetworks/SB_MMC.gif",
        "MMC Image");
    ADD_APPLICATION_IMAGE2(
...
void PopulateSpofRes(void)
{
    ...
    ADD_APPLICATION_IMAGE2(
        ...
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/Poweronoff/ST_PON.gif",
        "Icon for Type of SPOF on/off.");
    ADD_APPLICATION_IMAGE2(
        SPOF_TYPEPOWEROFF_IMAGEID,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/Poweronoff/ST_POFF.gif",
        "Icon for Type of SPOF on/off.");
    ADD_APPLICATION_IMAGE2(
        SPOF_BLANK_IMAGEID,
        CUST_IMG_BASE_PATH "/EmptyImage.bmp",
        "Icon for Title of Alarms Option Screen.");
    ADD_APPLICATION_IMAGE2(SPOF_SETTING_STATUS_IMAGEID, CUST_IMG_PATH "/MainLCD/SubMenu/Settings/common/ST_STATU.gif", "Setting Image for Power on off Status icon");    /* have to check */
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_THEME_WALLPAPER, CUST_IMG_PATH "/MainLCD/IdleScreen/Wallpaper/WALL03.jpg", "wallpaper download");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_THEME_SCREENSAVER, CUST_IMG_PATH "/MainLCD/IdleScreen/Wallpaper/WALL03.jpg", "wallpaper download");
#endif 

    ADD_APPLICATION_IMAGE2(IMG_WALLPAPER_SYSTEM, CUST_IMG_BASE_PATH "/NoImage.bmp", "IMG_WALLPAPER_SYSTEM");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_WALLPAPER_DOWNLAOD, CUST_IMG_BASE_PATH "/NoImage.gif", "IMG_WALLPAPER_DOWNLAOD");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_WALLPAPER_CAPTION, CUST_IMG_BASE_PATH "/NoImage.gif", "IMG_WALLPAPER_CAPTION");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SCREENSAVER_VIEW_CAPTION, "Screen Saver", "Screen Saver");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_NO_SCREENSAVER_AVAIL, "Screen Saver List Is Empty", "Screen Saver List Is Empty");
...
#endif 
#ifdef __MMI_THEMES_V2_SUPPORT__
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_DISPCHAR_THEME_WALLPAPER, "Theme Image", "Wallpaper Menu string");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_DISPCHAR_THEME_SCREENSAVER, "Theme Image", "Wallpaper Menu string");
#endif 

    ADD_APPLICATION_IMAGE2(
        IMAGE_SETTING_TIME,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/Common/ST_TIME.gif",
        "Icon for Time In  Category 57");

#ifdef __MMI_POWER_ON_OFF_DISPLAY__
    /* Populating Power on/off dependent Resources */
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_ON_OFF_CAPTION, "Power On/Off Display", "STR_ID_PHNSET_ON_OFF_CAPTION");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_ON_OFF_BAD_FILE, "Invalid File", "STR_ID_PHNSET_ON_OFF_BAD_FILE");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_ON_OFF_SELECT_CAPTION, "On/off Select", "STR_WALLPAPER_SET");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_PHNSET_ON_OFF_SYSTEM, CUST_IMG_BASE_PATH "/NoImage.gif", "IMG_WALLPAPER_SYSTEM");
    ADD_APPLICATION_IMAGE2(
        IMG_ID_PHNSET_ON_OFF_DOWNLAOD,
        CUST_IMG_BASE_PATH "/NoImage.bmp",
        "IMG_WALLPAPER_DOWNLAOD");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_PHNSET_ON_OFF_CAPTION, CUST_IMG_BASE_PATH "/NoImage.gif", "IMG_WALLPAPER_CAPTION");
#endif /* __MMI_POWER_ON_OFF_DISPLAY__ */ 

#ifdef __MMI_ANALOG_CLOCK__
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_DISPCHAR_ANALOG, "Analog Clock", "DisplayCharList");
#endif 
#ifdef __MMI_DIGITAL_CLOCK__
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_DISPCHAR_DIGITAL, "Digital Clock", "DisplayCharList");
#endif 
#ifdef __MMI_THEMES_V2_SUPPORT__
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_THEME_WALLPAPER, CUST_IMG_PATH "/MainLCD/IdleScreen/WallPaper/WALL03.jpg", "Image associated with screen saver.");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_THEME_SCREENSAVER, CUST_IMG_PATH "/MainLCD/IdleScreen/WallPaper/WALL03.jpg", "Image associated with screen saver.");
#endif 
#ifdef __OTG_ENABLE__
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_PHNSET_DISPCHAR_INVALID_PATH, "Invalid Folder", "OTG doesn't support dispchar");
#endif 
#if 0
    if (!res_log)
    {
    ...
    #endif
        {
            char gif_path[] = CUST_IMG_PATH "/MainLCD/IdleScreen/WallPaper/WALL01.jpg";
...
//del by reslim v0.1        ADD_APPLICATION_STRING2(STR_ID_DISPCHAR_SWFLASH_0,"SWFlash 1","DisplayCharList");
//del by reslim v0.1        ADD_APPLICATION_STRING2(STR_ID_DISPCHAR_SWFLASH_1,"SWFlash 2","DisplayCharList");

//del by reslim v0.1        ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_SWFLASH_0,CUST_IMG_PATH"/MainLCD/SWFlash/IC_M01.CMP","Built-in SWFlash file 1");
//del by reslim v0.1        ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_SWFLASH_1,CUST_IMG_PATH"/MainLCD/SWFlash/IC_M02.CMP","Built-in SWFlash file 2");
        ...
        ADD_APPLICATION_IMAGE2(
            ...
            CUST_IMG_PATH "/SubLCD/WallPaper/WALL01.jpg",
            "Image associated with wallpaper.");
        ADD_APPLICATION_IMAGE2(
            IMG_ID_PHNSET_SUB_WP_1,
            CUST_IMG_PATH "/SubLCD/WallPaper/WALL02.jpg",
            "Image associated with wallpaper.");
        ADD_APPLICATION_IMAGE2(
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_MENU8236_BDL_VIEW_OPTIONS_MAIN, "BDN List ", "BDL OPTION CAPTION");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_MENU8234_FDL_VIEW_OPTIONS_MAIN, "FDN List ", "FDL MENU OPTION CAPTION");
...
//    ADD_APPLICATION_STRING2(STR_DIFF_PIN, "Different PIN codes!", "Pin codes Different String.");
    ...
    ADD_APPLICATION_IMAGE2(
        IMG_SETTING_SECURITY,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/SB_SECUR.gif",
...
ADD_APPLICATION_MENUITEM((MAIN_MENU_SETTINGS_MENUID,IDLE_SCREEN_MENU_ID,
	...
	//	MAIN_MENU_PROFILES_MENUID, 
		...
		SHOW,MOVEABLEWITHINPARENT|INSERTABLE,1,MAIN_MENU_SETTINGS_TEXT,
		MAIN_MENU_SETTINGS_ICON));
#elif defined (__MMI_MAINLCD_220X176__) || defined (__MMI_MAINLCD_128X128__)
ADD_APPLICATION_MENUITEM((MAIN_MENU_SETTINGS_MENUID,IDLE_SCREEN_MENU_ID,
#if defined(__MMI_TOUCH_SCREEN__) || defined(__MMI_HANDWRITING_PAD__)
		1+
#endif
...
ADD_APPLICATION_MENUITEM((MENU9141_TIME_AND_DATE,MENU9102_INITIAL_SETUP,2
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_HANDWRITING_MEDIUM, "Medium", "Pen Speed Medium");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_HANDWRITING_SLOW, "Slow", "Pen Speed Slow");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SCR9001_CALL_SETTING_CAPTION, "Call Setup", "Select Call Setting Menu.");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SCR9041_TIMEANDDATE_CAPTION, "Set Time/Date", "Select Time and Date Menu.");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SCR9042_SETTIME_CAPTION, "Set Time", "Select Set Time Menu.");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SCR9043_SETTIMEFORMAT_CAPTION, "Set Time Format", "Select Set Time Format Menu.");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SCR9044_SETDATE_CAPTION, "Set Date", "Select Set Date Menu.");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SCR9045_SETDATEFORMAT_CAPTION, "Set Date Format", "Select Set Date Format Menu.");

    ADD_APPLICATION_STRING2(STR_24, "24", "Time Format 24.");
    ADD_APPLICATION_STRING2(STR_12, "12", "Time Format 12.");

//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SCR9033_AUTO_REDIAL_CAPTION, "Auto Redial", "Enter Auto Redial Menu.");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_TVOUT_AUD_PATH, "Audio Output", "STR_ID_SETTING_TVOUT_AUD_PATH");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_TVOUT_AUD_PATH_BOTH, "TV and Phone", "STR_ID_SETTING_TVOUT_AUD_PATH_BOTH");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_TVOUT_AUD_PATH_TV, "TV Only", "STR_ID_SETTING_TVOUT_AUD_PATH_TV");

    ADD_APPLICATION_STRING2(STR_ID_SETTING_TVOUT_ADJUST, "Adjust", "STR_ID_SETTING_TVOUT_ADJUST");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_TVOUT_ADJUST_Y_GAMMA, "Gamma Y", "STR_ID_SETTING_TVOUT_MM_STYLE_PHONE");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_TVOUT_ADJUST_U, "U", "STR_ID_SETTING_TVOUT_MM_STYLE_FULLSCR");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_TVOUT_ADJUST_V, "V", "STR_ID_SETTING_TVOUT_MM_STYLE_FULLSCR");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_SETTING_TVOUT_NOT_READY, "TV-Out Not Ready", "STR_ID_SETTING_TVOUT_NOT_READY");
#endif /* __MMI_TVOUT__ */ 
    ...
    ADD_APPLICATION_IMAGE2(
        ...
        CUST_IMG_PATH "/MainLCD/TitleBar/TB_ST.gif",
        "Title Image For Settings Main Screen.");
    ADD_APPLICATION_IMAGE2(
        IMG_SETTING_CALL_SETUP,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/SB_SCALL.gif",
        "Setting Submenu image for Call Setup.");
    ADD_APPLICATION_IMAGE2(
        IMG_SETTING_NETWORK,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/SB_SNET.gif",
        "Setting Submenu image for Network Setup.");
    ADD_APPLICATION_IMAGE2(
        IMG_SETTING_PHONE,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/SB_SPH.gif",
        "Setting Submenu image for Phone Setup.");
    ADD_APPLICATION_IMAGE2(
        IMG_SETTING_STORE,
        CUST_IMG_PATH "/MainLCD/SubMenu/Settings/SB_STORE.gif",
    ...
    ADD_APPLICATION_IMAGE2(
        ...
        CUST_IMG_PATH "/MainLCD/UIElement/ValueMap/mapbg.jpg",
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_SETTING_WRONG_TIME, "Please Enter Correct Date/Time", "Notification Msg");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_MULTI_SIM_CARD_POPUP ,"Switch SIM card now, rebooting...","Switch SIM card now, rebooting...");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_MULTI_SIM_CARD_CHANGE,"No Sim And Switch Card?","No Sim And Switch Card?");
	/*UNI@liugang_20070724 提示信息修改*/
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_MULTI_SIM_CARD_DISPLAY,"Double waits the service to open please do confirm two SIM card insertion is correct!","Double waits the service to open please do confirm two SIM card insertion is correct!");
	ADD_APPLICATION_STRING2(STR_ID_MULTI_SIM_DISPLAY_MENU,"In idle hint dual online","In idle hint dual online");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_MULTI_SIM_FAILED_NO_SIM,"No Sim","No Sim");
//del by reslim v0.1    	ADD_APPLICATION_STRING2(STR_ID_MULTI_SIM_FAILED_NO_NET_SIM1,"SIM1 Network nonsupport","SIM1 Network nonsupport");
//del by reslim v0.1    	ADD_APPLICATION_STRING2(STR_ID_MULTI_SIM_FAILED_NO_NET_SIM2,"SIM2 Network nonsupport","SIM2 Network nonsupport");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_MULTI_SIM_SERVER_HELLP,"help","help");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ACTIVATE_MESSAGE, "GroupList Activated", "GroupList Activated");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_DEACTIVATE_MESSAGE, "GroupList Deactivated", "GroupList Deactivated");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_GROUPLIST_DEACTIVATED, "Deactivated", "Deactivated");
...
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_WALLPAPER_4,"Image 4","WallPaper");
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_WALLPAPER_5,"Image 5","WallPaper");
...
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_SCREENSAVER_SS4,"Screen Saver 4","Screen Saver");
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_SCREENSAVER_SS5,"Screen Saver 5","Screen Saver");
...
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_ID_PHNSET_ON_OFF_4,"Image 4","Power onoff Image");
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_ID_PHNSET_ON_OFF_5,"Image 5","Power onoff Image");
...
#endif
ADD_APPLICATION_IMAGE3(IMG_ID_PHNSET_ON_OFF_1,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/WALL01.jpg","Power ON/OFF image");
ADD_APPLICATION_IMAGE3(IMG_ID_PHNSET_ON_OFF_2,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/WALL02.jpg","Power ON/OFF image");
#if !defined(__MMI_RESOURCE_SLIM_ON_128X160__)
ADD_APPLICATION_IMAGE3(IMG_ID_PHNSET_ON_OFF_3,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall03.jpg","Power ON/OFF image");
#if !defined (__MMI_RESOURCE_SLIM__)
//del by reslim v0.1ADD_APPLICATION_IMAGE3(IMG_ID_PHNSET_ON_OFF_4,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall04.gif","Power ON/OFF image");
//del by reslim v0.1ADD_APPLICATION_IMAGE3(IMG_ID_PHNSET_ON_OFF_5,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall05.gif","Power ON/OFF image");
//del by reslim v0.1ADD_APPLICATION_IMAGE3(IMG_ID_PHNSET_ON_OFF_6,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall06.gif","Power ON/OFF image");
#endif
#endif

/* generatror Wallpaper image */
ADD_APPLICATION_IMAGE3(WALLPAPER_1,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/WALL01.jpg","Wallpaper image");
ADD_APPLICATION_IMAGE3(WALLPAPER_2,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/WALL02.jpg","Wallpaper image");
#if !defined(__MMI_RESOURCE_SLIM_ON_128X160__)
	ADD_APPLICATION_IMAGE3(WALLPAPER_2,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall03.jpg","Wallpaper image");
//del by reslim v0.1ADD_APPLICATION_IMAGE3(WALLPAPER_3,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/WALL04.jpg","Wallpaper image");
#if !defined (__MMI_RESOURCE_SLIM__)
//del by reslim v0.1ADD_APPLICATION_IMAGE3(WALLPAPER_4,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall04.gif","Wallpaper image");
//del by reslim v0.1ADD_APPLICATION_IMAGE3(WALLPAPER_5,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall05.gif","Wallpaper image");
//del by reslim v0.1ADD_APPLICATION_IMAGE3(WALLPAPER_6,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall06.gif","Wallpaper image");
#endif
#endif
...
ADD_APPLICATION_IMAGE3(SCREENSAVER_1,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/WALL01.jpg","SaveScreen image");
ADD_APPLICATION_IMAGE3(SCREENSAVER_2,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/WALL02.jpg","SaveScreen image");
#if !defined(__MMI_RESOURCE_SLIM_ON_128X160__)
	ADD_APPLICATION_IMAGE3(SCREENSAVER_3,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall03.jpg","SaveScreen image");
//del by reslim v0.1ADD_APPLICATION_IMAGE3(SCREENSAVER_3,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/WALL03.jpg","SaveScreen image");
#if !defined (__MMI_RESOURCE_SLIM__)
//del by reslim v0.1ADD_APPLICATION_IMAGE3(SCREENSAVER_4,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall04.gif","SaveScreen image");
//del by reslim v0.1ADD_APPLICATION_IMAGE3(SCREENSAVER_5,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall05.gif","SaveScreen image");
//del by reslim v0.1ADD_APPLICATION_IMAGE3(SCREENSAVER_6,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/wall06.gif","SaveScreen image");
#endif
