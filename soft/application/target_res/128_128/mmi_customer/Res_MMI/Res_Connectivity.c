...
//    ADD_APPLICATION_IMAGE2(IMG_USB_POWER_ON,CUST_IMG_PATH"/MainLCD/Active/Poweronoff/USB_noanimation.gif","Power on with USB boot mode");
    ADD_APPLICATION_IMAGE2(IMG_USB_CHGR_CMPLT,CUST_IMG_PATH"/MainLCD/UIELEMENT/charger/CHARGF.JPG","Power on with USB boot mode");
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_WEBCAM_PAUSE_JPEG_1, CUST_IMG_PATH"/MainLCD/Active/webcam/webcam_jpeg_1.gif","Pause screen jpeg");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_WEBCAM_PAUSE_JPEG_2, CUST_IMG_PATH"/MainLCD/Active/webcam/webcam_jpeg_2.gif","Pause screen jpeg");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_ID_WEBCAM_PAUSE_JPEG_3, CUST_IMG_PATH"/MainLCD/Active/webcam/webcam_jpeg_3.gif","Pause screen jpeg");
	#endif
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_USB_CONFIG_CDCACM_DEBUG,"Debug Port","USB Detection");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_USB_MODE_PROGRESS,"Waiting","USB Detection");
    ADD_APPLICATION_STRING2(STR_ID_USB_NO_MS_FOR_PC,"USB: No storage for PC","USB Detection");    
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_USB_NO_MS_FOR_PC,"USB: No storage for PC","USB Detection");    
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_USB_SYS_NOT_READY,"USB: System not ready","USB Detection");    
#endif
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_USB_IRCOMM_OCCUPY_CDCACM, "Please turn off IrDA","USB Detection");
	
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_USB_UART2_OCCUPIED,"UART2 is Occupied!","USB Detection");    	
	#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_IRDA_MENU_STORAGE, "Storage Location","Infrared Data Storage Location");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_IRDA_MENU_ACTIVATION, "Activation Menu","Infrared Activation Menu");
...
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_SET_AUTH,"Authentication");
...
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_PWRON,"Power on Bluetooth...");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_SEARCH,"Searching...");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_SEARCH_FOUND,"Found");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_SEARCH_RES,"Device Found");
	ADD_APPLICATION_STRING(STR_BT_LSK_CONN,"Conn.");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_PAIR,"Pair");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_PAIRING,"Pairing...");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_ENTER_PIN,"Enter Bluetooth Passcode:");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_CONN_CNF,"Connect Device?");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_PWRON_CNF,"Power on Bluetooth?");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_MYDEVOPT_SCH,"Search new device");
	ADD_APPLICATION_STRING(STR_BT_SCH_ALL_DEV,"Inquiry BT Device");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_HW_ERROR,"Hardware Error!");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_MYDEVOPT_CONN,"Connect");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_MYDEVOPT_DEL,"Delete");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_BUSY,"Bluetooth device busy");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_ENLIST_TRDEV_CNF,"Add to trust list?");
	ADD_APPLICATION_STRING(STR_BT_LSK_DISC,"Disc.");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_PROFCON_HS,"Bluetooth Headset Connected");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_PROFCON_HF,"Bluetooth HeadFree Connected");	
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_SCO_CON,"Bluetooth Voice Channel Established");
	ADD_APPLICATION_STRING(STR_BT_CM_SETPATH,"Swap Bluetooth Voice Path");
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_MYDEVOPT_REN,"Rename");
...
//del by reslim v0.1	ADD_APPLICATION_STRING(STR_BT_SCO_DISCON,"Bluetooth Voice Channel Released");

//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_BT_SET_VIS_PROC, "Setting...","Bluetooth Setting title");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_BT_SET_NAME_DONE, "Done! Reboot to take effect","Bluetooth Setting title");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_BT_SET_NAME_DENY, "Ascii Character Only!","Bluetooth Setting title");
	ADD_APPLICATION_STRING2(STR_BT_SET_NAME_LENGTH_LIMITATION, "Cannot be NULL!","Bluetooth Setting title");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_BT_AUD_PATH_PHONE, "Phone","Bluetooth Setting title");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_BT_AUD_PATH_HF, "HandFree","Bluetooth Setting title");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_BT_REMOTE_CTRL_MEDIA_PLAYER, "Media Player", "Bluetooth Setting title");
   ...
   /* Status icon is populate in Res_Gui.c */
#if !defined(MMI_ULC)
	ADD_APPLICATION_IMAGE2(IMG_BT_MENU_TITLE, CUST_IMG_PATH"/MainLCD/Bluetooth/SB_BT.JPG","Bluetooth menu icon");
	//ADD_APPLICATION_IMAGE2(IMG_BT_SCH_TITLE, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_Search.gif","Bluetooth menu icon");

	ADD_APPLICATION_IMAGE2(IMG_BT_DEV_MOB, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_MOB.JPG","Bluetooth menu icon");
	ADD_APPLICATION_IMAGE2(IMG_BT_DEV_LAP, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_LAP.JPG","Bluetooth menu icon");
	ADD_APPLICATION_IMAGE2(IMG_BT_DEV_EAR, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_EAR.JPG","Bluetooth menu icon");
	ADD_APPLICATION_IMAGE2(IMG_BT_DEV_OTHER, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_other.JPG","Bluetooth menu icon");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_OPTION_GET, "Get","Get File string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_OPTION_REFRESH, "Refresh","Refresh string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_OPTION_DETAIL, "Detail","File detailed info string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_OPTION_BACK_TO_ROOT_DIR, "Back to Root Dir","Back to Root Dir string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_OPTION_DISCONNECT, "Disconnect","Disconnect string");
#ifdef __MMI_FTC_MULTIPULL_SUPPORT__
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_OPTION_ADD_TO_LIST, "Add To List","Add To List");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_OPTION_SHOW_LIST, "Show List","Show List");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_OPTION_GET_LIST, "Get List","Get List");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_OPTION_GET_ALL, "Get All","Get All");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_LIST_OPTION_UP, "Up","Up");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FTP_LIST_OPTION_DOWN, "Down","Down");
