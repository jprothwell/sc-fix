...
//del by reslim v0.1ADD_APPLICATION_STRING2 (WGUI_UCE_SMS_STRING_ID, "SMS", "SMS string used in information bar showing size of SMS");
//del by reslim v0.1ADD_APPLICATION_STRING2 (WGUI_UCE_MMS_STRING_ID, "MMS", "MMS string used in information bar showing size of MMS");

#ifdef __MMI_TOUCH_SCREEN__
//del by reslim v0.1ADD_APPLICATION_IMAGE2 (WGUI_UCE_ATTACHFILE_ICON_IMAGE_ID, CUST_IMG_PATH"/MainLCD/UCE/LAttachfile.gif", "Attachment ICON");
//del by reslim v0.1ADD_APPLICATION_IMAGE2 (WGUI_UCE_AUDIO_ICON_IMAGE_ID, CUST_IMG_PATH"/MainLCD/UCE/LAudio.gif", "Audio ICON");
//del by reslim v0.1ADD_APPLICATION_IMAGE2 (WGUI_UCE_PICTURE_ICON_IMAGE_ID, CUST_IMG_PATH"/MainLCD/UCE/LPic.gif", "Picture ICON");
//del by reslim v0.1ADD_APPLICATION_IMAGE2 (WGUI_UCE_VIDEO_ICON_IMAGE_ID, CUST_IMG_PATH"/MainLCD/UCE/LVideo.gif", "Video ICON");
#else
//del by reslim v0.1ADD_APPLICATION_IMAGE2 (WGUI_UCE_ATTACHFILE_ICON_IMAGE_ID, CUST_IMG_PATH"/MainLCD/UCE/SAttachfile.gif", "Attachment ICON");
//del by reslim v0.1ADD_APPLICATION_IMAGE2 (WGUI_UCE_AUDIO_ICON_IMAGE_ID, CUST_IMG_PATH"/MainLCD/UCE/SAudio.gif", "Audio ICON");
//del by reslim v0.1ADD_APPLICATION_IMAGE2 (WGUI_UCE_PICTURE_ICON_IMAGE_ID, CUST_IMG_PATH"/MainLCD/UCE/Spic.gif", "Picture ICON");
//del by reslim v0.1ADD_APPLICATION_IMAGE2 (WGUI_UCE_VIDEO_ICON_IMAGE_ID, CUST_IMG_PATH"/MainLCD/UCE/SVideo.gif", "Video ICON");
#endif /*__MMI_TOUCH_SCREEN__ */
//del by reslim v0.1ADD_APPLICATION_IMAGE2 (WGUI_DEFAULT_PREVIEW_IMAGE_ID, CUST_IMG_PATH"/MainLCD/UCE/broken.gif", "Default Preview");
...
{	
      ...
      */
      ...
      #endif
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_DD_STRING_ID,"DD","Category screens string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_MM_STRING_ID,"MM","Category screens string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_YYYY_STRING_ID,"YYYY","Category screens string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_THH_STRING_ID,"HH","Category screens string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_TMM_STRING_ID,"MM","Category screens string");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_YYYY_MM_DD_STRING_ID,"YYYY/MM/DD","Category screens string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_HH_MM_STRING_ID,"HH:MM","Category screens string");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_hebrew_STRING_ID,"He","Category screens string");
#endif 
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_PERSIAN_STRING_ID,"FA","Category screens string");
#endif	
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_TSS_STRING_ID,"SS","Category screens string");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(WGUI_CATEGORY_CANCEL_STRING_ID,"Cancel","Category screens string");
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL8,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/SC_Volume_Level_08.gif","VOL LEVEL8");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL9,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/SC_Volume_Level_09.gif","VOL LEVEL9");	
#endif
#endif	
 
#if defined(__MMI_TOUCH_SCREEN__)      /* 081206 volume control */
	//ADD_APPLICATION_IMAGE2(WGUI_VOLUME_UP_UP_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_up_up.gif","Volume up button normal image");
	//ADD_APPLICATION_IMAGE2(WGUI_VOLUME_UP_DOWN_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_up_down.gif","Volume up button pressed image");
	//ADD_APPLICATION_IMAGE2(WGUI_VOLUME_DOWN_UP_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_down_up.gif","Volume down button normal image");
	//ADD_APPLICATION_IMAGE2(WGUI_VOLUME_DOWN_DOWN_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_down_down.gif","Volume down button pressed image");
#endif
	...
	ADD_APPLICATION_IMAGE2(WGUI_SLIDE_CONTROL_SI_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIElement/Valuemap/INDICATE.gif","Slide Indicator image for Slide Control");
#endif
	ADD_APPLICATION_IMAGE2(WGUI_INPUT_INFORMATION_ICON1,CUST_IMG_PATH"/MainLCD/Edit/MUT.gif","Icon for Multitap input mode");
//For dialing screen
...
#else
#if !defined(MMI_ULC)
	ADD_APPLICATION_IMAGE2(IMG_DIALING_SCREEN,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_SCREEN.JPG","Image of Dialing Screen");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_0,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY0.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_1,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY1.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_2,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY2.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_3,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY3.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_4,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY4.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_5,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY5.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_6,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY6.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_7,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY7.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_8,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY8.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_9,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY9.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_HASH,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY_HASH.JPG","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_STAR,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY_STAR.JPG","Image of Dialing Key");
#endif
...
#endif
#if !defined(MMI_ULC)
	ADD_APPLICATION_IMAGE2 (CHAT_LOCAL_IMG, CUST_IMG_PATH"/MainLCD/Chat/CT_IN.gif", "CHAT app Menu item OUT common Image");	
	ADD_APPLICATION_IMAGE2 (CHAT_REMOTE_IMG, CUST_IMG_PATH"/MainLCD/Chat/CT_OUT.gif", "CHAT app Menu item IN common Image");	
#endif
	ADD_APPLICATION_IMAGE2(IMG_H_SELECT_LEFT,CUST_IMG_PATH"/MainLCD/UIElement/Arrow/SELECT_LEFT.gif", "Left arrow in horizontal select");
	ADD_APPLICATION_IMAGE2(IMG_H_SELECT_RIGHT,CUST_IMG_PATH"/MainLCD/UIElement/Arrow/SELECT_RIGHT.gif", "Right arrow in horizontal select");
	ADD_APPLICATION_IMAGE2 (RIGHT_RED_ARROW, CUST_IMG_PATH"/MainLCD/UIElement/Arrow/PV_ARR.gif","right arrow");
	ADD_APPLICATION_IMAGE2 (LEFT_RED_ARROW, CUST_IMG_PATH"/MainLCD/UIElement/Arrow/PV_ARL.gif","left arrow");
...
#if defined( __MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__)||defined( __MMI_MAINLCD_220X176__)||defined( __MMI_MAINLCD_128X160__)||defined(__MMI_MAINLCD_128X128__)
	ADD_APPLICATION_IMAGE2 (IMG_POPUP_TITLE, CUST_IMG_PATH"/MainLCD/WarningPage/PopUpPage/PP_TB.gif","Background image of popup screen");
#endif
#endif
	...
	ADD_APPLICATION_IMAGE2 (IMG_SOFTKEY_BAR, CUST_IMG_PATH"/MainLCD/UIElement/softkey/softkey.jpg","Background image of SOFTKEY");
#else
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_FEB,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/FEB.gif","Box image FEB.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_MAR,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/MARCH.gif","Box image MAR.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_APR,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/APRIL.gif","Box image APR.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_MAY,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/MAY.gif","Box image MAY.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_JUN,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/JUNE.gif","Box image JUN.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_JUL,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/JULY.gif","Box image JUL.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_AUG,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/AUG.gif","Box image AUG.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_SEP,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/SEP.gif","Box image SEP.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_OCT,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/OCT.gif","Box image OCT.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_NOV,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/NOV.gif","Box image NOV.");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(DALMATIAN_WEEK_HIGHLIGHTER_IMAGE_ID_DEC,CUST_IMG_PATH"/MainLCD/Calendar/DALMATIAN/WEEK/DEC.gif","Box image DEC.");
#endif
 
	ADD_APPLICATION_IMAGE2(CAL_ENGLISH_DAYS_IMAGE,CUST_IMG_PATH"/MainLCD/Calendar/Week/week.gif","Day of Week display");
#ifndef MEM_ULC_3216
	ADD_APPLICATION_IMAGE2(CAL_CHINESE_DAYS_IMAGE,CUST_IMG_PATH"/MainLCD/Calendar/Week/chinese week.gif","Day of Week display");
#endif
#ifdef __MMI_TOUCH_SCREEN__
	...
	ADD_APPLICATION_IMAGE2 (IMG_TITLEBAR_BG, CUST_IMG_PATH"/MainLCD/Titlebar/TB_BG_1.jpg","keyboard for password input"); 
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_IDLESCREEN_MONDAY, "Monday", "String Sunday shown in Techno Idlescreen Bar");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_IDLESCREEN_TUESDAY, "Tuesday", "String Sunday shown in Techno Idlescreen Bar");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_IDLESCREEN_WEDNESDAY, "Wednesday", "String Sunday shown in Techno Idlescreen Bar");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_IDLESCREEN_THURSDAY, "Thursday", "String Sunday shown in Techno Idlescreen Bar");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_IDLESCREEN_FRIDAY, "Friday", "String Sunday shown in Techno Idlescreen Bar");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_IDLESCREEN_SATURDAY, "Saturday", "String Sunday shown in Techno Idlescreen Bar");
	...
	ADD_APPLICATION_IMAGE2(IMAGE_VIEW_TITLEBAR_BG, CUST_IMG_PATH"/MainLCD/Titlebar/TB_BG_1.jpg","Title bar of Wallpaper and ScreenSaver Image View Screen");
#endif
	ADD_APPLICATION_IMAGE2(IMG_FLEXIBLE_TITLEBAR_BG, CUST_IMG_PATH"/MainLCD/Titlebar/TB_BG_1.jpg","Title bar for flexible size");//093006 popup title
	...
	ADD_APPLICATION_IMAGE2(IMG_HORIZONTAL_TAB_HINT_AREA, CUST_IMG_PATH"/MainLCD/UIElement/TabBar/TitleBar.jpg", "tab hint area");

	ADD_APPLICATION_IMAGE2(IMG_PERCENTAGE_BAR_LEFT_IMAGE, CUST_IMG_PATH"/MainLCD/UIElement/ProgressBar/load_left.gif", "aa");
	ADD_APPLICATION_IMAGE2(IMG_PERCENTAGE_BAR_RIGHT_IMAGE, CUST_IMG_PATH"/MainLCD/UIElement/ProgressBar/load_right.gif", "bb");
	ADD_APPLICATION_IMAGE2(IMG_PERCENTAGE_BAR_BG_IMAGE, CUST_IMG_PATH"/MainLCD/UIElement/ProgressBar/load_bg.gif", "cc");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_SI_SIGNAL_STRENGTH_IDLE,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/Techno/signal/SI_SIG_IDLE","Status Icon: Signal strength");
...
//del by reslim v0.1       ADD_APPLICATION_IMAGE2( IMG_SI_SIGNAL_STRENGTH_CARD1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/signal/SI_SIG_S1","Status Icon: Signal strength");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2( IMG_SI_SIGNAL_STRENGTH_CARD2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/signal/SI_SIG_S2","Status Icon: Signal strength");
#endif
...
#ifdef __MMI_VOIP__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_SI_VOIP,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_VOIP.gif","Status Icon: VOIP");
#endif
	/*Keypad Lock/Unlock*/
	ADD_APPLICATION_IMAGE2(IMG_SI_KEYPAD_LOCK,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_LOCK.gif","Status Icon: Keypad lock");
	ADD_APPLICATION_IMAGE2(IMG_SI_KEYPAD_UNLOCK,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_UNLOCK.gif","Status Icon: Keypad lock");

	/*Profiles*/
	ADD_APPLICATION_IMAGE2(IMG_SI_VIBRATE,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_VIB.gif","Status Icon: Vibrator");
	ADD_APPLICATION_IMAGE2(IMG_SI_SILENT,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_SILENT.gif","Status Icon: Silent");	
	ADD_APPLICATION_IMAGE2(IMG_SI_RING,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_RING.gif","Status Icon: Ring");
	ADD_APPLICATION_IMAGE2(IMG_SI_VIBRATE_AND_RING,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_VR.gif","Status Icon: Vibrate and ring");
	ADD_APPLICATION_IMAGE2(IMG_SI_VIBRATE_THEN_RING,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_VTR.gif","Status Icon: Vibrate then ring");

	/*Alarm*/
	ADD_APPLICATION_IMAGE2(IMG_SI_ALARM_ACTIVATED,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_ALARM.gif","Status Icon: Alarm");

	/*Roaming*/
	ADD_APPLICATION_IMAGE2(IMG_SI_ROAMING_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_RM.gif","Status Icon: Roaming");

#ifndef __MMI_MULTI_SIM__
	/*Missed Call*/
	ADD_APPLICATION_IMAGE2(IMG_SI_MISSED_CALL_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_MCA.gif","Status Icon: Missed Call");
#endif	
#ifdef __DOUBLE_PHONE_MISSED_SIM2_CALL_ICON
#ifdef __UNI_TWIN_C__
//del by reslim v0.1      ADD_APPLICATION_IMAGE2(IMG_SI_MISSED_SIM2_CALL_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_MCA_C.gif","Status Icon: Missed Call");
#else
//del by reslim v0.1       ADD_APPLICATION_IMAGE2(IMG_SI_MISSED_SIM2_CALL_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_MCA2.gif","Status Icon: Missed Call");
#endif
#endif
	/*Gprs*/
	ADD_APPLICATION_IMAGE2(IMG_SI_GPRS_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_GPRS.gif","Status Icon: GPRS");

	/*Earphone*/
#if (defined (__MMI_STATUS_ICON_EN_EARPHONE__) || defined(__MMI_BT_HP_SUPPORT__)  )
	ADD_APPLICATION_IMAGE2(IMG_SI_EARPHONE_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_EAR.gif","Status Icon: EarPhone");
#endif

	/*MMS*/
//#ifdef __MMI_STATUS_ICON_MMS__
	ADD_APPLICATION_IMAGE2(IMG_SI_MMS_UNREAD_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_MMSU.gif","Status Icon: EarPhone");
	ADD_APPLICATION_IMAGE2(IMG_SI_MMS_BUSY_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_MMSB.gif","Status Icon: EarPhone");
//#endif
     ...
     ADD_APPLICATION_IMAGE2(IMG_SI_BT,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_BT.gif","Status Icon: BT");
     ADD_APPLICATION_IMAGE2(IMG_SI_BT_CON,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_BT_CON.gif","Status Icon: BT");
     ADD_APPLICATION_IMAGE2(IMG_SI_BT_ND,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_BT_ND.gif","Status Icon: BT");
#endif
...
//del by reslim v0.1     ADD_APPLICATION_IMAGE2(IMG_SI_REVERBSND,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_AudReverb.gif","Status Icon: audio reverb effect");
#endif

#ifdef __MMI_AUDIO_SURROUND_EFFECT__
//del by reslim v0.1     ADD_APPLICATION_IMAGE2(IMG_SI_SURROUNDSND,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_3DSound.gif","Status Icon: audio surround effect");
#endif
	...
	ADD_APPLICATION_IMAGE2(IMG_SI_GPRS_ATT_NO_PDP_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_GPRSC.gif","Status Icon: GPRS, attach without pdp");	
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_VOICE_L1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_VOML1.gif","Status Icon: Unread Voice L1");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_VOICE_L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_VOML2.gif","Status Icon: Unread Voice L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_VOICE_L1L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_VOML12.gif","Status Icon: Unread Voice L1+L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_FAX_L1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_FM1.gif","Status Icon: Unread Fax L1");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_FAX_L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_FM2.gif","Status Icon: Unread Fax L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_FAX_L1L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_FM12.gif","Status Icon: Unread Fax L1+L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_EMAIL_L1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_EM1.gif","Status Icon: Unread Email L1");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_EMAIL_L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_EM2.gif","Status Icon: Unread Email L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_EMAIL_L1L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_EM12.gif","Status Icon: Unread Email L1+L2");
	...
	/*Call Divert*/
	ADD_APPLICATION_IMAGE2(IMG_SI_CALL_DIVERT_L1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_FOR01.gif","Status Icon: Call Divert L1");
	ADD_APPLICATION_IMAGE2(IMG_SI_CALL_DIVERT_L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_FOR02.gif","Status Icon: Call Divert L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_CALL_DIVERT_L1L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_FOR.gif","Status Icon: Call Divert L1+L2");
	
	ADD_APPLICATION_IMAGE2(IMG_SI_VOICE_RECORD,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_REC.gif","Status Icon: Voice record");
	ADD_APPLICATION_IMAGE2(IMG_SI_MUTE,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_MUTE.gif","Status Icon: Mute");
	
	ADD_APPLICATION_IMAGE2(IMG_BLINKINGICON_CHAT_ROOM1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_CHAT1.gif","Chat Room1 Blinking Icon");
	ADD_APPLICATION_IMAGE2(IMG_BLINKINGICON_CHAT_ROOM2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_CHAT2.gif","Chat Room2 Blinking Icon");
	ADD_APPLICATION_IMAGE2(IMG_SI_STOPWATCH,CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/SI_STWATCH.gif","Image for Stopwatch Icon");
	ADD_APPLICATION_IMAGE2(IMG_SI_JAVA_PAUSE,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_Jvlogo.gif","Java pause"); 
	...
	//ADD_APPLICATION_IMAGE2(IMG_SI_WAP,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_WMAL.bmp","Sub LCD Status Icon: Vibrate then Ring");
    	ADD_APPLICATION_IMAGE2(IMG_SI_WAP,CUST_IMG_PATH"/MainLCD/WAP/SW_UNREAD.gif","Sub LCD Status Icon: Vibrate then Ring");//2010-4-14 used for wap_push_indicator

	ADD_APPLICATION_IMAGE2(IMG_SI_NETWORK_CIPHER_GSM,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_NCGSM.gif","Network Ciphering for GSM"); 
	ADD_APPLICATION_IMAGE2(IMG_SI_NETWORK_CIPHER_GPRS,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_NCGPRS.gif","Network Ciphering for GPRS"); 
...
#ifdef __MMI_WLAN_FEATURES__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_DTCNT_WLAN_STATUS_DISCONNECT, CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/WiFi/wifi_disconnect.gif","Image of WLAN");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_DTCNT_WLAN_STATUS_SCANNING, CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/WiFi/wifi_connecting.gif","Image of WLAN");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_DTCNT_WLAN_STATUS_CONNECT1, CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/WiFi/WiFi_connect_1.gif","Image of WLAN");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_DTCNT_WLAN_STATUS_CONNECT2, CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/WiFi/WiFi_connect_2.gif","Image of WLAN");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_DTCNT_WLAN_STATUS_CONNECT3, CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/WiFi/WiFi_connect_3.gif","Image of WLAN");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_DTCNT_WLAN_STATUS_CONNECT4, CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/WiFi/WiFi_connect_4.gif","Image of WLAN");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_DTCNT_WLAN_STATUS_CONNECT5, CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/WiFi/WiFi_connect_5.gif","Image of WLAN");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_DTCNT_WLAN_STATUS_CONNECT6, CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/WiFi/WiFi_connect_6.gif","Image of WLAN");
#endif
...
//del by reslim v0.1      ADD_APPLICATION_IMAGE2(IMG_SI_SIGNAL_STRENGTH_TWIN_ALL ,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/signal/SI_SIG_GC","Status Icon: Signal strength");
  #else
//del by reslim v0.1      ADD_APPLICATION_IMAGE2(IMG_SI_SIGNAL_STRENGTH_TWIN_ALL ,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/signal/SI_SIG_SA","Status Icon: Signal strength");
  #endif 
#endif

       /*Fix Bug#12707 for cs2324c by cong.li on 2009.07.02. */
	ADD_APPLICATION_IMAGE2(IMG_SLSI_USB_CONNECTED,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/qpad/SI_USB.gif","Status Icon: usb connected");
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_SI_VOIP,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_VOIP.gif","Status Icon: VOIP");
#endif
	ADD_APPLICATION_IMAGE2(IMG_SI_KEYPAD_LOCK,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_LOCK.gif","Status Icon: Keypad lock");
	ADD_APPLICATION_IMAGE2(IMG_SI_KEYPAD_UNLOCK,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_UNLOCK.gif","Status Icon: Keypad lock");
	ADD_APPLICATION_IMAGE2(IMG_SI_VIBRATE,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_VIB.gif","Status Icon: Vibrator");
	ADD_APPLICATION_IMAGE2(IMG_SI_SILENT,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_SILENT.gif","Status Icon: Silent");
	ADD_APPLICATION_IMAGE2(IMG_SI_RING,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_RING.gif","Status Icon: Ring");
	ADD_APPLICATION_IMAGE2(IMG_SI_VIBRATE_AND_RING,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_VR.gif","Status Icon: Vibrate and ring");
	ADD_APPLICATION_IMAGE2(IMG_SI_VIBRATE_THEN_RING,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_VTR.gif","Status Icon: Vibrate then ring");
	ADD_APPLICATION_IMAGE2(IMG_SI_ALARM_ACTIVATED,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_ALARM.gif","Status Icon: Alarm");
	...
	ADD_APPLICATION_IMAGE2(IMG_SI_SLAVE_ROAMING_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Slave/SI_RM_2.gif","Status Icon: Roaming");    
#if (MMI_SIM_NUMBER >= 3)
	ADD_APPLICATION_IMAGE2(IMG_SI_SIM3_ROAMING_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Slave/SI_RM_3.gif","Status Icon: Roaming");    
#endif
#if (MMI_SIM_NUMBER >= 4)
	ADD_APPLICATION_IMAGE2(IMG_SI_SIM4_ROAMING_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Slave/SI_RM_4.gif","Status Icon: Roaming");    
#endif
    #else
	ADD_APPLICATION_IMAGE2(IMG_SI_ROAMING_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_RM.gif","Status Icon: Roaming");
    #endif
#ifndef __MMI_MULTI_SIM__
	ADD_APPLICATION_IMAGE2(IMG_SI_MISSED_CALL_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_MCA.gif","Status Icon: Missed Call");
#endif
#ifdef __DOUBLE_PHONE_MISSED_SIM2_CALL_ICON
#ifdef __UNI_TWIN_C__
//del by reslim v0.1      ADD_APPLICATION_IMAGE2(IMG_SI_MISSED_SIM2_CALL_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_MCA_C.gif","Status Icon: Missed Call");
...
#endif
#endif
	ADD_APPLICATION_IMAGE2(IMG_SI_GPRS_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_GPRS.gif","Status Icon: GPRS");
#if (defined (__MMI_STATUS_ICON_EN_EARPHONE__) || defined(__MMI_BT_HP_SUPPORT__)  )
	ADD_APPLICATION_IMAGE2(IMG_SI_EARPHONE_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_EAR.gif","Status Icon: EarPhone");
#endif

//2009-6-9 for MMS indicator
//#ifdef __MMI_STATUS_ICON_MMS__
	ADD_APPLICATION_IMAGE2(IMG_SI_MMS_UNREAD_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_MMSU.gif","Status Icon: EarPhone");
	ADD_APPLICATION_IMAGE2(IMG_SI_MMS_BUSY_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_MMSB.gif","Status Icon: EarPhone");
//#endif
...
#if defined(__MMI_BT_HP_SUPPORT__)  || defined(__MMI_BT_SUPPORT__)
     ADD_APPLICATION_IMAGE2(IMG_SI_BT,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_BT.gif","Status Icon: BT");
     ADD_APPLICATION_IMAGE2(IMG_SI_BT_CON,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_BT_CON.gif","Status Icon: BT");
     ADD_APPLICATION_IMAGE2(IMG_SI_BT_ND,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_BT_ND.gif","Status Icon: BT");
#endif

#ifdef __MMI_POC__
     ADD_APPLICATION_IMAGE2(IMG_SI_POC,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_Walkt.bmp","Status Icon: PoC registration"); 
#endif
...
//del by reslim v0.1     ADD_APPLICATION_IMAGE2(IMG_SI_SURROUNDSND,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_3DSound.gif","Status Icon: audio surround effect");
	...
	ADD_APPLICATION_IMAGE2(IMG_SI_GPRS_ATT_NO_PDP_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_GPRSC.gif","Status Icon: GPRS, attach without pdp");	
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_VOICE_L1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_VOML1.gif","Status Icon: Unread Voice L1");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_VOICE_L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_VOML2.gif","Status Icon: Unread Voice L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_VOICE_L1L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_VOML12.gif","Status Icon: Unread Voice L1+L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_FAX_L1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_FM1.gif","Status Icon: Unread Fax L1");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_FAX_L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_FM2.gif","Status Icon: Unread Fax L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_FAX_L1L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_FM12.gif","Status Icon: Unread Fax L1+L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_EMAIL_L1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_EM1.gif","Status Icon: Unread Email L1");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_EMAIL_L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_EM2.gif","Status Icon: Unread Email L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_UNREAD_EMAIL_L1L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_EM12.gif","Status Icon: Unread Email L1+L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_SMS_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_MGE.gif","Status Icon: Message");
	ADD_APPLICATION_IMAGE2(IMG_SI_CALL_DIVERT_L1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_FOR01.gif","Status Icon: Call Divert L1");
	ADD_APPLICATION_IMAGE2(IMG_SI_CALL_DIVERT_L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_FOR02.gif","Status Icon: Call Divert L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_CALL_DIVERT_L1L2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_FOR.gif","Status Icon: Call Divert L1+L2");
	ADD_APPLICATION_IMAGE2(IMG_SI_VOICE_RECORD,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_REC.gif","Status Icon: Voice record");
	ADD_APPLICATION_IMAGE2(IMG_SI_MUTE,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_MUTE.gif","Status Icon: Mute");
	ADD_APPLICATION_IMAGE2(IMG_BLINKINGICON_CHAT_ROOM1,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_CHAT1.gif","Chat Room1 Blinking Icon");
	ADD_APPLICATION_IMAGE2(IMG_BLINKINGICON_CHAT_ROOM2,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_CHAT2.gif","Chat Room2 Blinking Icon");
	ADD_APPLICATION_IMAGE2(IMG_SI_STOPWATCH,CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/SI_STWATCH.gif","Image for Stopwatch Icon");
	ADD_APPLICATION_IMAGE2(IMG_SI_JAVA_PAUSE,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_Jvlogo.gif","Java pause"); 
//	ADD_APPLICATION_IMAGE2(IMG_SI_WMAL,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_WMAL.bmp","Sub LCD Status Icon: Vibrate then Ring");
	...
	ADD_APPLICATION_IMAGE2(IMG_SI_NETWORK_CIPHER_GSM,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_NCGSM.gif","Network Ciphering for GSM"); 
	ADD_APPLICATION_IMAGE2(IMG_SI_NETWORK_CIPHER_GPRS,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_NCGPRS.gif","Network Ciphering for GPRS"); 
...
#endif
       /*Fix Bug#12707 for cs2324c by cong.li on 2009.07.02. */
	ADD_APPLICATION_IMAGE2(IMG_SLSI_USB_CONNECTED,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_USB.gif","Status Icon: usb connected");
...
{	
	...
	ADD_APPLICATION_IMAGE(CM3D_COMMON_IMAGE3_IMAGE_ID,CUST_IMG_PATH"/MainLCD/MainMenu/CIRCULAR_3D/CM3D7ball.png");
#endif
}
#endif
...
//del by reslim v0.1	      ADD_APPLICATION_IMAGE2(IMG_LIST_MENU_BG_IMAGE,CUST_IMG_PATH"/MainLCD/Theme/select_bg.gif", "Animation Image for title");
#endif
