...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_NO_COLOR_MESSAGE,"No Color is selected","No Color is selected");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_COLOR1_MESSAGE,"Color1 is selected","Color1 is selected");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_COLOR2_MESSAGE,"Color2 is selected","Color2 is selected");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_COLOR3_MESSAGE,"Color3 is selected","Color3 is selected");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_COLOR3_MESSAGE,"Color4 is selected","Color4 is selected");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_COLOR3_MESSAGE,"Color5 is selected","Color5 is selected");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_COLOR3_MESSAGE,"Color6 is selected","Color6 is selected");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_SPARE_TOGGLE_MESSAGE,"don't change in silent spare" ,"don't change in silent spare");	
#endif
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FONT_SIZE,"Font Size" ,"Font Size-option");	
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_RING_TONE_SETUP_PATHTOOLONG,"Path too long","Tone Setup screen string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_RING_TONE_SETUP_FILETOOLONG,"File name too long","Tone Setup screen string");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_BT_ACTIVATE_MESSAGE, "Bluetooth Activated", "Profile changed to Bluetooth");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_BT_DEACTIVATE_MESSAGE, "Bluetooth Dectivated", "Profile changed to other profiles");
#endif
#ifdef __MMI_SPARE_PROFILE__ //   添加省电模式
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_PROFILES_SPARE,"Spare Profile","Spare Profile");
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_PROFILES_SPARE_HINT,"Don't modify In Spare Profile","Spare Profile");
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_PROFILES_SPARE_INTRODUCE,"Spare Profile Introduce","Spare Profile");
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_PROFILES_SPARE_INTRODUCE_CONTENT,"don't be modified in spare profile","Spare Profile");
//del by reslim v0.1ADD_APPLICATION_STRING2(STR_SPARE_RESTORED_MESSAGE,"Spare Profile Actived","Spare Profile");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_15,"MIDI 15","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_16,"MIDI 16","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_17,"MIDI 17","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_18,"MIDI 18","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_19,"MIDI 19","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_20,"MIDI 20","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_21,"MIDI 21","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_22,"MIDI 22","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_23,"MIDI 23","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_24,"MIDI 24","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_25,"MIDI 25","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_26,"MIDI 26","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_27,"MIDI 27","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_28,"MIDI 28","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_29,"MIDI 29","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_30,"MIDI 30","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_31,"MIDI 31","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_32,"MIDI 32","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_33,"MIDI 33","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_34,"MIDI 34","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_35,"MIDI 35","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_36,"MIDI 36","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_37,"MIDI 37","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_38,"MIDI 38","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_39,"MIDI 39","Ring string");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_PROFILES_MIDI_40,"MIDI 40","Ring string");
#ifdef __MMI_DOWNLOADABLE_THEMES_SUPPORT__	
         ADD_APPLICATION_STRING2(STR_PROFILES_CURR_THEME,"Theme tone","current downloaded theme ring tone string");
#endif
	ADD_APPLICATION_IMAGE2(IMG_PROFILES_GENERAL,CUST_IMG_PATH"/MainLCD/SubMenu/Profile/SB_POG.gif","Image Associated with General Profiles");
	ADD_APPLICATION_IMAGE2(IMG_PROFILES_MEETING,CUST_IMG_PATH"/MainLCD/SubMenu/Profile/SB_PMEET.gif","Image Associated with Meeting Profiles");
	ADD_APPLICATION_IMAGE2(IMG_PROFILES_OUTDOOR,CUST_IMG_PATH"/MainLCD/SubMenu/Profile/SB_POUT.gif","Image Associated with OutDoor Profiles");
	ADD_APPLICATION_IMAGE2(IMG_PROFILES_INDOOR,CUST_IMG_PATH"/MainLCD/SubMenu/Profile/SB_PIN.gif","Image Associated with InDoor Profiles");
	ADD_APPLICATION_IMAGE2(IMG_PROFILES_HEADSET,CUST_IMG_PATH"/MainLCD/SubMenu/Profile/SB_HDSET.gif","Image Associated with InDoor Profiles");
#ifdef __MMI_BT_PROFILE__
	ADD_APPLICATION_IMAGE2(IMG_PROFILES_BT,CUST_IMG_PATH"/MainLCD/SubMenu/Profile/SB_BT.gif","Image Associated with InDoor Profiles");
#endif
#if !defined(MEM_ULC_3216)
	ADD_APPLICATION_IMAGE2(IMG_PROFILES_TITLEE,CUST_IMG_PATH"/MainLCD/TitleBar/TB_PR.gif","Image Associated with Title of Profiles");
#endif
	ADD_APPLICATION_IMAGE2(IMG_PROFILES_NO_IMAGE,CUST_IMG_BASE_PATH"/NoImage.bmp", "IMG_PROFILES_NO_IMAGE");
	ADD_APPLICATION_IMAGE2(IMG_PROFILES_ACTIVATED,CUST_IMG_PATH"/MainLCD/UIElement/checkbox/CK_V.gif", "IMG_PROFILES_ACTIVATED");
