...
//menu tree	 XXX
	...
	ADD_APPLICATION_MENUITEM((MENU_ID_ANALOGTV_OPTION_EFFECT,MENU_ID_ANALOGTV_OPTION,2,
...
//		STR_MENU_ID_ANALOGTV_OPTION_RECORDER,0));
	...
	//SETTING
	//vincent add for tv submenu 20071206 begin	
	#if 0
	ADD_APPLICATION_MENUITEM((MENU_ID_ANALOGTV_OPTION_SETTING, MENU_ID_ANALOGTV_OPTION, 2,
	MENU_ID_ANALOGTV_SETTING_STORAGE,
	#else 
	ADD_APPLICATION_MENUITEM((MENU_ID_ANALOGTV_OPTION_SETTING, MENU_ID_ANALOGTV_OPTION, 
	1,
	#endif
	//vincent add for tv submenu 20071206 end	
