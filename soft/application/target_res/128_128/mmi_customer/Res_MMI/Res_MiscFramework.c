...
void PopulateChgrPwrOnScrRes()
{
	...
	ADD_APPLICATION_IMAGE2(IMG_BATTERY_FULL_CHARGED,CUST_IMG_PATH"/MainLCD/UIELEMENT/charger/CHARGF.jpg","	Image Associated with Charger Fully charged");
#endif

//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_CHARGER_POWER_ON,"Charging","Message for Power On by Charger Screen");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_LOW_CURRENT_BATTERY,"Warning! Low Charge Current!","String Displyed when charge current is low.");	
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_SUBLCD_ABNORMAL_BATTERY,"Warning! Abnormal Battery Status","#NO_TRANS# String Associated with Abnormal Battery Status on Sub LCD");
...
void PopulateQuickAccessData(void)
{
	...
	ADD_APPLICATION_IMAGE2(IMG_KPAD_SCR_UNLOCKED_HELP_MESSAGE,CUST_IMG_PATH"/MainLCD/Warningpage/notification/N_KEY.jpg","Img Associated with Keypad Lock Help Message Screen.");
...
//qiff append extra menu to no sim menu
	...
	ADD_APPLICATION_MENUITEM((MENU_SIM_OPTION_ID,0,6,
				...
				SHOW,INSERTABLE,DISP_LIST,STR_GLOBAL_OPTIONS,MAIN_MENU_TITLE_ICON));
#else
	ADD_APPLICATION_MENUITEM((MENU_SIM_OPTION_ID,0,5
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INSERT_SIM_1,"Insert SIM 1","Insert SIM 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INSERT_SIM_2,"Insert SIM 2","Insert SIM 2");
	#endif
...
#endif
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ENTER_PIN_CAPTION,CUST_IMG_BASE_PATH"/EmptyImage.gif","Img Associated with Enter PIN Caption");
...
//	ADD_APPLICATION_STRING2(STR_ENTER_PUK_RSK, "SOS", "Make SOS Calls.");
	...
	#endif
	#endif
//	ADD_APPLICATION_IMAGE2(IMG_SIM_INSERTION_MSG,CUST_IMG_PATH"/MainLCD/Warningpage/popupPage/PP_WARN.gif","	Image Associated with Insert Sim Screen MSG.");
...
#endif
#if 0
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_SIM_REFRESH,"SIM card is refreshing...","SIM REFRESH");

//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_NAND_QUOTA_OVER_DISK,"Quota over disk!","Quota over disk");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_NAND_QUOTA_USAGE_WARNING,"Quota usage warning!","Quota usage warning");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_NAND_DEVICE_NOT_SUPPORTED,"NAND device not support!","NAND device not support");
#endif
...
#if 0
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_PHONEBOOK_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_PB.gif", "phonebook icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_MESSAGES_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_MG.gif", "message icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_FUNANDGAMES_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_FG.gif", "fun and game icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_ORGANIZER_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_OR.gif", "organizer icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_SETTINGS_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_ST.gif", "setting icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_PROFILES_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_PR.gif", "profile icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_SHORTCUTS_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_SC.gif", "shortcut icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_SERVICES_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_SV.gif", "service icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_CALL_HISTORY_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_CA.gif", "call history icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_MULTIMEDIA_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_MM.gif", "multimedia icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_FILEMNGR_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_FM.gif", "file manager icon for sim option menu");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_EXTRA_ICON,		CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_EX.gif", "extra icon for sim option menu");
#endif
#endif
}
