...
extern void PopulateVoiceMailResData (void);
extern void PopulateCBResData();

//////////////////////////////////////////////////////////////////////////////////
void PopulateSMSMenu(void)
{
	U8 i;
	ADD_APPLICATION_MENUITEM((MESSAGES_MENU_WMESSAGE_MENU_ID,MESSAGES_MENU_SMS_MENUID,0,
				SHOW,MOVEABLEWITHINPARENT|SHORTCUTABLE,DISP_LIST,STR_WMESSAGE_MENUENTRY,IMG_SMS_WMESSAGE_MENUENTRY));

	ADD_APPLICATION_MENUITEM((MESSAGES_MENU_INBOX_MENUID,MESSAGES_MENU_SMS_MENUID,
				#ifndef __MMI_MULTI_SIM__
				0,
				#else
				MMI_SIM_NUMBER,
				MULTI_MENU(MENU_MTPNP_SMS_MASTER_INBOX),
				#endif
				SHOW, MOVEABLEWITHINPARENT|SHORTCUTABLE, DISP_LIST,STR_INBOX_MENUENTRY,IMG_SMS_INBOX_MENUENTRY));
				
	ADD_APPLICATION_MENUITEM((MESSAGES_MENU_OUTBOX_MENUID,MESSAGES_MENU_SMS_MENUID,
			#ifndef __MMI_MULTI_SIM__
				0,
			#else
				MMI_SIM_NUMBER,
				MULTI_MENU(MENU_MTPNP_SMS_MASTER_OUTBOX),
			#endif
				SHOW,MOVEABLEWITHINPARENT|SHORTCUTABLE,DISP_LIST,STR_OUTBOX_MENUENTRY,IMG_SMS_OUTBOX_MENUENTRY));
	for(i = 0; i < MMI_SIM_NUMBER; i++)
	{
		ADD_APPLICATION_MENUITEM((MESSAGES_MENU_MSG_SETTINGS_MENUID+i,MESSAGES_MENU_SMS_MENUID,4,
					...
					STRING_MTPNP_SIM1_MESSAGESETUP_MENUENTRY +i,
				#else
	...
	ADD_APPLICATION_MENUITEM((SETUP_MENU_PROFILE_SETTING_MENUID,MESSAGES_MENU_MSG_SETTINGS_MENUID,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_PROFILE_SETTING_MENUENTRY, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SETUP_MENU_COMMONSETTING_MENUID,MESSAGES_MENU_MSG_SETTINGS_MENUID,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_COMMONSETTING_MENUENTRY,	IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MESSAGES_MENU_MEMSTATUS_MENUID,MESSAGES_MENU_MSG_SETTINGS_MENUID,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SMSSTATUS_MENUENTRY,	IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SETUP_MENU_PREFEREDSTORAGE_MENUID,MESSAGES_MENU_MSG_SETTINGS_MENUID,2,
				PREFEREDSTORAGE_SIM_MENUID,
				PREFEREDSTORAGE_ME_MENUID,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_PREFEREDSTORAGE_MENUENTRY,IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((PREFEREDSTORAGE_SIM_MENUID,SETUP_MENU_PREFEREDSTORAGE_MENUID,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SIM_STORAGE_MENUENTRY, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((PREFEREDSTORAGE_ME_MENUID,SETUP_MENU_PREFEREDSTORAGE_MENUID,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_ME_STORAGE_MENUENTRY, IMG_SMS_COMMON_NOIMAGE));

	ADD_APPLICATION_MENUITEM((MESSAGES_MENU_TEMPLATES_MENUID,MAIN_MENU_MESSAGES_MENUID,0,
				SHOW, MOVEABLEWITHINPARENT,DISP_LIST,STR_TEMPLATES_MENUENTRY,IMG_SMS_TEMPLATES_MENUENTRY));
	ADD_APPLICATION_MENUITEM((SEND_OPT_SEND_ONLY_MENUID, EMS_ED_OPT_DONE,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SEND_ONLY_MENU_ITEM, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SEND_OPT_SAVE_AND_SEND_MENUID,EMS_ED_OPT_DONE,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SAVE_AND_SEND_MENU_ITEM, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SEND_OPT_SAVE_MENUID,EMS_ED_OPT_DONE,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_SAVE,IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SEND_OPT_SEND_TO_MANY_MENUID,EMS_ED_OPT_DONE,2,
	...
	ADD_APPLICATION_MENUITEM((SEND_OPT_SEND_TO_MANY_BY_LIST_OPTION,0,2,
	...
	ADD_APPLICATION_MENUITEM((SEND_OPT_SEND_TO_MANY_BY_LIST_EDIT,SEND_OPT_SEND_TO_MANY_BY_LIST_OPTION,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_EDIT, IMG_GLOBAL_OK));
	ADD_APPLICATION_MENUITEM((SEND_OPT_SEND_TO_MANY_BY_LIST_ERASE,SEND_OPT_SEND_TO_MANY_BY_LIST_OPTION,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_VM_2_ERASE_ID, IMG_GLOBAL_OK));
	ADD_APPLICATION_MENUITEM((SEND_OPT_SEND_BY_GROUP_MENUID,EMS_ED_OPT_DONE,	0,
				SHOW, NONMOVEABLE, DISP_LIST,STR_SENDBYGROUP_MENUENTRY, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SEND_OPT_SEND_TO_MANY_BY_LIST,SEND_OPT_SEND_TO_MANY_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SENDTOMANY_LIST, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SEND_OPT_SEND_TO_MANY_NOW,SEND_OPT_SEND_TO_MANY_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SENDTOMANY_NOW, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPTIONS_MENUID,0, 6,
				...
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_OPTIONS, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_SR_OPTIONS_MENUID,0, 2,
				SMS_INBOX_OPT_DELETE_MENUID,
				SMS_INBOX_OPT_DELETE_ALL_MENUID,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_OPTIONS, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_REPLY_MENUID,SMS_INBOX_OPTIONS_MENUID,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_REPLY, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_EDIT_MENUID,SMS_INBOX_OPTIONS_MENUID, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_EDIT, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_FORWARD_MENUID,SMS_INBOX_OPTIONS_MENUID,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_FORWARD_MENUENTRY, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_DELETE_MENUID,SMS_INBOX_OPTIONS_MENUID, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_DELETE, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_DELETE_ALL_MENUID,SMS_INBOX_OPTIONS_MENUID, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_DELETE_ALL, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_USE_NUMBER_MENUID,SMS_INBOX_OPTIONS_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_USE_NUMBER_MENUENTRY, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_FORMATING_TEXT_ID,EMS_ED_OPTIONS_MENU_ID,	4,
				MENU_EMS_TEXT_SIZE_ID,
				MENU_EMS_TEXT_STYLE_ID,
				MENU_EMS_ALIGNMENT_ID,
				MENU_EMS_NEW_PARAGRAPH_ID,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_FORMATING_TEXT_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_TEXT_SIZE_ID,MENU_EMS_FORMATING_TEXT_ID,	3,
				MENU_EMS_TEXT_SIZE_SMALL_ID,
				MENU_EMS_TEXT_SIZE_MEDIUM_ID,
				MENU_EMS_TEXT_SIZE_LARGE_ID,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_TEXT_SIZE_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_TEXT_STYLE_ID, MENU_EMS_FORMATING_TEXT_ID,4,
				...
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_TEXT_STYLE_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_ALIGNMENT_ID, MENU_EMS_FORMATING_TEXT_ID,4,
				MENU_EMS_ALIGNMENT_AUTOMATIC_ID,
				MENU_EMS_ALIGNMENT_LEFT_ID,
				MENU_EMS_ALIGNMENT_CENTER_ID,
				MENU_EMS_ALIGNMENT_RIGHT_ID,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_ALIGNMENT_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_NEW_PARAGRAPH_ID, MENU_EMS_FORMATING_TEXT_ID,4,
				...
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_NEW_PARAGRAPH_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_TEXT_SIZE_SMALL_ID, MENU_EMS_TEXT_SIZE_ID,0, 
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_TEXT_SIZE_SMALL_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_TEXT_SIZE_MEDIUM_ID, MENU_EMS_TEXT_SIZE_ID,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_TEXT_SIZE_MEDIUM_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_TEXT_SIZE_LARGE_ID, MENU_EMS_TEXT_SIZE_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_TEXT_SIZE_LARGE_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_TEXT_STYLE_BOLD_ID, MENU_EMS_TEXT_STYLE_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_TEXT_STYLE_BOLD_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_TEXT_STYLE_ITALICS_ID, MENU_EMS_TEXT_STYLE_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_TEXT_STYLE_ITALICS_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_TEXT_STYLE_UNDERLINE_ID, MENU_EMS_TEXT_STYLE_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_TEXT_STYLE_UNDERLINE_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_TEXT_STYLE_STRIKETHROUGH_ID, MENU_EMS_TEXT_STYLE_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_TEXT_STYLE_STRIKETHROUGH_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_ALIGNMENT_AUTOMATIC_ID, MENU_EMS_ALIGNMENT_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_ALIGNMENT_AUTOMATIC_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_ALIGNMENT_LEFT_ID, MENU_EMS_ALIGNMENT_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_ALIGNMENT_LEFT_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_ALIGNMENT_CENTER_ID, MENU_EMS_ALIGNMENT_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_ALIGNMENT_CENTER_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_ALIGNMENT_RIGHT_ID, MENU_EMS_ALIGNMENT_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_ALIGNMENT_RIGHT_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_NEW_PARAGRAPH_AUTOMATIC_ID, MENU_EMS_NEW_PARAGRAPH_ID,0,  
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_NEW_PARAGRAPH_AUTOMATIC_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_NEW_PARAGRAPH_LEFT_ID, MENU_EMS_NEW_PARAGRAPH_ID,0, 
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_NEW_PARAGRAPH_LEFT_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_NEW_PARAGRAPH_CENTER_ID, MENU_EMS_NEW_PARAGRAPH_ID,0, 
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_NEW_PARAGRAPH_CENTER_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((MENU_EMS_NEW_PARAGRAPH_RIGHT_ID, MENU_EMS_NEW_PARAGRAPH_ID,0, 
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_EMS_NEW_PARAGRAPH_RIGHT_ID, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_OUTBOX_OPTIONS_MENUID,0, 5,
                ...
                SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_OPTIONS, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_OUTBOX_DEFAULT_OPTIONS_MENUID,0, 2,
				SMS_OUTBOX_OPT_DELETE_MENUID,
				SMS_OUTBOX_OPT_DELETE_ALL_MENUID,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_OPTIONS, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_OUTBOX_OPT_SEND_MENUID,SMS_OUTBOX_OPTIONS_MENUID,3,
				SEND_OPT_SEND_ONLY_MENUID,
				SEND_OPT_SEND_TO_MANY_MENUID,
				SEND_OPT_SEND_BY_GROUP_MENUID,
				SHOW, MOVEABLEWITHINPARENT,DISP_LIST,STR_GLOBAL_SEND,IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_OUTBOX_OPT_EDIT_MENUID,SMS_OUTBOX_OPTIONS_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_EDIT, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_OUTBOX_OPT_DELETE_MENUID,SMS_OUTBOX_OPTIONS_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_DELETE,IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_OUTBOX_OPT_DELETE_ALL_MENUID,SMS_OUTBOX_OPTIONS_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_DELETE_ALL,	IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_OUTBOX_OPT_USE_NUMBERS_MENUID,SMS_OUTBOX_OPTIONS_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_OUTBOX_USE_NUMBERS_MENUENTRY,IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((TEMPLATES_OPTIONS_MENUENTRY,0,	2,
	...
	ADD_APPLICATION_MENUITEM((TEMPLATES_OPTIONS_ERASE_MENUENTRY,TEMPLATES_OPTIONS_MENUENTRY,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_TEMPL_OPTIONS_ERASE,0));
	ADD_APPLICATION_MENUITEM((TEMPLATES_OPTIONS_EDIT_MENUENTRY,TEMPLATES_OPTIONS_MENUENTRY,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_EDIT,0));
	ADD_APPLICATION_MENUITEM((SMS_ED_TEMPL_OPTIONS_MENU_ID,0,  2,
				SMS_ED_TEMPL_OPT_DONE_MENU,
				SMS_ED_TEMPL_OPT_INPUT_METHODS_MENU,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_OPTIONS,		0));
	ADD_APPLICATION_MENUITEM((SMS_ED_TEMPL_OPT_DONE_MENU,SMS_ED_TEMPL_OPTIONS_MENU_ID, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_SAVE, 0));
	ADD_APPLICATION_MENUITEM((SMS_ED_TEMPL_OPT_INPUT_METHODS_MENU,SMS_ED_TEMPL_OPTIONS_MENU_ID, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_INPUT_METHOD, 0));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_SAVE_OBJECT_OPTION,0,  2,
				SMS_INBOX_OPT_SAVE_OPTION_DONE,
				SMS_INBOX_OPT_SAVE_OPTION_INPUT_METHOD,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_OPTIONS, 0));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_SAVE_OPTION_DONE,SMS_INBOX_OPT_SAVE_OBJECT_OPTION, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_DONE, 0));
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_SAVE_OPTION_INPUT_METHOD,SMS_INBOX_OPT_SAVE_OBJECT_OPTION, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_INPUT_METHOD, 0));
	ADD_APPLICATION_MENUITEM((SMS_USE_NUMBER_OPTIONS_MENUID,0,	2,
				SMS_USE_NUM_OPT_DIAL,
				SMS_USE_NUM_OPT_SAVE,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_USE_NUMBER_MENUENTRY, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_USE_NUM_OPT_DIAL,SMS_USE_NUMBER_OPTIONS_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_DIAL,	IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((SMS_USE_NUM_OPT_SAVE,SMS_USE_NUMBER_OPTIONS_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_USE_NUMBER_OPT_SAVE,IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((EMS_OBJECT_OPTION_MENUENTRY,0,3,
				EMS_OBJECT_OPTION_VIEW_MENUENTRY,
				EMS_OBJECT_OPTION_SEND_BY_EMS_MENUENTRY,
				EMS_OBJECT_OPTION_DELETE_MENUENTRY,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_OPTIONS, 0));
	ADD_APPLICATION_MENUITEM((EMS_OBJECT_OPTION_VIEW_MENUENTRY,EMS_OBJECT_OPTION_MENUENTRY, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_VIEW, 0));
	ADD_APPLICATION_MENUITEM((EMS_OBJECT_OPTION_SEND_BY_EMS_MENUENTRY,EMS_OBJECT_OPTION_MENUENTRY, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_MESSAGES_SEND_BY_EMS_ID, 0));
	ADD_APPLICATION_MENUITEM((EMS_OBJECT_OPTION_DELETE_MENUENTRY,	EMS_OBJECT_OPTION_MENUENTRY,0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_DELETE, 0));
	typedef enum
	{
		OPTION_DONE,
		OPTION_USE_TEMPLATES,
	...
	ADD_APPLICATION_MENUITEM((EMS_ED_OPTIONS_MENU_ID,0,
				EMS_ED_OPT_NUM + MMI_SIM_NUMBER - 1,
				MULTI_MENU(EMS_ED_OPT_DONE),
	...
	#ifdef __MMI_MESSAGES_INSERT_FROM_PHB__
	ADD_APPLICATION_MENUITEM((EMS_ED_OPT_INS_PHB_NUM, EMS_ED_OPTIONS_MENU_ID, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_OPT_INSERT_NUM, NULL));
	ADD_APPLICATION_MENUITEM((EMS_ED_OPT_INS_PHB_NAM, EMS_ED_OPTIONS_MENU_ID, 0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_OPT_INSERT_NAME, NULL));
	#endif
	for(i = 0; i < MMI_SIM_NUMBER; i++)
	{
		ADD_APPLICATION_MENUITEM((EMS_ED_OPT_DONE + i, EMS_ED_OPTIONS_MENU_ID, 5,
					SEND_OPT_SEND_ONLY_MENUID,
					...
					#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
					STRING_MTPNP_SMS_MASTER_DONE + i, 
					#else
					STR_GLOBAL_DONE,
					#endif
	...
	ADD_APPLICATION_MENUITEM((EMS_ED_OPT_USE_TEMPLATES,EMS_ED_OPTIONS_MENU_ID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_USE_TEMPLATE, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((EMS_ED_OPT_INS_OBJ,EMS_ED_OPTIONS_MENU_ID,	7,
				EMS_INS_OBJ_PICTURE,
	...
	ADD_APPLICATION_MENUITEM((EMS_ED_OPT_INPUT_METHOD, EMS_ED_OPTIONS_MENU_ID,0, 
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_GLOBAL_INPUT_METHOD, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((EMS_INS_OBJ_PICTURE,EMS_ED_OPT_INS_OBJ,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_INS_OBJ_PICTURE, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((EMS_INS_OBJ_MY_PICTURE,EMS_ED_OPT_INS_OBJ,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_INS_OBJ_MY_PICTURE, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((EMS_INS_OBJ_PRED_ANIMATION,EMS_ED_OPT_INS_OBJ,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_INS_OBJ_PRED_ANIMATION, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((EMS_INS_OBJ_MY_ANIMATION,EMS_ED_OPT_INS_OBJ,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_INS_OBJ_MY_ANIMATION, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((EMS_INS_OBJ_MELODY,	EMS_ED_OPT_INS_OBJ,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_INS_OBJ_MELODY, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((EMS_INS_OBJ_MY_MELODY,EMS_ED_OPT_INS_OBJ,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_INS_OBJ_MY_MELODY, IMG_SMS_COMMON_NOIMAGE));
	ADD_APPLICATION_MENUITEM((EMS_INS_OBJ_PRED_SOUND,EMS_ED_OPT_INS_OBJ,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_INS_OBJ_MY_SOUND, IMG_SMS_COMMON_NOIMAGE));
	//to be modify B
	ADD_APPLICATION_MENUITEM((MENU_ID_EMAIL_MAIN, 0,3,
				MENU_ID_EMAIL_COMP_SEND,
				MENU_ID_EMAIL_COMP_OPT,
				MENU_ID_EMAIL_COMP_SAVE_N_SEND,
				HIDE, 0, 0,0, 0));
	ADD_APPLICATION_MENUITEM((MENU_ID_EMAIL_COMP_OPT,0,0,
				0,0,0,25781,0));
	ADD_APPLICATION_MENUITEM((MENU_ID_EMAIL_COMP_SEND,0,0,
				0,0,0,15201,0));
	ADD_APPLICATION_MENUITEM((MENU_ID_EMAIL_COMP_SAVE_N_SEND,0,0,
				0,0,0,25764,0));
	//to be modify E
	ADD_APPLICATION_MENUITEM((SMS_INBOX_OPT_SAVE_OBJECT_MENUID,SMS_INBOX_OPTIONS_MENUID,	0,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SAVE_OBJECT_MENUENTRY, IMG_SMS_COMMON_NOIMAGE));
	...
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_DM_MSG_SETTINGS,
			...
			#endif
				MMI_SIM_NUMBER,
				MULTI_MENU(MESSAGES_MENU_MSG_SETTINGS_MENUID),
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST, 
	...
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_SELECT_OPTION, 0,
                              MMI_SIM_NUMBER,
                              MULTI_MENU(MENU_MTPNP_SMS_SELECT_SIM1_OPTION),
                              SHOW, NONMOVEABLE | INSERTABLE, DISP_LIST, NULL, NULL));

	ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_SELECT_SAVE_OPTION, 0, 
				MMI_SIM_NUMBER,
				MULTI_MENU(MENU_MTPNP_SMS_SELECT_SAVE_SIM1_OPTION),
				MENU_MTPNP_SMS_SELECT_SAVE_SIM2_OPTION,
				SHOW, NONMOVEABLE | INSERTABLE, DISP_LIST, NULL, NULL));
	
	for(i = 0; i < MMI_SIM_NUMBER; i++)
	{
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_MASTER_INBOX + i,
	                              MESSAGES_MENU_INBOX_MENUID, 0,
	                              SHOW, MOVEABLEWITHINPARENT | SHORTCUTABLE, DISP_LIST,
	                              STRING_MTPNP_SMS_MASTER_INBOX + i, IMG_SMS_INBOX_MENUENTRY));
		
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_MASTER_OUTBOX + i,
                              MESSAGES_MENU_OUTBOX_MENUID, 0,
                              SHOW, MOVEABLEWITHINPARENT | SHORTCUTABLE, DISP_LIST,
                              STRING_MTPNP_SMS_MASTER_OUTBOX + i, IMG_SMS_OUTBOX_MENUENTRY));
		
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_SELECT_SIM1_OPTION + i, MENU_MTPNP_SMS_SELECT_OPTION,
                              0, SHOW, NONMOVEABLE | INSERTABLE, DISP_LIST, 
                              STRING_MTPNP_OUTBOX_MASTER_SEND_SMS + i, NULL));
		
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_SELECT_SAVE_SIM1_OPTION + i, MENU_MTPNP_SMS_SELECT_SAVE_OPTION,
				0, SHOW, NONMOVEABLE | INSERTABLE, DISP_LIST, STRING_MTPNP_SAVE_SMS_TO_SIM1 + i, NULL));
	}
	#endif
}
...
//MENU ICONs
	...
	ADD_APPLICATION_IMAGE2 (IMG_SMS_ENTRY_SCRN_CAPTION,
								CUST_IMG_PATH"/MainLCD/TitleBar/TB_MG.gif",
								"SMS Menu item LSK common Image");
	ADD_APPLICATION_IMAGE2 (IMG_CB_RECEIVE_MODE_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/SB_WRITE.gif",
	...
	ADD_APPLICATION_IMAGE2 (IMG_CB_CHNL_TITLE,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/Channel/CH_TITLE.gif",
								"CB channel title Image");
	ADD_APPLICATION_IMAGE2 (IMG_CB_CHNL_NUMBER,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/Channel/CH_NB.gif",
...
//MAIN MENU ICONs
	...
	ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/SB_INBOX.gif",
								"Inbox SMS menu item String");
	ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/SB_UTBOX.gif",
	...
	ADD_APPLICATION_IMAGE2 (IMG_SMS_TEMPLATES_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/SB_TEMP.gif",
	...
	ADD_APPLICATION_IMAGE2 (IMG_SMS_MEMSTATUS_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/SB_MMORY.gif",
	...
	ADD_APPLICATION_IMAGE2 (IMG_CHAT_MESSAGE_ID,
								CUST_IMG_PATH"/MainLCD/Chat/SB_CHAT.gif",
...
//IDLE SCREEN ICONS
	...
	ADD_APPLICATION_IMAGE2 (IMG_NEW_MESSAGE_NOTIFICATION_MSG,
								CUST_IMG_PATH"/MainLCD/SMS/Receiving/qpad/SS_RECEIVING.gif",
...
//SEND ICONS
...
#ifdef __PRODUCT_QPAD__
	ADD_APPLICATION_IMAGE2 (IMG_NEW_SMS_SEND,
								CUST_IMG_PATH"/MainLCD/SMS/Sending/qpad/SS_SENDING.gif",
	...
	ADD_APPLICATION_IMAGE2 (IMG_SEND_FAIL_PIC_MSG,
								CUST_IMG_PATH"/MainLCD/SMS/SentFail/SS_WARN.jpg",
								"You have New Voicemail SMS Notification Caption Image");
...
//STATUS ICONS
#if 0		//guoyt delete for changing inbox image id resources@09.04.20
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ.gif",
	...
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP.gif",
								"Message SS_NSUP SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP.gif",
								"Message SS_NCOMP SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_ME,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_ME.gif",
								"Message SS_NCOMP SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SM,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_SM.gif",
								"Message SS_NCOMP SMS Image");
	#else
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_M.gif",
								"Message SS_NCOMP SMS Image for master");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_S.gif",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_ME_M.gif",
								"Message SS_NCOMP SMS Image for master");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_ME_S.gif",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SM_M.gif",
								"Message SS_NCOMP SMS Image for master");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SM_S.gif",
								"Message SS_NCOMP SMS Image for slave");
	#if(MMI_SIM_NUMBER >= 3)
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SIM3.gif",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_ME_SIM3.gif",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SM_SIM3.gif",
								"Message SS_NCOMP SMS Image for slave");
	#endif
	#if(MMI_SIM_NUMBER >= 4)
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SIM4.gif",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_ME_SIM4.gif",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SM_SIM4.gif",
								"Message SS_NCOMP SMS Image for slave");
	#endif
	#endif
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SI_MGE,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ.JPG",
//del cont.								"Message SI_MGE SMS Image");
	#ifndef __MMI_MULTI_SIM__

//begin:guoyt added for changing inbox image id resources@09.04.20
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UNREAD_SM.gif",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UNREAD_ME.gif",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_SM.gif",
								"Message SI_MGE SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_ME.gif",
								"Message SI_MGE SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_ME.gif",
								"Message Sent SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_ME.gif",
								"Message Unsent SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_SM.gif",
								"Message Sent SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_SM.gif",
								"Message Unsent SMS Image");		
//end:guoyt added for changing inbox image id resources@09.04.20
#endif
#ifdef __MMI_MULTI_SIM__        // Don't diff me and sm
#ifdef __MMI_DUAL_SIM_SINGLE_OPENED_
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UNREAD_SM.gif",
								"Message UnRead SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UNREAD_SM.gif",
								"Message UnRead SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_SM.gif",
								"Message SI_MGE SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_SM.gif",
								"Message SI_MGE SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_SM.gif",
								"Message Sent SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_SM.gif",
								"Message Unsent SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_SM.gif",
								"Message Sent SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_SM.gif",
								"Message Unsent SMS Image for master");	
#else
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_M.gif",
								"Message UnRead SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_M.gif",
								"Message UnRead SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_M.gif",
								"Message SI_MGE SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_M.gif",
								"Message SI_MGE SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_M.gif",
								"Message Sent SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_M.gif",
								"Message Unsent SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_M.gif",
								"Message Sent SMS Image for master");
...
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_S.gif",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_S.gif",
								"Message UnRead SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_S.gif",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_S.gif",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_S.gif",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_S.gif",
								"Message Unsent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_S.gif",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_S.gif",
								"Message Unsent SMS Image for slave");
#if(MMI_SIM_NUMBER >= 3)
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_SIM3.gif",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_SIM3.gif",
								"Message UnRead SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_SIM3.gif",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_SIM3.gif",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_SIM3.gif",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_SIM3.gif",
								"Message Unsent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_SIM3.gif",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_SIM3.gif",
								"Message Unsent SMS Image for slave");	
#endif
#if(MMI_SIM_NUMBER >= 4)
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_SIM4.gif",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_SIM4.gif",
								"Message UnRead SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_SIM4.gif",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_SIM4.gif",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_SIM4.gif",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_SIM4.gif",
								"Message Unsent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_SIM4.gif",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_SIM4.gif",
								"Message Unsent SMS Image for slave");	
#endif
#endif

/*UNI@wutianlong_20070929:区分短信在手机与卡*/
#ifdef __UNI_MMI_SMS_PK_ICON__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ1,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ1.gif",
//del cont.								"Message Read SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD1,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD1.gif",
//del cont.								"Message UnRead SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT1,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT1.gif",
//del cont.								"Message Sent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT1,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT1.gif",
//del cont.								"Message Unsent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP1,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP1.gif",
//del cont.								"Message SS_NSUP SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP1,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP1.gif",
//del cont.								"Message SS_NCOMP SMS Image");	
#endif


/*UNI@zhulanchen_20070925 14:47:50 */
#ifdef __UNI_TWIN_A__
#ifdef __UNI_TWIN_C__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_2_C.gif",
//del cont.								"Message Read SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD_2_C.gif",
//del cont.								"Message UnRead SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_2_C.gif",
//del cont.								"Message Sent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_2_C.gif",
//del cont.								"Message Unsent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP_2_C.gif",
//del cont.								"Message SS_NSUP SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_2_C.gif",
//del cont.								"Message SS_NCOMP SMS Image");
	/*UNI@wutianlong : 20071129 14:52:08  : 主机副机 区分短信在手机与卡  */

	#ifdef __UNI_MMI_SMS_PK_ICON__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_k_2_C.gif",
//del cont.								"Message Read SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD_k_2_C.gif",
//del cont.								"Message UnRead SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_k_2_C.gif",
//del cont.								"Message Sent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_k_2_C.gif",
//del cont.								"Message Unsent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP_k_2_C.gif",
//del cont.								"Message SS_NSUP SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_k_2_C.gif",
//del cont.								"Message SS_NCOMP SMS Image");
	#endif
...
#else
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_2.gif",
//del cont.								"Message Read SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD_2.gif",
//del cont.								"Message UnRead SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_2.gif",
//del cont.								"Message Sent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_2.gif",
//del cont.								"Message Unsent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP_2.gif",
//del cont.								"Message SS_NSUP SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_2.gif",
//del cont.								"Message SS_NCOMP SMS Image");
	/*UNI@wutianlong : 20071129 14:52:08  : 主机副机 区分短信在手机与卡  */

	#ifdef __UNI_MMI_SMS_PK_ICON__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_k_2.gif",
//del cont.								"Message Read SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD_k_2.gif",
//del cont.								"Message UnRead SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_k_2.gif",
//del cont.								"Message Sent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_k_2.gif",
//del cont.								"Message Unsent SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP_k_2.gif",
//del cont.								"Message SS_NSUP SMS Image");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP2,
//del cont.								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_k_2.gif",
//del cont.								"Message SS_NCOMP SMS Image");
	#endif
#endif	
#endif
	...
	ADD_APPLICATION_IMAGE2 (IMG_EMS05_PIC,
								CUST_IMG_PATH"/MainLCD/SMS/PIC/EMS05.gif",
								"EMS predefined pictures");

	ADD_APPLICATION_IMAGE2 (IMG_EMS06_PIC,
								CUST_IMG_PATH"/MainLCD/SMS/PIC/EMS06.gif",
								"EMS predefined pictures");

	ADD_APPLICATION_IMAGE2 (IMG_EMS07_PIC,
								CUST_IMG_PATH"/MainLCD/SMS/PIC/EMS07.gif",
								"EMS predefined pictures");

	ADD_APPLICATION_IMAGE2 (IMG_EMS08_PIC,
								CUST_IMG_PATH"/MainLCD/SMS/PIC/EMS08.gif",
								"EMS predefined pictures");
#endif	
#else
	ADD_APPLICATION_IMAGE2 (IMG_EMS01_PIC,
...
#ifdef MMS_SUPPORT
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MMS_MENUENTRY, "MMS", "MMS menu item String");
#endif	//__MMI_MMS__
#endif
...
//[221] Added by Ryh 2009/02/12								[BEGIN]
#ifdef __MMI_MULTI_SIM__
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_SHOW_STYLE,"Show Style");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_SHOW_MIXED,"Show Mixed");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_SHOW_DIVIDED,"Show Divided");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM1_MESSAGESETUP_MENUENTRY,"SIM1 Message Settings");
	ADD_APPLICATION_STRING(STRING_MTPNP_MESSAGESETUP_MENUENTRY,"SIM2 Message Settings");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_MASTER_INBOX,"Master Inbox");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_SLAVE_INBOX,"Slave Inbox");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_MASTER_OUTBOX,"Master Outbox");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_SLAVE_OUTBOX,"Slave Outbox");
	ADD_APPLICATION_STRING(STRING_MTPNP_OUTBOX_MASTER_SEND_SMS,"Send From SIM1");
	ADD_APPLICATION_STRING(STRING_MTPNP_OUTBOX_SLAVE_SEND_SMS,"Send From SIM2");
	ADD_APPLICATION_STRING(STRING_MTPNP_MASTER_SEND_OPTIONS_CAPTION,"Master Send Option");
	ADD_APPLICATION_STRING(STRING_MTPNP_SLAVE_SEND_OPTIONS_CAPTION,"Slave Send Option");
	ADD_APPLICATION_STRING(STRING_MTPNP_MASTER_SENDING_SMS,"Master: Sending SMS");
	ADD_APPLICATION_STRING(STRING_MTPNP_SLAVE_SENDING_SMS,"Slave: Sending SMS");
	ADD_APPLICATION_STRING(STRING_MTPNP_MASTER_VOICEMAIL_IND,"New SIM1 Voice Mail!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SLAVE_VOICEMAIL_IND,"New SIM2 Voice Mail!");
	ADD_APPLICATION_STRING(STRING_MTPNP_MASTER_FAX_IND,"New SIM1 Fax!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SLAVE_FAX_IND,"New SIM2 Fax!");
	ADD_APPLICATION_STRING(STRING_MTPNP_MASTER_EMAIL_IND,"New SIM1 E-Mail!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SLAVE_EMAIL_IND,"New SIM2 E-Mail!");
	ADD_APPLICATION_STRING(STRING_MTPNP_MASTER_RECEIVED_SMS,"New Master Message!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SLAVE_RECEIVED_SMS,"New Slave Message!");
	ADD_APPLICATION_STRING(STRING_MTPNP_MASTER_DELIVERY_REPORT_MENUENTRY,"Master Delivery Report");
	ADD_APPLICATION_STRING(STRING_MTPNP_SLAVE_DELIVERY_REPORT_MENUENTRY,"Slave Delivery Report");
	ADD_APPLICATION_STRING(STRING_MTPNP_NEW_SLAVE_MESSAGE_FROM_ID,"Slave Message From");
	ADD_APPLICATION_STRING(STRING_MTPNP_NEW_MASTER_MESSAGE_FROM_ID,"Master Message From");
	ADD_APPLICATION_STRING(STRING_MTPNP_SAVE_SMS_TO_SIM1,"Save to SIM1");
	ADD_APPLICATION_STRING(STRING_MTPNP_SAVE_SMS_TO_SIM2,"Save to SIM2");
	ADD_APPLICATION_STRING(STRING_MTPNP_MASTER_DELETE_INBOX_MENUENTRY,"Delete SIM1 Inbox?");
	ADD_APPLICATION_STRING(STRING_MTPNP_MASTER_DELETE_OUTBOX_MENUENTRY,"Delete SIM1 Outbox?");
	ADD_APPLICATION_STRING(STRING_MTPNP_SLAVE_DELETE_INBOX_MENUENTRY,"Delete SIM2 Inbox?");
	ADD_APPLICATION_STRING(STRING_MTPNP_SLAVE_DELETE_OUTBOX_MENUENTRY,"Delete SIM2 Outbox?");
	#if(MMI_SIM_NUMBER >= 3)
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_MESSAGESETUP_MENUENTRY,"SIM3 Message Settings");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_SIM3_INBOX,"SIM3 Inbox");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_SIM3_OUTBOX,"SIM3 Outbox");
	ADD_APPLICATION_STRING(STRING_MTPNP_OUTBOX_SIM3_SEND_SMS,"Send From SIM3");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_SEND_OPTIONS_CAPTION,"SIM3 Send Option");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_SENDING_SMS,"SIM3: Sending SMS");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_VOICEMAIL_IND,"New SIM3 Voice Mail!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_FAX_IND,"New SIM3 Fax!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_EMAIL_IND,"New SIM3 E-Mail!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_RECEIVED_SMS,"New SIM3 Message!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_DELIVERY_REPORT_MENUENTRY,"SIM3 Delivery Report");
	ADD_APPLICATION_STRING(STRING_MTPNP_NEW_SIM3_MESSAGE_FROM_ID,"SIM3 Message From");
	ADD_APPLICATION_STRING(STRING_MTPNP_SAVE_SMS_TO_SIM3,"Save to SIM3");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_DELETE_INBOX_MENUENTRY,"Delete SIM3 Inbox?");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM3_DELETE_OUTBOX_MENUENTRY,"Delete SIM3 Outbox?");
	#endif
	#if(MMI_SIM_NUMBER >= 4)
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_MESSAGESETUP_MENUENTRY,"SIM4 Message Settings");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_SIM4_INBOX,"SIM4 Inbox");
	ADD_APPLICATION_STRING(STRING_MTPNP_SMS_SIM4_OUTBOX,"SIM4 Outbox");
	ADD_APPLICATION_STRING(STRING_MTPNP_OUTBOX_SIM4_SEND_SMS,"Send From SIM4");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_SEND_OPTIONS_CAPTION,"SIM4 Send Option");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_SENDING_SMS,"SIM4: Sending SMS");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_VOICEMAIL_IND,"New SIM4 Voice Mail!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_FAX_IND,"New SIM4 Fax!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_EMAIL_IND,"New SIM4 E-Mail!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_RECEIVED_SMS,"New SIM4 Message!");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_DELIVERY_REPORT_MENUENTRY,"SIM4 Delivery Report");
	ADD_APPLICATION_STRING(STRING_MTPNP_NEW_SIM4_MESSAGE_FROM_ID,"SIM4 Message From");
	ADD_APPLICATION_STRING(STRING_MTPNP_SAVE_SMS_TO_SIM4,"Save to SIM4");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_DELETE_INBOX_MENUENTRY,"Delete SIM4 Inbox?");
	ADD_APPLICATION_STRING(STRING_MTPNP_SIM4_DELETE_OUTBOX_MENUENTRY,"Delete SIM4 Outbox?");
	#endif
#endif
//[221] Added by Ryh 2009/02/12								[END]

#if 0//!defined(PRO_CT01)
#ifdef __MMI_MESSAGES_MULTI_APP__
	/* Message main menu */
	...
	for(i = 0; i < MMI_SIM_NUMBER; i++)
	{
		ADD_APPLICATION_MENUITEM((MESSAGES_MENU_VMAIL_MENUID + i,
								#ifndef __MMI_MULTI_SIM__
									...
									SHOW, MOVEABLEWITHINPARENT|SHORTCUTABLE, DISP_LIST,
								#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
									STRING_MTPNP_SIM1_VMAIL_MENUENTRY + i,
								#else /*__MMI_MULTI_SIM__*/
									STR_VMAIL_MENUENTRY,
								#endif /*__MMI_MULTI_SIM__*/
	...
	ADD_APPLICATION_MENUITEM((MESSAGES_MENU_CB_MENUID,
									...
									SHOW, MOVEABLEWITHINPARENT, DISP_LIST ,
									STR_CB_MENUENTRY, IMG_SMS_CB_MENUENTRY));
...
#ifdef __UNI_MMI_SEND_MSG_FROM_SMS_EXTRACT_NO__
	ADD_APPLICATION_MENUITEM((SMS_USE_NUMBER_OPTIONS_MENUID,
									0,	3,
									SMS_USE_NUM_OPT_DIAL,
									SMS_USE_NUM_OPT_SAVE,
									SMS_INBOX_OPT_SEND_MSG_MENUID,
									SHOW, MOVEABLEWITHINPARENT, DISP_LIST,
									STR_USE_NUMBER_MENUENTRY, IMG_SMS_COMMON_NOIMAGE));
#else
ADD_APPLICATION_MENUITEM((SMS_USE_NUMBER_OPTIONS_MENUID,
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE, "Voice Interaction", "message club menu 1");
	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_QUIT, "Cancel", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_MORE, "More SMS", "message club menu 1");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_05, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_06, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_07, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_08, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_09, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_10, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_11, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_12, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_13, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17, "Loves", "message club menu 2");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_01_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_01_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_01_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_01_04, "Comics", "message club menu 1");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_02_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_02_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_02_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_02_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_02_05, "Loves", "message club menu 2");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_03_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_03_02, "Loves", "message club menu 2");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_04_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_04_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_04_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_04_04, "Comics", "message club menu 1");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_05_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_05_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_05_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_05_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_05_05, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_05_06, "Friends", "message club menu 3");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_06_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_06_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_06_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_06_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_06_05, "Loves", "message club menu 2");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_07_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_07_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_07_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_07_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_07_05, "Loves", "message club menu 2");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_08_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_08_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_08_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_08_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_08_05, "Loves", "message club menu 2");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_09_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_09_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_09_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_09_04, "Comics", "message club menu 1");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_10_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_10_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_10_03, "Friends", "message club menu 3");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_11_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_11_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_11_03, "Friends", "message club menu 3");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_12_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_12_02, "Loves", "message club menu 2");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_13_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_13_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_13_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_13_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_13_05, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_13_06, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_13_07, "Comics", "message club menu 1");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14_05, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14_06, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14_07, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14_08, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_14_09, "Friends", "message club menu 3");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_05, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_06, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_07, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_08, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_09, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_10, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_15_11, "Loves", "message club menu 2");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_05, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_06, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_07, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_08, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_09, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_10, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_16_11, "Loves", "message club menu 2");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_01, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_02, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_03, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_04, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_05, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_06, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_07, "Comics", "message club menu 1");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_08, "Loves", "message club menu 2");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_09, "Friends", "message club menu 3");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_17_10, "Comics", "message club menu 1");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_01, "V1", "message club menu 4");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_02, "V2", "message club menu 5");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_03, "V3", "message club menu 5");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_01_01, "V1-1", "message club menu 4");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_01_02, "V1-2", "message club menu 5");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_01_03, "V1-3", "message club menu 5");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_01_04, "V1-4", "message club menu 5");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_01_05, "V1-5", "message club menu 5");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_02_01, "V2-1", "message club menu 6");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_02_02, "V2-2", "message club menu 6");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_02_03, "V2-3", "message club menu 6");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_03_01, "V3-1", "message club menu 6");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_03_02, "V3-2", "message club menu 6");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_03_03, "V3-3", "message club menu 6");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_03_04, "V3-4", "message club menu 6");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MSG_CLUB_VOICE_03_05, "V3-5", "message club menu 6");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_VIEW_INBOX_CAPTION, "View Inbox",	"View Inbox Caption String");
#ifdef __MMI_MESSAGES_CHAT__
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_CHAT_MENUENTRY,			  "Chat",		"Inbox Options Menu Chat  SMS String");
#endif
...
#if defined(__MMI_MESSAGES_USE_URL__)
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_USE_URL_MENUENTRY,			"Use URL",		"SMS option Use URL menu string");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_CONNECT_MENUENTRY,			"Connect",		"Use URL option - Connect string");
...
#if 0
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_VOICEMAIL_NUM_IND,			"New Voice Mail(s)!",	"Number of new voice Mail SMS Notification Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_FAX_NUM_IND,			"New Fax(es)!",	"Number of new Fax SMS Notification Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_EMAIL_NUM_IND,			"New E-Mail(s)!",	"Number of new E-Mail SMS Notification Caption String");
#endif		
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_DELETE_INBOX_MENUENTRY,	 "Delete Inbox",		"Delete Options Menu Delete Inbox SMS String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_DELETE_OUTBOX_MENUENTRY,	 "Delete Outbox",		"Delete Options Menu Delete Outbox SMS String");
#ifdef __MMI_MESSAGES_DRAFT_BOX__
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_DELETE_DRAFTBOX_MENUENTRY,	 "Delete Drafts",		"Delete Options Menu Delete Outbox SMS String");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_DEFAULTSET_MENUENTRY,		     "Default Set",	"Message Setup Default Set SMS  String");
	...
	ADD_APPLICATION_STRING2 (STR_GPRS_BEARER_MENUENTRY,	"GPRS Only",	"Message Setup Preferred Bearer SMS  String");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FDN_CHECK_NO_STORE, "Not in FDL", "Not in FDL String");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FDN_CHECK_STORED_IN_OUTBOX, "Not in FDL! Stored in Outbox", "Not in FDL! Stored in Outbox String");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FDN_CHECK_STORE_IN_OUTBOX_FAIL, "Not in FDL! Store in Outbox fail", "Not in FDL! Stored in Outbox fail String");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_FDN_PHB_ERROR, "FDL Not Ready!", "FDN phb not ready String");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MESSAGE_SAVE_ERROR,		"Save in Outbox Failed",	"SMS Save Error Message String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_MESSAGE_INCOMPLETE,		"Message Not Complete!",	"Popup for Incomplete Message");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_SIM_STORAGE_FULL,		"SIM Full !",	"SMS SIM Memory Storage is Full Error Message String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_MEM_CAP_EXCEEDED,		"Memory Capacity Exceeded!",	"SMS Memory Capacity Exceeded Error Message String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_MEM_FAILURE,			"Memory Failure!",	"SMS Memory Failure Error Message String");
...
//#if defined(__MMI_MESSAGES_EMS__)
	...
	ADD_APPLICATION_STRING2 (STR_NO_SPACE_TO_INSERT_OBJECT, "No Space!",	"SMS No Space Message String");
//#endif // defined(__MMI_MESSAGES_EMS__)
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_TOO_MANY_MO_CONCAT_MSG,		"Too many concatenated messages !",	"SMS too Many Concatenated Message String");
...
#endif
	#if 0
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_COPY_ALL_SMS,		"Copy All Text Messages",	"SMS copy function Copy All SMS String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_MOVE_ALL_SMS,		"Move All Text Messages",	"SMS move function Move All SMS String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_MESSAGES_ADVANCED,	"Advanced",	"SMS Advanced option String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_UNSENTBOX_DELETEALL_QUERY, "Delete All Outbox" ,"Delete Message Confirmation SMS Screen String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SENTBOX_DELETEALL_QUERY, "Delete All Sent" ,"Delete Message Confirmation SMS Screen String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_UNSENTBOX_MENUENTRY, "Outbox", "Outbox SMS menu item String");

//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_REMOVE_EMS_OBJECT, "Remove EMS Object", "Remove EMS Object String");    
	#endif
#if defined(__MMI_MESSAGES_TEMPLATE__)
		// main template
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_DATA_EMPTY,	"No Content",	"SMS Empty Content String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_DATA_INVALID,	"Invalid Content",	"SMS Invalid Content String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_DATA_EXCEED,	"Content Size Exceeded",	"SMS Exceeded Content String");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_STATUS_REPORT_MESSAGE_NOT_DELIVERD_MSG,	"Not Delivered!",		"Message Not Deliverd String");
	ADD_APPLICATION_STRING2 (STR_SMS_MSG_NOT_READY_YET,						"SMS Not Ready Yet!",			"Message SMS not ready yet String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_DELIVERY_REPORT_SENT_TO, "sent to: ",	"Message sent to: String");
...
#endif
	#ifdef __MMI_MESSAGES_INSERT_FROM_PHB__
	ADD_APPLICATION_STRING2(STR_OPT_INSERT_NUM, "Insert PHB Number", "Insert PHB Number option");
	ADD_APPLICATION_STRING2(STR_OPT_INSERT_NAME, "Insert PHB Name", "Insert PHB Name option");
	#endif
}
...
static void PopulateEMSResourceData (void)
{
	...
	ADD_APPLICATION_MENUITEM((MENU_EMS_FORMATING_TEXT_ID,
									...
									MENU_EMS_TEXT_STYLE_ID,
									MENU_EMS_ALIGNMENT_ID,
									//MENU_EMS_NEW_PARAGRAPH_ID, // jonson 070826 mod for bug
									SHOW, MOVEABLEWITHINPARENT, DISP_LIST,
									STR_EMS_FORMATING_TEXT_ID, IMG_SMS_COMMON_NOIMAGE));
	#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_EMS_OBJECT_ANIMATION_ID,	"EMS Animation",	"STR_EMS_PICTURE_OBJECT_FILE_NAME_INIT_PATH_ID");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (STR_SMS_INSERT_PHB_NUMBER_ID,	"Insert PHB Number",	"STR_SMS_INSERT_PHB_NUMBER_ID");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (STR_SMS_INSERT_PHB_NAME_ID,	"Insert PHB Name",	"STR_SMS_INSERT_PHB_NAME_ID");
...
// Strings
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR101_MITEM102_CB_SERVICE	,  			"Receive Mode",	"CB Menu Item Service Cell Broadcast String");
	ADD_APPLICATION_STRING2 (STR101_MITEM102_CB_READ_MESSAGE	, "Read Message",	"CB Menu Read Message Cell Broadcast String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR101_MITEM102_CB_CHANNELS	, 		"Channel Setting",	"CB Menu Channels Cell Broadcast String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR101_MITEM102_CB_LANGUAGE	,		"Languages",	"CB Menu Language Cell Broadcast String");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SC_EMPTY_STORED_IN_OUTBOX, 		"SC empty! Stored in Outbox", "CB SC empty! Stored in Outbox String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_SC_EMPTY_STORE_IN_OUTBOX_FAIL, "SC empty! Store in Outbox fail", "CB SC empty! Store in Outbox fai String");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR102_SCR102_CAPTION		,			"Channels", "CB Menu Item Cell Broadcast Channels Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR102_MITEM103_CB_CHANNEL_ENBL_OPTIONS,	"Channel Options",	     "CB Menu Item Cell Broadcast Channels Options Enable String");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (	STR_ID_NSM_PICTURE,		"Picture",	"Test picture menu item for NSM"	);
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (	STR_ID_NSM_RINGTONE_PLAY_MSG,	"Playing...",	" Message for ringtone play screen" );
//del by reslim v0.1	ADD_APPLICATION_STRING2 (	STR_ID_NSM_RINGTONE_STOP,	"Stop",	"Stop ringtone" );
//del by reslim v0.1	ADD_APPLICATION_STRING2 (	STR_ID_NSM_RINGTOEN_FORMAT_NOT_SUPPORTED_MSG,	"Format not supported",	"Message string for pop-up " );
//del by reslim v0.1	ADD_APPLICATION_STRING2 (	STR_ID_NSM_PICTURE_MESSAGES,	"My Picture",		"For Nokia smart messaging" );

//del by reslim v0.1	ADD_APPLICATION_STRING2 ( STR_ID_NSM_NEW_PICTURE_MESSAGE,	"New Pic Msg",	" String for new picture message ");
//del by reslim v0.1	ADD_APPLICATION_STRING2 ( STR_ID_NSM_NEW_RINGTONE_MESSAGE,	"New Ringtone Msg",	"String for new ringtone message");
//del by reslim v0.1	ADD_APPLICATION_STRING2 ( STR_ID_NSM_NEW_NORMAL_MESSAGE,	" New Msg received",		"String for new normal message ");

	ADD_APPLICATION_STRING2 ( STR_ID_NSM_PICMSG_SAVE_PICTURE,	"Save Picture",		" Save picture menu item for picture message ");
//del by reslim v0.1	ADD_APPLICATION_STRING2 ( STR_ID_MYPIC_ADDTEXT,	"Insert Text"	,"My Picture - insert text menu item in My picture");

	ADD_APPLICATION_STRING2 ( STR_ID_PICMSG_FORWARD,	"Forward",		"Picture message option - Forward ");
//del by reslim v0.1	ADD_APPLICATION_STRING2 ( STR_ID_PICMSG_EDIT_TEXT,		"Edit text",			"Picture message option - Edit ");

//del by reslim v0.1	ADD_APPLICATION_STRING2 ( STR_ID_NSM_SPACE_FULL,	"Space full!!",	" Space full error message");

//del by reslim v0.1	ADD_APPLICATION_STRING2 ( STR_ID_GLOBAL_RENAME,	"Rename",	"Rename option");
	 
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_INSERT_PICTURE, "Insert Picture", "Insert Nokia Smart Picture string");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_REMOVE_PICTURE, "Remove Picture", "Remove Nokia Smart Picture string");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_INSERT,"Insert","Insert picture");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_REPLACE,"Replace","Replace picture");

//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC1, "PIC1", "Nokia smart picture -PIC1");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC2, "PIC2", "Nokia smart picture -PIC2");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC3, "PIC3", "Nokia smart picture -PIC3");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC4, "PIC4", "Nokia smart picture -PIC4");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC5, "PIC5", "Nokia smart picture -PIC5");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC6, "PIC6", "Nokia smart picture -PIC6");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC7, "PIC7", "Nokia smart picture -PIC7");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC8, "PIC8", "Nokia smart picture -PIC8");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC9, "PIC9", "Nokia smart picture -PIC9");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC10, "PIC10", "Nokia smart picture -PIC10");

//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM2_PIC_LIST,"Picture List","Nokia Smart message : picture list");
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_NSM_INVALID_PIC,"Invalid picture","NSM:Invalid picture");
...
#if defined(__MMI_MYPICTURE__)
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM_MYPIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/SubMenu/Message/MyPicture.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );
#endif /*__MMI_MYPICTURE__ */

#if (defined(__MMI_SMART_MESSAGE_MO__) && !defined(__MMI_MESSAGES_EMS__))

//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM01_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic1.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM02_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic2.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM03_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic3.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM04_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic4.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM05_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic5.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM06_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic6.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM07_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic7.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM08_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic8.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM09_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic9.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2 ( IMG_NSM010_PIC,
//del cont.							 CUST_IMG_PATH"/MainLCD/Sms/NSM2/Pic10.gif",
//del cont.							 " Image for My Picture"
//del cont.						   );
