...
const s16 coordinate_set64[]=
{
		...
		MMI_POP_UP_DIALOG_X+5,MMI_POP_UP_DIALOG_Y+2,MMI_POP_UP_DIALOG_WIDTH-10,MMI_POP_UP_DIALOG_HEIGHT-4,DM_ALLIGNED_AREA_EQUAL_SPACE_TOP_AND_BOTTOM|DM_ALLIGNED_AREA_NO_BACK_FILL,
#else
...
const U8 category120[]=
{
	...
	const s16 coordinate_set120[]=
	{
			DM_FULL_SCREEN_COORDINATE_FLAG,
			DM_DEFAULT_STATUS_BAR_FLAG,
			0, 12, MAIN_LCD_DEVICE_WIDTH, MMI_CONTENT_HEIGHT,DM_NO_FLAGS,
			0, 26, MAIN_LCD_DEVICE_WIDTH, MMI_CONTENT_HEIGHT,DM_CENTRE_ALIGN_X,
			DM_DEFAULT_BUTTON_BAR_FLAG,MMI_SOFTKEY_WIDTH
	};
#endif
...
const s16 coordinate_set200[] =
{
		...
		4, MAIN_LCD_DEVICE_HEIGHT-MMI_BUTTON_BAR_HEIGHT-MMI_SINGLELINE_INPUTBOX_HEIGHT-2, MAIN_LCD_DEVICE_WIDTH-4, MMI_SINGLELINE_INPUTBOX_HEIGHT,DM_NO_FLAGS			//Single Line Input box
#else
