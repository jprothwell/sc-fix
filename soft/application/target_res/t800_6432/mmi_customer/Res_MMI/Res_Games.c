...
void PopulateBqmetRes(void)
{
	...
	ADD_APPLICATION_IMAGE2(IMG_GX_MJ_GAME_1,CUST_IMG_BASE_PATH"/GameImages/bqgame/mj/logo.gif","");
...
void PopulateUfoRes(void)
{
	...
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_0,			UFO_IMG_PATH"gx_ufo_digit_0.gif",					"Image for 0");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_1,			UFO_IMG_PATH"gx_ufo_digit_1.gif",					"Image for 1");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_2,			UFO_IMG_PATH"gx_ufo_digit_2.gif",					"Image for 2");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_3,			UFO_IMG_PATH"gx_ufo_digit_3.gif",					"Image for 3");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_4,			UFO_IMG_PATH"gx_ufo_digit_4.gif",					"Image for 4");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_5,			UFO_IMG_PATH"gx_ufo_digit_5.gif",					"Image for 5");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_6,			UFO_IMG_PATH"gx_ufo_digit_6.gif",					"Image for 6");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_7,			UFO_IMG_PATH"gx_ufo_digit_7.gif",					"Image for 7");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_8,			UFO_IMG_PATH"gx_ufo_digit_8.gif",					"Image for 8");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_DIGIT_9,			UFO_IMG_PATH"gx_ufo_digit_9.gif",					"Image for 9");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_BACKGROUND_1,		UFO_IMG_PATH"gx_ufo_background_1.GIF",			"Background image 1");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_BACKGROUND_2,		UFO_IMG_PATH"gx_ufo_background_2.GIF",			"Background image 2");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_BACKGROUND_3,		UFO_IMG_PATH"gx_ufo_background_3.GIF",			"Background image 3");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_BACKGROUND_4,		UFO_IMG_PATH"gx_ufo_background_4.GIF",			"Background image 4");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_BACKGROUND_5,		UFO_IMG_PATH"gx_ufo_background_5.GIF",			"Background image 5");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_BACKGROUND_6,		UFO_IMG_PATH"gx_ufo_background_6.GIF",			"Background image 6");
	...
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_ENERGY,				UFO_IMG_PATH"gx_ufo_energy.gif",					"Image for string ENERGY");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_SCORE,				UFO_IMG_PATH"gx_ufo_score.gif",					"Image for string SCORE");
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_ENERGY_UNIT,		UFO_IMG_PATH"gx_ufo_energy_unit.gif",			"Image for energy unit");
	...
	ADD_APPLICATION_IMAGE2(IMG_ID_GX_UFO_LEVEL_CLEAR,		UFO_IMG_PATH"gx_ufo_level_clear.gif",			"String for LEVEL CLRAR");
