...
void PopulatevObjectRes(void)
{
	...
	ADD_APPLICATION_STRING2(STR_ID_VOBJ_ABORT	,"Abort"	,"key message");	
	...
	ADD_APPLICATION_STRING2(STR_ID_VOBJ_RECEIVE_FALL	,"Receive fail" ,"Receive fail");	
...
void PopulatevCardRes(void)
{
...
#if defined(__MMI_FILE_MANAGER__)
	ADD_APPLICATION_MENUITEM((MENU_ID_VCARD_RECV_OPTION, 0,2+MMI_SIM_NUMBER,
		MULTI_MENU(MENU_ID_VCARD_RECV_OPTION_TO_SIM),
		MENU_ID_VCARD_RECV_OPTION_TO_PHONE,
		MENU_ID_VCARD_RECV_OPTION_FMGR,
		SHOW,NONMOVEABLE, DISP_LIST, STR_GLOBAL_OPTIONS, 0));
#else /* defined(__MMI_FILE_MANAGER__) */
	ADD_APPLICATION_MENUITEM((MENU_ID_VCARD_RECV_OPTION, 0,1+MMI_SIM_NUMBER,
		MULTI_MENU(MENU_ID_VCARD_RECV_OPTION_TO_SIM),
		MENU_ID_VCARD_RECV_OPTION_TO_PHONE,
		SHOW,NONMOVEABLE, DISP_LIST, STR_GLOBAL_OPTIONS, 0));
	...
	ADD_APPLICATION_MENUITEM((MENU_ID_VCARD_RECV_OPTION_TO_PHONE, MENU_ID_VCARD_RECV_OPTION,0,
		SHOW,MOVEABLEWITHINPARENT, DISP_LIST, STR_STORAGE_LOCATION_PHONE, 0));
	...
	ADD_APPLICATION_MENUITEM((MENU_ID_VCARD_RECV_OPTION_TO_SIM, MENU_ID_VCARD_RECV_OPTION,0,
		SHOW,MOVEABLEWITHINPARENT, DISP_LIST, STR_STORAGE_LOCATION_SIM, 0));
	#else/* __MMI_DUAL_SIM_SINGLE_OPENED_*/
    #if 0
	for(i = 0; i < MMI_SIM_NUMBER; i++)
	{
		ADD_APPLICATION_MENUITEM((MENU_ID_VCARD_RECV_OPTION_TO_SIM + i, MENU_ID_VCARD_RECV_OPTION,0,
			SHOW,MOVEABLEWITHINPARENT, DISP_LIST, STR_STORAGE_LOCATION_SIM1 + i, 0));
	}
    #endif
		ADD_APPLICATION_MENUITEM((MENU_ID_VCARD_RECV_OPTION_TO_SIM , MENU_ID_VCARD_RECV_OPTION,0,
			SHOW,MOVEABLEWITHINPARENT, DISP_LIST, STR_STORAGE_LOCATION_SIM1 , 0));
		ADD_APPLICATION_MENUITEM((MENU_ID_VCARD_RECV_OPTION_TO_SIM + 1, MENU_ID_VCARD_RECV_OPTION,0,
			SHOW,MOVEABLEWITHINPARENT, DISP_LIST, STR_STORAGE_LOCATION_SIM1 + 1, 0));
		ADD_APPLICATION_MENUITEM((MENU_ID_VCARD_RECV_OPTION_TO_SIM + 2, MENU_ID_VCARD_RECV_OPTION,0,
			SHOW,MOVEABLEWITHINPARENT, DISP_LIST, STR_STORAGE_LOCATION_SIM1 + 2, 0));
	...
	ADD_APPLICATION_STRING2(STR_ID_VCARD_FILE_TO_LARGE	,"file too large" ,"file too large");	
	ADD_APPLICATION_STRING2(STR_ID_VCARD_VCARD_DETAILS	, "vCard details"	,"vCard details");	
}
#endif
