...
void PopulateIdleMenuRes(void)
{
    ...
    ADD_APPLICATION_IMAGE2(RADIO_ON_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIELement/Radiobutton/ro_s.gif","Image associated with Radio On.");
    ADD_APPLICATION_IMAGE2(RADIO_OFF_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIELement/Radiobutton/ro_uns.gif","Image associated with Radio Off.");
    ADD_APPLICATION_IMAGE2(CHECKBOX_ON_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIELement/Checkbox/CK_S.gif","Image associated with CheckBox On.");
    ADD_APPLICATION_IMAGE2(CHECKBOX_OFF_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIELement/Checkbox/CK_UNS.gif","Image associated with CheckBox Off.");
    ...
    //ADD_APPLICATION_IMAGE2(UNDER_CONSTRUCTION_IMAGE_ID,CUST_IMG_BASE_PATH"/UnderC.gif","Image assciated for the screen under construction.");
#if defined (__MMI_NOKIA_STYLE_N800__)  /* DON'T CHANGE THE ORDER */
   ADD_APPLICATION_IMAGE2(IMG_IDLE_MAINMENU_SHORCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_MM_UP.gif","Idle Screen Main Menu shorcut image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_MAINMENU_SHORCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_MM_DOWN.png","Idle Screen Main Menu shorcut pressed image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_MESSAGE_SHORTCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_MG_UP.gif","Idle Screen Message shorcut image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_MESSAGE_SHORTCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_MG_DOWN.png","Idle Screen Message shorcut pressed image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_PHONEBOOK_SHORTCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_PB_UP.gif","Idle Screen Phonebook shorcut image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_PHONEBOOK_SHORTCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_PB_DOWN.png","Idle Screen Phonebook shorcut pressed image.");
	ADD_APPLICATION_IMAGE2(IMG_IDLE_QQ_SHORTCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_service_up.gif","QQ.");
	//ADD_APPLICATION_IMAGE2(IMG_IDLE_DIALING_SCREEN_SHORTCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_DS_UP.gif","Idle Screen Dialing Screen shorcut image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_DIALING_SCREEN_SHORTCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_service_down.png","Idle Screen Dialing Screen shorcut pressed image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_JIAQUAN_SHORTCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/JI_PB_UP.gif","Idle Screen Phonebook shorcut image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_JIAQUAN_SHORTCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/JI_PB_DOWN.png","Idle Screen Phonebook shorcut pressed image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_MAINMENU1_SHORCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_M1_UP.gif","Idle Screen Main Menu shorcut image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_MAINMENU1_SHORCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_M1_DOWN.gif","Idle Screen Main Menu shorcut pressed image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_MESSAGE1_SHORTCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_M2_UP.gif","Idle Screen Message shorcut image.");
    ADD_APPLICATION_IMAGE2(IMG_IDLE_MESSAGE1_SHORTCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch_nok/TH_M2_DOWN.gif","Idle Screen Message shorcut pressed image.");
    ADD_APPLICATION_STRING2(STR_IDLE_MAINMENU_SHORCUT, "Calender", "String associated with Idle screen LSK.");
    ADD_APPLICATION_STRING2(STR_IDLE_MESSAGE_SHORTCUT, "Inbox", "String associated with Idle screen shortcut.");
    ADD_APPLICATION_STRING2(STR_IDLE_PHONEBOOK_SHORTCUT, "Camera", "String associated with Idle screen LSK.");
    ADD_APPLICATION_STRING2(STR_IDLE_WAP_SHORTCUT, "WAP", "String associated with Idle screen LSK.");
   // ADD_APPLICATION_STRING2(STR_IDLE_MSN_SCREEN_SHORTCUT, "MSN", "MSN");
    ADD_APPLICATION_STRING2(STR_IDLE_IMGVIEW_SHORTCUT, "ImgView", "String associated with Idle screen LSK.");
 ...
 //   ADD_APPLICATION_IMAGE2(IMG_ID_NOKIA_PWR_LOGO,CUST_IMG_PATH"/MainLCD/Active/poweronoff/POON_NOKIA.gif","Idle Screen Dialing Screen shorcut pressed image.");
...
void PopulateMainDemoRes(void)
{
    ...
    ADD_APPLICATION_IMAGE(DEMO_CONSTRUCTION_IMAGE_ID, CUST_IMG_BASE_PATH"/UnderC.gif");
    ADD_APPLICATION_IMAGE(DEMO_UNDER_CONSTRUCTION_TITLE_ICON, CUST_IMG_BASE_PATH"/TitleIcon.gif");
}
