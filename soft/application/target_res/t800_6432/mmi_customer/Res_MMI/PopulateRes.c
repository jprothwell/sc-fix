...
static void PopulateFOTAData(void)
{
    ...
    char filename_in[] = CUST_IMG_PATH2"/MainLCD/Submenu/Services/FOTA/FW_update_bg.png";
...
/// WX changed here
    ...
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_L31,
        CUST_IMG_PATH2 "/MainLCD/SubMenu/ListMenuIcon/L_NB31.png",
        "Menu Image");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_L32,
        CUST_IMG_PATH2 "/MainLCD/SubMenu/ListMenuIcon/L_NB32.png",
        "Menu Image");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_L33,
        CUST_IMG_PATH2 "/MainLCD/SubMenu/ListMenuIcon/L_NB33.png",
        "Menu Image");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_L34,
        CUST_IMG_PATH2 "/MainLCD/SubMenu/ListMenuIcon/L_NB34.png",
        "Menu Image");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_L35,
        CUST_IMG_PATH2 "/MainLCD/SubMenu/ListMenuIcon/L_NB35.png",
        "Menu Image");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_L36,
        CUST_IMG_PATH2 "/MainLCD/SubMenu/ListMenuIcon/L_NB36.png",
        "Menu Image");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_L37,
        CUST_IMG_PATH2 "/MainLCD/SubMenu/ListMenuIcon/L_NB37.png",
        "Menu Image");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_L38,
        CUST_IMG_PATH2 "/MainLCD/SubMenu/ListMenuIcon/L_NB38.png",
        "Menu Image");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_L39,
        CUST_IMG_PATH2 "/MainLCD/SubMenu/ListMenuIcon/L_NB39.png",
        "Menu Image");
    ...
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_WARNING,
        CUST_IMG_PATH2 "/MainLCD/Warningpage/PopUpPage/PP_WARN.png",
        "warning image");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_PROGRESS,
    ...
    ADD_APPLICATION_IMAGE2(
        ...
        CUST_IMG_PATH2 "/MAINLCD/WarningPage/notification/1_N_HDSET.png",
