...
void PopulateEMMenu(void)
{
	...
	ADD_APPLICATION_MENUITEM((EM_GPRS_TEST, ENGINEER_MODE_MENUID, 0,
			SHOW, NONMOVEABLE,DISP_LIST,EM_GPRS_TEST_TEXT,EM_NETWORK_ICON));
...
void populateEngineerModeMenu(void)
{
	...
	ADD_APPLICATION_STRING2 (EM_GPRS_TEST_TEXT, "GPRS Test", "GPRS Test");
#if 0
    /***************** Network Info ******************/
	...
	ADD_APPLICATION_STRING2 (EM_NETWORK_PREFER_RAT_2G_TEXT	,  "2G", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_NETWORK_PREFER_RAT_3G_TEXT	,  "3G", "Engineer Mode Menu Caption String");	
...
*/
	...
	ADD_APPLICATION_STRING2 (EM_DEV_SET_UART_CTI_ENABLE_TEXT   , "CTI log Config", "Engineer Mode Menu Caption String");
#endif    
   ...
   /* End of Device */
	...
	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_LEVEL1_TEXT , "Level 1", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_LEVEL2_TEXT , "Level 2", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_LEVEL3_TEXT , "Level 3", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_LEVEL4_TEXT , "Level 4", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_LEVEL5_TEXT , "Level 5", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_LEVEL6_TEXT , "Level 6", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_LEVEL7_TEXT , "Level 7", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_VOICE_FLOW, "Voice Flow", "Voice Flow");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_MUSIC_FLOW, "Musice Flow", "Music Flow");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_SIDE_TONE, "Side Tone", "Side Tone");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_MICROPHONE, "Microphone", "Microphone");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_DIGIT_GAINS_STR, "Digit Gains", "Digit Gains");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_ANALOG_GAINS_STR, "Analog Gains", "Analog Gains");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_MICROPHONE_GAIN_STR, "Microphone Gain", "Microphone Gain");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_GAIN_IN_VOC_STR, "Digit Gain In VoC", "Microphone Gain");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_FM_MODE_STR, "FM Mode", "FM Mode");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_TV_MODE_STR, "TV Mode", "TV Mode");
	ADD_APPLICATION_STRING2(EM_AUD_ENH_SET_DEFAULT, "Set Default", "Set Default");
#endif
    /* AUD TV OUT */    
    ...
    ADD_APPLICATION_STRING2 (EM_WAP_USERAGENT_NOKIA_6630_TEXT, "NOKIA 6630", "Engineer Mode Menu Caption String");
    ADD_APPLICATION_STRING2 (EM_WAP_USERAGENT_MOTO_E1000_TEXT, "MOTO E1000", "Engineer Mode Menu Caption String");
	#endif
...
//	ADD_APPLICATION_STRING2 (EM_DEV_DCMMODE_ON_TEXT      , "Enable", "Engineer Mode Menu Caption String");
   ...
   /* audio */
...
#ifdef __MMI_EM_AUDIO_SPEECH_ENHANCEMENT__
    ADD_APPLICATION_MENUITEM((EM_AUD_SPEECH_ENHANCEMENT_MENUID, EM_AUDIO_MENUID, 8, 
	...
	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_NORMAL_MODE_MENUID, EM_AUD_SPEECH_ENHANCEMENT_MENUID, 3,
							EM_AUD_SPH_ENH_VOICE_FLOW,
							EM_AUD_SPH_ENH_SIDE_TONE,
							EM_AUD_SPH_ENH_MICROPHONE,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_NORMAL_MODE_TEXT, EM_AUD_NORMAL_MODE_ICON));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_HEADSET_MODE_MENUID, EM_AUD_SPEECH_ENHANCEMENT_MENUID, 4,
							EM_AUD_SPH_ENH_VOICE_FLOW,
	...
	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_LOUDSPK_MODE_MENUID, EM_AUD_SPEECH_ENHANCEMENT_MENUID, 4,
							EM_AUD_SPH_ENH_VOICE_FLOW,
							EM_AUD_SPH_ENH_MUSIC_FLOW,
							EM_AUD_SPH_ENH_SIDE_TONE,
							EM_AUD_SPH_ENH_MICROPHONE,
	...
	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_FM_MENUID, EM_AUD_SPEECH_ENHANCEMENT_MENUID, 2,
							EM_AUD_SPH_ENH_MUSIC_FLOW,
							EM_AUD_SPH_ENH_MICROPHONE,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_FM_MODE_STR, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_TV_MENUID, EM_AUD_SPEECH_ENHANCEMENT_MENUID, 1,
							EM_AUD_SPH_ENH_MUSIC_FLOW,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_TV_MODE_STR, 0));


	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_VOICE_FLOW,EM_AUD_SPH_ENH_NORMAL_MODE_MENUID,2,
							EM_AUD_SPH_ENH_DIGIT_GAINS,
							EM_AUD_SPH_ENH_ANALOG_GAINS,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_VOICE_FLOW, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_MUSIC_FLOW,EM_AUD_SPH_ENH_NORMAL_MODE_MENUID,0,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_MUSIC_FLOW, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_SIDE_TONE,EM_AUD_SPH_ENH_NORMAL_MODE_MENUID,0,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_SIDE_TONE, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_MICROPHONE,EM_AUD_SPH_ENH_NORMAL_MODE_MENUID,2,
							EM_AUD_SPH_ENH_MICROPHONE_GAINS,
							EM_AUD_SPH_ENH_DIGIT_GAIN_IN_VOC,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_MICROPHONE, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_DIGIT_GAINS,EM_AUD_SPH_ENH_VOICE_FLOW, 0,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_DIGIT_GAINS_STR, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_ANALOG_GAINS,EM_AUD_SPH_ENH_VOICE_FLOW, 0,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_ANALOG_GAINS_STR, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_MICROPHONE_GAINS,EM_AUD_SPH_ENH_MICROPHONE, 0,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_MICROPHONE_GAIN_STR, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_DIGIT_GAIN_IN_VOC,EM_AUD_SPH_ENH_MICROPHONE, 0,
							SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_GAIN_IN_VOC_STR, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_SET_DEFAULT,EM_AUD_SPEECH_ENHANCEMENT_MENUID, 0, 
								SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_ENH_SET_DEFAULT, 0));

	ADD_APPLICATION_MENUITEM((EM_AUD_SPH_ENH_SAVE,EM_AUD_SPEECH_ENHANCEMENT_MENUID, 0, 
