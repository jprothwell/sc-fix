...
void PopulateCalculator(void)
{
	...
	ADD_APPLICATION_IMAGE2(IMG_ID_CALC_PLUS,CUST_IMG_PATH"/MainLCD/Calculator/PLUS.jpg","DIVIDE png");
	ADD_APPLICATION_IMAGE2(IMG_ID_CALC_MINUS,CUST_IMG_PATH"/MainLCD/Calculator/SUBTRACT.jpg","DIVIDE png");	
	ADD_APPLICATION_IMAGE2(IMG_ID_CALC_MULTIPLY,CUST_IMG_PATH"/MainLCD/Calculator/MULTI.jpg","DIVIDE png");
	ADD_APPLICATION_IMAGE2(IMG_ID_CALC_DIVIDE,CUST_IMG_PATH"/MainLCD/Calculator/DIVIDE.jpg","DIVIDE png");	
	ADD_APPLICATION_IMAGE2(IMG_ID_CALC_MAIN,CUST_IMG_PATH"/MainLCD/Calculator/MAP.gif","DIVIDE png");
	ADD_APPLICATION_IMAGE2(IMG_ID_CALC_MP,CUST_IMG_PATH"/MainLCD/Calculator/MP.gif","DIVIDE png");
	ADD_APPLICATION_IMAGE2(IMG_ID_CALC_MM,CUST_IMG_PATH"/MainLCD/Calculator/Mm.gif","DIVIDE png");
	ADD_APPLICATION_IMAGE2(IMG_ID_CALC_MC,CUST_IMG_PATH"/MainLCD/Calculator/MC.gif","DIVIDE png");
	ADD_APPLICATION_IMAGE2(IMG_ID_CALC_MR,CUST_IMG_PATH"/MainLCD/Calculator/MR.gif","DIVIDE png");
#else
...
/*+ zhouqin modify for dual t-flash card 20110503*/
    ...
    ADD_APPLICATION_STRING2(STR_SETTINGS_SEC_CARD_MEMORY, "Card2 Memory", "Bookshelf Option Screen");
#endif
/*- zhouqin modify for dual t-flash card 20110503*/
...
void PopulateHealthMensisRes(void)
{
  ADD_APPLICATION_STRING2(STR_SCR_HEALTH_CAPTION,"Health","Health");
	...
	ADD_APPLICATION_STRING2(STR_AVERAGE_DAYS_HEALTH_NAVIGATE,"Next Screen", "Go To Next Screen");


	ADD_APPLICATION_STRING2(STR_CALENDER_MENSES_CAPTION,"Period", "Menses Calender Period ");
...
void PopulateBMIData()
{
	...
	ADD_APPLICATION_IMAGE2(IMG_BMI_WELCOME_SCREEN,CUST_IMG_PATH"/MainLCD/Health/H_BMI.gif","BMI welcome image");
	...
	ADD_APPLICATION_STRING2(STR_BMI_LEVEL,"Level :", "BMI level ");
...
void PopulateUnitConvertor()
{
	...
	ADD_APPLICATION_STRING2(STR_UNITCONVERTOR_CAPTION,"Unit Converter","UnitConverter");
...
//	ADD_APPLICATION_STRING2(STR_ID_UNITCONVERTOR_RESET,"Reset","Reset Input Text");
	...
	ADD_APPLICATION_IMAGE2(IMG_ID_UNITCONVERTOR_RESET, "../../mmi_customer/Images/EmptyImage.bmp","Reset RSK image");
...
void PopulateShortcutsRes(void)
{
	...
	ADD_APPLICATION_IMAGE2(SHORTCUTS_TITLE_IMAGE_ID,CUST_IMG_PATH"/MainLCD/TitleBar/TB_SC.gif","Icon for Title displayed in Shortcuts Application.");
	...
	ADD_APPLICATION_STRING2(SHORTCUTS_OPTIONS_EDIT_STRING_ID,"Edit","Edit Button displayed in Shortcuts Screen Menu.");
