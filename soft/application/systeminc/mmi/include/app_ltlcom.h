...
#include "stack_config.h" /* wufasong added 2007.06.14 */
...
#define construct_local_para(local_para_size, direction) \
        construct_int_local_para(local_para_size, __FILE__, __LINE__)
#else
#define construct_local_para(local_para_size, direction) \
	MMI_Malloc((char *)__FILE__,(char *)__FUNCTION__,(int )__LINE__,local_para_size)
...
#define construct_uplane_local_para(local_para_size, direction, alloc_fptr, status_ptr) \
        construct_int_uplane_local_para(local_para_size, direction, alloc_fptr, status_ptr , __FILE__, __LINE__)
...
#define construct_local_para(local_para_size, direction) \
	MMI_Malloc((char *)__FILE__,(char *)__FUNCTION__,(int )__LINE__,local_para_size)
       // construct_int_local_para(local_para_size, NULL, 0)
