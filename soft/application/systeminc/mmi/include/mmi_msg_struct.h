...
#include "l4c_ss_parse.h"    ///wangrui add
...
/*CSD:BEGIN:generate_message_structure*/
/* Call Control Related Messages */
	...
	typedef struct
	{
		...
		U8 acm[6 + 1 + 2];		// 6:整数位数(365 day); 1:小数点; 2:小数位数
#else
		double acm;
#endif
	...
	typedef struct
	{
		...
		//kal_uint32	ccm;
#ifdef _MMI_OPERATOR_
		U8 ccm[4 + 1 + 2];		// 4:整数位数(1 day); 1:小数点; 2:小数位数
#else
		double ccm;
#endif
		//modified by zhoumn @2006/12/05<<<end
	...
	typedef struct
	{
		...
		kal_uint8	call_type;
		kal_uint8	mt_type; /* mt_type_enum */		
	...
	typedef struct
	{
		...
		kal_uint8	dcs;
		kal_uint8	length;
		kal_uint8	ip_string[11];
		kal_bool	IsEmergencyNo;
...
/* Hardware - Audio Related Service Messages */
	...
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	rotate;
	} mmi_eq_gsensor_rotate_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	direction;
	} mmi_eq_gsensor_direction_ind_struct;
#endif
	typedef struct
	{
		LOCAL_PARA_HDR
...
/* Hardware - Misc Messages */
	...
	typedef struct
	{
		...
		kal_uint8	dm_setting;
		#endif
	} mmi_eq_power_on_ind_struct;

	//tangjie add begin 20060621
	typedef struct
	{
		LOCAL_PARA_HDR
		 
		kal_uint32 timeid;       
	} mmi_eq_timer_id_struct;
	//tangjie add end 20060621


//dyj add start 20060608
	typedef struct msg_kbd_data
      {
...
/* Network Related Messages */
	...
	typedef struct
	{
		...
		kal_bool	result;
#ifdef __MMI_MULTI_SIM__
		kal_uint8	imei[MMI_SIM_NUMBER][16];
#else 
		kal_uint8	imei[16];
	...
	typedef struct
	{
        ...
        typedef struct _MMI_SPN_INFO{
          kal_uint8 nSPNameLen;
          kal_uint8 nSPNDisplayFlag;  
          kal_uint8 nSpnName[18];
        }MMI_SPN_INFO;    
	typedef struct
	{
		LOCAL_PARA_HDR
...
/* PhoneBook Related Messages */
	...
	{
		LOCAL_PARA_HDR
		kal_uint16	sim_max_num[MMI_SIM_NUMBER];	
	...
	typedef struct
	{
		...
		kal_uint8	dcs; /* smsal_dcs_enum */
		kal_uint16	length;
		kal_uint8	msg[SMSAL_MAX_MSG_LEN+1];			//add by yaosq 20070131
	...
	typedef struct
	{
		...
		kal_uint8	status;
		kal_uint8	storage_type;
		smsal_concat_struct	concat_info;    //wangwb add @2007.06.22
...
/* GPRS Related Messages */
	...
	}  mmi_ps_gprs_connect_status_ind_struct;
	  typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	status; /* l4c_gprs_status_enum */
	}  mmi_ps_gprs_deconnect_status_ind_struct;
...
/* Audio Task - Voice Memo(via FS) */
	...
	typedef struct
	{
		...
		l4csmu_info_num_struct	info_num[1];
...
/* Bluetooth */
	...
	{
		LOCAL_PARA_HDR
		kal_uint8	my_bd_addr[6];
		kal_uint8	name[40];
		kal_uint8	visibility;
		kal_uint8	auth; /* bt_authenticate_type_enum */
	} mmi_l4_bt_pwron_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
	} mmi_l4_bt_pwron_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	name[40];
	} mmi_l4_bt_set_name_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_set_name_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	pskey[5];
		kal_uint8	data[40];
		kal_uint8	store[5];
	} mmi_l4_bt_set_pskey_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_set_pskey_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	pskey[5];
	} mmi_l4_bt_get_pskey_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	data[40];
	} mmi_l4_bt_get_pskey_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	bd_addr[6];
		kal_uint8	link_key[16];
	} mmi_l4_bt_set_tr_dev_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_set_tr_dev_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	idx;
		kal_uint8	bd_addr[6];
	} mmi_l4_bt_del_tr_dev_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_del_tr_dev_rsp_struct;
	#if 0
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8 	num;
		bt_trust_device_struct	devs;
	} mmi_l4_bt_get_tr_dev_rsp_struct;
	#endif
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	code;
		kal_uint8	no_rsp;
	} mmi_l4_bt_inq_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_inq_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	status; /* bt_inq_status_enum */
		kal_uint8	idx;
		kal_uint8	name[40];
		kal_uint8	bd_addr[6];
		kal_uint8	type;
	} mmi_l4_bt_inq_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	idx;
		kal_uint8	bd_addr[6];
	} mmi_l4_bt_pair_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_pair_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint32	handle;
		kal_uint8	bd_addr[6];
	} mmi_l4_bt_pin_req_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint32	handle;
		...
		kal_uint8	bd_addr[6];
		kal_uint8	link_key[16];
	} mmi_l4_bt_set_pin_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_set_pin_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	result; /* bt_pin_verify_err_enum */
		kal_uint8	bd_addr[6];
		kal_uint8	link_key[16];
		kal_uint32	handle;
	} mmi_l4_bt_linkkey_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	source;
		...
		kal_uint8	bd_addr[6];
		kal_uint8	auth; /* bt_authenticate_type_enum */
		kal_uint8	prof; /* bt_profile_enum */
	} mmi_l4_bt_page_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_page_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	from_user;
		kal_uint8	visibility;
		kal_uint8	auth; /* bt_authenticate_type_enum */
	} mmi_l4_bt_inq_scan_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_inq_scan_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint32	handle;
		kal_uint8	bd_addr[6];
		kal_uint8	status; /* bt_rfcomm_status_enum */
	} mmi_l4_bt_rf_conn_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	prof; /* bt_profile_enum */
	} mmi_l4_bt_prof_conn_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	keycode;
		kal_uint8	keytype;
	} mmi_l4_bt_ckpd_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	sco_type;
	} mmi_l4_bt_add_sco_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint32	handle;
		kal_uint8	status; /* bt_sco_status_enum */
	} mmi_l4_bt_sco_state_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	cause;
	} mmi_l4_bt_pair_as_slave_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	conn_status; /* bt_gateway_status_enum */
		kal_uint8	sco_status; /* bt_sco_status_enum */
	} mmi_l4_bt_get_state_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	reason; /* bt_error_reason_enum */
	} mmi_l4_bt_error_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	level;
	} mmi_l4_bt_volume_level_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	accept;
	} mmi_l4_bt_data_accept_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	mode;
	} mmi_l4_bt_enter_testmode_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
	} mmi_l4_bt_enter_testmode_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	count;
	} mmi_l4_bt_poweron_status_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	type;
	} mmi_l4_bt_force_idle_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	result;
		kal_uint8	stat;
	} mmi_l4_bt_force_idle_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	vis;
		kal_uint8	auth;
	} mmi_l4_bt_force_scan_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	result;
		kal_uint8	stat;
	} mmi_l4_bt_force_scan_rsp_struct;
/* HOMEZONE */
