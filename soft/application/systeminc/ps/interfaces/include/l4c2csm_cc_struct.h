...
#include "csmcc_enums.h"  /*csd00924 add 041208 for +ecpi*/
#include "csmcc_common_enums.h"    /*csd00924 add 041208 for +ecpi*/
...
} l4ccsm_cc_cpi_ind_struct; /*CSD00924 add 041208 for +ECPI*/
...
typedef struct {
    ...
    kal_uint8 src_id;
    kal_uint8 call_id;
} l4ccsm_cc_call_sync_ind_struct; /*CSD00924 add 050727 for indicate MMI to get call info*/
