...
extern void l4csmu_read_plmn_sel(kal_uint8 start_indx,kal_uint16 *num, smu_plmn_id_struct *plmn_ptr);
extern smu_chv_status_enum l4csmu_get_chv_status(smu_chv_type_enum type);
extern void l4csmu_get_puct_value(kal_uint8 *currency,kal_uint8 *ppu);
...
extern kal_uint16 l4csmu_test_preferred_plmn (void); //Benson 20040407 modified for CSD00714's request 
