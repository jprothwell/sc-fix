...
void PopulateDictionaryData()
{
	...
	ADD_APPLICATION_STRING2(STR_DICTIONARY_CHINESE_STRING,"Chinese String Search","Chinese string search dictionary");
	ADD_APPLICATION_STRING2(STR_DICTIONARY_SYNONYMS,"Synonyms","Synonyms for dictionary");
	ADD_APPLICATION_STRING2(STR_DICTIONARY_ANTONYMS,"Antonyms","Antonyms for dictionary");
	ADD_APPLICATION_STRING2(STR_DICTIONARY_EXAMPLE_SENTENCE,"Example Sentence","Example Sentence for dictionary");
