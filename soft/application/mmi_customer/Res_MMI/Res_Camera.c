...
/*********** Shot Mode *************/
	...
	ADD_APPLICATION_STRING2(STR_ID_CAMERA_NOTIFY_QQ_BACKGROUND,					       "QQ is run in background.",		"[Notify-Write Protection]");
	ADD_APPLICATION_STRING2(STR_ID_CAMERA_NOTIFY_QQ_QUIT,					       "Quit QQ .",		"[Notify-Write Protection]");
...
#endif				
	ADD_APPLICATION_MENUITEM((MENU_ID_CAMERA_OPTION, 0,9
#ifndef __MMI_DISABLE_DUAL_SENSOR__
        +1 
#endif
,
