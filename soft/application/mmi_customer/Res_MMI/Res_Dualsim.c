...
void Dualsim_ResPopulate(void)
{
...
#else
    ADD_APPLICATION_IMAGE2(IMG_STORAGE_SIM_1,
                           CUST_IMG_PATH "/MainLCD/Phonebook/PBView/storage_sim_1.pbm",
                           "IMG_STORAGE_SIM_1");
#endif /* __MMI_DUAL_SIM_SINGLE_OPENED_ */
    ADD_APPLICATION_IMAGE2(IMG_STORAGE_SIM_2,
                           CUST_IMG_PATH "/MainLCD/Phonebook/PBView/storage_sim_2.pbm",
                           "IMG_STORAGE_SIM_2");
    ...
    ADD_APPLICATION_IMAGE2(IMG_SI_MASTER_SIGNAL_CLOSED,
                           CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/qpad/DualSIM/Master/SI_SIG1_CLOSE/SI_SIG_1_CLOSE.bmp",
    ...
    ADD_APPLICATION_IMAGE2(IMG_SI_SLAVE_SIGNAL_CLOSED,
                           CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/qpad/DualSIM/Slave/SI_SIG2_CLOSE/SI_SIG_2_CLOSE.bmp",
                           "Slave Status Icon: rf closed");
#else
    ADD_APPLICATION_IMAGE2(IMG_SI_MASTER_SIGNAL_STRENGTH,
...
#else
	ADD_APPLICATION_IMAGE2(IMG_SI_MASTER_SMS_INDICATOR, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Master/SI_MGE_1.bmp",
                           "Status Icon: MASTER Message");
#endif /* __MMI_DUAL_SIM_SINGLE_OPENED_ */
