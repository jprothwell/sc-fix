...
#include "phoedtstrenum.h"			/* photo editor string id enum */
#include "phoedtimgenum.h"			/* Photo Editor Image ID Enum */
...
{	
   ...
   ADD_APPLICATION_STRING2(STR_ID_PHOART_TEXT_TEXT_COLOR,		"Text Color",		"[Inline-Text Color]");	
	...
	ADD_APPLICATION_STRING2(STR_ID_PHOART_NOTIFY_CANCELED,
									...
									"[Notify-Canceled]");	
#if 0
  	ADD_APPLICATION_STRING2(STR_ID_PHOART_NOTIFY_IMG_DECODE_TIMEOUT,
									"Image Decode TimeOut",
									"[Notify-Image decode timeout]");
#endif
