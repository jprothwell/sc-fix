...
void PopulateGamesRes(void)
{
	...
	ADD_APPLICATION_IMAGE2(IMG_ID_FNG_SETTING_GAME, CUST_IMG_PATH"/MainLCD/SubMenu/Funandgame/Gamesetting/SB_FGST.pbm",	"effect setting");
...
//	ADD_APPLICATION_STRING2(STR_ID_GAME_SETTING_MULTICHANNEL_SOUND_EFFECT, "Sound Effect",	"Game Audio setting");
	...
	ADD_APPLICATION_IMAGE2(IMG_ID_FNG_SETTING_GAME_AUD, CUST_IMG_PATH"/MainLCD/SubMenu/Funandgame/Gamesetting/SB_GAMEAUD.pbm",	"Game Audio Icon");	
#ifdef __MMI_GAME_MULTICHANNEL_SOUND__
...
#endif  /*__MMI_GAME_MULTICHANNEL_SOUND__*/
	ADD_APPLICATION_IMAGE2(IMG_ID_FNG_SETTING_GAME_VIB, CUST_IMG_PATH"/MainLCD/SubMenu/Funandgame/Gamesetting/SB_GAMEVIB.pbm",	"Game Vib Icon");	
