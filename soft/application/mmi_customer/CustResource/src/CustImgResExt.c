...
//const unsigned short  CSD_CurrMaxImageNumEXT=4;
#ifndef MMI_ON_WIN32
...
{(U8*)&_MAINLCD_IDLESCREEN_WALLPAPER_WALL01_GIF_},
...
const CUSTPACK_IMAGE_HEADER CSD_image_header={4, (CUSTOM_IMAGE *)CSD_nCustImageNamesEXT};
