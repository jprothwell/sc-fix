...
#if need regenerate plmn, please enable this script. And read HowToGeneratePLMN.txt
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>BEGIN>>>>>>>>>>>>>>
#echo "run plmncreate.exe......"
#if [ ! -f ./res_temp/plmncreate.exe ]; then
#echo "Can't build plmncreate.exe"
#elif [ "$2" = "str" ] ; then
#./res_temp/plmncreate.exe -s
#echo "./res_temp/plmncreate.exe -s"
#elif [ "$2" = "nozip" ] ;then
#./res_temp/plmncreate.exe -g -o > ./res_temp/plmncreate.log
#echo "./res_temp/plmncreate.exe -g -o > ./res_temp/plmncreate.log"
#else
#./res_temp/plmncreate.exe -g -x > ./res_temp/plmncreate.log
#echo "./res_temp/plmncreate.exe -g -x > ./res_temp/plmncreate.log"
#fi

#echo "run plmncreate.exe done"
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>END>>>>>>>>>>>>>>
