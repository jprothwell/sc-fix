...
// GPIO(1)  // 
#define TGT_HAL_GPIO_1_USED AS_GPIO //KEYIN_6
// GPIO(2)  // HST_CTS
#define TGT_HAL_GPIO_2_USED NOT_CONNECTED //BT_SLEEP
// GPIO(3)  // HST_RTS
#define TGT_HAL_GPIO_3_USED AS_GPIO //BT_LDO_ON
// GPIO(4)  // LPSCO_1
#define TGT_HAL_GPIO_4_USED NOT_CONNECTED
// GPIO(5)  // UART2_CTS, UART1_DSR
#define TGT_HAL_GPIO_5_USED AS_GPIO //HANDSET_DET
// GPIO(6)  // UART2_TXD, UART1_CD
#define TGT_HAL_GPIO_6_USED NOT_CONNECTED //GPIO_6
// GPIO(7)  // UART2_RTS, UART1_RI
#define TGT_HAL_GPIO_7_USED NOT_CONNECTED //GPIO_7
// GPIO(8)  // UART2_RXD, UART1_DTR
#define TGT_HAL_GPIO_8_USED NOT_CONNECTED //GPIO_8
// GPIO(9)  // KEYOUT_5
#define TGT_HAL_GPIO_9_USED AS_GPIO //KEYOUT_5
// GPIO(10) // KEYIN_5
#define TGT_HAL_GPIO_10_USED NOT_CONNECTED //KEYIN_5
// GPIO(11) // I2S_DI1
#define TGT_HAL_GPIO_11_USED AS_ALT_FUNC //FM_I2S_DI
// GPIO(12) // SPI1_CLK
#define TGT_HAL_GPIO_12_USED NOT_CONNECTED

// GPIO(13) // SPI1_CS0
//#define TGT_HAL_GPIO_13_USED AS_ALT_FUNC //KEYIN_7
// GPIO(13) // SPI1_CS0
#define TGT_HAL_GPIO_13_USED NOT_CONNECTED //KEYIN_7


// GPIO(14) // SPI1_CS1, I2C3_SDA
#define TGT_HAL_GPIO_14_USED NOT_CONNECTED//songhui hk603
...
// GPIO(17) // I2S_BCK
#define TGT_HAL_GPIO_17_USED AS_ALT_FUNC //I2S_BCK
// GPIO(18) // LCD DATA
#define TGT_HAL_GPIO_18_USED AS_ALT_FUNC //LCD DATA
// GPIO(19) // LCD DATA
#define TGT_HAL_GPIO_19_USED AS_ALT_FUNC //LCD DATA
// GPIO(20) // UART1_CTS
#define TGT_HAL_GPIO_20_USED AS_ALT_FUNC //UR1_CTS
// GPIO(21) // UART1_RTS
#define TGT_HAL_GPIO_21_USED AS_ALT_FUNC //UR1_RTS
// GPIO(22) // M_CS2
#define TGT_HAL_GPIO_22_USED NOT_CONNECTED
// GPIO(23) // M_CS3
#define TGT_HAL_GPIO_23_USED NOT_CONNECTED
// GPIO(24) // I2C2 SCL, USB_RXD
#define TGT_HAL_GPIO_24_USED AS_ALT_FUNC //I2C_SCL
// GPIO(25) // I2C2 SDA
#define TGT_HAL_GPIO_25_USED AS_ALT_FUNC //I2C_SDA
// GPIO(26) // LCD DATA
#define TGT_HAL_GPIO_26_USED AS_ALT_FUNC //LCD DATA
// GPIO(27) // LCD DATA
#define TGT_HAL_GPIO_27_USED AS_ALT_FUNC //LCD DATA
// GPIO(28) // LCD DATA
#define TGT_HAL_GPIO_28_USED AS_ALT_FUNC //LCD DATA
// GPIO(29) // LCD DATA
#define TGT_HAL_GPIO_29_USED AS_ALT_FUNC //LCD DATA
// GPIO(30) // LCD DATA
#define TGT_HAL_GPIO_30_USED AS_ALT_FUNC //LCD DATA
// GPIO(31) // LCD DATA
#define TGT_HAL_GPIO_31_USED AS_ALT_FUNC //LCD DATA
// -----------------------------------------------------------------------------
...
#define TGT_HAL_GPO_0_USED 0 //KEYOUT_6
// GPO(1)   // GPO_1 SPI2_DI0, USB_DIP
#define TGT_HAL_GPO_1_USED 1 //SEN_PWDN1
...
#define TGT_HAL_GPO_4_USED 1 //auodio pa en
// GPO(5)   // GPO_5 KEYOUT_7, USB_RX_DM
#define TGT_HAL_GPO_5_USED 0 //SEN_PWDN0
// GPO(6)   // PWL_1, CLK_32K
#define TGT_HAL_GPO_6_USED 0 // rgb en
...
// GPO(11)  // LCD_CS1
#define TGT_HAL_GPO_11_USED 1 //LCD_RST//songhui modify lcd reset func ->cs1
// -----------------------------------------------------------------------------
...
{                                                                       \
    ...
    .camRstActiveH      = FALSE,                                        \
    .camPdnActiveH      = TRUE,                                         \
    .camPdnRemap        = { .gpoId  = HAL_GPIO_NONE},                       \
    .camRstRemap        = { .gpioId  = HAL_GPIO_NONE},                  \
    .cam1Used           = TRUE,                                         \
    .cam1RstActiveH     = FALSE,                                        \
    .cam1PdnActiveH     = TRUE,                                         \
    .cam1PdnRemap       = { .gpoId  = HAL_GPO_1},                       \
...
{                                                                       \
    ...
    .lcdResetPin        = { .gpioId = HAL_GPO_11 },                      \
}
//songhui modify gpo11 ->gpio8
...
#define KEY_MAP                                                           \
{                                                                         \
	KP_BACK,		KP_DW,		KP_POUND,	KP_0, 		KP_STAR,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
	KP_DEL,		      KP_LT,		KP_9,		KP_8,	                   KP_7,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
	KP_SL,		      KP_OK,		KP_6, 	      KP_5,	                   KP_4,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
	KP_CALENDER,	KP_RT,		KP_3,		KP_2,		             KP_1,			KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
	KP_SR,		      KP_UP,		KP_UNMAPPED,KP_UNMAPPED,			       KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .lightLevelToRda1203 = {    0x8188, 0x8288, 0x8488, 0x8688,     \
								0x8788, 0x8888, 0x8988, 0x8a88},            \
        .lightLevelToPwm0 = {   0,  16,  16,  16,  16,  24,  32, 32},  \
...
#define TGT_AUD_CONFIG_EXT_AUD_INTERFACE_DRIVER                   ExtAudInterface
#define TGT_AUD_CONFIG_EXT_AUD_INTERFACE_PARAM                    0
#define TGT_AUD_CONFIG_EXT_AUD_INTERFACE_OUTPUT_PATH              AUD_SPK_EAR_PIECE
#define TGT_AUD_CONFIG_EXT_AUD_INTERFACE_OUTPUT_TYPE              AUD_SPEAKER_STEREO
#define TGT_AUD_CONFIG_EXT_AUD_INTERFACE_INPUT_PATH               AUD_MIC_RECEIVER
...
#define TGT_TSD_CONFIG                                                  \
    {                                                                   \
        .penGpio        = HAL_GPIO_0,                                   \
        .debounceTime   = 4*HAL_TICK1S/1000,                            \
        .downPeriod     = 1,                                            \
        .upPeriod       = 1,                                            \
        .maxError       = 0x50                                          \
    }
...
#ifdef TGT_WITH_FM_MODEL_rda5888e
// =============================================================================
#ifndef TGT_FMD_CONFIG
#define TGT_FMD_CONFIG                                                  \
{                                                                   \
