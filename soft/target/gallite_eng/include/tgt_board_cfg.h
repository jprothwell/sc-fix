...
#define KEY_MAP                                                           \
{                                                                         \
    KP_STAR, KP_7, KP_4, KP_1, KP_UNMAPPED, KP_END, KP_UNMAPPED, KP_UNMAPPED, \
    KP_0, KP_8, KP_5, KP_3, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_POUND, KP_9, KP_6, KP_2, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_UNMAPPED, KP_F0, KP_F1, KP_F2, KP_VU, KP_VD, KP_UNMAPPED, KP_UNMAPPED, \
    KP_UNMAPPED, KP_UNMAPPED, KP_SND/*KP_BACK*//*SND1*/, KP_DEL/*SND2*/, KP_SR, KP_SL, KP_UNMAPPED, KP_UNMAPPED, \
    KP_UNMAPPED, KP_UP, KP_DW, KP_OK, KP_RT, KP_LT, KP_UNMAPPED, KP_UNMAPPED, \
