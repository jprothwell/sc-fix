...
#define TGT_HAL_GPO_1_USED 1		//? used as gpo?
...
{                                                                       \
    ...
    .useLpsCo1          = FALSE,                                        \
    .keyInMask          = 0x3f,    /* Please modify to 0x7f in P1 PCB */                  \
    .keyOutMask         = 0xff,                                         \
...
#define KEY_MAP                                                           \
{                                                                         \
    KP_SND,KP_Q,KP_A,KP_NUMLOCK,  KP_SHIFT,   KP_SR,   KP_UNMAPPED,KP_UNMAPPED,\
    KP_SL, KP_W,KP_S,KP_Z,   KP_0,       KP_F4,   KP_F0,KP_UNMAPPED,\
    KP_F5,KP_E,KP_D,KP_X,   KP_UNMAPPED,KP_O,    KP_VD,KP_UNMAPPED,\
    KP_LT, KP_R,KP_F,KP_C,   KP_UNMAPPED,KP_L,    KP_F3,KP_UNMAPPED,\
    KP_UP, KP_T,KP_G,KP_V,   KP_SPACE, KP_P,    KP_VU,KP_UNMAPPED,\
    KP_OK, KP_Y,KP_H,KP_B,   KP_UNMAPPED,KP_BKSPACE,  KP_UNMAPPED,KP_UNMAPPED,\
    KP_DW, KP_U,KP_J,KP_N,   KP_F1,      KP_F2,   KP_UNMAPPED,KP_UNMAPPED,\
    KP_RT, KP_I,KP_K,KP_M,   KP_CTRL,   KP_ENTER,KP_UNMAPPED,KP_UNMAPPED\
}
#endif // KEY_MAP
...
#define TGT_BTD_CONFIG                                                  \
    {                                                                   \
        .i2cBusId  = HAL_I2C_BUS_ID_2,                                  \
        .pinReset  = { .gpioId  = HAL_GPIO_2 },                          \
        .pinWakeUp = { .gpioId = HAL_GPIO_NONE },                       \
        .pinSleep  = { .gpioId = HAL_GPIO_3 }                           \
    }
