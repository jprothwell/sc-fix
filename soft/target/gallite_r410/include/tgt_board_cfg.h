...
#define TGT_HAL_GPIO_6_USED AS_GPIO
...
// GPIO(9)  // KEYOUT_5
#define TGT_HAL_GPIO_9_USED  NOT_CONNECTED
// GPIO(10) // KEYIN_5
...
#define TGT_HAL_GPIO_24_USED AS_GPIO
// GPIO(25) // I2C2 SDA
#define TGT_HAL_GPIO_25_USED AS_GPIO
// GPIO(26) // LCD DATA
...
{                                                                       \
    ...
    .cs1Used            = FALSE,                                        \
    .lcdData16Bit       = FALSE,                                         \
    .lcdResetActiveLow  = FALSE,                                         \
    .lcdResetPin        = { .gpoId = HAL_GPO_NONE },                    \
}
...
{                                                                         \
    ...
    KP_DEL, 			KP_SR, 			KP_MUSIC,		KP_OK,			KP_LT , 		KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_BACK, 		KP_SL, 			KP_UNMAPPED,	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, \
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .lightLevelToRda1203 = {    0x8088, 0x8188, 0x8488, 0x8488,     \
                            0x8488, 0x8488, 0x8488, 0x8688},            \
        .lightLevelToPwm0 = {   0,  8,  8,  8,  8,  16,  16, 16},   \
        ...
        /*   POWER or LEVEL LDO.                                    */  \
        .ldoEnableNormal = PMD_LDO_MMC | PMD_LDO_USB,                                 \
        .ldoEnableLowPower = 0,                                         \
        .ldoMicIs2_8 = TRUE,                                            \
        .ldoCamIs2_8 = TRUE,                                            \
        .ldoLcdIs2_8 = TRUE,                                            \
...
{                                                                       \
    .i2cBusId          = HAL_I2C_BUS_ID_2,                              \
    .spiCamPinCSB = { .gpoId = HAL_GPO_5 },                      \
    .spiCamPinOverflowM = { .gpioId = HAL_GPIO_3 },                      \
    .spiCamPinOverflowS = { .gpioId = HAL_GPIO_2 },                      \
}
#else
#define TGT_CAMD_CONFIG                                                 \
{                                                                       \
...
// TGT_SPILCD_CFG
// -----------------------------------------------------------------------------
/// This structure describes the spi interface lcd configuration for a given target. 
// =============================================================================
#ifndef TGT_SPILCD_CONFIG
#ifdef __PRJ_WITH_SPILCD__
#define TGT_SPILCD_CONFIG                                               \
{                                                                       \
    .lcdA0Pin        = { .gpioId = HAL_GPIO_6 },                      \
