...
#define KEY_MAP                                                         \
{                                                                       \
   KP_POUND,  KP_8,     KP_5,     	KP_2,    KP_DW,       KP_CALENDER,       KP_STAR,		KP_UNMAPPED,    \
   KP_0,     	KP_9,     KP_6,   		KP_3,    KP_RT,	      KP_PBOOK,   KP_4,			KP_UNMAPPED,     \
   KP_SR,		KP_END,   KP_BKSPACE,	KP_P,  	 KP_LT,       KP_ENTER,   KP_7,			KP_UNMAPPED,           \
   KP_SL,   	KP_OK,	  KP_A, 		KP_Q,    KP_SND,      KP_Z,       KP_1,			KP_UNMAPPED,           \
   KP_QUES,   KP_STOP,  KP_L,    		KP_O,    KP_SMS,      KP_CTRL,    KP_4,			KP_UNMAPPED,          \
   KP_SHIFT,  KP_X,     KP_S,     	KP_W,    KP_SL,        KP_NUMLOCK, KP_UNMAPPED,	KP_UNMAPPED,      \
   KP_AND,    KP_COMMA, KP_K, 		KP_I, 	 KP_UP,   	  KP_SLASH,KP_UNMAPPED,	KP_UNMAPPED,       \
   KP_SPACE, 	KP_C, 	  KP_D,  		KP_E, 	 KP_UNMAPPED, KP_UNMAPPED,KP_UNMAPPED,	KP_UNMAPPED,       \
}
#endif // KEY_MAP
