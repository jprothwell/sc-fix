...
// Partition count.
#define DSM_PART_COUNT   4 // 5

#if 0
#undef UCTLS_SERVICE
#if (DSM_PART_COUNT==4)
	#define UCTLS_SERVICE 2
#elif (DSM_PART_COUNT==5)
	#define UCTLS_SERVICE 4
#endif
#endif
...
// =============================================================================
//  .cswHeapSize = 180*1024,                                              
//  .cosHeapSize = 670*1024                                               
#ifdef USER_DATA_CACHE_SUPPORT
#define TGT_CSW_CONFIG                                                  \
{  																																			\
  .cswHeapSize = 130*1024,                                              \
  .cosHeapSize = 680*1024                                               \
}
#else // !USER_DATA_CACHE_SUPPORT
#define TGT_CSW_CONFIG                                                  \
{  																																			\
  .cswHeapSize = 80*1024,                                               \
