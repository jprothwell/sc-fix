...
// GPIO(15) // SPI1_DIO
#define TGT_HAL_GPIO_15_USED AS_GPIO
...
#define KEY_MAP                                                           \
{                                                                         \
    KP_STAR,		KP_7, 			KP_4, 			KP_1, 			KP_BACK ,		KP_DEL, 		KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_0   , 		KP_8, 			KP_5, 			KP_2, 			KP_DW ,			KP_OK, 			KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_POUND,		KP_9,			KP_6, 			KP_3, 			KP_QQ,		KP_RT, 			KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_MUSIC, 		KP_MUSIC_PREV, 	KP_MUSIC_NEXT,	KP_MUSIC_PLAY,	KP_LT , 		KP_UP, 			KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_SR, 			KP_SL, 			KP_UNMAPPED,	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, \
    ...
    {                                                                   \
        ...
        {                                                               \
            ...
            { /* PMD_POWER_LOUD_SPEAKER : Loud Speaker enable */        \
                .ldo            = { .pin = { .gpioId = HAL_GPIO_15/*HAL_GPIO_NONE*/ } }, \
                             /* { .pin = { .gpioId = HAL_GPIO_15 } }, */ \
                .polarity       = TRUE,                                 \
                .shared         = FALSE,                                \
                .powerOnState   = FALSE,                                \
            },                                                          \
            ...
            { /* PMD_POWER_CAMERA_FLASH : Camera Flash Light enable */  \
                .ldo            = { .pin = {.gpioId = HAL_GPO_2 /*HAL_GPIO_NONE*/}},      \
                .polarity       = TRUE,                                 \
                .shared         = FALSE,                                \
                .powerOnState   = FALSE,                                \
            },                                                          \
