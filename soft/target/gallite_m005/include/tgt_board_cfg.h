...
#define KEY_MAP                                                           \
{                                                                         \
    KP_6		, KP_9	, KP_POUND	, KP_3		, KP_SR	, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_1		, KP_UNMAPPED	, KP_7		, KP_STAR	, KP_4	, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_5		, KP_0	, KP_2		, KP_8		, KP_UP	, KP_BACK, KP_UNMAPPED, KP_UNMAPPED, \
    KP_SL		, KP_UNMAPPED	, KP_RT		, KP_DEL		, KP_UNMAPPED	, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_LT		, KP_DW	, KP_OK, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    ...
    {                                                                   \
        ...
        {                                                               \
            ...
            { /* PMD_LEVEL_LED1         : LED1 Light level */           \
                ...
                .ldo            = { .pin = { .gpoId = HAL_GPO_3 } },    \
                .powerOnState   = 0,                                    \
            },                                                          \
            { /* PMD_LEVEL_LED2         : LED2 Light level */           \
                .type           = PMD_LEVEL_TYPE_LDO,                   \
                .ldo            = { .pin = { .gpoId = HAL_GPO_5 } },    \
                .powerOnState   = 0,                                    \
            },                                                          \
