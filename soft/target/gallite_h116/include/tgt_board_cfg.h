...
// GPO(8)   // TCO_3
#define TGT_HAL_GPO_8_USED 0 //hc113 keypad led en
// GPO(9)   // TCO_4
...
{                                                                       \
    ...
    .camRstActiveH      = FALSE,                                        \
    .camPdnActiveH      = TRUE,                                         \
    .camPdnRemap        = { .gpoId  = HAL_GPO_NONE},                       \
    .camRstRemap        = { .gpioId  = HAL_GPIO_NONE},                  \
    .cam1Used           = FALSE,                                         \
    .cam1RstActiveH     = FALSE,                                        \
    .cam1PdnActiveH     = TRUE,                                         \
    .cam1PdnRemap       = { .gpoId  = HAL_GPO_NONE},                       \
...
{                                                                       \
    ...
    .useLpsCo1          = FALSE,                                        \
    .keyInMask          = 0x1f,                                         \
    .keyOutMask         = 0x1f, /*KEYOUT_5/GPIO_9 used by BT*/          \
...
#define KEY_MAP                                                           \
	{																		  \
		KP_7,		KP_8,		KP_9,	KP_UP, 		KP_SL,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
		KP_STAR,		KP_0,		KP_POUND,		KP_SR,			KP_DEL,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
		KP_4,		KP_5,		KP_6, 	KP_SC,			KP_OK,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
		KP_BACK,		KP_DW,		KP_3,		KP_RT,		KP_LT,			KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
		KP_1,		KP_2,		KP_UNMAPPED,		KP_UNMAPPED,			KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .lightLevelToRda1203 = {    0, 0x8488, 0x8988, 0x8b88,     \
								0x8c88, 0x8d88, 0x8e88, 0x8588},        \
        .lightLevelToPwm0 = {   0,  9,  9,  9,  9,  9,  9, 9},  \
