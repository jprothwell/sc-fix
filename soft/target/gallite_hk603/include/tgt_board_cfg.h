...
// GPIO(1)  // 
#define TGT_HAL_GPIO_1_USED AS_ALT_FUNC //KEYIN_6
// GPIO(2)  // HST_CTS
#define TGT_HAL_GPIO_2_USED AS_GPIO //BT_SLEEP
// GPIO(3)  // HST_RTS
...
#define TGT_HAL_GPIO_6_USED AS_GPIO //GPIO_6
// GPIO(7)  // UART2_RTS, UART1_RI
#define TGT_HAL_GPIO_7_USED AS_GPIO //GPIO_7
// GPIO(8)  // UART2_RXD, UART1_DTR
#define TGT_HAL_GPIO_8_USED AS_GPIO //GPIO_8
// GPIO(9)  // KEYOUT_5
#define TGT_HAL_GPIO_9_USED AS_ALT_FUNC //KEYOUT_5
// GPIO(10) // KEYIN_5
#define TGT_HAL_GPIO_10_USED AS_ALT_FUNC //KEYIN_5
// GPIO(11) // I2S_DI1
...
#define TGT_HAL_GPIO_14_USED AS_GPIO//songhui hk603
...
#define TGT_HAL_GPO_5_USED 1 //SEN_PWDN0
// GPO(6)   // PWL_1, CLK_32K
#define TGT_HAL_GPO_6_USED 1 // rgb en
...
#define KEY_MAP                                                           \
{                                                                         \
	KP_SL,		KP_LT,		KP_BACK,	KP_DEL, 		KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
	KP_UP,		KP_OK,		KP_DW,		KP_UNMAPPED,	KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
	KP_SR,		KP_RT,		KP_SMS, 	KP_UNMAPPED,	KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
	KP_1,		KP_4,		KP_7,		KP_STAR,		KP_UNMAPPED,			KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
	KP_2,		KP_5,		KP_8,		KP_0,			KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
	KP_3,		KP_6,		KP_9,		KP_POUND,		KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .lightLevelToPwm0 = {   0,  16,  24,  32,  48,  64,  96, 96/*128*/},  \
        ...
        /*   POWER or LEVEL LDO.                                    */  \
        .ldoEnableNormal = PMD_LDO_MMC|PMD_LDO_CAM,                                 \
        .ldoEnableLowPower = PMD_LDO_CAM,                                         \
        .ldoMicIs2_8 = TRUE,                                            \
        .ldoCamIs2_8 = TRUE,                                            \
        .ldoLcdIs2_8 = TRUE,                                            \
        .ldoMMCIs2_8 = TRUE,                                            \
...
//ATVD config
// -----------------------------------------------------------------------------
/// This fills the ATVD_CONFIG_T structure for RDA ATV
// =============================================================================
#ifndef TGT_ATVD_CONFIG
#define TGT_ATVD_CONFIG                                                  \
    {                                                                   \
        .i2cBusId  = HAL_I2C_BUS_ID_1,                                  \
        .pinPdn  = { .gpioId = HAL_GPIO_NONE },                          \
    }
#endif // TGT_ATVD_CONFIG
