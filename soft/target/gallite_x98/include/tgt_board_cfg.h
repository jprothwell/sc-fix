...
// GPIO(17) // I2S_BCK
#define TGT_HAL_GPIO_17_USED NOT_CONNECTED
// GPIO(18) // LCD DATA
...
{                                                                         \
    ...
    KP_SL, 			KP_SR, 			KP_BACK,		KP_OK,			KP_LT , 		KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_DEL, 		KP_FM, 			KP_UNMAPPED,	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, \
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .lightLevelToRda1203 = {    0x8088, 0x8188, 0x8488, 0x8488,     \
                            0x8488, 0x8488, 0x8688, 0x8888},            \
        .lightLevelToPwm0 = {   0,  32,  32,  32,  32,  48,  64, 32},   \
