...
#define KEY_MAP                                                           \
{                                                                         \
    KP_6		, KP_9	, KP_POUND	, KP_3		, KP_FM	, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_1		, KP_SND	, KP_7		, KP_STAR	, KP_4	, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_5		, KP_0	, KP_2		, KP_8		, KP_OK	, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_ENTER	, KP_SR	, KP_RT		, KP_UP		, KP_SL	, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_LT		, KP_DW	, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
