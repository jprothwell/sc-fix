...
#define KEY_MAP                                                           \
{                                                                         \
    KP_SR,       KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_SL,       KP_UNMAPPED, KP_UNMAPPED, \
    KP_DW,       KP_2,        KP_LT,       KP_5,        KP_8,        KP_0,        KP_UNMAPPED, KP_UNMAPPED, \
    KP_BACK,     KP_1,        KP_DEL,      KP_4,        KP_7,        KP_STAR,     KP_UNMAPPED, KP_UNMAPPED, \
    KP_UNMAPPED, KP_3,        KP_RT,       KP_6,        KP_9,        KP_POUND,    KP_UNMAPPED, KP_UNMAPPED, \
    KP_OK,       KP_UP,       KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
