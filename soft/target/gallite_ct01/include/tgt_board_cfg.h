...
#define KEY_MAP                                                         \
{                                                                       \
    KP_6	,KP_POUND		,KP_8	            ,KP_9	            ,KP_UNMAPPED	,  KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,      \
    KP_5	,KP_0	      ,KP_STAR		      ,KP_1	            ,KP_UNMAPPED	,   KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,          \
    KP_4	,KP_3		,KP_7		      ,KP_2		      ,KP_UNMAPPED	,  KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,           \
    KP_RT	,KP_LT		,KP_DW		,KP_SND	             ,KP_UNMAPPED	,  KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,            \
    KP_SR	,KP_UP		,KP_OK	,KP_SL	,KP_UNMAPPED ,KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,             \
