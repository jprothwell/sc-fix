...
// GPIO(13) // SPI1_CS0
#define TGT_HAL_GPIO_13_USED AS_GPIO
...
{                                                                       \
    ...
    .camRstActiveH      = FALSE,                                        \
    .camPdnActiveH      = TRUE,                                         \
    .camPdnRemap        = { .gpioId  = HAL_GPIO_13},                  \
    .camRstRemap        = { .gpioId  = HAL_GPIO_NONE},                  \
    .cam1Used           = TRUE,                                        \
    .cam1RstActiveH     = FALSE,                                        \
    .cam1PdnActiveH     = TRUE,                                         \
    .cam1PdnRemap       = { .gpioId  = HAL_GPIO_14},                  \
...
{                                                                         \
    ...
    KP_STAR, 		KP_7, 		KP_4, 		KP_1, 		KP_BACK, 		KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_DEL, 		KP_UP, 		KP_SL ,		KP_LT ,		KP_OK, 		KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_FM, 		KP_SR, 		KP_MUSIC_PREV, 		KP_UNMAPPED, 		KP_MUSIC_NEXT, 	KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
