...
// GPIO(11) // I2C_SCL
#define TGT_HAL_GPIO_11_USED NOT_CONNECTED
...
// GPO(1)   // GPO_1 keyout6  (with spi2UseSdPins = FALSE)-->NC
#define TGT_HAL_GPO_1_USED  1
// GPO(2)   // GPO_2 ECO_MODE   (with spi2UseSdPins = FALSE)-->ECOMODE
#define TGT_HAL_GPO_2_USED  0
// GPO(3)   // GPO_3 keyout7  (with spi2UseSdPins = FALSE)-->NC
#define TGT_HAL_GPO_3_USED  0
// GPO(4)   // GPO_4 keyout8  (with spi2UseSdPins = FALSE)-->SIMSEL
#define TGT_HAL_GPO_4_USED  1
// GPO(5)   // GPO_5 BT_LOD_ON   (with spi2UseSdPins = FALSE)-->VMIC_ON
#define TGT_HAL_GPO_5_USED  0
// GPO(6)   // PWL_1 -->LED_PWM
#define TGT_HAL_GPO_6_USED  0
// GPO(7)   // PWL_0 -->KEYLIGHTEN
...
/************  Note: Gallite only has TCO0-TCO5 ***************/
// TCO(6)   // GPIO_31 -->NC
#define TGT_HAL_TCO_6_USED 0         ///power  on
// TCO(7)   // DIGRF_RXTX_EN -->NC
#define TGT_HAL_TCO_7_USED 0
// TCO(8)   // DIGRF_STROBE  -->NC
#define TGT_HAL_TCO_8_USED 0
// TCO(9)   // DIGRF_RXTX_DATA -->XCV_RST
...
#define KEY_MAP                                                         \
{                                                                       \
    KP_STAR	,KP_7		,KP_4	            ,KP_1	            ,KP_UP	,        \
    KP_0	      ,KP_8	      ,KP_5		      ,KP_2	            ,KP_DW	,             \
    KP_POUND	,KP_9		,KP_6		      ,KP_3		      ,KP_RT	,             \
    KP_SND	,KP_SR		,KP_COMMA		,KP_OK	             ,KP_LT	,              \
    KP_DEL	,KP_SL		,KP_UNMAPPED	,KP_UNMAPPED	,KP_UNMAPPED              \
} 
#endif // KEY_MAP
...
//       
// PA->ENA is VLOGIC pin for SKY77518, MODEN for TQM4002.
