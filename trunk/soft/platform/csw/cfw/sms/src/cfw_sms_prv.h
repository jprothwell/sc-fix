...
#define SMS_INIT_GET_ME_PARA 1  //  1:±éÁ¤MEÉÏSMS, 0: ²»±éÁ¤.   ME init,just one time
#ifdef SMS_DEBUG
...
UINT32 sms_tool_ComposePDU(UINT8 Concat, UINT8 SMSStatus, UINT8*  pData, UINT16 nDataSize, CFW_DIALNUMBER* pNumber, CFW_EV* pEvent);
