...
#define factory_settings_t              TGT_FACTORY_SETTINGS_T
// FIXME Do that one less dirtly
#define valid_marker                    mobileId.validMarker
#define IMEISV                          mobileId.imeiSv
#define MB_SN                           mobileId.mbSn
#define MP_SN                           mobileId.mpSn
