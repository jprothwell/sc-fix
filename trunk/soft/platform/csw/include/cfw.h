...
//modify by wuys 2010.08.02 for 4C4D
...
#ifdef CFW_MULTI_SIM
#define CFW_NW_SRV_ID         		0     // Indicate the network management  Service
#define CFW_NW_SRV_ID_SIM1    		1     // Indicate the network management  Service use to SIM2
#define CFW_SIM_SRV_ID        		2     // Indicate the SIM management  Service
#define CFW_SIM_SRV_ID_SIM1   		3     // Indicate the SIM management  Service use to SIM2
#define CFW_CC_SRV_ID         			4     // Indicate the Call management Service
#define CFW_CC_SRV_ID_SIM1    		5     // Indicate the Call management Service use to SIM2
#define CFW_SS_SRV_ID         			6     // Indicate the SS Service
#define CFW_SS_SRV_ID_SIM1    		7     // Indicate the SS Service use to SIM2
#define CFW_SMS_MO_SRV_ID     		8     // Indicate the SMS MO management  Service
#define CFW_SMS_MO_SRV_ID_SIM1	9     // Indicate the SMS MO management  Service use to SIM2
#define CFW_SMS_MT_SRV_ID     		10    // Indicate the SMS MT management  Service
#define CFW_SMS_MT_SRV_ID_SIM1	11    // Indicate the SMS MT management  Service use to SIM2
#define CFW_SMS_CB_ID         			12    // Indicate the SMS CB management  Service
#define CFW_SMS_CB_ID_SIM1    		13    // Indicate the SMS CB management  Service use to SIM2
                              	
#define CFW_GPRS_SRV_ID       	14
#define CFW_GPRS_SRV_ID_SIM1  	15     // use to SIM2
#define CFW_PDP_SRV_ID        	CFW_GPRS_SRV_ID
#define CFW_PDP_SRV_ID_SIM1     CFW_GPRS_SRV_ID_SIM1
#define CFW_PSD_SRV_ID        	CFW_GPRS_SRV_ID
#define CFW_PSD_SRV_ID_SIM1     CFW_GPRS_SRV_ID_SIM1
                              	
#define CFW_CSD_SRV_ID        	16
#define CFW_CSD_SRV_ID_SIM1     17
#define CFW_EMOD_SRV_ID       	18   	 // Engineering Mode
#define CFW_EMOD_SRV_ID_SIM1  19   	 // Engineering Mode
#define CFW_APP_SRV_ID        	20
#define CFW_APP_SRV_ID_SIM1     21
#define CFW_TIMER_SRV_ID      	22
                              	
#define CFW_MAX_SRV_ID        	22
#else
#define CFW_NW_SRV_ID         0     // Indicate the network management  Service
#define CFW_SIM_SRV_ID        1     // Indicate the SIM management  Service
#define CFW_CC_SRV_ID         2     // Indicate the Call management Service
...
UINT32 SRVAPI CFW_CfgSetSmsParam (
  CFW_SMS_PARAMETER* pInfo,//modified by fengwei 20080707 for save sca to sim 
  UINT16 nUTI
);
...
UINT32 SRVAPI CFW_SimGetServiceProviderName(UINT16 nUTI);
...
typedef struct _CFW_GPRS_PDPCONT_INFO {
    ...
    UINT8  nApnSize;
    UINT8  nPdpAddrSize;
    #if 1 //modify by wuys 2008-02-15, for APN authentication
    //UINT8  padding[3];
    UINT8  nApnUserSize;
    UINT8  nApnPwdSize;
    UINT8  padding[1];
...
// that is used when the MT sends an Activate PDP Context Request message 
// to the network.
UINT32 SRVAPI CFW_GprsSetMinQos(
    UINT8 nCid, 
    CFW_GPRS_QOS *pQos
    ); // [in]nCid, [in]pQos
    
UINT32 SRVAPI CFW_GprsGetMinQos(
    UINT8 nCid, 
...
//tcp error code, add by wuys 2009-12-01


#define CFW_ERR_TCPIP_OK    0        /* No error, everything OK. */
#define CFW_ERR_TCPIP_MEM  1        /* Out of memory error.     */
#define CFW_ERR_TCPIP_BUF  2        /* Buffer error.            */

#define CFW_ERR_TCPIP_ABRT 3        /* Connection aborted.      */
#define CFW_ERR_TCPIP_RST  4        /* Connection reset.        */
#define CFW_ERR_TCPIP_CLSD 5        /* Connection closed.       */
#define CFW_ERR_TCPIP_CONN 6        /* Not connected.           */

#define CFW_ERR_TCPIP_VAL  7        /* Illegal value.           */

#define CFW_ERR_TCPIP_ARG  8        /* Illegal argument.        */

#define CFW_ERR_TCPIP_RTE  9        /* Routing problem.         */

#define CFW_ERR_TCPIP_USE  10        /* Address in use.          */

#define CFW_ERR_TCPIP_IF   11        /* Low-level netif error    */
#define CFW_ERR_TCPIP_ISCONN 12        /* Already connected.       */
...
#define ML_ISO8859_1  "ISO8859-1"
#define ML_ISO8859_5  "ISO8859-5"
#define ML_ISO8859_6  "ISO8859-6"
...
#else
UINT32 cfw_SimReadElementaryFile(UINT16 nUTI,UINT32 fileId);
...
UINT32 CFW_SimReadRecord(UINT8 nFileID,UINT8 nRecordNum,UINT16 nUTI);
