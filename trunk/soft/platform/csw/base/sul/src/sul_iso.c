			...
			switch(*pISO_Str)
			{
				case 0x5b:
					...
					*(++pGSM_Str)  = 0x3C;
					...
					pISO_Str++;
					break;
				case 0x5c: *pGSM_Str =0x1B;*(++pGSM_Str)  = 0x2F;pGSM_Str++;pISO_Str++;
					break;
				case 0x5d: *pGSM_Str =0x1B;*(++pGSM_Str)  = 0x3E;pGSM_Str++;pISO_Str++;
					break;	
				case 0x5e: *pGSM_Str =0x1B;*(++pGSM_Str)  = 0x14;pGSM_Str++;pISO_Str++;
					break;
				case 0x7b: *pGSM_Str =0x1B;*(++pGSM_Str)  = 0x28;pGSM_Str++;pISO_Str++;
					break;
				case 0x7c: *pGSM_Str =0x1B;*(++pGSM_Str)  = 0x40;pGSM_Str++;pISO_Str++;
					break;
				case 0x7d: *pGSM_Str =0x1B;*(++pGSM_Str)  = 0x29;pGSM_Str++;pISO_Str++;
					break;
				case 0x7e: *pGSM_Str =0x1B;*(++pGSM_Str)  = 0x3D;pGSM_Str++;pISO_Str++;
					break;	
				default:
					*pGSM_Str++=*pISO_Str++;
					break;					
                    ...
                    )
{
	...
	while(i<nSrcSize)
	{
		...
		if(*pGSM_Str==0x1b)
		{
                    ...
                    switch(*pGSM_Str) 
                    {
                    case 0x14:*pISO_Str =0x5E;pISO_Str++;pGSM_Str++;
                        break;
                    case 0x28:*pISO_Str =0x7B;pISO_Str++;pGSM_Str++;
                        break;
                    case 0x29:*pISO_Str =0x7D;pISO_Str++;pGSM_Str++;
                        break;
                    case 0x2f:*pISO_Str =0x5C;pISO_Str++;pGSM_Str++;
                        break;
                    case 0x3C:*pISO_Str =0x5B;pISO_Str++;pGSM_Str++;
                        break;
                    case 0x3D:*pISO_Str =0x7E;pISO_Str++;pGSM_Str++;
                        break;
                    case 0x3E:*pISO_Str =0x5D;pISO_Str++;pGSM_Str++;
                        break;
                    case 0x40:*pISO_Str =0x7C;pISO_Str++;pGSM_Str++;
                        break;
		    case 0x65:
			{
				if(ISO_type==ISO_8859_TYPE7)
			...
			break;
                    default:*pISO_Str=*(--pGSM_Str); pISO_Str++;pGSM_Str++;
                    }
                    i++;
		    continue;
                }
