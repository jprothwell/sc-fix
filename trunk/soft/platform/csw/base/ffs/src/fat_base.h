...
// FAT卷之前的隐藏扇区最大数
#define FAT_NR_MAX_HIDE_SECTOR   8192
#define FAT_NR_MAX_SCAN_SECTOR   256
// Size defined.
...
// get the file or directory first cluster.
...
#define NAME_BUF_ALLOC()  (WCHAR*)DSM_MAlloc((FS_PATH_LEN + LEN_FOR_NULL_CHAR) * SIZEOF(WCHAR))
