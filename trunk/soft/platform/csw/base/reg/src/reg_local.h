...
#define REG_DATA_TYPE_INT8_NUM_LEN        2       // int8 number length.
...
INT32 reg_FindValueName(HKEY hKey,PCSTR pcSubKey,REG_R_CTR* pRCtr, PCSTR pValueName,INT32 iRecOffset);
INT32 reg_GetFreeRSK();
INT32 reg_SetRSK(HKEY hKey,PCSTR pcSubKey,INT32 iIndex,PHKEY phKey);
INT32 reg_FreeRSK();
...
#define _ERR_REG_CFG_STR2HEX_WRONG                  -1032   // str to hex wrong.
#define _ERR_REG_CFG_ROOT_KEY_TOO_LONG          -1032   // root key too long.  
#define _ERR_REG_CFG_SUB_KEY_TOO_LONG            -1032   // sub key too long.
#define _ERR_REG_CFG_VALUE_NAME_TOO_LONG     -1032   // value name too long.
#define _ERR_REG_CFG_VALUE_TYPE_TOO_LONG      -1032   // value type too long.
#define _ERR_REG_CFG_VALUE_TOO_LONG                -1032   // value too long. case int8: - 2; case int32:4 case string and hex: 64.  
#define _ERR_REG_DEV_NOT_EXIST                           -1033   // the device not exist for reg moucle.
