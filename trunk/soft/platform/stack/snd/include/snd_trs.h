...
#define M_GET_FIRST_SEG_RX_NPDU_NB_UNACK(_PtSndHead) ((u8)((((u32)((*(_PtSndHead+2))&0xF))<<8)|(*(_PtSndHead+3))))
#define M_GET_SUBS_SEG_RX_NPDU_NB_UNACK(_PtSndHead)  ((u8)((((u32)((*(_PtSndHead+1))&0xF))<<8)|(*(_PtSndHead+2))))
