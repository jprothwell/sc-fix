...
#else
	typedef struct SCSN1Action {
		void (*Action) (const struct SCSN1Action* This, struct SCSN1Context* CSN1Context);
	} TCSN1Action;

	extern TCSN1Action CSN1Action_FAIL;
	extern TCSN1Action CSN1Action_SUCCESS;
	extern TCSN1Action CSN1Action_NULL;

	/*typedef void (*TCSN1NextType) (const struct SCSN1Action* This, struct SCSN1Context*);*/
	typedef const struct SCSN1Action* TCSN1NextType;
#define CSN1_FAIL        &CSN1Action_FAIL
#define CSN1_SUCCESS     &CSN1Action_SUCCESS
#define CSN1_NULL        &CSN1Action_NULL
...
#ifndef CSN1_OLD_ENCODER
/*------------------------------------------------------------------------------
	Action invoked when encode/decode failed
------------------------------------------------------------------------------*/
void Csn1_Action_FAIL (const struct SCSN1Action* This, TCSN1Context* CSN1Context);

/*------------------------------------------------------------------------------
	Action invoked when encode/decode terminated succesfully
------------------------------------------------------------------------------*/
void Csn1_Action_SUCCESS (const struct SCSN1Action* This, TCSN1Context* CSN1Context);

/*------------------------------------------------------------------------------
	Action invoked on NULL actions
------------------------------------------------------------------------------*/
void Csn1_Action_NULL (const struct SCSN1Action* This, TCSN1Context* CSN1Context);

/*------------------------------------------------------------------------------
	Standard ENCODE function
------------------------------------------------------------------------------*/
long Csn1_Encode (char* ED_CONST Buffer, ED_CONST long BitOffset, const void* ED_CONST Source, TCSN1NextType StartTransition);

/*------------------------------------------------------------------------------
	Standard DECODE function
------------------------------------------------------------------------------*/
void Csn1_Decode (TCSN1Context* CSN1Context, const char* ED_CONST Buffer, ED_CONST long BitOffset, void* ED_CONST Destin, unsigned long DestinSize, long Length, TCSN1NextType StartTransition);

/*------------------------------------------------------------------------------
	Optimized action: EnterField
------------------------------------------------------------------------------*/
typedef struct SCSN1ActionEnterField {
	TCSN1Action Action;
	const TCSN1Action* PreAction;
	int FieldId;
	const TCSN1Action* PostAction;
} TCSN1ActionEnterField;

/*------------------------------------------------------------------------------
	Optimized action for EnterField
------------------------------------------------------------------------------*/
void CSN1ActionFunction_EnterField (const struct SCSN1Action* This, TCSN1Context* CSN1Context);

/*------------------------------------------------------------------------------
	Optimized action: StandardPush
------------------------------------------------------------------------------*/
typedef struct SCSN1ActionStandardPush {
	TCSN1Action Action;
	const TCSN1Action** PreAction;
} TCSN1ActionStandardPush;

/*------------------------------------------------------------------------------
	Optimized action for EnterField
------------------------------------------------------------------------------*/
void CSN1ActionFunction_StandardPush (const struct SCSN1Action* This, TCSN1Context* CSN1Context);
#endif
