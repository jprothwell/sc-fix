...
/*
================================================================================
  Structure  : smscb_ActivateReq_t
--------------------------------------------------------------------------------
  Direction  : API -> SMS
  Scope      : API activates the SMSCB receiving for a list of SMSCB message id
  Comment    :
================================================================================
*/
typedef struct
{
  u8  MIDNb;         // Number of SMSCB identifiers
  u16 MID[10];       // Message ID to listen to
}smscb_ActivateReq_t;

/*
================================================================================
  Structure  : smscb_DeactivateReq_t
--------------------------------------------------------------------------------
  Direction  : API -> SMS
  Scope      : API deactivates the SMSCB receiving for a list of
               SMSCB message id
  Comment    :
================================================================================
*/
...
{
  u8  MIDNb;         // Number of SMSCB identifiers
  u16 MID[10];       // Message ID to not listen to
}smscb_DeactivateReq_t;
