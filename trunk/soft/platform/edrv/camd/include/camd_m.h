...
////////////////////////////////////////////////////////////////////////////////
//
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/camd/include/camd_m.h $
//  $Author: huazeng $
...
////////////////////////////////////////////////////////////////////////////////
//
/// @defgroup camd EDRV Camera Driver (CAMD)
/// @{
///
/// This document describes the CAMera Driver (CAMD) API.
///
/// @par
/// This driver implements all the functions needed to:
///   - Open the camera
///   - Close the camera
...
///   - Take a picture.
///   .
/// These functions are device dependent, and one implementation will be needed
/// per device. Higher level behaviour (aiming, saving picture, etc.) are
/// handled by the CAMera Service (CAMS) or Media Recorder Service (MPS).
///
/// The driver communicates its status (eg. capture done) with a message
/// of type CAMD_MSG_T sent to the mailbox passed as a parameter to the 
/// camd_Open open function.
///
//
////////////////////////////////////////////////////////////////////////////////
...
typedef enum
{
    ...
    /// Frame Rate. Possible values are defined by a strictly positive integer
    CAMD_PARAM_FRAME_RATE,
...
typedef enum
{
    CAMD_PARAM_EXPOSURE_NEGATIVE_2  = 0x00,
    CAMD_PARAM_EXPOSURE_NEGATIVE_1  = 0x01,
    CAMD_PARAM_EXPOSURE_AUTO        = 0x02,
...
typedef enum
{
    ...
    CAMD_PARAM_WHITE_BALANCE_TUNGSTEN   = 0x02,
    CAMD_PARAM_WHITE_BALANCE_OFFICE     = 0x03,
    CAMD_PARAM_WHITE_BALANCE_CLOUDY     = 0x04,
} CAMD_PARAM_WHITE_BALANCE_T;
