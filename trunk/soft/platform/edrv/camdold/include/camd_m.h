...
////////////////////////////////////////////////////////////////////////////////
//
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/camdold/include/camd_m.h $
//  $Author: huazeng $
...
/// @file camd_m.h
///
/// @mainpage Camera Driver (CAMD)
///
/// This document describes the CAMera Driver (CAMD) API.
///
/// @par This driver implements all the functions needed to:
///   - Open the camera
///   - Close the camera
...
/// per device. Higher level behaviour (aiming, saving picture on the phone,
/// etc ...) are handled by the CAMera Service (CAMS).
///
