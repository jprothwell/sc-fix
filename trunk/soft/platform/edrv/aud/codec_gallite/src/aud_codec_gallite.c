...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/aud/codec_gallite/src/aud_codec_gallite.c $ //
//	$Author: huazeng $                                                        // 
...
PRIVATE VOID aud_CodecGallitePopulateAifCfg(CONST HAL_AIF_STREAM_T* stream)
{
    ...
    g_audCodecGalliteAifCfg.channelNb=(stream->channelNb==HAL_AIF_MONO)?HAL_AIF_MONO:HAL_AIF_STEREO;
