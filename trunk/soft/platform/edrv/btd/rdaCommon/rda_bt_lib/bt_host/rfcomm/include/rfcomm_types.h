 ...
 * DATE:           14 Jan 2000
 *
 * SOURCE CONTROL: $Id: rfcomm_types.h 1532 2010-08-23 05:47:34Z huazeng $
 *
 * LICENSE:
...
#define PRH_RFCOMM_LSTAT_FRAMING_ERROR 8
 ...
 * Flow Ind
 */
struct prh_rfcomm_dlc_cb {
  t_api (*dlc_estab_ind)(t_bdaddr bd_addr, prh_t_rfcomm_dlci dlci, prh_t_rfcomm_dlc_params *dlc_params, void *multi_inst);
 t_api (*dlc_estab_conf)(t_bdaddr bd_addr, prh_t_rfcomm_dlci dlci_b, prh_t_rfcomm_dlc_params *dlc_params_b, prh_t_rfcomm_accept accept, void *multi_inst);
  t_api (*dlc_data_ind)(prh_t_rfcomm_dlci DLCI, struct host_buf *buffer, void *multi_inst);
  t_api (*dlc_rel_ind)(prh_t_rfcomm_dlci DLCI, void *multi_inst);
  t_api (*portneg)(prh_t_rfcomm_dlci DLCI, prh_t_rfcomm_port_params *port_params, void *multi_inst, prh_t_rfcomm_cb_type cbtype);
  t_api (*control)(prh_t_rfcomm_dlci DLCI, prh_t_rfcomm_control_params *ctrl_params, void *multi_inst, prh_t_rfcomm_cb_type cbtype);
  t_api (*linestat)(prh_t_rfcomm_dlci, prh_t_rfcomm_line_stat_params ls_params, void *multi_inst, prh_t_rfcomm_cb_type cbtype);
  t_api (*agg_flow_ind)(prh_t_rfcomm_dlci DLCI, prh_t_rfcomm_flow_state state, void *multi_inst);  
  t_api (*dlc_paramneg)(prh_t_rfcomm_dlci DLCI, prh_t_rfcomm_dlc_params *dlc_params, void *multi_inst, prh_t_rfcomm_cb_type cbtype);
  t_api (*credit_flow_ind)(prh_t_rfcomm_dlci DLCI, prh_t_rfcomm_flow_state state, void *multi_inst);
};


struct prh_rfcomm_multi_cb {
  t_api (*rfstart_conf)(t_bdaddr bd_addr, prh_t_rfcomm_start_sys_params *system_parameters, prh_t_rfcomm_accept accept, void *multi_inst);
