...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/memd/flsh_s71pl256nc0/src/drv_flsh_map.c $ //
//	$Author: huazeng $                                                        // 
...
#define BANK0_BASE 		0
#define BANK1_BASE 		(4*MBYTES)
#define BANK2_BASE 		(16*MBYTES)
#define BANK3_BASE 		(28*MBYTES)
...
PUBLIC CONST MEMD_BANK_LAYOUT_T g_memdFlashBankLayout [NUMBER_OF_BANKS]
     =
{
    { BANK0_BASE, { {4 , 64*KBYTES}, {15 , 256*KBYTES}, {0 , 0*KBYTES} } },
    { BANK1_BASE, { {48 , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK2_BASE, { {48 , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK3_BASE, { {15 , 256*KBYTES}, {4 , 64*KBYTES}, {0 , 0*KBYTES} } }
};
