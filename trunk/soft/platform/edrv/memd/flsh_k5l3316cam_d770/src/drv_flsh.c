...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/memd/flsh_k5l3316cam_d770/src/drv_flsh.c $ //
//	$Author: yanshengzhang $                                                        // 
//	$Date: 2011-07-11 20:28:53 +0800 (Mon, 11 Jul 2011) $                     //   
//	$Revision: 8968 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
/// @file drv_flsh.c                                                          //
/// That file provides the driver implementation for the flsh_k5l3316cam_d770 //
/// flash.                                                                    //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
PUBLIC MEMD_FLASH_LAYOUT_T* memd_FlashOpen(CONST MEMD_FLASH_CONFIG_T* cfg)
{
    ...
    //sxs_fprintf(TSTDOUT,"hal_flash: g_memdFlashBaseAddress 0x%08x \n", g_memdFlashBaseAddress);
...
PUBLIC MEMD_ERR_T memd_FlashErase(UINT8 *startFlashAddress, UINT8 *endFlashAddress)
{
    ...
    while (Start != phys_end_add)
    {
        ...
        //sxs_fprintf(TSTDOUT,"hal_flash: erase BankAddr 0x%08x, Page %d \n", BankAddr, GET_PAGE_PHYS(Start));
        //sxs_fprintf(TSTDOUT,"hal_flash: erase ptr 0x%08x \n", ptr);
        ...
        CONST UINT8* buffer)
{
    ...
    //sxs_fprintf(TSTDOUT,"hal_flash: Flash Write 0x%08x, %d\n", flash_address, bytesize);
    ...
    *pWrittenbyteSize=0;
    ...
    //sxs_fprintf(TSTDOUT,"hal_flash: BankAddr 0x%08x \n", BankAddr);
    ...
    *(BankAddr+0x555) = 0x20;
    hal_SysExitCriticalSection(status);
    //sxs_fprintf(TSTDOUT,"hal_flash: unlock\n");
