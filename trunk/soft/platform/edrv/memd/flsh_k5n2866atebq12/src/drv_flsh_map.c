...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: svn://atlas/SVN_SOFT/Granite/trunk/platform/memd/flsh_s71pl064ja0/src/drv_flsh_map.c $ //
//	$Author: ytt $                                                        // 
//	$Date: 2011-01-03 16:55:17 +0200 (Mon, 03 Sep 2007) $                     //   
//	$Revision: 6466 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
     ...
     =
{
    ...
    { BANK3_BASE,   { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK4_BASE,   { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK5_BASE,   { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK6_BASE,   { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK7_BASE,   { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK8_BASE,   { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK9_BASE,   { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK10_BASE,  { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK11_BASE,  { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK12_BASE,  { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK13_BASE,  { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK14_BASE,  { {16 , 64*KBYTES} , {0 , 0*KBYTES} , {0 , 0*KBYTES} } },
    { BANK15_BASE,  { {15 , 64*KBYTES} , {8 , 8*KBYTES} , {0 , 0*KBYTES} } }
};
