...
PUBLIC CONST MEMD_BANK_LAYOUT_T g_memdFlashBankLayout [NUMBER_OF_BANKS]
     =
{
    { BANK0_BASE, { {8  , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK1_BASE, { {8  , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK2_BASE, { {8  , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK3_BASE, { {8  , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK4_BASE, { {8  , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK5_BASE, { {8  , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK6_BASE, { {8  , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } },
    { BANK7_BASE, { {8  , 256*KBYTES}, {0 , 0*KBYTES}, {0 , 0*KBYTES} } }    
};
