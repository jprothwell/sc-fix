...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/lcdd/s6b33bf/ebc/src/drv_lcd_s6b33bf.c $ //
//	$Author: pengzg $                                                        // 
...
PUBLIC LCDD_ERR_T lcdd_SetPixel16(UINT16 x, UINT16 y, UINT16 pixelData)
{
    ...
    { 
        ...
        else
        {
            ...
            LCM_WR_CMD(x);
            LCM_WR_CMD(x);
#if defined(LCDD_8_BITS_PARALLEL)
...
PUBLIC LCDD_ERR_T lcdd_FillRect16(CONST LCDD_ROI_T* regionOfInterrest, UINT16 bgColor)
{
    ...
    {        
        ...
        else
        {
            ...
            LCM_WR_CMD(0x42);
            LCM_WR_CMD(g_lcddActiveWin.vsa);
            LCM_WR_CMD(g_lcddActiveWin.vea);
            LCM_WR_CMD(0x43);
            LCM_WR_CMD(g_lcddActiveWin.hsa+4);
            LCM_WR_CMD(g_lcddActiveWin.hea+4);
            ...
            lcdd_MutexFree(&g_lcddLock);
#else
#error 16 bits tranfering without DMA is not support by now!
#endif
