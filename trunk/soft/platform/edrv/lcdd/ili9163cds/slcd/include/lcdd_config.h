...
// =============================================================================
#define LCDD_CONFIG_STRUCT_T LCDD_CONFIG_HX8353D_GOUDA_STRUCT_T
...
// =============================================================================
// LCDD_CONFIG_STRUCT_TPUBLIC BOOL lcdd_9163c_RegInit(LCDD_REG_T *pLcdDrv)
// -----------------------------------------------------------------------------
/// Configuration structure for the LCD driver, using the Gouda module of the chip.
// =============================================================================
struct LCDD_CONFIG_9163C_GOUDA_STRUCT_T
{
