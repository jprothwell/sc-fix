...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/edrv/trunk/lcdd/ili9320/ebc/src/drv_lcd_ili9320.c $ //
//    $Author: pengzg $                                                        // 
...
//                                                                            //
/// @file drv_lcd.c                                                           //
/// That file provides an implementation for the ili9320  LCD screen.         //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
#error 8 bits LCD is NOT implemented by this driver now!
#endif
...
#define LCDD_DMA_ONE_SIZE   32640      //136*(240*2)=65280<65535
#define LCDD_DMA_TWO_SIZE   32640*2
// =============================================================================
//  GLOBAL VARIABLES
// =============================================================================
...
PUBLIC LCDD_ERR_T lcdd_FillRect16(CONST LCDD_ROI_T* regionOfInterrest, UINT16 bgColor)
{
    ...
    {        
        ...
        else
        {
            ...
            LCM_WR_REG(0x0050,g_lcddActiveWin.hsa);//Window Horizontal RAM Address Start                                                                                         
            LCM_WR_REG(0x0051,g_lcddActiveWin.hea);//Window Horizontal RAM Address End                                                                                           
            LCM_WR_REG(0x0052,g_lcddActiveWin.vsa);//Window Vertical RAM Address Start                                                                                           
            LCM_WR_REG(0x0053,g_lcddActiveWin.vea);//Window Vertical RAM Address End 
            ...
            else if (transferlength<LCDD_DMA_TWO_SIZE)
            {
         ...
         else
         {
            lcdd_TransferRectDmaData(LCDD_DMA_ONE_SIZE,bgColor,FALSE);
            lcdd_TransferRectDmaData(LCDD_DMA_ONE_SIZE,bgColor,FALSE);
            lcdd_TransferRectDmaData(transferlength-LCDD_DMA_TWO_SIZE,bgColor,TRUE);
         }
            ...
            if (frameBufferWin->roi.width == frameBufferWin->fb.width)
            {
                // The source buffer and the roi have the same width,
                   ...
                   {                       
                    ...
                    {
                          lcdd_TransferData(curBufAdd,LCDD_DMA_ONE_SIZE,FALSE);
                          lcdd_TransferData(curBufAdd+LCDD_DMA_ONE_SIZE,LCDD_DMA_ONE_SIZE,FALSE);
                          lcdd_TransferData(curBufAdd+LCDD_DMA_TWO_SIZE,transferlength-LCDD_DMA_TWO_SIZE,TRUE);
                    }
