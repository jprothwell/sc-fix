...
//	$Author: jiancui $                                                        // 
//	$Date: 2010-11-16 12:16:47 +0800 (星期二, 16 十一月 2010) $                     //   
//	$Revision: 3708 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
PRIVATE VOID lcddp_BlitRoi2Win(CONST HAL_GOUDA_WINDOW_T* pRoi, CONST HAL_GOUDA_WINDOW_T* pActiveWin)
{
    ...
    {
       LCM_WR_CMD(0x0037);
		LCM_WR_DATA((LCDD_DISP_X-1-pActiveWin->brPX));
		
		LCM_WR_CMD(0x0036);
		LCM_WR_DATA((LCDD_DISP_X-1-pActiveWin->tlPX));
		
		LCM_WR_CMD(0x0039);
		LCM_WR_DATA((LCDD_DISP_Y-1-pActiveWin->brPY));
		
		LCM_WR_CMD(0x0038);
		LCM_WR_DATA((LCDD_DISP_Y-1-pActiveWin->tlPY));
...
{
   static char otm2201h_id_str[] = "otm2201h\n"; 
   return otm2201h_id_str; 
}
...
/// @return #TRUE, #FALSE
// ============================================================================
PUBLIC BOOL  lcdd_otm2201h8b_RegInit(LCDD_REG_T *pLcdDrv)
{  
