...
//                                                                              //
///  @file drv_sim.c                                                        //
///  This file contains the  sim IF CT1010 module driver source code      //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
{
    SIMD_ASSERT(simdConfig == NULL, "SIMD: CT1010 SIM driver does not take config structure!\n");
...
// simd_SetSimEnable
// ----------------------------------------------------------------------------
/// This function does nothing since there is only one interface on the CT1010
// ============================================================================
...
PUBLIC VOID simd_SetSimVoltage(SIMD_VOLTAGE_T simLevel)
{
    ...
    pmd_SetLevel(PMD_LEVEL_SIM, simLevel);
}
...
// simd_ConfigReset
// ----------------------------------------------------------------------------
/// This function is not required for the CT1010 system.
// ============================================================================
