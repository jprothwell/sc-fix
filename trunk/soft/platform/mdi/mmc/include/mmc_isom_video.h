...
#ifdef TARGET_MEDIA_RM_SUPPORT //define in target.def
#define RM_SUPPORT
#endif
...
typedef struct
{
	...
	uint16 v_height;
	uint16 v_display_width;//will display width(maybe !=zoom_width)
