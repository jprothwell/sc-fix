/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: rm2yuv.c,v 1.4 2005/04/29 17:42:41 hubbe Exp $
 * 
 ...
 * rm2yuv
 *
 * This application reads an .rm file and produces
 * an .yuv file containing raw YUV frames. This 
 * file can be viewed with the YUV Viewer tool
 * which can be obtained from:
 *
 * http://www.ee.columbia.edu/~ywang/Links/YUVviewer.zip
 *
 * The application is called as follows:
 *
 * rm2yuv <rm_file> <yuv_file>
 *
 */
...
int main(int argc, char* argv[])
{
    ...
    fpOutAUD = fopen("F://²âÊÔÎÄ¼þ//test.aac", "wb");
    if (!fpOutAUD)
    {
