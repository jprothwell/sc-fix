...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://10.10.100.14/svn/developing/Sources/svc/branches/Total_BJ/avps/src/avps.c $ //
//    $Author: lilian $                                                        //
...
//                                                                            //
/// @file avps.c                                                               //
/// That file implementes the AVPS service.                                    //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
                            ...
                            CONST AVPS_BUFFER_CONTEXT_T*   bufContext)
{
    ...
    switch (audErr)
    {
        case AUD_ERR_NO:
            ...
            hal_SysRequestFreq(HAL_SYS_FREQ_CAMS, HAL_SYS_FREQ_39M, NULL);
            return AVPS_ERR_NO;
        default:
