...
////////////////////////////////////////////////////////////////////////////////
//
/// @file imgs_jpeg_dec.h
///
/// This file implements the JPEG decoder.
//
////////////////////////////////////////////////////////////////////////////////
...
CONST UINT8   g_imgsTable[5 * (MAXJSAMPLE+1) + CENTERJSAMPLE]={//1408
#include "imgs_rangelist_data.tab"
};

CONST INT8* g_imgsSampleRangeLimit = g_imgsTable+256;
            ...
            default:
                if ((id&0xf0)!=0xd0){
                    ...
                    else if (llength>TEMPBUFSIZE && g_imgsFileHandle) 
                    {
                        ...
                        INT32 filelen;
#ifndef  TESTONPC
                        FS_Seek(g_imgsFileHandle, templen, FS_SEEK_CUR);
                        filelen = FS_Read(g_imgsFileHandle, g_imgsTempBuf, TEMPBUFSIZE);
#else
