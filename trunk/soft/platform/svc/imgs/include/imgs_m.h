...
////////////////////////////////////////////////////////////////////////////////
//
//  $HeadURL: http://10.10.100.14/svn/developing/Sources/svc/branches/Total_BJ/imgs/include/imgs_m.h $
//  $Author: romuald $
//  $Date$
//  $Revision: 21880 $
//
...
/// @file imgs_m.h
///
/// @mainpage Image Service
/// 
///
/// This document describes the IMaGe Service (IMGS) API.
/// 
///
/// @par This service purposes are:
///   - Encode still images into various format (JPEG, ...)
///   - Decode images encoded in those format into data understandable by LCDD.
///   - Similarize decoded images, for example to fit into the screen, or a part 
/// of it. (Similarize is to move and resize,
/// cf: http://en.wikipedia.org/wiki/Similarity_(geometry) )
///   - Open and save from and to file on the filesystem.
///   .
/// 
/// @par The display of the image is ensured by the LCDD.
///
/// @par API:
///    - @ref imgs
///
/// @defgroup imgs Image Service
/// @{
//
////////////////////////////////////////////////////////////////////////////////
