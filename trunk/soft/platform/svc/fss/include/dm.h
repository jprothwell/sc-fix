...
#define DM_RESOURCE_USER HAL_RESOURCE_USER
#else
#define DM_RESOURCE_USER HAL_SYS_FREQ_USER_0
#endif

enum MMI_LP_Resources {
    MMI_LPR_LCDBACKLIGHT = DM_RESOURCE_USER,
    MMI_LPR_KEYBACKLIGHT,
    MMI_LPR_MMIACTIVE,
    MMI_LPR_DEVICE
};
