...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/base/branches/gallite441/sx/src/sxp_debug.h $ //
//	$Author: lijy $                                                        // 
//	$Date: 2010-12-13 12:44:05 +0800 (Mon, 13 Dec 2010) $                     //   
//	$Revision: 4567 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
// decimal value
#define CP_JOB_START_START_ID   1050


#define SX_PROFILE_JOB_START_ENTER(id) \
    { \
        hal_DbgPxtsProfileFunctionEnter(HAL_DBG_PXTS_SX, CP_JOB_START_START_ID + (sxr_Job -> Ctx [(id)].Desc -> Id));\
    }

#define SX_PROFILE_JOB_START_EXIT(id) \
    { \
        hal_DbgPxtsProfileFunctionExit(HAL_DBG_PXTS_SX, CP_JOB_START_START_ID + (sxr_Job -> Ctx [(id)].Desc -> Id));\
    }
