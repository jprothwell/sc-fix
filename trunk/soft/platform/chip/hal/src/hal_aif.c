...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_aif.c $ //
//    $Author: huazeng $                                                        // 
...
#define VOICE_BCK_LRCK_RATIO_MIN 16
#define VOICE_BCK_LRCK_RATIO_MAX 31
#define AUDIO_BCK_LRCK_RATIO_MIN 32
#define AUDIO_BCK_LRCK_RATIO_MAX 62
...
PROTECTED VOID hal_AifIrqHandler(UINT8 interruptId)
{
    ...
    UINT32 status = hwp_bbIfc->ch[direction].status & (BB_IFC_CAUSE_IEF|BB_IFC_CAUSE_IHF);
