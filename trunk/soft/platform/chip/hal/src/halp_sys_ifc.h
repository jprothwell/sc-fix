...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/halp_sys_ifc.h $ //
//    $Author: admin $                                                        // 
...
/// Receiving data from the SDMMC
    HAL_IFC_SDMMC_RX,
/// Sending data on the EXTAPB
    HAL_IFC_EXTAPB_TX,
/// Receiving data from the EXTAPB
    HAL_IFC_EXTAPB_RX,
/// Sending data on the LCDC
    HAL_IFC_LCDC_TX,
/// Receiving data from the LCDC : Doesn't exist 
    HAL_IFC_LCDC_RX_RESERVED,
...
#else
#error "Not implemented for your CHIP_ASIC_ID"
#endif // CHIP_ASIC_ID
...
// =============================================================================
PROTECTED UINT16 hal_IfcGetTc(HAL_IFC_REQUEST_ID_T requestId, UINT8 channel);
