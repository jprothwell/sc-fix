...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_key.c $ //
//    $Author: kongdq $                                                       // 
//    $Date: 2011-01-31 11:11:07 +0800 (Mon, 31 Jan 2011) $                     //   
//    $Revision: 5774 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
///     @file hal_key.c                                                       //
///                                                                           //
///     This file contains Granite's Keypad driver implementation             //
///                                                                           //
///                                                                           //
//////////////////////////////////////////////////////////////////////////////// 
...
PUBLIC VOID hal_KeyOpen(UINT16 debounceTime, UINT16 kpItvTime)
{
    ...
    UINT32 keyOutMask = halCfg->keyOutMask;
    UINT32 nbKeyOut = 0;
    ...
    while (keyOutMask != 0)
    {
        ...
        keyOutMask = keyOutMask >>1;
    }
    
    keyOutMask = halCfg->keyOutMask;
    ...
    UINT32 irqMask = hwp_keypad->KP_CTRL
                        & (KEYPAD_KP_ITV_IRQ_MASK
                            | KEYPAD_KP_EVT1_IRQ_MASK
                            | KEYPAD_KP_EVT0_IRQ_MASK);
    
    // enable keypad module and key IRQ
    hwp_keypad->KP_CTRL = KEYPAD_KP_DBN_TIME(dbnTimeReg)
        | KEYPAD_KP_ITV_TIME(kpItvTime)
        | irqMask | KEYPAD_KP_EN | KEYPAD_KP_IN_MASK(halCfg->keyInMask)
...
{
#if (CHIP_ASIC_ID == CHIP_ASIC_ID_GREENSTONE)
    if (hwp_keypad->KP_DATA_L & KEYPAD_KP_ON)
#else
...
PUBLIC VOID hal_KeyIrqSetMask(HAL_KEY_IRQ_MASK_T mask)
{
    ...
    else
    {
        ...
        hwp_keypad->KP_CTRL |= KEYPAD_KP_EVT0_IRQ_MASK  // key up or down
