...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_timer.c $ //
//    $Author: huazeng $                                                        // 
//    $Date: 2011-01-10 16:46:06 +0800 (Mon, 10 Jan 2011) $                     //   
//    $Revision: 5260 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
// g_timWatchDogDelay
// -----------------------------------------------------------------------------
/// Variable to store the watchdog delay.
// =============================================================================
PRIVATE  UINT32 g_timWatchDogDelay
         = 0; // 5 * HAL_TICK1S ;
...
PUBLIC VOID hal_TimWatchDogOpen(UINT32 delay)
{
    ...
    g_timWatchDogDelay = TIMER_LOADVAL(delay * 2);
    hwp_timer->WDTimer_LoadVal = g_timWatchDogDelay;
    hwp_timer->WDTimer_Ctrl = (TIMER_START | TIMER_RELOAD | TIMER_WDENABLED);
...
PUBLIC VOID hal_TimWatchDogSetPeriod(UINT32 delay)
{
    ...
    g_timWatchDogDelay = TIMER_LOADVAL(delay * 2);
    hwp_timer->WDTimer_Ctrl = (TIMER_LOAD | TIMER_ENABLE
                                    | g_timWatchDogDelay);
}
...
{
    //HAL_PROFILE_PULSE(hal_TimWatchDogKeepAlive);
    // this resets the watchdog and starts it if not done yet
    if (g_timWatchDogDelay != 0)
    {
...
// =============================================================================
PUBLIC UINT32 HAL_FUNC_RAM hal_TimGetUpTime(VOID)
{
