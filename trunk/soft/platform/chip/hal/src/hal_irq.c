...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_irq.c $ //
...
#define PRIO_MASK_EXTERNAL_IRQ      (MASK_PRIO_6_IRQS)
...
#elif ((CHIP_ASIC_ID == CHIP_ASIC_ID_GALLITE) || (CHIP_ASIC_ID == CHIP_ASIC_ID_ESPERITE))
{
    ...
    hal_TimTickIrqHandler,
    hal_TimRtcIrqHandler,
    hal_SpiIrqHandler,      // SPI   
    hal_SpiIrqHandler,      // SPI2
    hal_SpiIrqHandler,      // SPI3
    NULL, // No irq on hst_trace uart
    hal_UartIrqHandler,
    hal_UartIrqHandler,
    NULL, // reserved for i2c, no IRQ for it
...
#else
#error "No Logical IRQ Mapping defined for your target Chip"
#endif
...
#else
#error "No Logical IRQs Mapping defined for your target Chip"
#endif
