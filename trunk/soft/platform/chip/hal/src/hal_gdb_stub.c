...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_gdb_stub.c $ //
//    $Author: huazeng $                                                        // 
//    $Date: 2010-07-08 16:27:00 +0800 (Thu, 08 Jul 2010) $                     //   
//    $Revision: 301 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
CHAR *excCodeName[HAL_EXCEPTION_QTY] = {
  "Interrupt [Int]",
  "TLB modif. exc. [Mod]",
...
PRIVATE UINT32* HAL_DBG_STEPFORBIDDEN_FUNCTIONS [HAL_DBG_STEPFORBIDDEN_FUNCTION_COUNT] = 
    {(UINT32*)hal_DbgGdbHstSendEvent, (UINT32*)hal_HstSendEvent};
...
#if (ASICSIMU == 1)
    asicsimu_Fatal("XCPU in GDB Loop...");
#endif
...
#if (ASICSIMU == 1)
    asicsimu_Fatal("XCPU Division by 0 exception\n");
#endif
...
#endif
    HAL_TRACE(_PAL|TABORT|TSTDOUT, 0, 
...
//  don't actually send command if the BCPU triggered the IT
    ...
    if ((cpuid == 0) && (bcpu_error_code != HAL_DBG_ERROR_NO))
    {
        ...
        case HAL_DBG_ERROR_IT:
            HAL_TRACE(_PAL|TABORT|TSTDOUT|TSMAP(0x2), 0,
...
#if (ASICSIMU == 1)
    asicsimu_Fatal("Write Protect exception");
#endif
...
PROTECTED VOID hal_GdbBackTrace(VOLATILE UINT32 *hal_GdbRegs)
{
        ...
        HAL_TRACE(_PAL|TSTDOUT, 0, "To Get a complete context connect GDB\n");
#endif
