...
// =============================================================================
//                                                                            
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/include/hal_aif.h $
//    $Author: huazeng $                                                        
...
//                                                                            
/// @file hal_aif.h                                                             
/// That file describes the Audio InterFace driver API                        
//                                                                            
// =============================================================================
//                                                                            
/// @defgroup aif HAL Audio Interface                                         
///                                                                           
/// This driver provides ways to control and configure the audio interface.   
/// This interface allows ...                                                 
///                                                                           
/// Attention must be paid to the fact that the buffer handled by this API    
/// must have a size multiple of 16 bytes and that the maximum buffer size
/// is 32 KB.
///
/// @{                                                                        
//                                                                            
