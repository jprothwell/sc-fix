...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/include/hal_map.h $                                                                   
//  $Author: huazeng $                                                                    
//  $Date: 2011-04-08 18:38:15 +0800 (Fri, 08 Apr 2011) $                                                                      
//  $Revision: 6983 $                                                                  
//                                                                              
//==============================================================================
//
...
//config
#define HAL_PROFILE_CONTROL_GLOBAL_ENABLE_RAM (1<<0)
#define HAL_PROFILE_CONTROL_GLOBAL_ENABLE_TRACE (1<<1)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_RESERVED_0 (1<<16)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_BOOT (1<<17)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_HAL (1<<18)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_SX (1<<19)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_PAL (1<<20)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_EDRV (1<<21)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_SVC (1<<22)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_STACK (1<<23)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_CSW (1<<24)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_RESERVED_9 (1<<25)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_RESERVED_10 (1<<26)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_RESERVED_11 (1<<27)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_BB_IRQ (1<<28)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_SPAL (1<<29)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_SPP (1<<30)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_SPC (1<<31)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG(n) (((n)&0xFFFF)<<16)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_MASK (0xFFFF<<16)
#define HAL_PROFILE_CONTROL_ENABLE_PXTS_TAG_SHIFT (16)

//status
#define HAL_PROFILE_CONTROL_WRAPPED (1<<0)
#define HAL_PROFILE_CONTROL_OVERFLOWED (1<<1)
