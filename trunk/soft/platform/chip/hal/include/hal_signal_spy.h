...
////////////////////////////////////////////////////////////////////////////////
//                                                                            
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/hal/include/hal_signal_spy.h $
//    $Author: admin $                                                       
...
////////////////////////////////////////////////////////////////////////////////
//                                                                            
/// @file hal_signal_spy.h
/// This file contains Signal Spy functionalities API
//                                                                            
////////////////////////////////////////////////////////////////////////////////
...
typedef enum
{
    HAL_DBG_SIGNAL_SPY_CLK_SYS_NOGATE,      // 0
    HAL_DBG_SIGNAL_SPY_CLK_SYSD_SCI,        // 1
    HAL_DBG_SIGNAL_SPY_CLK_SYSD_SPI,        // 2
    HAL_DBG_SIGNAL_SPY_CLK_SYSD_RF_SPI,     // 3
    HAL_DBG_SIGNAL_SPY_CLK_SYSD_OSC,        // 4
    HAL_DBG_SIGNAL_SPY_CLK_SYSD_PWM,        // 5
    HAL_DBG_SIGNAL_SPY_CLK_BBD_AU_208K,     // 6
    HAL_DBG_SIGNAL_SPY_CLK_HOST,            // 7
    HAL_DBG_SIGNAL_SPY_CLK_AUDIO_PLL,       // 8
    HAL_DBG_SIGNAL_SPY_CLK_AUDIO_BCK,       // 9
    HAL_DBG_SIGNAL_SPY_CLK_SYS_UART1,       // 10
    HAL_DBG_SIGNAL_SPY_CLK_RF_RX,           // 11
    HAL_DBG_SIGNAL_SPY_CLK_RF_TX,           // 12
    HAL_DBG_SIGNAL_SPY_CLK_MEM_BRIDGE,      // 13
    HAL_DBG_SIGNAL_SPY_CLK_VOC,             // 14
    HAL_DBG_SIGNAL_SPY_CLK_32K,             // 15
    HAL_DBG_SIGNAL_SPY_CLK_OSC,             // 16
    HAL_DBG_SIGNAL_SPY_CLK_RF,              // 17
    HAL_DBG_SIGNAL_SPY_CLK_SLOW,            // 18
    HAL_DBG_SIGNAL_SPY_CLK_PLL,             // 19
    HAL_DBG_SIGNAL_SPY_CLK_VOC_PLL,         // 20
    HAL_DBG_SIGNAL_SPY_CLK_PLL52,           // 21
    HAL_DBG_SIGNAL_SPY_CLK_AU_CLK_520K,     // 22
    HAL_DBG_SIGNAL_SPY_CLK_AU_CLK_40K,      // 23
    HAL_DBG_SIGNAL_SPY_CLK_PADAC_CLK,       // 24
    HAL_DBG_SIGNAL_SPY_CLK_AFCDAC_CLK,      // 25
    HAL_DBG_SIGNAL_SPY_CLK_GPADC_CLK,       // 26
    HAL_DBG_SIGNAL_SPY_CLK_TX_CLK_FS,       // 27
    HAL_DBG_SIGNAL_SPY_CLK_RX_CLK_FS,       // 28

    HAL_DBG_SIGNAL_SPY_CLK_QTY
