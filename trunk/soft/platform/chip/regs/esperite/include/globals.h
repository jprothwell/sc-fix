...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/esperite/include/globals.h $                                                                   
//  $Author: admin $                                                                    
...
typedef enum
{
    ...
    SYS_ID_PAGE_SPY                             = 0x0000000B,
    SYS_ID_DEBUG_PORT                           = 0x0000000C,
    SYS_ID_RF_SPI                               = 0x0000000D,
    SYS_ID_TCU                                  = 0x0000000E,
/// The following modules are linked to ifc dma req with 2 requests per module
    SYS_ID_SCI                                  = 0x0000000F,
    SYS_ID_SPI1                                 = 0x00000010,
    SYS_ID_SPI2                                 = 0x00000011,
    SYS_ID_SPI3                                 = 0x00000012,
    SYS_ID_DEBUG_UART                           = 0x00000013,
    SYS_ID_UART                                 = 0x00000014,
    SYS_ID_UART2                                = 0x00000015,
    SYS_ID_SDMMC                                = 0x00000016,
    SYS_ID_CAMERA                               = 0x00000017,
    SYS_ID_XCPU_REG                             = 0x00000018,
    SYS_ID_XCPU_TAG                             = 0x00000019,
    SYS_ID_XCPU_IDATA                           = 0x0000001A,
    SYS_ID_XCPU_DDATA                           = 0x0000001B,
    SYS_ID_SYS_AHBC_MON                         = 0x0000001C,
    SYS_ID_BB_AHBC_MON                          = 0x0000001D,
    SYS_ID_BIST                                 = 0x0000001E,
    SYS_ID_GPADC                                = 0x0000001F,
    SYS_ID_GOUDA                                = 0x00000020,
    SYS_ID_I2C2                                 = 0x00000021,
    SYS_ID_I2C3                                 = 0x00000022,
    SYS_ID_EXT_APB                              = 0x00000023
} SYS_MODULE_ID_T;

#define FIRST_SYS_ID_DATA                        (13)
#define LAST_SYS_ID_DATA                         (24)
...
/// Level IRQ
    ...
    SYS_IRQ_GPADC                               = 0x0000001E,
    SYS_IRQ_PMU                                 = 0x0000001F
} SYS_IRQ_ID_T;
...
typedef enum
{
    ...
    BB_MID_DMASC                                = 0x00000006
} BB_MASTER_ID_T;

/// After this starts the Round Robib Pool
#define BB_MID_RR_START                          (3)
#define BB_MID_RR_END                            (7)
...
typedef enum
{
    BB_ID_BB_CTRL                               = 0x00000000,
    BB_ID_XCOR                                  = 0x00000001,
    BB_ID_IFC                                   = 0x00000002,
    BB_ID_IRQ                                   = 0x00000003,
    BB_ID_ITLV                                  = 0x00000004,
    BB_ID_CAP                                   = 0x00000005,
    BB_ID_VITERBI                               = 0x00000006,
    BB_ID_A5                                    = 0x00000007,
    BB_ID_RF                                    = 0x00000008,
    BB_ID_AIF                                   = 0x00000009,
    BB_ID_BIST                                  = 0x0000000A,
    BB_ID_BCPU_REG                              = 0x0000000B,
    BB_ID_BCPU_TAG                              = 0x0000000C,
    BB_ID_BCPU_IDATA                            = 0x0000000D,
    BB_ID_BCPU_DDATA                            = 0x0000000E,
    BB_ID_COMREGS                               = 0x0000000F,
    BB_ID_DMASC                                 = 0x00000010
} BB_MODULE_ID_T;

#define FIRST_BB_ID_DATA                         (7)
#define LAST_BB_ID_DATA                          (10)
/// The maximum number of slaves is currently 32.
#define BB_NB_PSEL                               (17)
