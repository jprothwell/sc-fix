...
#ifndef CT_ASM
#error "You are trying to use in a normal C code the assembly H description of 'spi'."
#endif
...
/// 
//==============================================================================
#define REG_SPI1_BASE               0x01A10000
#define REG_SPI2_BASE               0x01A11000
#define REG_SPI3_BASE               0x01A12000

#define REG_SPI1_BASE_HI            BASE_HI(REG_SPI1_BASE)
#define REG_SPI1_BASE_LO            BASE_LO(REG_SPI1_BASE)

#define REG_SPI1_CTRL               REG_SPI1_BASE_LO + 0x00000000
#define REG_SPI1_STATUS             REG_SPI1_BASE_LO + 0x00000004
#define REG_SPI1_RXTX_BUFFER        REG_SPI1_BASE_LO + 0x00000008
#define REG_SPI1_CFG                REG_SPI1_BASE_LO + 0x0000000C
#define REG_SPI1_PATTERN            REG_SPI1_BASE_LO + 0x00000010
#define REG_SPI1_STREAM             REG_SPI1_BASE_LO + 0x00000014
#define REG_SPI1_PIN_CONTROL        REG_SPI1_BASE_LO + 0x00000018
#define REG_SPI1_IRQ                REG_SPI1_BASE_LO + 0x0000001C

#define REG_SPI2_BASE_HI            BASE_HI(REG_SPI2_BASE)
#define REG_SPI2_BASE_LO            BASE_LO(REG_SPI2_BASE)

#define REG_SPI2_CTRL               REG_SPI2_BASE_LO + 0x00000000
#define REG_SPI2_STATUS             REG_SPI2_BASE_LO + 0x00000004
#define REG_SPI2_RXTX_BUFFER        REG_SPI2_BASE_LO + 0x00000008
#define REG_SPI2_CFG                REG_SPI2_BASE_LO + 0x0000000C
#define REG_SPI2_PATTERN            REG_SPI2_BASE_LO + 0x00000010
#define REG_SPI2_STREAM             REG_SPI2_BASE_LO + 0x00000014
#define REG_SPI2_PIN_CONTROL        REG_SPI2_BASE_LO + 0x00000018
#define REG_SPI2_IRQ                REG_SPI2_BASE_LO + 0x0000001C

#define REG_SPI3_BASE_HI            BASE_HI(REG_SPI3_BASE)
#define REG_SPI3_BASE_LO            BASE_LO(REG_SPI3_BASE)

#define REG_SPI3_CTRL               REG_SPI3_BASE_LO + 0x00000000
#define REG_SPI3_STATUS             REG_SPI3_BASE_LO + 0x00000004
#define REG_SPI3_RXTX_BUFFER        REG_SPI3_BASE_LO + 0x00000008
#define REG_SPI3_CFG                REG_SPI3_BASE_LO + 0x0000000C
#define REG_SPI3_PATTERN            REG_SPI3_BASE_LO + 0x00000010
#define REG_SPI3_STREAM             REG_SPI3_BASE_LO + 0x00000014
#define REG_SPI3_PIN_CONTROL        REG_SPI3_BASE_LO + 0x00000018
#define REG_SPI3_IRQ                REG_SPI3_BASE_LO + 0x0000001C
