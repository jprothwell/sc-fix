...
#define SYS_ID_PAGE_SPY                          (11)
#define SYS_ID_DEBUG_PORT                        (12)
#define FIRST_SYS_ID_DATA                        (13)
#define SYS_ID_RF_SPI                            (13)
#define SYS_ID_TCU                               (14)
/// The following modules are linked to ifc dma req with 2 requests per module
#define SYS_ID_SCI                               (15)
#define SYS_ID_SPI1                              (16)
#define SYS_ID_SPI2                              (17)
#define SYS_ID_SPI3                              (18)
#define SYS_ID_DEBUG_UART                        (19)
#define SYS_ID_UART                              (20)
#define SYS_ID_UART2                             (21)
#define SYS_ID_SDMMC                             (22)
#define SYS_ID_CAMERA                            (23)
#define LAST_SYS_ID_DATA                         (24)
#define SYS_ID_XCPU_REG                          (24)
#define SYS_ID_XCPU_TAG                          (25)
#define SYS_ID_XCPU_IDATA                        (26)
#define SYS_ID_XCPU_DDATA                        (27)
#define SYS_ID_SYS_AHBC_MON                      (28)
#define SYS_ID_BB_AHBC_MON                       (29)
#define SYS_ID_BIST                              (30)
#define SYS_ID_GPADC                             (31)
#define SYS_ID_GOUDA                             (32)
#define SYS_ID_I2C2                              (33)
#define SYS_ID_I2C3                              (34)
#define SYS_ID_EXT_APB                           (35)
...
#define SYS_IRQ_GPADC                            (30)
#define SYS_IRQ_PMU                              (31)
...
#define BB_ID_BB_CTRL                            (0)
#define BB_ID_XCOR                               (1)
#define BB_ID_IFC                                (2)
#define BB_ID_IRQ                                (3)
#define BB_ID_ITLV                               (4)
#define BB_ID_CAP                                (5)
#define BB_ID_VITERBI                            (6)
#define FIRST_BB_ID_DATA                         (7)
#define BB_ID_A5                                 (7)
#define BB_ID_RF                                 (8)
#define BB_ID_AIF                                (9)
#define LAST_BB_ID_DATA                          (10)
#define BB_ID_BIST                               (10)
#define BB_ID_BCPU_REG                           (11)
#define BB_ID_BCPU_TAG                           (12)
#define BB_ID_BCPU_IDATA                         (13)
#define BB_ID_BCPU_DDATA                         (14)
#define BB_ID_COMREGS                            (15)
#define BB_ID_DMASC                              (16)
