...
/// 
//==============================================================================
#define REG_UART_BASE               0x01A14000
#define REG_UART2_BASE              0x01A15000
...
#define REG_UART_XCHAR              REG_UART_BASE_LO + 0x00000018
#define REG_UART_CMD_SET            REG_UART_BASE_LO + 0x0000001C
#define REG_UART_CMD_CLR            REG_UART_BASE_LO + 0x00000020
...
#define REG_UART2_XCHAR             REG_UART2_BASE_LO + 0x00000018
#define REG_UART2_CMD_SET           REG_UART2_BASE_LO + 0x0000001C
#define REG_UART2_CMD_CLR           REG_UART2_BASE_LO + 0x00000020
...
#define UART_SWRX_FLOW_CTRL(n)      (((n)&3)<<12)
#define UART_SWRX_FLOW_CTRL_MASK    (3<<12)
#define UART_SWRX_FLOW_CTRL_SHIFT   (12)
#define UART_SWTX_FLOW_CTRL(n)      (((n)&3)<<14)
#define UART_SWTX_FLOW_CTRL_MASK    (3<<14)
#define UART_SWTX_FLOW_CTRL_SHIFT   (14)
#define UART_BACKSLASH_EN           (1<<16)
...
#define UART_RX_LOCK_ERR_DISABLE    (0<<25)
#define UART_RX_LOCK_ERR_ENABLE     (1<<25)
...
//XChar
#define UART_XON1(n)                (((n)&0xFF)<<0)
#define UART_XOFF1(n)               (((n)&0xFF)<<8)
#define UART_XON2(n)                (((n)&0xFF)<<16)
#define UART_XOFF2(n)               (((n)&0xFF)<<24)
