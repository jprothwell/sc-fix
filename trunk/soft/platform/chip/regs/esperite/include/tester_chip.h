...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/esperite/include/tester_chip.h $                                                                   
//  $Author: admin $                                                                    
...
// TESTER_CHIP_T
// -----------------------------------------------------------------------------
/// This module is not inside the esperite chip. It's connected to a Chip select
/// of EBC and placed in the testbench for simulation. It is also partially included
/// in the FPGA.
// =============================================================================
