...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/greenstone/include/bb_irq.h $                                                                   
//    $Author: admin $                                                                    
...
/// 
// =============================================================================
#define REG_BB_IRQ_BASE             0x00AC2000
...
typedef volatile struct
{
    ...
    /// up the System CPU (i.e.: Reenable it's clock, see CLOCK_BB_ENABLE and CLOCK_BB_DISABLE
    /// registers in general registers section)
...
#define BB_IRQ_BB_IRQ_RF_IF         (1<<9)
#define BB_IRQ_BB_IRQ_ITLV          (1<<10)
#define BB_IRQ_BB_IRQ_VITAC         (1<<11)
#define BB_IRQ_BB_IRQ_XCOR          (1<<12)
#define BB_IRQ_CAUSE(n)             (((n)&0x1FFF)<<0)
#define BB_IRQ_CAUSE_MASK           (0x1FFF<<0)
...
//#define BB_IRQ_BB_IRQ_VITAC       (1<<11)
//#define BB_IRQ_BB_IRQ_XCOR        (1<<12)
#define BB_IRQ_STATUS(n)            (((n)&0x1FFF)<<0)
#define BB_IRQ_STATUS_MASK          (0x1FFF<<0)
...
//#define BB_IRQ_BB_IRQ_VITAC       (1<<11)
//#define BB_IRQ_BB_IRQ_XCOR        (1<<12)
#define BB_IRQ_MASK_SET(n)          (((n)&0x1FFF)<<0)
#define BB_IRQ_MASK_SET_MASK        (0x1FFF<<0)
...
//#define BB_IRQ_BB_IRQ_VITAC       (1<<11)
//#define BB_IRQ_BB_IRQ_XCOR        (1<<12)
#define BB_IRQ_MASK_CLR(n)          (((n)&0x1FFF)<<0)
#define BB_IRQ_MASK_CLR_MASK        (0x1FFF<<0)
...
//#define BB_IRQ_BB_IRQ_VITAC       (1<<11)
//#define BB_IRQ_BB_IRQ_XCOR        (1<<12)
#define BB_IRQ_WAKEUP_MASK(n)       (((n)&0x1FFF)<<0)
#define BB_IRQ_WAKEUP_MASK_MASK     (0x1FFF<<0)
