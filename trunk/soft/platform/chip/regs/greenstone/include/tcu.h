...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/greenstone/include/tcu.h $                                                                   
//    $Author: admin $                                                                    
...
/// Internal TCO mapping
    TCO_GMSK_ON                                 = 0x0000000A,
    TCO_TX_OEN                                  = 0x0000000B,
    TCO_TX_ON                                   = 0x0000000C,
    TCO_RX_ON                                   = 0x0000000D,
    TCO_RX_DEC_ON                               = 0x0000000E
...
/// stop modulation
    STOP_GMSK                                   = 0x00000014,
/// starts modulation and output on IQ DAC
    START_GMSK                                  = 0x00000015,
    HIGHZ_IQ_DAC                                = 0x00000016,
    DRIVE_IQ_DAC                                = 0x00000017,
    DISABLE_IQ_DAC                              = 0x00000018,
    ENABLE_IQ_DAC                               = 0x00000019,
/// disable IQ ADC
    DISABLE_IQ_ADC                              = 0x0000001A,
/// enable IQ ADC
    ENABLE_IQ_ADC                               = 0x0000001B,
/// stop recording IQ samples
    STOP_RFIN_RECORD                            = 0x0000001C,
/// start recording IQ samples
    START_RFIN_RECORD                           = 0x0000001D,
/// Send RF spi command
    SEND_SPI_CMD                                = 0x0000001E,
    NEXT_GAIN                                   = 0x0000001F,
    FIRST_GAIN                                  = 0x00000020,
    NEXT_FC                                     = 0x00000021,
/// Start Ramp 0
    PA_RAMP0                                    = 0x00000022,
/// Start Ramp 1
...
/// Start Ramp 4
    PA_RAMP4                                    = 0x00000026,
    RX_SOC                                      = 0x00000027,
    DIGRF_STB                                   = 0x00000028,
/// Trigger BCPU TCU irq 0
    BCPU_TCU_IRQ0                               = 0x00000029,
/// Trigger BCPU TCU irq 1
    BCPU_TCU_IRQ1                               = 0x0000002A,
/// Trigger XCPU TCU irq 0
    XCPU_TCU_IRQ0                               = 0x0000002B,
/// Trigger XCPU TCU irq 1
    XCPU_TCU_IRQ1                               = 0x0000002C,
/// End of the WakeUp Mode
    WAKEUP_DONE                                 = 0x0000002D,
    NO_EVENT                                    = 0x0000003F
} TCU_EVENT_T;
...
/// 
// =============================================================================
#define REG_TCU_BASE                0x00B8F000
...
#define TCU_POL_TCO_12_ACTIVE_HIGH  (0<<12)
#define TCU_POL_TCO_12_ACTIVE_LOW   (1<<12)
#define TCU_POL_TCO_13_ACTIVE_HIGH  (0<<13)
#define TCU_POL_TCO_13_ACTIVE_LOW   (1<<13)
#define TCU_POL_TCO_14_ACTIVE_HIGH  (0<<14)
#define TCU_POL_TCO_14_ACTIVE_LOW   (1<<14)
#define TCU_WRITE_ERROR             (1<<28)
#define TCU_DEBUG_ACTIVE_NORMAL     (0<<31)
#define TCU_DEBUG_ACTIVE_DEBUG      (1<<31)
#define TCU_TCO_POLARITY(n)         (((n)&0x7FFF)<<0)
#define TCU_TCO_POLARITY_MASK       (0x7FFF<<0)
...
#define TCU_SET_TCO_12              (1<<12)
#define TCU_SET_TCO_13              (1<<13)
#define TCU_SET_TCO_14              (1<<14)
#define TCU_SET_TCO(n)              (((n)&0x7FFF)<<0)
#define TCU_SET_TCO_MASK            (0x7FFF<<0)
...
#define TCU_CLR_TCO_12              (1<<12)
#define TCU_CLR_TCO_13              (1<<13)
#define TCU_CLR_TCO_14              (1<<14)
#define TCU_CLR_TCO(n)              (((n)&0x7FFF)<<0)
#define TCU_CLR_TCO_MASK            (0x7FFF<<0)
...
#define TCU_EVENT_ID_STOP_GMSK      (0x14<<16)
#define TCU_EVENT_ID_START_GMSK     (0x15<<16)
#define TCU_EVENT_ID_HIGHZ_IQ_DAC   (0x16<<16)
#define TCU_EVENT_ID_DRIVE_IQ_DAC   (0x17<<16)
#define TCU_EVENT_ID_DISABLE_IQ_DAC (0x18<<16)
#define TCU_EVENT_ID_ENABLE_IQ_DAC  (0x19<<16)
#define TCU_EVENT_ID_DISABLE_IQ_ADC (0x1A<<16)
#define TCU_EVENT_ID_ENABLE_IQ_ADC  (0x1B<<16)
#define TCU_EVENT_ID_STOP_RFIN_RECORD (0x1C<<16)
#define TCU_EVENT_ID_START_RFIN_RECORD (0x1D<<16)
#define TCU_EVENT_ID_SEND_SPI_CMD   (0x1E<<16)
#define TCU_EVENT_ID_NEXT_GAIN      (0x1F<<16)
#define TCU_EVENT_ID_FIRST_GAIN     (0x20<<16)
#define TCU_EVENT_ID_NEXT_FC        (0x21<<16)
#define TCU_EVENT_ID_PA_RAMP0       (0x22<<16)
#define TCU_EVENT_ID_PA_RAMP1       (0x23<<16)
#define TCU_EVENT_ID_PA_RAMP2       (0x24<<16)
#define TCU_EVENT_ID_PA_RAMP3       (0x25<<16)
#define TCU_EVENT_ID_PA_RAMP4       (0x26<<16)
#define TCU_EVENT_ID_RX_SOC         (0x27<<16)
#define TCU_EVENT_ID_DIGRF_STB      (0x28<<16)
#define TCU_EVENT_ID_BCPU_TCU_IRQ0  (0x29<<16)
#define TCU_EVENT_ID_BCPU_TCU_IRQ1  (0x2A<<16)
#define TCU_EVENT_ID_XCPU_TCU_IRQ0  (0x2B<<16)
#define TCU_EVENT_ID_XCPU_TCU_IRQ1  (0x2C<<16)
#define TCU_EVENT_ID_WAKEUP_DONE    (0x2D<<16)
