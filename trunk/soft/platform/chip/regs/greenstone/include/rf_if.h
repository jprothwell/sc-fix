...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/greenstone/include/rf_if.h $                                                                   
//    $Author: admin $                                                                    
...
/// 
// =============================================================================
#define REG_RF_IF_BASE              0x00AC6000
...
#define RF_IF_DIGRF_SHIFT_SAMPLE(n) (((n)&7)<<28)
#define RF_IF_DIGRF_NB_BIT_SELECT   (1<<31)

//Status
#define RF_IF_RX_FIFO_LEVEL(n)      (((n)&7)<<0)
#define RF_IF_TX_FIFO_LEVEL(n)      (((n)&31)<<3)
...
//Rx_Offset
#define RF_IF_RX_OFFSET_I(n)        (((n)&0x1FFF)<<0)
#define RF_IF_RX_OFFSET_Q(n)        (((n)&0x1FFF)<<16)
