#ifndef _GRANITE_IP_CONFIG_ASM_H_
#define _GRANITE_IP_CONFIG_ASM_H_

//THIS FILE HAS BEEN GENERATED WITH COOLWATCHER. PLEASE EDIT WITH CARE !

#ifndef CT_ASM
#error "You are trying to use in a normal C code the assembly H description of 'granite_ip_config'."
#endif
