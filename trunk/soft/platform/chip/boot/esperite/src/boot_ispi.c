...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/boot/esperite/src/boot_ispi.c $
//  $Author: admin $                                                         
...
PUBLIC VOID boot_IspiOpen(CONST BOOT_ISPI_CFG_T* spiConfigPtr)
{
    ...
    cfgReg |= SPI_CLOCK_DIVIDER(clkDivider) | SPI_CLOCK_LIMITER;  
