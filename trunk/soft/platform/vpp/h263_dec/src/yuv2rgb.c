...
*/
  ...
  int  i;
	...
	r_2_pix_alloc = (short *) 0x80c068b0;//h263_myMalloc (1024 * sizeof (short));
	g_2_pix_alloc = (short *) 0x80c070b0;//h263_myMalloc (1024 * sizeof (short));
	b_2_pix_alloc = (short *) 0x80c078b0;//h263_myMalloc (1024 * sizeof (short));
