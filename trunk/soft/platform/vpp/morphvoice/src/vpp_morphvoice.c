...
#include "vpp_morphvoice.h"
#include "vppp_morphvoice.h"
#include "vppp_morphvoice_asm.h"
#include "vppp_morphvoice_map.h"
...
PUBLIC VOID vpp_HelloCfg(VPP_MORPHVOICE_CFG_T* pCfg)
{
    ...
    *((VPP_MORPHVOICE_CFG_T*)hal_VocGetPointer(VPP_HELLO_CFG_STRUCT)) = *pCfg;
}
