...
//	voc_short ReservedX_ADDR,  (628+818+118-6),x
   ...
   voc_short  STATIC_CONST_bitno_MRDTX_ADDR	       ,3    ,x
	...
	voc_short ReservedX4_ADDR,    (2+720+8-32-32-38-480-4-15*6-16),x
...
voc_struct_end
	...
	voc_word GLOBAL_MORPH_CONSTY_ADDR __attribute__((export)),y
	...
	voc_short GLOBAL_RESERVE_ADDR[381-5-160-2-10-4-8-4-18-4-4-5-1-4-6-130-2-4-6+10-4-2]				,y
...
/*
  ...
  */
    ...
    voc_short Reserved2_ADDR,           (300-8-8-32-160-80),    y
	...
	voc_short GLOBAL_NON_CLIP_CROSSZEROINDEX_1[FRAMESIZE/2],y	
...
Coolsand_Encoder_HighPass:
	...
	VoC_bnez16_d(Coolsand_Encoder_MicDigitalGain,AGC_ENABLE_FLAG_ADDR);
...
Coolsand_Encoder_MicDigitalGain:


	//Auto gain controlling
	VoC_bez16_d(Coolsand_Encoder_Agc,AGC_ENABLE_FLAG_ADDR);
		VoC_jal(Coolsand_Agc);
Coolsand_Encoder_Agc:

	//Morph		
	VoC_bez16_d(Coolsand_Encoder_Morph,MORPHVOICE_ENABLE_FLAG_ADDR)
		VoC_jal(Coolsand_Morph);
	VoC_jump(Coolsand_Encoder_Aec);
Coolsand_Encoder_Morph:
...
Coolsand_Encoder_Aec:
	...
	VoC_bez16_d(Coolsand_Encoder_NoiseSuppress,NOISE_SUPPRESSER_ENABLE_FLAG_ADDR)
		VoC_jal(Coolsand_NoiseSuppresser);
Coolsand_Encoder_NoiseSuppress:

		VoC_jal(CII_ECHO_MAIN);
...
CII_DECODER_L1:
			...
			VoC_bnez16_d(CII_DECODER_L2,GLOBAL_BFI_ADDR)
			VoC_bnez16_d(CII_DECODER_L2,GLOBAL_SID_ADDR)
...
// VoC_directive: PARSER_OFF
	...
	printf("CrossZeroConter:%d  ",REGS[7].reg);
// VoC_directive: PARSER_ON	
...
/*		VoC_lw16i_short(INC0,1,DEFAULT);
	...
	Coolsand_NonClipDigitalGain_L6:
			...
			VoC_bngt16_rd(Coolsand_NonClipDigitalGain_L7,REG7,GLOBAL_DIGITAL_MAXVALUE_ADDR)
