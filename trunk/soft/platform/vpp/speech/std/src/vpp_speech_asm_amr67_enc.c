...
/*after popping alp16 a more pop16 is needed*/
	...
	VoC_lw16i(REG3,0x4000);	//reg3:&double_1_2 COSNT_1_2_ADDR
 ...
 VoC_jal		(COMPUTE_ALP1_M67_2);
	...
	VoC_mac32_rd	(REG7,CONST_D_1_4_ADDR);
	VoC_sw16_sd	(REG4,3,DEFAULT);
...
SEARCH_COPY_label_end:
	...
	VoC_lw16i(REG3,_1_16);					//reg7:_1_16
...
//	VoC_lw32_d(REG67,CONST_D_1_8_ADDR);	//reg3:&double_1_8
	...
	VoC_loop_i(1,8)
	    ...
	    VoC_multf32inc_rp(ACC0,REG3,REG0,DEFAULT);
	...
	// end of CII_cbseach_clear_CODE_67
 	...
 	VoC_loop_i(0,3);
	   ...
	   VoC_lw16i(REG4,0x199a);
		VoC_multf16_rp(REG6,REG4, REG0, DEFAULT);  //REG6   index
...
G_PITCH_NORM_L_3_1_67:
	VoC_loop_i_short(31,DEFAULT)
		VoC_startloop0
			VoC_bnlt32_rd(G_PITCH_NORM_L_3_EXIT_67,ACC0,CONST_0x40000000_ADDR)
				VoC_shr32_ri(ACC0,-1,DEFAULT);
	            VoC_inc_p(REG2,IN_PARALLEL);
