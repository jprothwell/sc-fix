...
//	VoC_lw16i_short(REG0,1,DEFAULT);   move this to the end of function  CII_lpc_M122
...
void CII_build_code_M122 (void)
{
  ...
  VoC_lw16i_short(INC3,1,IN_PARALLEL);
	...
	VoC_loop_i(0,10)
		...
		VoC_multf16_pd(REG6, REG0, CONST_0x199a_ADDR);  // 6554 ,REG6   index
