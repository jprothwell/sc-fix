...
#define TGT_HAL_GPO_4_USED 1 //SEN_PWDN0
// GPO(5)   // GPO_5 KEYOUT_7, USB_RX_DM
#define TGT_HAL_GPO_5_USED 0 //KEYOUT_7
// GPO(6)   // PWL_1, CLK_32K
#define TGT_HAL_GPO_6_USED 1 //CLASS_K_AUDIO_PA_EN
...
// GPO(11)  // LCD_CS1
#define TGT_HAL_GPO_11_USED 1 //LCD_RST
// -----------------------------------------------------------------------------
...
// TCO(2)   // GPO_10
#define TGT_HAL_TCO_2_USED 1 //CTR0
// TCO(3)   // GPO_8
#define TGT_HAL_TCO_3_USED 1 //CTR1
// TCO(4)   // GPO_9
#define TGT_HAL_TCO_4_USED 1 //CTR2
// TCO(5)   // I2S_DO
#define TGT_HAL_TCO_5_USED 0 //BT_PCMOUT
// TCO(6)   // 
...
{                                                                       \
    ...
    .camRstActiveH      = FALSE,                                        \
    .camPdnActiveH      = TRUE,                                         \
    .camPdnRemap        = { .gpioId  = HAL_GPO_4},                      \
    .camRstRemap        = { .gpioId  = HAL_GPIO_NONE},                  \
    .cam1Used           = TRUE,                                         \
    .cam1RstActiveH     = FALSE,                                        \
    .cam1PdnActiveH     = TRUE,                                         \
    .cam1PdnRemap       = { .gpioId  = HAL_GPO_1},                      \
...
{                                                                         \
    ...
    KP_U,       KP_SL,      KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
    ...
    {                                                                   \
        ...
        {                                                               \
            ...
            { /* PMD_LEVEL_LED0         : LED0 Light level */           \
                ...
                .ldo            = { .pin = { .gpoId = HAL_GPIO_6 }},    \
                .powerOnState   = 0,                                    \
            },                                                          \
            { /* PMD_LEVEL_LED1         : LED1 Light level */           \
                .type           = PMD_LEVEL_TYPE_LDO,                   \
                .ldo            = { .pin = { .gpoId = HAL_GPIO_7 }},    \
                .powerOnState   = 0,                                    \
            },                                                          \
            { /* PMD_LEVEL_LED2         : LED2 Light level */           \
                .type           = PMD_LEVEL_TYPE_LDO,                   \
                .ldo            = { .pin = { .gpoId = HAL_GPIO_8 }},    \
                .powerOnState   = 0,                                    \
            },                                                          \
