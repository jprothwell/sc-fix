...
#define KEY_MAP                                                         \
{                                                                       \
    KP_1	,KP_2		,KP_3	            ,KP_SND	            ,KP_SL	,  KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,      \
    KP_4	      ,KP_5	      ,KP_6		      ,KP_SR	            ,KP_UP	,   KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,          \
    KP_7	,KP_8		,KP_9		      ,KP_OK		      ,KP_DW	,  KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,           \
    KP_STAR	,KP_0		,KP_POUND		,KP_RT	             ,KP_LT	,  KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,            \
