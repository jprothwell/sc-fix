...
#define TGT_HAL_GPIO_6_USED AS_GPIO //GPIO_6 hc113_g_sensor 
// GPIO(7)  // UART2_RTS, UART1_RI
#define TGT_HAL_GPIO_7_USED AS_GPIO //GPIO_7 hc113_g_sensor
// GPIO(8)  // UART2_RXD, UART1_DTR
#define TGT_HAL_GPIO_8_USED AS_GPIO //GPIO_8 hc113_lcd_reset
// GPIO(9)  // KEYOUT_5
...
#define TGT_HAL_GPIO_14_USED AS_GPIO//hc113 bt led en
// GPIO(15) // SPI1_DIO
...
#define TGT_HAL_GPO_0_USED 0 //KEYOUT_6 hc113 as keyout6
...
// GPO(6)   // PWL_1, CLK_32K
#define TGT_HAL_GPO_6_USED 1
// GPO(7)   // TCO_1, DIGRF: CLK_RF_26M_EN
#define TGT_HAL_GPO_7_USED 0
// GPO(8)   // TCO_3
#define TGT_HAL_GPO_8_USED 1 //hc113 keypad led en
// GPO(9)   // TCO_4
...
{                                                                       \
    ...
    .useLpsCo1          = FALSE,                                        \
    .keyInMask          = 0x1f,                                         \
    .keyOutMask         = 0x3f, /*KEYOUT_5/GPIO_9 used by BT*/          \
...
#define KEY_MAP                                                             \
{                                                                           \
    KP_SL,            KP_UP ,          KP_SR,     KP_RT,      KP_DEL ,      KP_UNMAPPED,\
    KP_STAR  ,      KP_7  ,           KP_4,       KP_1,        KP_F0,      KP_UNMAPPED,\
    KP_0 ,             KP_8 ,            KP_5,       KP_2,         KP_DW,     KP_UNMAPPED,\
    KP_POUND,     KP_9,              KP_6,      KP_3,         KP_END,    KP_UNMAPPED,\
    KP_OK,            KP_BACK,       KP_LT,     KP_UNMAPPED,      KP_UNMAPPED,      KP_UNMAPPED,\
    KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED \
} // KP_BACK is used for SIM1 call, KP_DEL is used for SIM2 call
#endif
#if 1
#define KEY_MAP                                                           \
	{																		  \
		KP_SL,		KP_LT,		KP_BACK,	KP_DEL, 		KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
		KP_UP,		KP_OK,		KP_DW,		KP_VU,			KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
		KP_SR,		KP_RT,		KP_SMS, 	KP_VD,			KP_UNMAPPED,		KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
    ...
    {                                                                   \
        ...
        {                                                               \
            ...
            { /* PMD_LEVEL_LOUD_SPEAKER : loudspeaker gain */           \
                .type           = PMD_LEVEL_TYPE_NONE,                  \
                .ldo            = { .opal = PMD_LDO_NONE},              \
                .powerOnState   = 13,  /* (13-1)*2dB-6dB=18dB */        \
            },                                                          \
        },                                                              \
        .lightLevelToRda1203 = {    0x8588, 0x8788, 0x8988, 0x8b88,     \
								0x8c88, 0x8d88, 0x8e88, 0x8f88},        \
        .lightLevelToPwm0 = {   0,  32,  32,  32,  32,  48,  64, 255},  \
