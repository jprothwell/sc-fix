...
#define KEY_MAP                                                           \
{                                                                         \
    KP_POUND, KP_OK, KP_4, KP_SND, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_VU, KP_0, KP_5, KP_2, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_LT, KP_8, KP_7, KP_3, KP_1, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_ENTER, KP_UP, KP_9, KP_6, KP_BACK, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_DW, KP_VD, KP_F0, KP_STAR, KP_RT, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
