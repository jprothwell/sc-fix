...
// GPIO(3)  // HST_RTS
#define TGT_HAL_GPIO_3_USED NOT_CONNECTED
// GPIO(4)  // LPSCO_1
...
#define KEY_MAP                                                           \
{                                                                         \
    KP_STAR,		KP_7, 			KP_4, 			KP_1, 			KP_UP ,			KP_F6, 		KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_0   , 		KP_8, 			KP_5, 			KP_2, 			KP_DW ,			KP_F2, 			KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_POUND,		KP_9,			KP_6, 			KP_3, 			KP_RT,			KP_F3, 			KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_DEL, 		KP_SR, 			KP_F5,			KP_OK,			KP_LT , 		KP_SL, 			KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_BACK, 		KP_F1, 			KP_F0,	        KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, \
    ...
    {                                                                   \
        ...
        {                                                               \
            ...
            { /* PMD_POWER_CAMERA_FLASH : Camera Flash Light enable */  \
                .ldo            = { .pin = {.gpoId = HAL_GPO_6 /*HAL_GPIO_NONE*/}},      \
                .polarity       = TRUE,                                 \
                .shared         = FALSE,                                \
                .powerOnState   = FALSE,                                \
            },                                                          \
        ...
        .lightLevelToPwm0 = {   0,  16,  16,  16,  16,  32,  32, 32},   \
