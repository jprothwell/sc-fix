...
{                                                                       \
    ...
    .useLpsCo1          = FALSE,                                        \
    .keyInMask          = 0x7f,                                         \
    .keyOutMask         = 0xff, /*KEYOUT_5/GPIO_9 used by BT*/          \
...
#define KEY_MAP                                                         \
{                                                                       \
    KP_BACK	,KP_Q		,KP_A      	,KP_Z	    ,KP_SL	            ,KP_SR           ,KP_BACK,     KP_UNMAPPED,          \
    KP_DEL	,KP_W	        ,KP_S		,KP_X	    ,KP_SHIFT	            ,KP_SR           ,KP_DW,     KP_UNMAPPED,     \
    KP_DEL	,KP_E		,KP_D		,KP_C	    ,KP_CTRL	            ,KP_P             ,KP_UNMAPPED,     KP_UNMAPPED,   \
    KP_LT         ,KP_1		,KP_4		,KP_7	    ,KP_SPACE	            ,KP_END         ,KP_UNMAPPED,      KP_UNMAPPED, \
    KP_OK	        ,KP_2		,KP_5		,KP_8	    ,KP_UP	            ,KP_ENTER      ,KP_UNMAPPED,      KP_UNMAPPED,  \
    KP_RT	        ,KP_3		,KP_6		,KP_9	    ,KP_SPACE	            ,KP_O             ,KP_O,      KP_UNMAPPED,\
    KP_SMS	,KP_STAR	,KP_POUND	,KP_0	    ,KP_SLASH             ,KP_L              ,KP_UNMAPPED,      KP_UNMAPPED,\
    KP_SMS	,KP_I		,KP_K		,KP_COMMA	,KP_CALENDER    ,KP_STOP            ,KP_UNMAPPED,      KP_UNMAPPED,   \
    KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,	KP_UNMAPPED,  KP_UNMAPPED		\
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .lightLevelToPwm0 = {   0,  24,  32,  32,  32,  48,  64, 88},  \
