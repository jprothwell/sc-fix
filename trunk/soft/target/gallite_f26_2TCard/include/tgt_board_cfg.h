...
{                                                                       \
    ...
    KP_SND	,KP_SR		,KP_UNMAPPED		,KP_OK	             ,KP_LT	,  KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,            \
    KP_MUSIC_PREV	,KP_SL		,KP_MUSIC	,KP_MUSIC_PLAY	,KP_MUSIC_NEXT ,KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED,             \
...
#ifdef TGT_WITH_MCD_IF_sdmmc_spi
// =============================================================================
// MCD config
// -----------------------------------------------------------------------------
/// @Elem HAL_SPI_CS0
