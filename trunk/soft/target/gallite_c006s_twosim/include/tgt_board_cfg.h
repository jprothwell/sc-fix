...
// GPIO(20) // UART1_CTS
#define TGT_HAL_GPIO_20_USED AS_GPIO
// GPIO(21) // UART1_RTS
...
{                                                                       \
    ...
    .spiCamPinOverflowM = { .gpoId = HAL_GPIO_3 },                      \
    .spiCamPinOverflowS = { .gpoId = HAL_GPIO_2 },                      \
}
#else
#define TGT_CAMD_CONFIG                                                 \
{                                                                       \
