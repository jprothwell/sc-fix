...
#define KEY_MAP                                                           \
{                                                                         \
    KP_STAR,		KP_7, 			KP_4, 			KP_1, 			KP_UP ,		KP_MUSIC_NEXT, 		KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_0   , 		KP_8, 			KP_5, 			KP_2, 			KP_DW ,			KP_MUSIC, 			KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_POUND,		KP_9,			KP_6, 			KP_3, 			KP_RT,		KP_MUSIC_PLAY, 			KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_DEL, 		KP_SR, 			KP_BACK,		KP_OK,			KP_LT , 		KP_MUSIC_PREV, 			KP_UNMAPPED, 	KP_UNMAPPED, \
    KP_QQ, 			KP_SL, 			KP_UNMAPPED,	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, 	KP_UNMAPPED, \
