...
// =============================================================================
#ifdef TGT_WITH_MCD_IF_spi_dual
...
#define KEY_MAP                                                           \
{                                                                         \
    KP_SL,KP_UP, KP_SR, KP_RT, KP_DEL, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_STAR, KP_7, KP_4, KP_1, KP_F0, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_0, KP_8, KP_5, KP_2, KP_DW, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_POUND, KP_9, KP_6, KP_3, KP_END, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
    KP_OK, KP_BACK, KP_LT, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, KP_UNMAPPED, \
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .lightLevelToRda1203 = {    0x8088, 0x8188, 0x8488, 0x8488,     \
                            0x8488, 0x8488, 0x8488, 0x8488},            \
...
/// @todo FIXME GPIO should not be needed here anymore
// =============================================================================
#ifndef TGT_MCD_CONFIG
#define TGT_MCD_CONFIG                                                  \
    {                                                                   \
        .usedSpiId = HAL_SPI_2,                                         \
        .usedSpiCs0 = HAL_SPI_CS0,                                      \
        .usedSpiCs1 = HAL_SPI_CS1,                                       \
        .tmpGpioOverCs0 =   HAL_GPIO_27,                                 \
        .tmpGpioOverCs1 = HAL_GPIO_26,                                  \
