...
// GPIO(4)  // LPSCO_1
#define TGT_HAL_GPIO_4_USED AS_GPIO   //LCD_RST
// GPIO(5)  // UART2_CTS, UART1_DSR
#define TGT_HAL_GPIO_5_USED AS_GPIO //HANDSET_DET
// GPIO(6)  // UART2_TXD, UART1_CD
#define TGT_HAL_GPIO_6_USED NOT_CONNECTED //GPIO_6 //? NOT_CONNECTED
// GPIO(7)  // UART2_RTS, UART1_RI
#define TGT_HAL_GPIO_7_USED AS_GPIO //GPIO_7 EINT_FLIP
// GPIO(8)  // UART2_RXD, UART1_DTR
#define TGT_HAL_GPIO_8_USED NOT_CONNECTED //GPIO_8 //?NOT_CONNECTED
// GPIO(9)  // KEYOUT_5
...
// GPIO(12) // SPI1_CLK
#define TGT_HAL_GPIO_12_USED AS_ALT_FUNC //OLED_CLK
// GPIO(13) // SPI1_CS0
#define TGT_HAL_GPIO_13_USED NOT_CONNECTED 
// GPIO(14) // SPI1_CS1, I2C3_SDA
#define TGT_HAL_GPIO_14_USED AS_ALT_FUNC  //OLED_CS
// GPIO(15) // SPI1_DIO
#define TGT_HAL_GPIO_15_USED AS_ALT_FUNC  //OLED_DO
// GPIO(16) // SPI1_DI, I2C3_SCL
#define TGT_HAL_GPIO_16_USED AS_ALT_FUNC  //OLED_DI
// GPIO(17) // I2S_BCK
...
// GPIO(22) // M_CS2
#define TGT_HAL_GPIO_22_USED AS_GPIO	// G_SENSOR_SCL
// GPIO(23) // M_CS3
#define TGT_HAL_GPIO_23_USED AS_GPIO  // G_SENSOR_SDA
...
// GPO(11)  // LCD_CS1
#define TGT_HAL_GPO_11_USED 0 //LCD_CS_1
// -----------------------------------------------------------------------------
...
// TCO(5)   // I2S_DO
#define TGT_HAL_TCO_5_USED 0 //I2S_DO ?
// TCO(6)   // 
...
#define KEY_MAP                                                           \
{                                                                         \
    KP_A /***/,    KP_4,       KP_5,       KP_RT,       KP_OK,       KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
    KP_B/*0*/,    KP_7,       KP_6,       KP_D /* Temp*/,       KP_LT,       KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
    KP_C/*#*/,    KP_8,       KP_3,       KP_SR,       KP_SND,       KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
    KP_STAR,    KP_9,       KP_2,       KP_DW,       KP_SL, KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
    KP_0,    KP_POUND,       KP_1,       KP_END,       KP_UP, KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
    KP_VD,KP_UNMAPPED,KP_VD,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED,KP_UNMAPPED, \
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .lightLevelToRda1203 = {    0x8088, 0x8188, 0x8388, 0x8488,     \
                            0x8588, 0x8688, 0x8788, 0x8888},            \
...
#define TGT_TSD_CONFIG                                                  \
    {                                                                   \
        .penGpio        = HAL_GPIO_0,                                   \
        .debounceTime   = 15*HAL_TICK1S/1000,                            \
        .downPeriod     = 1,                                            \
        .upPeriod       = 1,                                            \
        .maxError       = 0x50                                          \
    }
