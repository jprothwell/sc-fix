...
{   /* SAMPLE Line
	 ...
	 */
    {FSSIM_SYSTEM_DRIVE, 0, 1, FS_DEVICE_TYPE_NOR, FSSIM_BYTES_PER_SECTOR, FSSIM_SECTORS_PER_CLUSER, 4096, 0, 0},        /* 8M */
    {FSSIM_SYSTEM_DRIVE + 1, 0, 0, FS_DEVICE_TYPE_NAND, FSSIM_BYTES_PER_SECTOR, FSSIM_SECTORS_PER_CLUSER, 262144, 0, 0}, /* 512M */
    {FSSIM_SYSTEM_DRIVE + 2, 0, 0, FS_DEVICE_TYPE_CARD, FSSIM_BYTES_PER_SECTOR, FSSIM_SECTORS_PER_CLUSER, 262144, 0, 0}  /* 512M */
};
