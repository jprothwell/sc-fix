...
{
	U8 level;
	analogtv_button bright_dec;
	analogtv_button bright_inc;
	U16 level_imgid[MAX_VOL_LEVEL];
}analogtv_button_bright;
...
typedef struct
{
	...
	analogtv_button bright_dec;
	analogtv_button bright_inc;
	analogtv_static_pic bright_indication;
}analogtv_brightness_ctrl;
