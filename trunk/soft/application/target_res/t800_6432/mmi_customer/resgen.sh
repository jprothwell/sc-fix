...
rm -f $SOFT_WORKDIR/application/CoolSimulator/Bin/PhoneSkins/bmp176x220/bmp176x220.xml
cp $CUSTRES_DIR/../include/bmp176x220.xml $SOFT_WORKDIR/application/CoolSimulator/Bin/PhoneSkins/bmp176x220/bmp176x220.xml
