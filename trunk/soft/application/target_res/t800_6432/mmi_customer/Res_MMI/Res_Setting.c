...
void populateManageCalls()
{
	...
	ADD_APPLICATION_MENUITEM((MENU8237_SCR8093_MNGCALL_MENU_MAIN,MAIN_MENU_CALL_CENTER,
#ifdef __MMI_MULTI_SIM__
				6 + MMI_SIM_NUMBER,
...
void PopulatePhoneSetupResData(void)
{
...
#if !(((defined(__MMI_MULTI_SIM__))&&(defined( __MMI_MAINLCD_128X160__)))||defined(__MMI_NOKIA_STYLE_N800__))                              
    ...
    ADD_APPLICATION_MENUITEM((MITEM113_PBOOK_SPEED_DIAL, MENU_SETTING_SPEED_DIAL, 0,
		...
		ADD_APPLICATION_MENUITEM((MENU_SETTING_2D_SENSOR_SWITCH,MENU9102_INITIAL_SETUP,2,
		                        MENU_SETTING_2D_SENSOR_ON,MENU_SETTING_2D_SENSOR_OFF,
						SHOW, MOVEABLEWITHINPARENT , DISP_LIST,STR_SETTING_2D_SENSOR,0));
...
void PopulateDisplayChar(void)
{
    ...
    ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_THEME_WALLPAPER, CUST_IMG_PATH "/MainLCD/IdleScreen/Wallpaper/WALL01.jpg", "wallpaper download");
    ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_THEME_SCREENSAVER, CUST_IMG_PATH "/MainLCD/IdleScreen/Wallpaper/WALL01.jpg", "wallpaper download");
#endif 
   ...
   // ADD_APPLICATION_STRING2(STR_ID_SUB_WP_FRAME_ERR, "Image error: Frame > 20", "User defined wallpaper error message");
...
#endif 
#ifdef __MMI_THEMES_V2_SUPPORT__
    ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_THEME_WALLPAPER, CUST_IMG_PATH "/MainLCD/IdleScreen/WallPaper/WALL01.jpg", "Image associated with screen saver.");
    ADD_APPLICATION_IMAGE2(IMG_ID_DISPCHAR_THEME_SCREENSAVER, CUST_IMG_PATH "/MainLCD/IdleScreen/WallPaper/WALL01.jpg", "Image associated with screen saver.");
#endif 
	...
	ADD_APPLICATION_IMAGE3(IMG_ID_PHNSET_OFF_ANIMATION_DEFAULT1,CUST_IMG_PATH"/MainLCD/Active/poweronoff/pooff.gif","Power OFF image");
        ...
        ADD_APPLICATION_IMAGE2(
            ...
            CUST_IMG_PATH "/SubLCD/WallPaper/WALL03.jpg",
            "Image associated with wallpaper.");
        ADD_APPLICATION_IMAGE2(
...
void populateSecuritySetup(void)
{
...
#ifdef __MMI_VIP_FUNCTION__
	ADD_APPLICATION_MENUITEM((MENU_SETTING_VIP_FUNCTION, MENU9101_SECURITY, 2,
								MENU_SETTING_VIP_STATUS,
								MENU_SETTING_VIP_LIST,
								SHOW, MOVEABLEACROSSPARENT | INSERTABLE | SHORTCUTABLE, DISP_LIST, STR_VIP_SETTING,IMG_SETTING_SECURITY));

	ADD_APPLICATION_MENUITEM((MENU_SETTING_VIP_STATUS, MENU_SETTING_VIP_FUNCTION, 0,
								SHOW, MOVEABLEACROSSPARENT | INSERTABLE | SHORTCUTABLE, DISP_LIST, STR_VIP_STATUS,IMG_SETTING_SECURITY));

	ADD_APPLICATION_MENUITEM((MENU_SETTING_VIP_LIST, MENU_SETTING_VIP_FUNCTION, 0,
								SHOW, MOVEABLEACROSSPARENT | INSERTABLE | SHORTCUTABLE, DISP_LIST, STR_VIP_LIST,IMG_SETTING_SECURITY));
	ADD_APPLICATION_MENUITEM((MENU_SETTING_VIP_EDIT_OPT, 0, 2,
								MENU_SETTING_VIP_EDIT,
								MENU_SETTING_VIP_ERASE,
								SHOW, MOVEABLEACROSSPARENT | INSERTABLE | SHORTCUTABLE, DISP_LIST, STR_GLOBAL_OPTIONS, IMG_SETTING_SECURITY));
	ADD_APPLICATION_MENUITEM((MENU_SETTING_VIP_EDIT, MENU_SETTING_VIP_EDIT_OPT, 0,
								SHOW, MOVEABLEACROSSPARENT | INSERTABLE | SHORTCUTABLE, DISP_LIST, STR_GLOBAL_EDIT, IMG_SETTING_SECURITY));
	ADD_APPLICATION_MENUITEM((MENU_SETTING_VIP_ERASE, MENU_SETTING_VIP_EDIT_OPT, 0,
								SHOW, MOVEABLEACROSSPARENT | INSERTABLE | SHORTCUTABLE, DISP_LIST, STR_GLOBAL_CLEAR, IMG_SETTING_SECURITY));
	ADD_APPLICATION_STRING2(STR_VIP_SETTING, "VIP Setting", "VIP Setting");
	ADD_APPLICATION_STRING2(STR_VIP_STATUS, "VIP Status", "VIP Status");
	ADD_APPLICATION_STRING2(STR_VIP_LIST, "VIP List", "VIP List");
	ADD_APPLICATION_STRING2(STR_VIP_PASSWORD_ERROR, "Password error", "Password error");
	ADD_APPLICATION_STRING2(STR_VIP_PASSWORD_NOT_ACCORDANT, "Password not accordant", "Password not accordant");
	ADD_APPLICATION_STRING2(STR_VIP_INPUT_PASSWORD, "Input Password", "Input Password");
	ADD_APPLICATION_STRING2(STR_VIP_CONFIRM_PASSWORD, "Confrim Password", "Confrim Password");
#endif
	...
	for(i = 0; i < MMI_SIM_NUMBER; i++)
	{
		...
		ADD_APPLICATION_MENUITEM((MENU9167_FIXED_DIAL ,MENU9101_SECURITY,2,
					MENU_SETTING_FDL_MODE,
					MENU_SETTING_FDL_LIST,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SIM1_FIXED_DAIL_CAPTION , 0));
		
		ADD_APPLICATION_MENUITEM((MENU9168_BARRED_DAIL  ,MENU9101_SECURITY,2,
					MENU_SETTING_BDL_MODE,
					MENU_SETTING_BDL_LIST,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SIM1_BARRED_DIAL_CAPTION ,0));

		 ADD_APPLICATION_MENUITEM((MENU9169_SIM_LOCK , MENU9101_SECURITY, 0,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST, STRING_MTPNP_CARD1_PINLOCK , 0));
		ADD_APPLICATION_MENUITEM((MENU9167_FIXED_DIAL + 1,MENU9101_SECURITY,2,
					MENU_SETTING_FDL_MODE,
					MENU_SETTING_FDL_LIST,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SIM1_FIXED_DAIL_CAPTION + 1, 0));
		
		ADD_APPLICATION_MENUITEM((MENU9168_BARRED_DAIL + 1 ,MENU9101_SECURITY,2,
					MENU_SETTING_BDL_MODE,
					MENU_SETTING_BDL_LIST,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SIM1_BARRED_DIAL_CAPTION + 1,0));

		 ADD_APPLICATION_MENUITEM((MENU9169_SIM_LOCK + 1, MENU9101_SECURITY, 0,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST, STRING_MTPNP_CARD1_PINLOCK + 1, 0));
		ADD_APPLICATION_MENUITEM((MENU9167_FIXED_DIAL +2,MENU9101_SECURITY,2,
					MENU_SETTING_FDL_MODE,
					MENU_SETTING_FDL_LIST,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SIM1_FIXED_DAIL_CAPTION + 2, 0));
		
		ADD_APPLICATION_MENUITEM((MENU9168_BARRED_DAIL + 2 ,MENU9101_SECURITY,2,
					MENU_SETTING_BDL_MODE,
					MENU_SETTING_BDL_LIST,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STR_SIM1_BARRED_DIAL_CAPTION + 2,0));

		 ADD_APPLICATION_MENUITEM((MENU9169_SIM_LOCK + 2, MENU9101_SECURITY, 0,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST, STRING_MTPNP_CARD1_PINLOCK + 2, 0));
    ...
    #endif
		ADD_APPLICATION_MENUITEM((MENU_ID_GSM_CHANGE_PIN_SELECT_SIM1 ,
									MENU_ID_GSM_CHANGE_PIN_SELECT_SIM, 0,
									SHOW,   MOVEABLEWITHINPARENT,   DISP_LIST,
									STR_ID_UCM_SIM1_VOICE_CALL ,                                
									0));
		ADD_APPLICATION_MENUITEM((MENU_ID_GSM_CHANGE_PIN_SELECT_SIM1 + 1,
									MENU_ID_GSM_CHANGE_PIN_SELECT_SIM, 0,
									SHOW,   MOVEABLEWITHINPARENT,   DISP_LIST,
									STR_ID_UCM_SIM1_VOICE_CALL + 1,                                
									0));
		ADD_APPLICATION_MENUITEM((MENU_ID_GSM_CHANGE_PIN_SELECT_SIM1 +2,
									MENU_ID_GSM_CHANGE_PIN_SELECT_SIM, 0,
									SHOW,   MOVEABLEWITHINPARENT,   DISP_LIST,
									STR_ID_UCM_SIM1_VOICE_CALL + 2,                                
									0));
#endif
...
ADD_APPLICATION_MENUITEM((MENU_MTPNP_DM_SETTING,MAIN_MENU_SETTINGS_MENUID, 4,
				...
				SHOW, MOVEABLEACROSSPARENT, DISP_LIST,STRING_MTPNP_DM_SETTING, IMG_ID_DM_SETTING));
ADD_APPLICATION_IMAGE(IMG_ID_DM_SETTING, CUST_IMG_PATH "/MainLCD/DualSIM/SETUP/DM_SETUP.gif");
#endif
...
#endif /*defined( __MMI_DUAL_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)*/
//[221] Added by Ryh 2009/02/12								[END]
...
#endif
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_CP_PIN1,MENU9170_CHANGE_PASSWORD,0,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STRING_MTPNP_CP_PIN1,0));
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_CP_PIN2,MENU9170_CHANGE_PASSWORD,0,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STRING_MTPNP_CP_PIN2,0));	
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_CP_PIN1+1,MENU9170_CHANGE_PASSWORD,0,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STRING_MTPNP_CP_PIN1+1,0));
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_CP_PIN2+1,MENU9170_CHANGE_PASSWORD,0,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STRING_MTPNP_CP_PIN2+1,0));	
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_CP_PIN1+2,MENU9170_CHANGE_PASSWORD,0,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STRING_MTPNP_CP_PIN1+2,0));
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_CP_PIN2+2,MENU9170_CHANGE_PASSWORD,0,
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,STRING_MTPNP_CP_PIN2+2,0));	
...
for(i = 0; i < MMI_SIM_NUMBER; i++)
{
...
#endif
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_SIM1_CALL_SETTING ,
				MENU8237_SCR8093_MNGCALL_MENU_MAIN,
				4,
				MENU8237_SCR8093_MNGCALL_MENU_WAIT,
				MENU8237_SCR8093_MNGCALL_MENU_FWD,
	...
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_SIM1_CALL_SETTING + 1,
				MENU8237_SCR8093_MNGCALL_MENU_MAIN,
				4,
				MENU8237_SCR8093_MNGCALL_MENU_WAIT,
				MENU8237_SCR8093_MNGCALL_MENU_FWD,
				...
				MENU_LINE_SWCH,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST, 
				STRING_MTPNP_CARD1_CALL_SETTING + 1, 0));
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_NETWORK_SETUP+1,
				MENU_MTPNP_DM_NETWORK_SETUP,
				3,
				MENU9186_SELECTION_MODE,
				MENU9187_PREFERRED_NETWORKS,
				MENU9188_BAND_SELECTION,
				SHOW, MOVEABLEACROSSPARENT, DISP_LIST, STRING_MTPNP_NETWORK_SETUP+1, IMG_SETTING_NETWORK));
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_SIM1_CALL_SETTING + 2,
				MENU8237_SCR8093_MNGCALL_MENU_MAIN,
				4,
				MENU8237_SCR8093_MNGCALL_MENU_WAIT,
				MENU8237_SCR8093_MNGCALL_MENU_FWD,
				...
				MENU_LINE_SWCH,
				SHOW, MOVEABLEWITHINPARENT, DISP_LIST, 
				STRING_MTPNP_CARD1_CALL_SETTING + 2, 0));
	ADD_APPLICATION_MENUITEM((MENU_MTPNP_NETWORK_SETUP+2,
				MENU_MTPNP_DM_NETWORK_SETUP,
				3,
				MENU9186_SELECTION_MODE,
				MENU9187_PREFERRED_NETWORKS,
				MENU9188_BAND_SELECTION,
				SHOW, MOVEABLEACROSSPARENT, DISP_LIST, STRING_MTPNP_NETWORK_SETUP+2, IMG_SETTING_NETWORK));
...
/* under construction !*/
    ...
    ADD_APPLICATION_IMAGE2(
        ...
        CUST_IMG_PATH "/MainLCD/Call/CallCenter/CC_setting.gif",
...
void PopulateIPNumber(void)
{
    ...
    #endif
	ADD_APPLICATION_MENUITEM((MENU_IP_NUM_ACTIVATE , MENU_SETTING_IP_NUM_OPN, 0,
							0, NONMOVEABLE, 1, 
							#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
							...
							#endif
							NULL));
	ADD_APPLICATION_MENUITEM((MENU_IP_NUM_ACTIVATE + 1, MENU_SETTING_IP_NUM_OPN, 0,
							0, NONMOVEABLE, 1, 
							#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
							STRING_MASTER_IP_ACTIVATE + 1,
							#else
							STR_GLOBAL_ACTIVATE, 
							#endif
							NULL));
	ADD_APPLICATION_MENUITEM((MENU_IP_NUM_ACTIVATE + 2, MENU_SETTING_IP_NUM_OPN, 0,
							0, NONMOVEABLE, 1, 
							#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
							STRING_MASTER_IP_ACTIVATE + 2,
							#else
							STR_GLOBAL_ACTIVATE, 
							#endif
							NULL));
...
#if !defined(__MMI_RESOURCE_SLIM_ON_128X160__)
ADD_APPLICATION_IMAGE3(WALLPAPER_3,CUST_IMG_PATH"/MainLCD/IdleScreen/WallPaper/WALL03.jpg","Wallpaper image");
#if !defined (__MMI_RESOURCE_SLIM__)
