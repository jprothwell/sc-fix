...
void PopulateChgrPwrOnScrRes()
{
	...
	ADD_APPLICATION_IMAGE2(IMG_BATTERY_FULL_CHARGED,CUST_IMG_PATH"/MainLCD/UIELEMENT/charger/CHARGF.png","	Image Associated with Charger Fully charged");
#endif
...
void PopulateQuickAccessData(void)
{
	...
	ADD_APPLICATION_IMAGE2(IMG_KPAD_SCR_UNLOCKED_HELP_MESSAGE,CUST_IMG_PATH"/MainLCD/Warningpage/notification/N_KEY.gif","Img Associated with Keypad Lock Help Message Screen.");
...
//qiff append extra menu to no sim menu
	...
	ADD_APPLICATION_MENUITEM((MENU_SIM_OPTION_ID,0,7,
				MAIN_MENU_PHONEBOOK_NO_SIM_MENUID,
				MAIN_MENU_SETTINGS_MENUID_NO_SIM,
				MAIN_MENU_MULTIMEDIA_MENUID,
				MAIN_MENU_FILE_MNGR_MENUID,
...
//	ADD_APPLICATION_STRING2(STR_ENTER_PUK_RSK, "SOS", "Make SOS Calls.");
	...
	ADD_APPLICATION_IMAGE2(IMG_WELCOME_SCR,	CUST_IMG_PATH "/MainLCD/Active/poweronoff/logo.png","Img Associated with Welcome Screen.");
	#else
...
#if 0
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_PHONEBOOK_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_PB.gif", "phonebook icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_MESSAGES_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_MG.gif", "message icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_FUNANDGAMES_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_FG.gif", "fun and game icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_ORGANIZER_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_OR.gif", "organizer icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_SETTINGS_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_ST.gif", "setting icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_PROFILES_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_PR.gif", "profile icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_SHORTCUTS_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_SC.gif", "shortcut icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_SERVICES_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_SV.gif", "service icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_CALL_HISTORY_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_CA.gif", "call history icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_MULTIMEDIA_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_MM.gif", "multimedia icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_FILEMNGR_ICON,	CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_FM.png", "file manager icon for sim option menu");
	ADD_APPLICATION_IMAGE2(IMG_ID_OPTION_MENU_EXTRA_ICON,		CUST_IMG_PATH"/MainLCD/Submenu/NoSIM/NS_EX.gif", "extra icon for sim option menu");
#endif
#endif
}
