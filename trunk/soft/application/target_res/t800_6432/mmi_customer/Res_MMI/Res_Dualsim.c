...
static void Dualsim_StrPopulate(void)
{
    ...
    ADD_APPLICATION_STRING2(STRING_MTPNP_NEW_SLAVE_MESSAGE_FROM_ID, "Slave Message From ",
                            "SMS New Message From String");
    ADD_APPLICATION_STRING2(STRING_MTPNP_NEW_SIM3_MESSAGE_FROM_ID, "SIM3 Message From ",
                            "SMS New Message From String");
    ADD_APPLICATION_STRING2(STRING_MTPNP_NEW_SIM4_MESSAGE_FROM_ID, "SIM4 Message From ",
                            "SMS New Message From String");
    ...
    ADD_APPLICATION_STRING2(STRING_MTPNP_SLAVE_RECEIVED_SMS, "New Slave Message!",
                            "SMS while receiving sms Message String");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM3_RECEIVED_SMS, "New SIM3 Message!",
                            "SMS while receiving sms Message String");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM4_RECEIVED_SMS, "New SIM4 Message!",
                            "SMS while receiving sms Message String");
    ...
    ADD_APPLICATION_STRING2 (STRING_MTPNP_SIM3_DELETE_INBOX_MENUENTRY,	"Delete SIM3 Inbox?",	"SMS Delete SIM2 Inbox Query String");
	ADD_APPLICATION_STRING2 (STRING_MTPNP_SIM3_DELETE_OUTBOX_MENUENTRY,	"Delete SIM3 Outbox?",	"SMS Delete SIM2 Outbox Query String");

    ADD_APPLICATION_STRING2 (STRING_MTPNP_SIM4_DELETE_INBOX_MENUENTRY,	"Delete SIM4 Inbox?",	"SMS Delete SIM2 Inbox Query String");
	ADD_APPLICATION_STRING2 (STRING_MTPNP_SIM4_DELETE_OUTBOX_MENUENTRY,	"Delete SIM4 Outbox?",	"SMS Delete SIM2 Outbox Query String");
	/* sms show end */
    ...
    /* SIM-ME-Lock */
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_ENTER_NP_MSG, "Input SIM1 NP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_ENTER_NSP_MSG, "Input SIM1 NSP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_ENTER_SP_MSG, "Input SIM1 SP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_ENTER_CP_MSG, "Input SIM1 CP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_ENTER_SIMP_MSG, "Input SIM1 SIMP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_ENTER_NSSP_MSG, "Input SIM1 NS-SP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_ENTER_SIMC_MSG, "Input SIM1 SIM-C Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_ENTER_NP_MSG, "Input SIM2 NP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_ENTER_NSP_MSG, "Input SIM2 NSP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_ENTER_SP_MSG, "Input SIM2 SP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_ENTER_CP_MSG, "Input SIM2 CP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_ENTER_SIMP_MSG, "Input SIM2 SIMP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_ENTER_NSSP_MSG, "Input SIM2 NS-SP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_ENTER_SIMC_MSG, "Input SIM2 SIM-C Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_WRONG_NP_MSG, "Wrong SIM1 NP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_WRONG_NSP_MSG, "Wrong SIM1 NSP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_WRONG_SP_MSG, "Wrong SIM1 SP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_WRONG_CP_MSG, "Wrong SIM1 CP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_WRONG_SIMP_MSG, "Wrong SIM1 SIMP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_WRONG_NSSP_MSG, "Wrong SIM1 NS-SP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_WRONG_SIMC_MSG, "Wrong SIM1 SIM-C Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_WRONG_NP_MSG, "Wrong SIM2 NP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_WRONG_NSP_MSG, "Wrong SIM2 NSP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_WRONG_SP_MSG, "Wrong SIM2 SP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_WRONG_CP_MSG, "Wrong SIM2 CP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_WRONG_SIMP_MSG, "Wrong SIM2 SIMP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_WRONG_NSSP_MSG, "Wrong SIM2 NS-SP Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_WRONG_SIMC_MSG, "Wrong SIM2 SIM-C Code", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_AUTO_LOCKED, "SIM1 auto locked", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM2_AUTO_LOCKED, "SIM2 auto locked", "SIM-ME-Lock");
    ADD_APPLICATION_STRING2(STRING_MTPNP_SIM1_SIM2_AUTO_LOCKED, "SIM1 and SIM2 auto locked", "SIM-ME-Lock");
	...
	ADD_APPLICATION_STRING2(STRING_MTPNP_SIM3_NOT_AVAILABLE, "SIM3 not available", "SIM3 not available");
   ...
   ADD_APPLICATION_STRING2(STRING_MASTER_IP_DEACTIVATE, "Deactive Master", "Deactive Slave");
    ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_1, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_1.bmp", "master ip");
    ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_2, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_2.bmp", "slave ip");
    ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_12, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_12.bmp","both ip");
#endif
...
void Dualsim_ResPopulate(void)
{
...
#else
    ADD_APPLICATION_IMAGE2(IMG_STORAGE_SIM_1,
                           CUST_IMG_PATH "/MainLCD/Phonebook/PBView/storage_sim_1.gif",
                           "IMG_STORAGE_SIM_1");
#endif /* __MMI_DUAL_SIM_SINGLE_OPENED_ */
    ADD_APPLICATION_IMAGE2(IMG_STORAGE_SIM_2,
                           CUST_IMG_PATH "/MainLCD/Phonebook/PBView/storage_sim_2.gif",
                           "IMG_STORAGE_SIM_2");
    ...
    ADD_APPLICATION_IMAGE2(IMG_SLAVE_CALL_FORWARD_L1, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Slave/SI_FOR_L1_2.gif",
                           "Status Icon: slave Call Divert L1");
    ADD_APPLICATION_IMAGE2(IMG_SLAVE_CALL_FORWARD_L2, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Slave/SI_FOR_L2_2.gif",
    ...
    ADD_APPLICATION_IMAGE2(IMG_SI_MMS_UNREAD_INDICATOR_SIM1, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/MMS/Master/SI_UNREAD_1.gif",
                           "Status Icon: Master unread mms");

    ADD_APPLICATION_IMAGE2(IMG_SI_MMS_UNREAD_INDICATOR_SIM2, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/MMS/Slave/SI_UNREAD_2.gif",
                           "Status Icon: Slave unread mms");

    ADD_APPLICATION_IMAGE2(IMG_SI_MMS_BUSY_INDICATOR_SIM1, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/MMS/Master/SI_BUSY_1.gif",
                           "Status Icon: Master unread mms");

    ADD_APPLICATION_IMAGE2(IMG_SI_MMS_BUSY_INDICATOR_SIM2, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/MMS/Slave/SI_BUSY_2.gif",
                           "Status Icon: Slave unread mms");

    ADD_APPLICATION_IMAGE2(IMG_SI_EDGE_SIM1, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/GPRS/Master/SI_EDGE_SIM1.gif",
    ...
    ADD_APPLICATION_IMAGE2(IMG_SI_EDGEC_SIM1, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/GPRS/Master/SI_EDGEC_SIM1.gif",
    ...
    ADD_APPLICATION_IMAGE2(IMG_SI_EDGE_SIM2, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/GPRS/Slave/SI_EDGE_SIM2.gif",
    ...
    ADD_APPLICATION_IMAGE2(IMG_SI_EDGEC_SIM2, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/GPRS/Slave/SI_EDGEC_SIM2.gif",
                           "Status Icon: Slave EDGEC");
    
    ADD_APPLICATION_IMAGE2(IMG_SI_GPRS_ATT_NO_PDP_INDICATOR_SIM2, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/GPRS/Master/SI_GPRSC_SIM2.bmp",
                           "Status Icon: Slave GPRS_ATT_NO_PDP_INDICATOR");
    ADD_APPLICATION_IMAGE2(IMG_SI_GPRS_ATT_NO_PDP_INDICATOR_SIM3, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/GPRS/Master/SI_GPRSC_SIM3.bmp",
                           "Status Icon: Slave GPRS_ATT_NO_PDP_INDICATOR");
    ADD_APPLICATION_IMAGE2(IMG_SI_GPRS_ATT_NO_PDP_INDICATOR_SIM4, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/GPRS/Master/SI_GPRSC_SIM4.bmp",
                           "Status Icon: Slave GPRS_ATT_NO_PDP_INDICATOR");
    ...
    ADD_APPLICATION_IMAGE2(IMG_SLAVE_LINE_SET_TITLE, CUST_IMG_BASE_PATH "/EmptyImage.bmp", "Image for Line 2 option");

    ADD_APPLICATION_IMAGE2(IMG_MASTER_MESSAGE_READ,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD1/INBOX/SS_READ_1.gif",
                           "read message");
    ADD_APPLICATION_IMAGE2(IMG_MASTER_MESSAGE_UNREAD,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD1/INBOX/SS_UNREAD_1.gif",
                           "unread message");
    ADD_APPLICATION_IMAGE2(IMG_MASTER_MESSAGE_SENT,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD1/OUTBOX/SS_SENT_1.gif",
                           "sent message");
    ADD_APPLICATION_IMAGE2(IMG_MASTER_MESSAGE_UNSENT,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD1/OUTBOX/SS_UNSENT_1.gif",
                           "unsent message");
    ADD_APPLICATION_IMAGE2(IMG_MASTER_MESSAGE_SS_NCOMP,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD1/INBOX/SS_NCOMP_1.gif",
                           "ncomp message");

    ADD_APPLICATION_IMAGE2(IMG_SLAVE_MESSAGE_READ,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD2/INBOX/SS_READ_2.gif",
                           "read message");
    ADD_APPLICATION_IMAGE2(IMG_SLAVE_MESSAGE_UNREAD,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD2/INBOX/SS_UNREAD_2.gif",
                           "unread message");
    ADD_APPLICATION_IMAGE2(IMG_SLAVE_MESSAGE_SENT,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD2/OUTBOX/SS_SENT_2.gif",
                           "sent message");
    ADD_APPLICATION_IMAGE2(IMG_SLAVE_MESSAGE_UNSENT,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD2/OUTBOX/SS_UNSENT_2.gif",
                           "unsent message");
    ADD_APPLICATION_IMAGE2(IMG_SLAVE_MESSAGE_SS_NCOMP,
                           CUST_IMG_PATH "/MainLCD/DualSIM/MESSAGE/CARD2/INBOX/SS_NCOMP_2.gif",
                           "ncomp message");
...
*/
...
#if (MMI_SIM_NUMBER >= 3)
	ADD_APPLICATION_IMAGE2(IMG_SI_CARD3MISSED_CALL_INDICATOR,CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Slave/SI_MCA_3.BMP","Status Icon: Missed Call");
	ADD_APPLICATION_IMAGE2(IMG_STORAGE_SIM_3,CUST_IMG_PATH "/MainLCD/Phonebook/PBView/storage_sim_3.pbm","IMG_STORAGE_SIM_3");
	ADD_APPLICATION_IMAGE2(IMG_SI_CARD3_SIGNAL_CLOSED,CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/Slave/SI_SIG2_CLOSE/SI_SIG_3_CLOSE.bmp", "Slave Status Icon: rf closed");
	ADD_APPLICATION_IMAGE2(IMG_SI_SIM3_SMS_INDICATOR, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Slave/SI_MGE_3.bmp","Status Icon: SIM3 Message");
	ADD_APPLICATION_IMAGE2(IMG_SI_CARD3MISSED_CALL_INDICATOR, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Slave/SI_MCA_3.BMP", "Status Icon: Missed Call");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_3, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_3.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_13, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_13.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_23, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_23.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_123, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_123.bmp", "ip");
#endif
#if (MMI_SIM_NUMBER >= 4)
	...
	ADD_APPLICATION_IMAGE2(IMG_SI_CARD4MISSED_CALL_INDICATOR, CUST_IMG_PATH "/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Slave/SI_MCA_4.BMP", "Status Icon: Missed Call");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_4, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_4.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_14, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_14.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_24, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_24.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_34, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_34.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_124, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_124.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_134, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_134.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_234, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_234.bmp", "ip");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_VICON_1234, CUST_IMG_PATH "/MainLCD/DualSIM/IPdial/IP_1234.bmp", "ip");
#endif
