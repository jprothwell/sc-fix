...
void PopulateExtDevUSBRes(void)
{
    ...
    ADD_APPLICATION_IMAGE2(IMG_USB_POWER_ON,CUST_IMG_PATH"/MainLCD/Active/Poweronoff/USB_noanimation.jpg","Power on with USB boot mode");
    ADD_APPLICATION_IMAGE2(IMG_USB_CHGR_CMPLT,CUST_IMG_PATH"/MainLCD/Active/Poweronoff/USB_ChgrCmplt.jpg","Power on with USB boot mode");
...
void PopulateExtDevBTRes(void)
{
   ...
   /* Image Resource */
   /* Status icon is populate in Res_Gui.c */
	ADD_APPLICATION_IMAGE2(IMG_BT_MENU_TITLE, CUST_IMG_PATH"/MainLCD/Bluetooth/SB_BT.gif","Bluetooth menu icon");
	//ADD_APPLICATION_IMAGE2(IMG_BT_SCH_TITLE, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_Search.gif","Bluetooth menu icon");

	ADD_APPLICATION_IMAGE2(IMG_BT_DEV_MOB, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_MOB.gif","Bluetooth menu icon");
	ADD_APPLICATION_IMAGE2(IMG_BT_DEV_LAP, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_LAP.gif","Bluetooth menu icon");
	ADD_APPLICATION_IMAGE2(IMG_BT_DEV_EAR, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_EAR.gif","Bluetooth menu icon");
	ADD_APPLICATION_IMAGE2(IMG_BT_DEV_OTHER, CUST_IMG_PATH"/MainLCD/Bluetooth/OBT_Other.gif","Bluetooth menu icon");
