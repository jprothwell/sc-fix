...
//qiff add multi-input method support
	...
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_PUNJABI,"Multitap punjabi","Input methods list Option Multitap ES");
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MULTITAP_PUNJABI,"Multitap punjabi","Input methods list Option Multitap es");
#endif
#if defined(__MMI_MULTITAP_TELUGU__)
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_TELUGU,"Multitap telugu","Input methods list Option Multitap ES");
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MULTITAP_TELUGU,"Multitap telugu","Input methods list Option Multitap es");
#endif
	...
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_SMART_TELUGU,"Smart telugu","Input methods list Option Smart telugu");
#endif
...
//qiff add end
	...
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_MARATHI,"Multitap marathi","Input methods list Option Multitap ES");
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MULTITAP_MARATHI,"Multitap marathi","Input methods list Option Multitap es");
#endif
...
//Norwegian end
	...
	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL0,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_SC00.jpg","VOL LEVEL1");
	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL1,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_SC01.jpg","VOL LEVEL1");
	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL2,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_SC02.jpg","VOL LEVEL2");
	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL3,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_SC03.jpg","VOL LEVEL3");
	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL4,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_SC04.jpg","VOL LEVEL4");
	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL5,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_SC05.jpg","VOL LEVEL5");
	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL6,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_SC06.jpg","VOL LEVEL6");
	ADD_APPLICATION_IMAGE2(WGUI_VOLUME_LEVEL7,CUST_IMG_PATH"/MainLCD/UIElement/SlideControls/V_SC07.jpg","VOL LEVEL7");
#endif    
#else
	...
	ADD_APPLICATION_IMAGE2(WGUI_SLIDE_CONTROL_BG_IMAGE_ID,CUST_IMG_PATH"/MainLCD/UIElement/Valuemap/MAP.gif","Background for Slide Control");
...
//For dialing screen
...
#else
	ADD_APPLICATION_IMAGE2(IMG_DIALING_SCREEN,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_SCREEN.png","Image of Dialing Screen");
#endif /* __MMI_DUAL_SIM_SINGLE_OPENED_ */
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_0,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY0.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_1,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY1.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_2,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY2.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_3,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY3.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_4,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY4.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_5,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY5.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_6,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY6.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_7,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY7.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_8,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY8.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_9,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY9.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_HASH,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY_HASH.gif","Image of Dialing Key");
	ADD_APPLICATION_IMAGE2(IMG_DIALING_KEY_STAR,CUST_IMG_PATH"/MainLCD/DialingScreen/TH_DIALING_KEY_STAR.gif","Image of Dialing Key");
	...
	//ADD_APPLICATION_IMAGE2(IMG_SCREEN_ROTATE_BACKGROUND,CUST_IMG_PATH"/MainLCD/UIElement/Horizontal/Rotated_bkgrnd.jpg","Image of rotated background");	
#endif 
...
#if defined( __MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__)||defined( __MMI_MAINLCD_220X176__)||defined( __MMI_MAINLCD_128X160__) 
	ADD_APPLICATION_IMAGE2 (IMG_POPUP_TITLE, CUST_IMG_PATH"/MainLCD/WarningPage/PopUpPage/PP_TB.png","Background image of popup screen");
#endif
#endif
...
#else
	ADD_APPLICATION_IMAGE2 (IMG_SOFTKEY_BAR, CUST_IMG_PATH"/MainLCD/UIElement/softkey/softkey.png","Background image of SOFTKEY");
#endif
#endif
#endif
	...
	ADD_APPLICATION_IMAGE2 (IMG_TITLEBAR_BG, CUST_IMG_PATH"/MainLCD/Titlebar/TB_BG_1.gif","keyboard for password input"); 
	...
	ADD_APPLICATION_IMAGE2(IMG_HORIZONTAL_NORMAL_TAB, CUST_IMG_PATH"/MainLCD/UIElement/TabBar/Tab_Normal.png", "normal tab");
	ADD_APPLICATION_IMAGE2(IMG_HORIZONTAL_FOCUSED_TAB, CUST_IMG_PATH"/MainLCD/UIElement/TabBar/Tab_Focused.png", "focused tab");
	ADD_APPLICATION_IMAGE2(IMG_HORIZONTAL_BLINKING_TAB, CUST_IMG_PATH"/MainLCD/UIElement/TabBar/Tab_Blinking.png", "blinking tab");
	...
	ADD_APPLICATION_IMAGE2(IMG_PERCENTAGE_BAR_LEFT_IMAGE, CUST_IMG_PATH"/MainLCD/UIElement/ProgressBar/load_left.png", "aa");
	ADD_APPLICATION_IMAGE2(IMG_PERCENTAGE_BAR_RIGHT_IMAGE, CUST_IMG_PATH"/MainLCD/UIElement/ProgressBar/load_right.png", "bb");
	ADD_APPLICATION_IMAGE2(IMG_PERCENTAGE_BAR_BG_IMAGE, CUST_IMG_PATH"/MainLCD/UIElement/ProgressBar/load_bg.png", "cc");
...
//	ADD_APPLICATION_IMAGE2(IMG_SI_3G,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_3G.BMP","Status Icon: WCDMA");
	...
	ADD_APPLICATION_IMAGE2(IMG_SI_ROAMING_INDICATOR,CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/DualSIM/Callforward/Master/SI_RM_1.gif","Status Icon: Roaming");
...
//#endif
	...
	ADD_APPLICATION_IMAGE2(WGUI_IMG_TEXT_BG_TOP,CUST_IMG_PATH"/MainLCD/UIElement/TextBG/TBG_TOP.gif","text background top");
    ADD_APPLICATION_IMAGE2(WGUI_IMG_TEXT_BG_MID,CUST_IMG_PATH"/MainLCD/UIElement/TextBG/TBG_MID.gif","text background middle");
    ADD_APPLICATION_IMAGE2(WGUI_IMG_TEXT_BG_BOTTOM,CUST_IMG_PATH"/MainLCD/UIElement/TextBG/TBG_BOTTOM.gif","text background bottom");
#endif
#ifdef __MMI_IRDA_SUPPORT__
	...
	ADD_APPLICATION_IMAGE2(IMG_SI_STOPWATCH,CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/SI_STWATCH.gif","Image for Stopwatch Icon");
		...
		ADD_APPLICATION_IMAGE2(IMG_SI_JAVA_LOGIN,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_QQIM.pbm","Java pause");
#else
...
//	ADD_APPLICATION_IMAGE2(IMG_SI_WMAL,CUST_IMG_PATH"/MainLCD/IdleScreen/StatusIcons/SI_WMAL.bmp","Sub LCD Status Icon: Vibrate then Ring");
	...
	PopulateTabResources();
#endif
#endif //endif __MMI_STYLE_E71_QCIF_S__
}
...
{	
	...
	ADD_APPLICATION_IMAGE(CM3D_COMMON_IMAGE0_IMAGE_ID,CUST_IMG_PATH"/MainLCD/MainMenu/CIRCULAR_3D/CM3D4ball.png");
