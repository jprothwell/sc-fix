...
void PopulateSMSMenu(void)
{
...
#endif
		ADD_APPLICATION_MENUITEM((MESSAGES_MENU_MSG_SETTINGS_MENUID,MESSAGES_MENU_SMS_MENUID,4,
					SETUP_MENU_PROFILE_SETTING_MENUID,
					SETUP_MENU_COMMONSETTING_MENUID,
					MESSAGES_MENU_MEMSTATUS_MENUID,
					SETUP_MENU_PREFEREDSTORAGE_MENUID,
				...
				#endif
					IMG_SMS_MSG_SETTINGS_MENUENTRY));
		ADD_APPLICATION_MENUITEM((MESSAGES_MENU_MSG_SETTINGS_MENUID+1,MESSAGES_MENU_SMS_MENUID,4,
					SETUP_MENU_PROFILE_SETTING_MENUID,
					SETUP_MENU_COMMONSETTING_MENUID,
					MESSAGES_MENU_MEMSTATUS_MENUID,
					SETUP_MENU_PREFEREDSTORAGE_MENUID,
					SHOW,MOVEABLEACROSSPARENT,DISP_LIST,
				#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
					STRING_MTPNP_SIM1_MESSAGESETUP_MENUENTRY +1,
				#else
					STR_MESSAGESETUP_MENUENTRY,
				#endif
					IMG_SMS_MSG_SETTINGS_MENUENTRY));
		ADD_APPLICATION_MENUITEM((MESSAGES_MENU_MSG_SETTINGS_MENUID+2,MESSAGES_MENU_SMS_MENUID,4,
					SETUP_MENU_PROFILE_SETTING_MENUID,
					SETUP_MENU_COMMONSETTING_MENUID,
					MESSAGES_MENU_MEMSTATUS_MENUID,
					SETUP_MENU_PREFEREDSTORAGE_MENUID,
					SHOW,MOVEABLEACROSSPARENT,DISP_LIST,
				#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
					STRING_MTPNP_SIM1_MESSAGESETUP_MENUENTRY +2,
				#else
					STR_MESSAGESETUP_MENUENTRY,
				#endif
					IMG_SMS_MSG_SETTINGS_MENUENTRY));
	...
	for(i = 0; i < MMI_SIM_NUMBER; i++)
	{
		...
		ADD_APPLICATION_MENUITEM((EMS_ED_OPT_DONE , EMS_ED_OPTIONS_MENU_ID, 5,
					SEND_OPT_SEND_ONLY_MENUID,
					SEND_OPT_SAVE_AND_SEND_MENUID,
					SEND_OPT_SAVE_MENUID,
					SEND_OPT_SEND_TO_MANY_MENUID,
					...
					#endif
					IMG_SMS_COMMON_NOIMAGE));
		ADD_APPLICATION_MENUITEM((EMS_ED_OPT_DONE + 1, EMS_ED_OPTIONS_MENU_ID, 5,
					SEND_OPT_SEND_ONLY_MENUID,
					SEND_OPT_SAVE_AND_SEND_MENUID,
					SEND_OPT_SAVE_MENUID,
					SEND_OPT_SEND_TO_MANY_MENUID,
					...
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,
					#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
					STRING_MTPNP_SMS_MASTER_DONE + 1, 
					#else
					STR_GLOBAL_DONE,
					#endif
					IMG_SMS_COMMON_NOIMAGE));
		ADD_APPLICATION_MENUITEM((EMS_ED_OPT_DONE + 2, EMS_ED_OPTIONS_MENU_ID, 5,
					SEND_OPT_SEND_ONLY_MENUID,
					SEND_OPT_SAVE_AND_SEND_MENUID,
					SEND_OPT_SAVE_MENUID,
					SEND_OPT_SEND_TO_MANY_MENUID,
					...
					SHOW, MOVEABLEWITHINPARENT, DISP_LIST,
					#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
					STRING_MTPNP_SMS_MASTER_DONE + 2, 
					#else
					STR_GLOBAL_DONE,
					#endif
					IMG_SMS_COMMON_NOIMAGE));
	...
	for(i = 0; i < MMI_SIM_NUMBER; i++)
	{
		...
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_SELECT_SIM1_OPTION , MENU_MTPNP_SMS_SELECT_OPTION,
                              0, SHOW, NONMOVEABLE | INSERTABLE, DISP_LIST, 
                              STRING_MTPNP_OUTBOX_MASTER_SEND_SMS , NULL));
		...
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_MASTER_INBOX + 1,
	                              MESSAGES_MENU_INBOX_MENUID, 0,
	                              SHOW, MOVEABLEWITHINPARENT | SHORTCUTABLE, DISP_LIST,
	                              STRING_MTPNP_SMS_MASTER_INBOX + 1, IMG_SMS_INBOX_MENUENTRY));
		
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_MASTER_OUTBOX + 1,
                              MESSAGES_MENU_OUTBOX_MENUID, 0,
                              SHOW, MOVEABLEWITHINPARENT | SHORTCUTABLE, DISP_LIST,
                              STRING_MTPNP_SMS_MASTER_OUTBOX + 1, IMG_SMS_OUTBOX_MENUENTRY));
		
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_SELECT_SIM1_OPTION + 1, MENU_MTPNP_SMS_SELECT_OPTION,
                              0, SHOW, NONMOVEABLE | INSERTABLE, DISP_LIST, 
                              STRING_MTPNP_OUTBOX_MASTER_SEND_SMS + 1, NULL));
		
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_SELECT_SAVE_SIM1_OPTION + 1, MENU_MTPNP_SMS_SELECT_SAVE_OPTION,
				0, SHOW, NONMOVEABLE | INSERTABLE, DISP_LIST, STRING_MTPNP_SAVE_SMS_TO_SIM1 + 1, NULL));

		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_MASTER_INBOX + 2,
	                              MESSAGES_MENU_INBOX_MENUID, 0,
	                              SHOW, MOVEABLEWITHINPARENT | SHORTCUTABLE, DISP_LIST,
	                              STRING_MTPNP_SMS_MASTER_INBOX + 2, IMG_SMS_INBOX_MENUENTRY));
		
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_MASTER_OUTBOX + 2,
                              MESSAGES_MENU_OUTBOX_MENUID, 0,
                              SHOW, MOVEABLEWITHINPARENT | SHORTCUTABLE, DISP_LIST,
                              STRING_MTPNP_SMS_MASTER_OUTBOX + 2, IMG_SMS_OUTBOX_MENUENTRY));
		
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_SELECT_SIM1_OPTION + 2, MENU_MTPNP_SMS_SELECT_OPTION,
                              0, SHOW, NONMOVEABLE | INSERTABLE, DISP_LIST, 
                              STRING_MTPNP_OUTBOX_MASTER_SEND_SMS + 2, NULL));
		
		ADD_APPLICATION_MENUITEM((MENU_MTPNP_SMS_SELECT_SAVE_SIM1_OPTION + 2, MENU_MTPNP_SMS_SELECT_SAVE_OPTION,
				0, SHOW, NONMOVEABLE | INSERTABLE, DISP_LIST, STRING_MTPNP_SAVE_SMS_TO_SIM1 + 2, NULL));
	#endif
	#if defined(__MMI_MESSAGES_BLACK_LIST__)
	
	ADD_APPLICATION_MENUITEM((MENU_MESSAGES_BLACK_LIST, 
							#ifdef __MMI_MULTI_SIM__
								...
								SHOW, MOVEABLEWITHINPARENT, DISP_LIST, STR_MESSAGES_BLACK_LIST, IMG_SMS_MSG_SETTINGS_MENUENTRY));

	ADD_APPLICATION_MENUITEM((MENU_MESSAGES_BLACK_LIST_MODE, MENU_MESSAGES_BLACK_LIST, 0,
								SHOW, NONMOVEABLE, DISP_LIST, STR_MESSAGES_BLACK_LIST_MODE, 0));

	ADD_APPLICATION_MENUITEM((MENU_MESSAGES_BLACK_LIST_NUM, MENU_MESSAGES_BLACK_LIST, 0,
								SHOW, NONMOVEABLE, DISP_LIST, STR_MESSAGES_BLACK_LIST_NUM, 0));

	ADD_APPLICATION_STRING2(STR_MESSAGES_BLACK_LIST, "Messages Black List", "STR_MESSAGES_BLACK_LIST");
	ADD_APPLICATION_STRING2(STR_MESSAGES_BLACK_LIST_MODE, "Mode", "STR_MESSAGES_BLACK_LIST_MODE");
	ADD_APPLICATION_STRING2(STR_MESSAGES_BLACK_LIST_NUM, "Black List Number", "STR_MESSAGES_BLACK_LIST_NUM");
...
//MENU ICONs
	...
	ADD_APPLICATION_IMAGE2 (IMG_CB_RECEIVE_MODE_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/SB_WRITE.png",
...
//MAIN MENU ICONs
	...
	ADD_APPLICATION_IMAGE2 (IMG_SMS_DRAFTBOX_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/SB_DraftsBox.gif",
	...
	ADD_APPLICATION_IMAGE2 (IMG_SMS_TEMPLATES_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/SB_TEMP.png",
	...
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SMS_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/SB_sms.png",
							 	"SMS menu item Image");
...
//#ifdef MMS_SUPPORT
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_MMS_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/MMS/SB_mms.png",
							 	"MMS menu item Image");
//#endif

#ifdef __T800_MAIN_MENU__
	ADD_APPLICATION_IMAGE2 (IMG_MMS_WMESSAGE_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/MMS/SB_WRITE.png",
								"Write Message MMS menu item Image");
	ADD_APPLICATION_IMAGE2 (IMG_MMS_INBOX_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/MMS/SB_INBOX.gif",
								"Inbox MMS menu item String");
	ADD_APPLICATION_IMAGE2 (IMG_MMS_OUTBOX_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/MMS/SB_UTBOX.gif",
								"Outbox MMS menu item Image");
	ADD_APPLICATION_IMAGE2 (IMG_MMS_DRAFTBOX_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/MMS/SB_DraftsBox.pbm",
								"Draftbox MMS menu item Image");
	ADD_APPLICATION_IMAGE2 (IMG_MMS_MSG_SETTINGS_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/MMS/SB_SET.gif",
							 	"MMS settings menu item Image");
	ADD_APPLICATION_IMAGE2 (IMG_MMS_MESSAGE_SENT_MENUENTRY,
								CUST_IMG_PATH"/MainLCD/MMS/SB_sent.gif",
							 	"MMS settings menu item Image");
#endif
...
//IDLE SCREEN ICONS
	...
	ADD_APPLICATION_IMAGE2 (IMG_NEW_SMS_PIC_SUBLCD_MSG,
								CUST_IMG_PATH"/SUBLCD/Active/SB_sms.png",
								"You have New Voicemail SMS Notification Caption Image");
...
//STATUS ICONS
	...
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_ME_M.png",
								"Message SS_NCOMP SMS Image for master");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_ME_S.png",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SM_M.png",
								"Message SS_NCOMP SMS Image for master");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SM_S.png",
								"Message SS_NCOMP SMS Image for slave");
	#if(MMI_SIM_NUMBER >= 3)
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SIM3.PBM",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_ME_SIM3.PBM",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SM_SIM3.PBM",
								"Message SS_NCOMP SMS Image for slave");
	#endif
	#if(MMI_SIM_NUMBER >= 4)
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SIM4.PBM",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_ME_SIM4.PBM",
								"Message SS_NCOMP SMS Image for slave");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_NCOMP_SM_SIM4.PBM",
								"Message SS_NCOMP SMS Image for slave");
	#endif
	#endif
...
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UNREAD_SM.png",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UNREAD_ME.png",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_SM.png",
								"Message SI_MGE SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_ME.png",
								"Message SI_MGE SMS Image");
...
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_ME.png",
								"Message Unsent SMS Image");
...
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_SM.png",
								"Message Unsent SMS Image");		
...
#else
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_M.PBM",
								"Message UnRead SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_ME_M.PBM",
								"Message UnRead SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_M.PBM",
								"Message SI_MGE SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_ME_M.PBM",
								"Message SI_MGE SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_ME_M.PBM",
								"Message Sent SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_ME_M.PBM",
								"Message Unsent SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_M.PBM",
								"Message Sent SMS Image for master");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM_M,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_M.PBM",
								"Message Unsent SMS Image for master");	
#endif /* __MMI_DUAL_SIM_SINGLE_OPENED_ */
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_S.PBM",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_ME_S.PBM",
								"Message UnRead SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_S.PBM",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_ME_S.PBM",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_ME_S.PBM",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_ME_S.PBM",
								"Message Unsent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_S.PBM",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM_S,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_S.PBM",
								"Message Unsent SMS Image for slave");
#if(MMI_SIM_NUMBER >= 3)
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_SIM3.PBM",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_ME_SIM3.PBM",
								"Message UnRead SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_SIM3.PBM",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_ME_SIM3.PBM",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_ME_SIM3.PBM",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_ME_SIM3.PBM",
								"Message Unsent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_SIM3.PBM",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM_SIM3,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_SIM3.PBM",
								"Message Unsent SMS Image for slave");	
#endif
#if(MMI_SIM_NUMBER >= 4)
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_SM_SIM4.PBM",
								"Message UnRead SMS Image");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_UNREAD_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_UNREAD_ME_SIM4.PBM",
								"Message UnRead SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_SM_SIM4.PBM",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_INBOX_READ_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/dual_sim/SS_READ_ME_SIM4.PBM",
								"Message SI_MGE SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_ME_SIM4.PBM",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_ME_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_ME_SIM4.PBM",
								"Message Unsent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_SEND_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_SENT_SM_SIM4.PBM",
								"Message Sent SMS Image for slave");
ADD_APPLICATION_IMAGE2 (IMG_SMS_OUTBOX_UNSEND_SM_SIM4,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/dual_sim/SS_UNSENT_SM_SIM4.PBM",
								"Message Unsent SMS Image for slave");	
#endif
#endif
...
/*UNI@wutianlong_20070929:区分短信在手机与卡*/
	...
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ1,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ1.PBM",
								"Message Read SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD1,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD1.PBM",
								"Message UnRead SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT1,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT1.PBM",
								"Message Sent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT1,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT1.PBM",
								"Message Unsent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP1,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP1.PBM",
								"Message SS_NSUP SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP1,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP1.PBM",
								"Message SS_NCOMP SMS Image");	
#endif
...
/*UNI@zhulanchen_20070925 14:47:50 */
	...
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_2_C.PBM",
								"Message Read SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD_2_C.PBM",
								"Message UnRead SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_2_C.PBM",
								"Message Sent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_2_C.PBM",
								"Message Unsent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP_2_C.PBM",
								"Message SS_NSUP SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_2_C.PBM",
								"Message SS_NCOMP SMS Image");
	/*UNI@wutianlong : 20071129 14:52:08  : 主机副机 区分短信在手机与卡  */

	#ifdef __UNI_MMI_SMS_PK_ICON__
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_k_2_C.PBM",
								"Message Read SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD_k_2_C.PBM",
								"Message UnRead SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_k_2_C.PBM",
								"Message Sent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_k_2_C.PBM",
								"Message Unsent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP_k_2_C.PBM",
								"Message SS_NSUP SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_k_2_C.PBM",
								"Message SS_NCOMP SMS Image");
	#endif
...
#else
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_2.PBM",
								"Message Read SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD_2.PBM",
								"Message UnRead SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_2.PBM",
								"Message Sent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_2.PBM",
								"Message Unsent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP_2.PBM",
								"Message SS_NSUP SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP_2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_2.PBM",
								"Message SS_NCOMP SMS Image");
	/*UNI@wutianlong : 20071129 14:52:08  : 主机副机 区分短信在手机与卡  */

	#ifdef __UNI_MMI_SMS_PK_ICON__
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_READ2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_READ_k_2.PBM",
								"Message Read SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNREAD2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_UREAD_k_2.PBM",
								"Message UnRead SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SENT2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_SENT_k_2.PBM",
								"Message Sent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_UNSENT2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/outbox/SS_UNSENT_k_2.PBM",
								"Message Unsent SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NSUP2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NSUP_k_2.PBM",
								"Message SS_NSUP SMS Image");
	ADD_APPLICATION_IMAGE2 (IMG_MESSAGE_SS_NCOMP2,
								CUST_IMG_PATH"/MainLCD/Sms/Submenu/inbox/SS_NCOMP_k_2.PBM",
								"Message SS_NCOMP SMS Image");
	#endif
#endif	
#endif
...
//[221] Added by Ryh 2009/02/12								[END]
	...
	for(i = 0; i < MMI_SIM_NUMBER; i++)
	{
		...
		ADD_APPLICATION_MENUITEM((MESSAGES_MENU_VMAIL_MENUID ,
								...
								#endif /*__MMI_MULTI_SIM__*/
									IMG_SMS_VMAIL_MENUENTRY));
		ADD_APPLICATION_MENUITEM((MESSAGES_MENU_VMAIL_MENUID + 1,
								#ifndef __MMI_MULTI_SIM__
									MAIN_MENU_MESSAGES_MENUID, 0,
								#else /* __MMI_MULTI_SIM__ */
									MENU_MTPNP_DM_VMAIL, 0,
									...
									SHOW, MOVEABLEWITHINPARENT|SHORTCUTABLE, DISP_LIST,
								#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
									STRING_MTPNP_SIM1_VMAIL_MENUENTRY + 1,
								#else /*__MMI_MULTI_SIM__*/
									STR_VMAIL_MENUENTRY,
								#endif /*__MMI_MULTI_SIM__*/
									IMG_SMS_VMAIL_MENUENTRY));
		ADD_APPLICATION_MENUITEM((MESSAGES_MENU_VMAIL_MENUID + 2,
								#ifndef __MMI_MULTI_SIM__
									MAIN_MENU_MESSAGES_MENUID, 0,
								#else /* __MMI_MULTI_SIM__ */
									MENU_MTPNP_DM_VMAIL, 0,
									...
									SHOW, MOVEABLEWITHINPARENT|SHORTCUTABLE, DISP_LIST,
								#if defined( __MMI_MULTI_SIM__) && !defined(__MMI_DUAL_SIM_SINGLE_OPENED_)
									STRING_MTPNP_SIM1_VMAIL_MENUENTRY + 2,
								#else /*__MMI_MULTI_SIM__*/
									STR_VMAIL_MENUENTRY,
								#endif /*__MMI_MULTI_SIM__*/
									IMG_SMS_VMAIL_MENUENTRY));
...
//	ADD_APPLICATION_STRING2 (STR_OUTBOX_DELETEALL_MENUENTRY, "Delete All", "Delete All menu String");
	...
	ADD_APPLICATION_STRING2 (STR_VIEW_INBOX_CAPTION, "View Inbox",	"View Inbox Caption String");
#ifdef __MMI_MESSAGES_CHAT__
...
//	ADD_APPLICATION_STRING2 (STR_PROFILE_EDIT_MENUENTRY,	    "Edit",	"Message Profile Edit  SMS  String");
	...
	ADD_APPLICATION_STRING2 (STR_DEFAULTSET_MENUENTRY,		     "Default Set",	"Message Setup Default Set SMS  String");
...
//	ADD_APPLICATION_STRING2 (STR_SCR6046_RSK,			"Abort",	"Loading Process Indicator SMS Screen RSK String");
	...
	ADD_APPLICATION_STRING2(STR_FDN_CHECK_NO_STORE, "Not in FDL", "Not in FDL String");
	ADD_APPLICATION_STRING2(STR_FDN_CHECK_STORED_IN_OUTBOX, "Not in FDL! Stored in Outbox", "Not in FDL! Stored in Outbox String");
	ADD_APPLICATION_STRING2(STR_FDN_CHECK_STORE_IN_OUTBOX_FAIL, "Not in FDL! Store in Outbox fail", "Not in FDL! Stored in Outbox fail String");
	ADD_APPLICATION_STRING2(STR_FDN_PHB_ERROR, "FDL Not Ready!", "FDN phb not ready String");

	ADD_APPLICATION_STRING2 (STR_MESSAGE_SAVE_ERROR,		"Save in Outbox Failed",	"SMS Save Error Message String");
	ADD_APPLICATION_STRING2 (STR_MESSAGE_INCOMPLETE,		"Message Not Complete!",	"Popup for Incomplete Message");
	...
	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_SIM_STORAGE_FULL,		"SIM Full !",	"SMS SIM Memory Storage is Full Error Message String");
	...
	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_MEM_FAILURE,			"Memory Failure!",	"SMS Memory Failure Error Message String");
...
//#endif // defined(__MMI_MESSAGES_EMS__)
	...
	ADD_APPLICATION_STRING2 (STR_SMS_FAILURE_TOO_MANY_MO_CONCAT_MSG,		"Too many concatenated messages !",	"SMS too Many Concatenated Message String");
...
//	ADD_APPLICATION_STRING2 (STR_DELIVERY_REPLY_OFF_MENUENTRY,		"OFF",				"Message OFF SMS String");
	...
	ADD_APPLICATION_STRING2 (STR_STATUS_REPORT_MESSAGE_NOT_DELIVERD_MSG,	"Not Delivered!",		"Message Not Deliverd String");
	ADD_APPLICATION_STRING2 (STR_SMS_MSG_NOT_READY_YET,						"SMS Not Ready Yet!",			"Message SMS not ready yet String");
	ADD_APPLICATION_STRING2 (STR_DELIVERY_REPORT_SENT_TO, "sent to: ",	"Message sent to: String");
...
// Strings
	...
	ADD_APPLICATION_STRING2 (STR_SC_EMPTY_STORED_IN_OUTBOX, 		"SC empty! Stored in Outbox", "CB SC empty! Stored in Outbox String");
	ADD_APPLICATION_STRING2 (STR_SC_EMPTY_STORE_IN_OUTBOX_FAIL, "SC empty! Store in Outbox fail", "CB SC empty! Store in Outbox fai String");
...
//	ADD_APPLICATION_STRING2 (STR101_MITEM103_CB_SERVICE_OFF,		"OFF", "CB Menu Item Service OFF Caption String");
	...
	ADD_APPLICATION_STRING2 (STR102_SCR102_CAPTION		,			"Channels", "CB Menu Item Cell Broadcast Channels Caption String");
