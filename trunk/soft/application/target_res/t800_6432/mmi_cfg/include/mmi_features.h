...
The macro __MMI_STYLE_E71_QCIF_S__ was defined in the file conversion.mk .*/
...
#ifdef LCDSIZE_176_220
//support 7+1 flash size on 176*220 screen add by licheng
#define __MMI_RESOURCE_SLIM_ON_128X160__
#define __MMI_FM_SLIM_SKIN__
#define __MMI_USE_LITTLIST_RESOURCE
//#define __MMI_WALLPAPER_ON_BOTTOM__
#endif

#if (defined(__MMI_RESOURCE_SLIM_ON_128X160__) || defined(__MMI_NOKIA_STYLE_N800__))											/* Detail Info: [Main LCD is 128x160]*/
...
//#define __MMI_SEND_MMS_FROM_IMG_VIEW__                                                                /*2011-5-27 fengzb add*/
#endif
