...
#if defined(__HORIZONTAL_LCD__) && !defined(LCDSIZE_160_128)
...
//#if ( defined(CSDLCM_COLOR) || defined(TOPPOLY_LCM) || defined(FIREFLY_LCM) || defined (MILAN_LCM) || defined (J121_DEMO_05B_LCM) || defined (FS01_LCM) )
	...
	#define	__MMI_MAINLCD_160X128__											/* Detail Info: [Main LCD is 160x128]*/
#endif // LCDSIZE_160_128    

#ifdef LCDSIZE_128_128
	#define	__MMI_MAINLCD_128X128__											/* Detail Info: [Main LCD is 128x160]*/
#endif // LCDSIZE_128_128   
...
#define __MMI_CM_SCREEN_HIDE_DATE_TIME__
#endif
...
#if defined (__MMI_DRAW_MANAGER__) && defined (__MMI_MAINLCD_128X128__)
	#define __MMI_WALLPAPER_ON_BOTTOM__									/* Detail Info: [Use an image on a new layer as the background]*/
#endif
...
#if !defined (MEM_ULC_3216) || defined(__MMI_LANG_SM_CHINESE__)
 ...
 *****************************************************************************/
#ifndef MEM_ULC_3216 
#if defined(__MMI_MAINLCD_176X220__)|| defined(__MMI_MAINLCD_128X128__)
#define __MMI_GAME__ 			
#elif !defined (__MMI_SUPPORT_JME__)
#define __MMI_GAME__ 
#endif
#else
...
/* Detail Info: [Turn On/Off Games] */
	...
	#elif defined(__MMI_MAINLCD_128X128__)
	    #define __MMI_GAME_PUZZLE_128x128__
		#define __MMI_GAME_PANDA_128x128__
	#elif defined(__MMI_MAINLCD_176X220__)
		/* 176x220 Games */
...
//[221] Added by ZXB 2009/02/02								[BEGIN]
// Add dual-sim support feature macros for 221 project.

// Use 221 global control switch instead of this macro.
...
#endif
#ifndef MEM_ULC_3216
//[221] Added by ZXB 2009/02/02								[END]
