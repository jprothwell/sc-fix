...
{
	#if 0
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_T9_EXP_UP_ABC,"Tap_ABC","multitap ABC");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_T9_EXP_LO_abc,"Tap_abc","multitap abc");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_T9_AMB_UP_ABC,"Smart_ABC","smart ABC");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_T9_AMB_LO_abc,"Smart_abc","smart abc");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_T9_123,"123","numeric input");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_T9_BOPOMOFO,"BoPoMo","bopomofo input");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_T9_TR_STROKE,"Tr_Stroke","stroke for traditional chinese");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_T9_PINYIN,"PinYin","pinyin for simplifed chinese");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_T9_SM_STROKE,"Sm_Stroke","stroke for simplified chinese");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_INPUT_METHOD_THAI,"Thai","thai input method indicator");
