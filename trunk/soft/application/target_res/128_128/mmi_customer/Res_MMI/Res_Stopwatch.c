...
{	
	ADD_APPLICATION_IMAGE2(IMG_MULTIPURPOSE_TIMER1,CUST_IMG_PATH"/MainLCD/Stopwatch/LEFT.gif","Image for MultiPurpose Timer1");
#if defined(__MMI_MAINLCD_128X128__)
    ADD_APPLICATION_IMAGE2(IMG_MULTIPURPOSE_TIMER2,CUST_IMG_PATH"/MainLCD/Stopwatch/UP.gif","Image for MultiPurpose Timer2");
    ADD_APPLICATION_IMAGE2(IMG_MULTIPURPOSE_TIMER3,CUST_IMG_PATH"/MainLCD/Stopwatch/RIGHT.gif","Image for MultiPurpose Timer3");
    ADD_APPLICATION_IMAGE2(IMG_MULTIPURPOSE_TIMER4,CUST_IMG_PATH"/MainLCD/Stopwatch/DOWN.gif","Image for MultiPurpose Timer4");
#endif
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_MULTIPURPOSE_TIMER2,CUST_IMG_PATH"/MainLCD/Stopwatch/UP.gif","Image for MultiPurpose Timer2");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_MULTIPURPOSE_TIMER3,CUST_IMG_PATH"/MainLCD/Stopwatch/RIGHT.gif","Image for MultiPurpose Timer3");
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_MULTIPURPOSE_TIMER4,CUST_IMG_PATH"/MainLCD/Stopwatch/DOWN.gif","Image for MultiPurpose Timer4");
