...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_DIALER_SCREEN_OPTIONS_GSM_DIAL, "Voice Call", "Dial by GSM");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_DIALER_SCREEN_OPTIONS_WLAN_DIAL, "VoIP Call", "Dial by WLAN");
...
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_IDLE_MESSAGE_SHORTCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch/TH_MG_UP.gif","Idle Screen Message shorcut image.");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_IDLE_MESSAGE_SHORTCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch/TH_MG_DOWN.gif","Idle Screen Message shorcut pressed image.");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_IDLE_PHONEBOOK_SHORTCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch/TH_PB_UP.gif","Idle Screen Phonebook shorcut image.");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_IDLE_PHONEBOOK_SHORTCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch/TH_PB_DOWN.gif","Idle Screen Phonebook shorcut pressed image.");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_IDLE_DIALING_SCREEN_SHORTCUT,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch/TH_DS_UP.gif","Idle Screen Dialing Screen shorcut image.");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(IMG_IDLE_DIALING_SCREEN_SHORTCUT_PRESSED,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch/TH_DS_DOWN.gif","Idle Screen Dialing Screen shorcut pressed image.");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_IDLE_DUMMY_SCREEN, "Exit SubLCD......", "For SubLCD master mode");
#endif

#ifdef __UNI_MMI_IDLE_SLIDE_UNLOCK__ /*  增加待机滑块解锁*/
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(WGUI_IDLE_SLIDE_UNLOCK_BACKGROUND,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch/TH_SLIDE_BG.gif","Idle Screen Slide Background.");
//del by reslim v0.1    ADD_APPLICATION_IMAGE2(WGUI_IDLE_SLIDE_UNLOCK_SLIDER,CUST_IMG_PATH"/MainLCD/IdleScreen/Touch/TH_SLIDER.gif","Idle Screen Slider.");
#endif
}
...
void PopulateMainDemoRes(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
//del by reslim v0.1    ADD_APPLICATION_STRING(DEMO_UNER_CONS_TEXT, "Under Construction");
//del by reslim v0.1    ADD_APPLICATION_STRING(DEMO_ICON_TEXT, "Pixtel");
//del by reslim v0.1    ADD_APPLICATION_IMAGE(DEMO_CONSTRUCTION_IMAGE_ID, CUST_IMG_BASE_PATH"/UnderC.gif");
//del by reslim v0.1    ADD_APPLICATION_IMAGE(DEMO_UNDER_CONSTRUCTION_TITLE_ICON, CUST_IMG_BASE_PATH"/TitleIcon.gif");
}
