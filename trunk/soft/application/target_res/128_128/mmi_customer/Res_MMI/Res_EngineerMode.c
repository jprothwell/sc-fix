...
/**************************************************************
	...
	FILENAME	: Res_EngineerMode.c

  	PURPOSE		: Populate Resource for EngineerMode
...
//////////////////////////////////////////////////////////////////////////////////
void PopulateEMMenu(void)
{
	ADD_APPLICATION_MENUITEM((ENGINEER_MODE_MENUID, IDLE_SCREEN_MENU_ID, 
				#if defined(__MMI_BT_HP_SUPPORT__) || defined(__MMI_BT_SUPPORT__)
				11, 
				#else
				10,
	...
	ADD_APPLICATION_MENUITEM((EM_CELL_ENVIRONMENT_MENUID, ENGINEER_MODE_MENUID, 0,
			SHOW, NONMOVEABLE,DISP_LIST,EM_CELL_ENVIRONMENT_TEXT,EM_NETWORK_ICON));
	
	ADD_APPLICATION_MENUITEM((EM_NETWORK_MENUID, ENGINEER_MODE_MENUID, 14,
				...
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NETWORK_TEXT, EM_NETWORK_ICON));
	ADD_APPLICATION_MENUITEM((EM_AUDIO_MENUID, ENGINEER_MODE_MENUID, 7, 
	...
	ADD_APPLICATION_MENUITEM((EM_DEVICE_MENUID, ENGINEER_MODE_MENUID, 8,
                EM_DEV_LCD_MENU_ID,  
                EM_DEV_GPIO_MENU_ID,  
                EM_DEV_PWM_MENU_ID,  
                EM_DEV_EINT_MENU_ID,  
	...
	ADD_APPLICATION_MENUITEM((EM_GPRS_ACT_MENUID, ENGINEER_MODE_MENUID, 5,
	...
	ADD_APPLICATION_MENUITEM((EM_BAND_SEL_MENUID, ENGINEER_MODE_MENUID, 4,
	            EM_BAND_900_MENUID,
	            EM_BAND_1800_MENUID,
	            EM_BAND_DUAL_MENUID,
	            EM_BAND_1900_MENUID,
				SHOW, NONMOVEABLE, DISP_LIST,	EM_BAND_SEL_TEXT, EM_BAND_SEL_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_RR_CELL_SEL_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_RR_CELL_SEL_TEXT, EM_NET_RR_CELL_SEL_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_RR_CH_DSCR_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_RR_CH_DSCR_TEXT, EM_NET_RR_CH_DSCR_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_RR_CTRL_CH_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_RR_CTRL_CH_TEXT, EM_NET_RR_CTRL_CH_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_RR_RACH_CTRL_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_RR_RACH_CTRL_TEXT, EM_NET_RR_RACH_CTRL_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_RR_LAI_INFO_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_RR_LAI_INFO_TEXT, EM_NET_RR_LAI_INFO_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_RR_RADIO_LINK_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_RR_RADIO_LINK_TEXT, EM_NET_RR_RADIO_LINK_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_RR_MEAS_REP_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_RR_MEAS_REP_TEXT, EM_NET_RR_MEAS_REP_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_RR_CTRL_MSG_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_RR_CTRL_MSG_TEXT, EM_NET_RR_CTRL_MSG_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_CC_CHAN_INFO_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_CC_CHAN_INFO_TEXT, EM_NET_CC_CHAN_INFO_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_CC_CALL_INFO_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_CC_CALL_INFO_TEXT, EM_NET_CC_CALL_INFO_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_CB_INFO_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_CB_INFO_TEXT, EM_NET_CB_INFO_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_SS_INFO_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_SS_INFO_TEXT, EM_NET_SS_INFO_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_MM_INFO_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_MM_INFO_TEXT, EM_NET_MM_INFO_ICON));
	ADD_APPLICATION_MENUITEM((EM_NET_UEM_INFO_MENUID, EM_NETWORK_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_NET_UEM_INFO_TEXT, EM_NET_UEM_INFO_ICON));
#if 0
	ADD_APPLICATION_MENUITEM((EM_AUD_SET_ECHO_PARAM_MENUID, EM_AUDIO_MENUID, 4, 
				EM_AUD_SET_ENERGY_1_MENUID,
				EM_AUD_SET_DELAY_1_MENUID,
				EM_AUD_SET_ENERGY_2_MENUID,
				EM_AUD_SET_DELAY_2_MENUID,
				SHOW, NONMOVEABLE, DISP_LIST,	EM_AUD_SET_ECHO_PARAM_TEXT, EM_AUD_SET_ECHO_PARAM_ICON));
	ADD_APPLICATION_MENUITEM((EM_AUD_SET_ENERGY_1_MENUID,EM_AUD_SET_ECHO_PARAM_MENUID,0,
				SHOW,NONMOVEABLE, DISP_LIST,EM_AUD_SET_ENERGY_1_TEXT,EM_AUD_SET_ENERGY_1_ICON));
	ADD_APPLICATION_MENUITEM((EM_AUD_SET_DELAY_1_MENUID,EM_AUD_SET_ECHO_PARAM_MENUID,0,
				SHOW,NONMOVEABLE, DISP_LIST,EM_AUD_SET_DELAY_1_TEXT,EM_AUD_SET_DELAY_1_ICON));
	ADD_APPLICATION_MENUITEM((EM_AUD_SET_ENERGY_2_MENUID,EM_AUD_SET_ECHO_PARAM_MENUID,0,
				SHOW,NONMOVEABLE, DISP_LIST,EM_AUD_SET_ENERGY_2_TEXT,EM_AUD_SET_ENERGY_2_ICON));
	ADD_APPLICATION_MENUITEM((EM_AUD_SET_DELAY_2_MENUID,EM_AUD_SET_ECHO_PARAM_MENUID,0,
				SHOW,NONMOVEABLE, DISP_LIST,EM_AUD_SET_DELAY_2_TEXT,EM_AUD_SET_DELAY_2_ICON));
	ADD_APPLICATION_MENUITEM((EM_AUD_SET_MAX_SWING_MENUID,EM_AUD_SET_ECHO_PARAM_MENUID,0,
	...
	ADD_APPLICATION_MENUITEM((EM_DEV_PWM_MENU_ID, EM_DEVICE_MENUID, 3,
				...
				SHOW, NONMOVEABLE, DISP_LIST,	EM_DEV_PWM_TEXT, EM_MISC_ICON));
	ADD_APPLICATION_MENUITEM((EM_DEV_LCD_MAIN_MENU_ID, EM_DEV_LCD_MENU_ID, 4,
	...
	ADD_APPLICATION_MENUITEM((EM_DEV_LCD_SUB_MENU_ID, EM_DEV_LCD_MENU_ID, 4,
                EM_DEV_LCD_SET_CONSTRAST_MENU_ID,
                EM_DEV_LCD_SET_BIAS_MENU_ID,
                EM_DEV_LCD_SET_LINERATE_MENU_ID,
                EM_DEV_LCD_SET_TEMPERATURE_MENU_ID,
	...
	ADD_APPLICATION_MENUITEM((EM_DEV_UART_1_MENUID, EM_DEV_SET_UART_MENUID, 0,
				SHOW, NONMOVEABLE, DISP_LIST,	EM_DEV_UART_1_TEXT, EM_DEV_UART_1_ICON));
	ADD_APPLICATION_MENUITEM((EM_DEV_UART_2_MENUID, EM_DEV_SET_UART_MENUID, 0,
				SHOW, NONMOVEABLE, DISP_LIST,	EM_DEV_UART_2_TEXT, EM_DEV_UART_2_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_ACTIVATE_PDP_MENUID, EM_GPRS_ACT_MENUID, 15, 
				...
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_ACTIVATE_PDP_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_DEACTIVATE_PDP_MENUID, EM_GPRS_ACT_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_DEACTIVATE_PDP_TEXT, EM_GPRS_ACT_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_SEND_DATA_MENUID, EM_GPRS_ACT_MENUID, 2,
                ...
                EM_GPRS_SEND_DATA_HDR_MENUID,   
 				SHOW, NONMOVEABLE, DISP_LIST,EM_GPRS_SEND_DATA_TEXT, EM_GPRS_SEND_DATA_ICON));
	...
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_1_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_1_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_2_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_2_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_3_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_3_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_4_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_4_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_5_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_5_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_6_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_6_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_7_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_7_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_8_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_8_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_9_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_9_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_10_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_10_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_11_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_11_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_12_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_12_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_13_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_13_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_14_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_14_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_GPRS_PDP_CONTEXT_15_MENUID, EM_GPRS_ACTIVATE_PDP_MENUID, 0, 
				SHOW, NONMOVEABLE, DISP_LIST,	EM_GPRS_PDP_CONTEXT_15_TEXT, EM_GPRS_AUTO_ATTACH_ICON));
	ADD_APPLICATION_MENUITEM((EM_MISC_MENUID, ENGINEER_MODE_MENUID, 10,
	...
	ADD_APPLICATION_MENUITEM((EM_DEBUG_INFO_MENUID, ENGINEER_MODE_MENUID, 2,
				EM_FS_TRACE_MENUID,
...
void populateEngineerModeMenu(void)
{
	...
	ADD_APPLICATION_STRING2 (EM_CELL_ENVIRONMENT_TEXT, "Cell Environment", "Cell Enviroment");
	...
	ADD_APPLICATION_STRING2 (EM_NETWORK_PREFER_RAT_TEXT	,  "Prefer Rat", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_NETWORK_PREFER_RAT_2G_TEXT	,  "2G", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_NETWORK_PREFER_RAT_3G_TEXT	,  "3G", "Engineer Mode Menu Caption String");	
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_NETWORK_1900_BAND_TEXT	,  "1900 Band", "Engineer Mode Menu Caption String");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_NETWORK_ARFCN_TEXT	,  "Arfcn", "Engineer Mode Menu Caption String");	
#endif
	ADD_APPLICATION_STRING2 (EM_NETWORK_TEXT   , "Network info", "Engineer Mode Menu Caption String");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_NET_GPRS_INFO_TEXT      , "GPRS Info", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_NET_Si2Q_MI_INFO_TEXT      , "Si2Q/Mi Info", "Engineer Mode Menu Caption String");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_NET_TBF_STATUS_TEXT      , "TBF Status", "Engineer Mode Menu Caption String");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_NET_BLK_INFO_TEXT      , "Block Info", "Engineer Mode Menu Caption String");	
*/
    /******************** Device *********************/
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_LCD_SET_PARAM_2_TEXT, "Set Param 2", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_LCD_SET_PARAM_3_TEXT, "Set Param 3", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_LCD_SET_PARAM_4_TEXT, "Set Param 4", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_LCD_SET_PARAM_5_TEXT, "Set Param 5", "Engineer Mode Menu Caption String");
	/*ADD_APPLICATION_STRING2 (EM_DEV_LCD_SET_COLOR_TEXT, "Set Color", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_LCD_RGB_R_TEXT, "Red", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_LCD_RGB_G_TEXT, "Green", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_LCD_RGB_B_TEXT, "Blue", "Engineer Mode Menu Caption String");	
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_GPIO_SET_TEXT, "Toggle GPIO", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_GPO_SET_TEXT, "Toggle GPO", "Engineer Mode Menu Caption String");
	...
	ADD_APPLICATION_STRING2 (EM_DEV_SET_UART_TST_TEXT   , "TST Config", "Engineer Mode Menu Caption String");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_SET_UART_CTI_ENABLE_TEXT   , "CTI log Config", "Engineer Mode Menu Caption String");
#endif    
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_STR_EXT_CAMERA_WRITE_TEXT , "Write Parameter", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_STR_EXT_CAMERA_READ_TEXT , "Read Parameter", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_STR_EXT_CAMERA_COMMAND_TEXT , "Command", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_STR_EXT_CAMERA_PARA_TEXT , "Parameter", "Engineer Mode Menu Caption String");
#endif	
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_VDROP_TEXT, "V_DROP", "Engineer Mode Menu Caption String");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_CHARGER_OVSPI_TEXT, "OV SPI", "Engineer Mode Over Voltage String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_CHARGER_CHRDET_TEXT, "Charger Detect", "Engineer Mode Charger Detection String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_CHARGER_AC_DET_TEXT, "AC Detect", "Engineer Mode AC Detection String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_CHARGER_USB_DET_TEXT, "USB Detect", "Engineer Mode USB Detection String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_CHARGER_BAT_ON_TEXT, "Battery ON", "Engineer Mode Battery ON String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_CHARGER_CV_TEXT, "CV Mode", "Engineer Mode CV mode String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_CHARGER_CHRG_DIS_TEXT, "Charger_DIS", "Engineer Mode Charging String");       
    /* Set charger */
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_SET_CHARGER_CURRENT_50_TEXT, "Current 50mA", "Engineer Mode Set Charger Current 50 String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_SET_CHARGER_CURRENT_90_TEXT, "Current 90mA", "Engineer Mode Set Charger Current 90 String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_SET_CHARGER_CURRENT_150_TEXT, "Current 150mA", "Engineer Mode Set Charger Current 150 String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_SET_CHARGER_CURRENT_225_TEXT, "Current 225mA", "Engineer Mode Set Charger Current 225 String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_SET_CHARGER_CURRENT_300_TEXT, "Current 300mA", "Engineer Mode Set Charger Current 300 String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_SET_CHARGER_CURRENT_450_TEXT, "Current 450mA", "Engineer Mode Set Charger Current 450 String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_SET_CHARGER_CURRENT_650_TEXT, "Current 650mA", "Engineer Mode Set Charger Current 650 String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_SET_CHARGER_CURRENT_800_TEXT, "Current 800mA", "Engineer Mode Set Charger Current 800 String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_CHARGER_CURRENT_TEXT, "Chr Current", "Engineer Mode Charger Current String");       
    /* RGB LED */
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_RGB_LED_CURRENT_12_TEXT, "12 mA", "Engineer Mode Menu RGB LED Current 12 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_RGB_LED_CURRENT_16_TEXT, "16 mA", "Engineer Mode Menu RGB LED Current 16 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_RGB_LED_CURRENT_20_TEXT, "20 mA", "Engineer Mode Menu RGB LED Current 20 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_RGB_LED_CURRENT_24_TEXT, "24 mA", "Engineer Mode Menu RGB LED Current 24 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_RGB_LED_CURRENT_TEXT, "RGB CURRENT", "Engineer Mode Menu RGB LED Current  String");              
    /* KP LED */
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_KP_CHR_PUMP_CURRENT_LEVEL1_TEXT, "Current Level 1", "Engineer Mode KP LED CHR_PUMP Current 1 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_KP_CHR_PUMP_CURRENT_LEVEL2_TEXT, "Current Level 2", "Engineer Mode KP LED CHR_PUMP Current 2 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_KP_CHR_PUMP_CURRENT_LEVEL3_TEXT, "Current Level 3", "Engineer Mode KP LED CHR_PUMP Current 3 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_KP_CHR_PUMP_CURRENT_LEVEL4_TEXT, "Current Level 4", "Engineer Mode KP LED CHR_PUMP Current 4 String");              
    /* BL LED */
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_AUDIO_AMPGAIN0_TEXT, "Speaker Gain 0", "Engineer Mode Audio Amplifier Gain 0 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_AUDIO_AMPGAIN1_TEXT, "Speaker Gain 1", "Engineer Mode Audio Amplifier Gain 1 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_AUDIO_AMPGAIN2_TEXT, "Speaker Gain 2", "Engineer Mode Audio Amplifier Gain 2 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_AUDIO_AMPGAIN3_TEXT, "Speaker Gain 3", "Engineer Mode Audio Amplifier Gain 3 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_AUDIO_AMPGAIN4_TEXT, "Speaker Gain 4", "Engineer Mode Audio Amplifier Gain 4 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_AUDIO_AMPGAIN5_TEXT, "Speaker Gain 5", "Engineer Mode Audio Amplifier Gain 5 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_AUDIO_AMPGAIN6_TEXT, "Speaker Gain 6", "Engineer Mode Audio Amplifier Gain 6 String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_AUDIO_AMPGAIN7_TEXT, "Speaker Gain 7", "Engineer Mode Audio Amplifier Gain 7 String");       
    /* Misc */
    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_TEXT, "Misc.", "Engineer Mode Menu Caption String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_VIBRATOR_ENABLE_TEXT, "Vibrator Enable", "Engineer Mode MISC Vibrator Enable String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_VIBRATOR_OUT_TEXT, "Vibrator VOUT", "Engineer Mode MISC Vibrator  OUT String");              
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_VMC_ENABLE_TEXT, "VMC", "Engineer Mode MISC VMC Enable String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_VMC_SEL_TEXT, "VMC Sel", "Engineer Mode MISC VMC Sel.  String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_VA_SW_ENABLE_TEXT, "VA SW", "Engineer Mode MISC VA SW Enable  String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_VA_SW_SEL_TEXT, "VA SW Sel", "Engineer Mode MISC VA SW Sel String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_USB_PWR_ENABLE_TEXT, "USB PWR", "Engineer Mode MISC USB PWR Enable String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_VBAT_OUT_ENABLE_TEXT, "VBAT V\OUT", "Engineer Mode MISC VBAT OUT Enable String");       
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_DEV_PMIC_6318_MISC_ISENSE_OUT_ENABLE_TEXT, "Isense OUT", "Engineer Mode MISC Isense Out Enable String");       
    /* LCM BL Setting */
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_STEREO_ENABLE_SBLEND_ON_TEXT, "Enable + Sblend On", "Engineer Mode FM Radio Stereo Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_STEREO_ENABLE_SBLEND_OFF_TEXT, "Enable + Sblend Off", "Engineer Mode FM Radio Stereo Menu Caption String");	
	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_RSSI_TEXT, "RSSI", "Engineer Mode FM Radio RSSI Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_RSSI_LEVEL1_TEXT, "Level 1", "Engineer Mode FM Radio RSSI Level 1 Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_RSSI_LEVEL2_TEXT, "Level 2", "Engineer Mode FM Radio RSSI Level 2 Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_RSSI_LEVEL3_TEXT, "Level 3", "Engineer Mode FM Radio RSSI Level 3 Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_RSSI_LEVEL4_TEXT, "Level 4", "Engineer Mode FM Radio RSSI Level 4 Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_RSSI_LEVEL5_TEXT, "Level 5", "Engineer Mode FM Radio RSSI Level 5 Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_RSSI_LEVEL6_TEXT, "Level 6", "Engineer Mode FM Radio RSSI Level 6 Caption String");	
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_IF_COUNT_DELTA_10_TEXT, "10 kHz", "Engineer Mode FM Radio IF count delta 10 Caption String");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_IF_COUNT_DELTA_15_TEXT, "15 kHz", "Engineer Mode FM Radio IF count delta 15 Caption String");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_IF_COUNT_DELTA_20_TEXT, "20 kHz", "Engineer Mode FM Radio IF count delta 20 Caption String");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_IF_COUNT_DELTA_25_TEXT, "25 kHz", "Engineer Mode FM Radio IF count delta 25 Caption String");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_DEV_FM_RADIO_IF_COUNT_DELTA_30_TEXT, "30 kHz", "Engineer Mode FM Radio IF count delta 30 Caption String");		
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_CALL_TONE_TEXT  , "Call Tone", "Engineer Mode Menu Caption String");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_MEDIA_TEXT , "Media", "Engineer Mode Menu Caption String");
	...
	ADD_APPLICATION_STRING2 (EM_AUD_SET_ECHO_PARAM_TEXT    , "Echo Suppression", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_SET_ENERGY_1_TEXT    , "Energy Thresh 1", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_SET_DELAY_1_TEXT    , "Delay 1", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_SET_ENERGY_2_TEXT    , "Energy Thresh 2", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_AUD_SET_DELAY_2_TEXT    , "Delay 2", "Engineer Mode Menu Caption String");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_0_TEXT , "Parameter 0", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_1_TEXT , "Parameter 1", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_2_TEXT , "Parameter 2", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_3_TEXT , "Parameter 3", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_4_TEXT , "Parameter 4", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_5_TEXT , "Parameter 5", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_6_TEXT , "Parameter 6", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_7_TEXT , "Parameter 7", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_8_TEXT , "Parameter 8", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_9_TEXT , "Parameter 9", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_10_TEXT , "Parameter 10", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_AUD_PARAMETER_11_TEXT , "Parameter 11", "Engineer Mode Menu Caption String");
    /* 16 Level Linear Volume */
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_AUD_16_LELVEL_VOLUME_TEXT , "16 Level Setting", "Engineer Mode Menu Caption String");
 
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_AUD_16_LELVEL_STEP_TEXT , "Step", "Engineer Mode Menu Caption String");    
#endif
    /* AUD TV OUT */    
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_AUD_VM_SUPPORT_TEXT , "VM Support", "Engineer Mode Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_AUD_AUTO_VM_TEXT , "Auto Speech Record", "Engineer Mode Menu Caption String");    
#endif
    ...
    /******************** Band Sel *******************/	
	ADD_APPLICATION_STRING2 (EM_BAND_SEL_TEXT	, "Band Sel.", "Engineer Mode Menu Caption String");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_MISC_CELL_RESELECT_SUSPEND_TEXT, "Resume", "Engineer Mode Menu Caption String"); 
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_MISC_CELL_RESELECT_RESUME_IN_TRANSFER_TEXT, "Suspend(Trans. State)", "Engineer Mode Menu Caption String"); 
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_MISC_CELL_RESELECT_RESUME_IN_ALL_TEXT, "Suspend(All State)", "Engineer Mode Menu Caption String"); 	
#endif
	...
	ADD_APPLICATION_STRING2 (EM_WAP_USER_AGENT_SONY_P800_TEXT      , "SONY P800", "Engineer Mode Menu Caption String");	
	ADD_APPLICATION_STRING2 (EM_WAP_USER_AGENT_NOKIA_7250i_TEXT      , "NOKIA 7250i", "Engineer Mode Menu Caption String");	
	ADD_APPLICATION_STRING2 (EM_WAP_USER_AGENT_SHARP_GX21_TEXT      , "SHARP GX21", "Engineer Mode Menu Caption String");	
	ADD_APPLICATION_STRING2 (EM_WAP_USER_AGENT_SONY_T610_TEXT      , "SONY T610", "Engineer Mode Menu Caption String");	
	ADD_APPLICATION_STRING2 (EM_WAP_USER_AGENT_SAMSUNG_TEXT      , "SAMSUNG", "Engineer Mode Menu Caption String");	
	ADD_APPLICATION_STRING2 (EM_WAP_USER_AGENT_NOKIA_6230_TEXT      , "NOKIA 6230", "Engineer Mode Menu Caption String");	
	ADD_APPLICATION_STRING2 (EM_WAP_USER_AGENT_MOTO_V303_TEXT      , "MOTO V303", "Engineer Mode Menu Caption String");	
	#if 0
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_WAP_USER_AGENT_SE_W800i_TEXT, "SE W800i", "Engineer Mode Menu Caption String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_WAP_USER_AGENT_SE_Z800_TEXT, "SE Z800", "Engineer Mode Menu Caption String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_WAP_USERAGENT_NOKIA_6630_TEXT, "NOKIA 6630", "Engineer Mode Menu Caption String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_WAP_USERAGENT_MOTO_E1000_TEXT, "MOTO E1000", "Engineer Mode Menu Caption String");
	#endif
    ...
    /******************** SW Patch *******************/	
	#if 0
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_STR_SW_PATCH_DSP, "DSP Patch", "Engineer Mode Menu Caption String");
...
#if 0
//del by reslim v0.1    ADD_APPLICATION_STRING2 (STR_ID_EM_FS_TRACE_ALL_OFF, "ALL OFF", "Engineer Mode Menu Caption String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (STR_ID_EM_FS_TRACE_ALL_ERROR, "ALL Error", "Engineer Mode Menu Caption String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (STR_ID_EM_FS_TRACE_ALL_API_ERROR, "ALL API + Error", "Engineer Mode Menu Caption String");    
	#endif
#endif 
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_IPERF_SETTING_STR, "Iperf Setting", "Engineer Mode Iperf Menu Title String");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_TCP_SETTING_STR, "TCP Settng", "Iperf Menu TCP Setting Title String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_UDP_SETTING_STR, "UDP Settng", "Iperf Menu UDP Setting Title String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_DATA_ACCOUNT_STR, "Data Account", "Iperf Menu Caption String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_CLIENT_SERVER_STR, "Client/Server", "Iperf Menu Caption String");    
 
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_CLIENT_STR, "Client", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_SERVER_STR, "Server", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_FADDR_STR, "Faddr", "Iperf Menu Caption String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_LEN_STR, "Len", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_PORT_STR, "Port", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_WINDOW_STR, "Window", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_BUFFER_STR, "Buffer", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_MSS_STR, "MSS", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_BANDWIDTH_STR, "Bandwidth (Kbps)", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_NUM_BYTES_STR, "Num(Bytes)", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_TIME_SECS_STR, "Time(Secs)", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_TOS_STR, "ToS", "Iperf Menu Caption String");        
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_DUAL_STR, "Dual Test", "Iperf Menu Caption String");        
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_BEST_EFFORT_STR, "BEST_EFFORT", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_BACK_GROUND_STR, "BACK_GROUND", "Iperf Menu Caption String");        
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_VIDEO_STR, "VIDEO", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_VOICE_STR, "VOICE", "Iperf Menu Caption String");    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_RUN_STR, "Run Iperf", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_LEN_ERR_STR, "Invalid Length", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_PORT_ERR_STR, "Invalid Port", "Iperf Menu Caption String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_WINDOW_ERR_STR, "Invalid Window", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_BUFFER_ERR_STR, "Invalid Buffer", "Iperf Menu Caption String");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_MSS_ERR_STR, "Invalid MSS", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_BANDWIDTH_ERR_STR, "Invalid Bandwidth", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_NUM_BYTES_ERR_STR, "Invalid Num(Bytes)", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_TIME_SECS_ERR_STR, "Invalid Num(Bytes)", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_FADDR_ERR_STR, "Invalid Faddr", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_SERVER_DUAL_ERR_STR, "Not Support Server Dual Mode Testing", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_CNF_FAILED_ERR_STR, "Confirm Failed", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_PROGRESSING_STR, "Progressing", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_REPORT_STR, "Iperf Report", "Iperf Menu Caption String");   
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_SOCKET_IPERF_TEST_FAILED_ERR_STR, "Test Failed", "Iperf Menu Caption String");   
	#endif
    /* END 0F IPERF */
#endif /* TCPIP */
    ...
    ADD_APPLICATION_STRING2 (EM_BT_ENTRY_TSMOD_STR_ID, "Enter Test Mode", "Engineer Mode Menu Caption String");
    ADD_APPLICATION_STRING2 (EM_BT_ENTRY_FW_VERSION_STR_ID, "Firmware Version", "Engineer Mode Menu Caption String");
    ADD_APPLICATION_STRING2 (EM_BT_ADD_SCO_LNK_STR_ID, "Add Audio Connection", "Engineer Mode Menu Caption String");
    ADD_APPLICATION_STRING2 (EM_BT_RMV_SCO_LNK_STR_ID, "Remove Audio Connection", "Engineer Mode Menu Caption String");
...
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_PROFILING_DISPLAY_TIME_TEXT, "Display Time", "Engineer Mode Profiling");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_PROFILING_GDI_PROFILE_TEXT, "GDI Image Profile", "Engineer Mode Profiling");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_PROFILING_SCREEN_DELAY_TEXT, "Screen Delay (ms)", "Engineer Mode Profiling");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_PROFILING_MATRIX_DELAY_TEXT, "Matrix Delay (ms)", "Engineer Mode Profiling");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_PROFILING_LIST_DELAY_TEXT, "List Delay (ms)", "Engineer Mode Profiling");
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_PROFILING_DELAY_OFFSET_TEXT,  "Time Offset (ms)", "Engineer Mode Profiling");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_EXTRA_LAYER, "Extra Layer",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_ROTATE, "Rotate",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_TV_OUT_MODE, "TV-Out Mode",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_RECORD_SIZE, "Record Size",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_PREVIEW_SIZE, "Preview Size",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_PLAY_SIZE, "Play Size",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_ROTATE_0, "Rotate 0",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_ROTATE_90, "Rotate 90",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_ROTATE_180, "Rotate 180",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_ROTATE_270, "Rotate 270",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_TV_FULL_SCREEN, "Full Screen",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_TV_LCD_SCREEN, "LCD Screen",	"Engineer Mode Profiling");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_SIZE_SQCIF, "SQCIF (128x96)",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_SIZE_QCIF, "QCIF (176x144)",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_SIZE_CIF, "CIF (352x288)",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_SIZE_QQVGA, "QQVGA (160x120)",	"Engineer Mode Profiling");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_SIZE_QVGA, "QQVGA (320x240)",	"Engineer Mode Profiling");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_SIZE_VGA, "QQVGA (640x480)",	"Engineer Mode Profiling");	
//del by reslim v0.1	ADD_APPLICATION_STRING2 (STR_ID_EM_PROFILING_SIZE_LCD, "LCD Size",	"Engineer Mode Profiling");		
    ...
    /* GSM -- Band */
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BAND_TEXT,  "Band", "Engineer Mode RF Test GSM Test String");                     
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BAND_GSM850_TEXT,  "GSM850", "Engineer Mode RF Test GSM Test String");                    
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BAND_GSM900_TEXT,  "GSM900", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BAND_DCS1800_TEXT,  "DCS1800", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BAND_PCS1900_TEXT,  "PCS1900", "Engineer Mode RF Test GSM Test String");  
    /* GSM -- ARFCN , TSC, PCL, AFC */
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_ARFCN_TEXT,  "ARFCN", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_TSC_TEXT,  "TSC", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_PCL_TEXT,  "PCL", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_AFC_TEXT,  "AFC", "Engineer Mode RF Test GSM Test String");  
    /* GSM -- TX Burst Type */
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BURST_TYPE_TEXT,  "Burst Type", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BURST_NB_TEXT,  "NB", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BURST_NBALL_TEXT,  "NB-All 1", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BURST_AB_TEXT,  "AB", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BURST_CONTTX00_TEXT,  "Cont. TX-0000", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BURST_CONTTX11_TEXT,  "Cont. TX-1111", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BURST_CONTTX01_TEXT,  "Cont. TX-0101", "Engineer Mode RF Test GSM Test String");  
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_BURST_CONTTX_RANDOM_TEXT,  "Cont. TX-Random", "Engineer Mode RF Test GSM Test String");  
    /* GSM -- Gain */
//del by reslim v0.1    ADD_APPLICATION_STRING2 (EM_RF_GSM_TX_GAIN_TEXT,  "Gain", "Engineer Mode RF Test GSM Test String");  
       ...
       /* WiFi TX -- Domain */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_DOMAIN_TEXT,  "Domain", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_DOMAIN_US_TEXT,  "US", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_DOMAIN_JP_TEXT,  "JP", "Engineer Mode RF Test WiFi TX Caption String");                            
       /* WiFi TX -- Channel Freq. */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_TEXT,  "CH Freq (KHz)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_1_TEXT,  "2412000 (1)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_2_TEXT,  "2417000 (2)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_3_TEXT,  "2422000 (3)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_4_TEXT,  "2427000 (4)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_5_TEXT,  "2432000 (5)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_6_TEXT,  "2437000 (6)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_7_TEXT,  "2442000 (7)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_8_TEXT,  "2447000 (8)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_9_TEXT,  "2452000 (9)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_10_TEXT,  "2457000 (10)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_11_TEXT,  "2462000 (11)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_12_TEXT,  "2467000 (12)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_13_TEXT,  "2472000 (13)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_CH_FREQ_14_TEXT,  "2484000 (14)", "Engineer Mode RF Test WiFi TX Caption String");                            
       /* WiFi TX -- TX Rate */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_TEXT,  "TX Rate", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_1_TEXT,  "1M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_2_TEXT,  "2M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_3_TEXT,  "5.5M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_4_TEXT,  "11M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_5_TEXT,  "6M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_6_TEXT,  "9M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_7_TEXT,  "12M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_8_TEXT,  "18M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_9_TEXT,  "24M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_10_TEXT,  "36M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_11_TEXT,  "48M", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_RATE_12_TEXT,  "54M", "Engineer Mode RF Test WiFi TX Caption String");                            
       /* WiFi TX -- TX Ant, Gain, pkt Count, pkt Interval, pkt Length */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_ANT_TEXT,  "TX Ant", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_GAIN_TEXT,  "Gain (Hex)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_PKT_COUNT_TEXT,  "PKT Count", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_PKT_INTERVAL_TEXT,  "PKT Interval (us)", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_PKT_LENGTH_TEXT,  "PKT Length (Byte)", "Engineer Mode RF Test WiFi TX Caption String");                            
       /* WiFi TX -- TX Pattern */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_PATTERN_TEXT,  "TX Pattern", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_PATTERN_ALL_0_TEXT,  "All 0", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_PATTERN_ALL_1_TEXT,  "All 1", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_PATTERN_ALTER_BITS_TEXT,  "Alter bits", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_PATTERN_RANDOM_TEXT,  "Random", "Engineer Mode RF Test WiFi TX Caption String");                            
       /* WiFi TX -- Short Peramble */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_SHORT_PERAMBLE_TEXT,  "Short Peramble", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_SHORT_PERAMBLE_TRUE_TEXT,  "TRUE", "Engineer Mode RF Test WiFi TX Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_SHORT_PERAMBLE_FALSE_TEXT,  "FALSE", "Engineer Mode RF Test WiFi TX Caption String");                                   
       /* WiFi TX -- MAC Header */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_TX_MAC_HEADER_TEXT,  "MAC Header (Hex)", "Engineer Mode RF Test WiFi TX Caption String");                            
       /* WiFi Power Save -- Mode */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_POWER_SAVE_MODE_TEXT,  "Mode", "Engineer Mode RF Test WiFi Power Save Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_POWER_SAVE_NORMAL_TEXT,  "Normal", "Engineer Mode RF Test WiFi Power Save Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_POWER_SAVE_IDLE_TEXT,  "Idle", "Engineer Mode RF Test WiFi Power Save Caption String");                            
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_POWER_SAVE_SLEEP_TEXT,  "Sleep", "Engineer Mode RF Test WiFi Power Save Caption String");                            
       /* WiFi Register */
       ...
       /* WiFi Register -- Type */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_REGISTER_TYPE_TEXT,  "Type", "Engineer Mode RF Test WiFi Caption String");     
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_REGISTER_16_TEXT,  "16", "Engineer Mode RF Test WiFi Caption String");     
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_REGISTER_32_TEXT,  "32", "Engineer Mode RF Test WiFi Caption String");     
       /* WiFI Register -- Access */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_REGISTER_ACCESS_TEXT,  "Access", "Engineer Mode RF Test WiFi Caption String");     
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_REGISTER_READ_TEXT,  "Read", "Engineer Mode RF Test WiFi Caption String");     
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_REGISTER_WRITE_TEXT,  "Write", "Engineer Mode RF Test WiFi Caption String");            
       /* WiFi Register -- Address, index, data */
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_REGISTER_ADDRESS_TEXT,  "Address(Hex)", "Engineer Mode RF Test WiFi Caption String");     
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_REGISTER_INDEX_TEXT,  "Index (Hex)", "Engineer Mode RF Test WiFi Caption String");     
//del by reslim v0.1       ADD_APPLICATION_STRING2 (EM_RF_WIFI_REGISTER_DATA_TEXT,  "Data (Hex)", "Engineer Mode RF Test WiFi Caption String");     
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_VOIP_P2P_CALL_TEXT, "P2P Call",	"Engineer Mode VOIP");		
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_VOIP_REREGISTER_TIMER_TEXT, "Re-register Timer",	"Engineer Mode VOIP");		
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_VOIP_CALL_REFRESH_TIMER_TEXT, "Call Refresh Timer",	"Engineer Mode VOIP");		
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_VOIP_REFER_SUB_TIMER_TEXT, "Refer Sub Timer",	"Engineer Mode VOIP");		
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_VOIP_MWI_SUB_TIMER_TEXT, "MWI Sub Timer",	"Engineer Mode VOIP");		
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_VOIP_MWI_RETRY_TIME_TEXT, "MWI Retry Time",	"Engineer Mode VOIP");			
...
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_VOIP_UAS_Refresher_TEXT, "UAS Refresher",	"Engineer Mode Menu Caption String")
//del cont.	ADD_APPLICATION_STRING2 (EM_VOIP_UAC_Refresher_TEXT, "UAC Refresher",	"Engineer Mode Menu Caption String")
//del cont.	ADD_APPLICATION_STRING2 (EM_VOIP_UAS_TEXT, "UAS",	"Engineer Mode Menu Caption String")
//del cont.	ADD_APPLICATION_STRING2 (EM_VOIP_UAC_TEXT, "UAC",	"Engineer Mode Menu Caption String")
//del cont.	ADD_APPLICATION_STRING2 (EM_VOIP_RPORT_SUPPORT_TEXT, "RPort Support",	"Engineer Mode Menu Caption String")	
//del cont.	ADD_APPLICATION_STRING2 (EM_VOIP_LOCAL_ADDR_TEXT, "Local Address",	"Engineer Mode Menu Caption String")		

#endif
#endif
    /********************* Common ********************/	
	ADD_APPLICATION_STRING2 (EM_SET_LSK_TEXT, "Set", "Engineer Mode Menu LSK String");
//del by reslim v0.1	ADD_APPLICATION_STRING2 (EM_TOGGLE_LSK_TEXT, "On/Off", "Engineer Mode Menu LSK String");
...
//	ADD_APPLICATION_STRING2 (EM_DEV_DCMMODE_ON_TEXT      , "Enable", "Engineer Mode Menu Caption String");
	...
	ADD_APPLICATION_STRING2 (EM_DEVICE_RDA_BT_TEST_VCO_TEXT, "VCO Test", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_DEVICE_RDA_BT_TEST_SINGLEHOP_TEXT, "SINGLEHOP Test", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_DEVICE_RDA_BT_TEST_CMU200_TEXT, "Integration Test ", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_DEVICE_RDA_BT_TEST_TC3000_TEXT, "CMU200 Test", "Engineer Mode Menu Caption String");
	ADD_APPLICATION_STRING2 (EM_DEVICE_RDA_BT_TEST_N4010_TEXT, "N4010 Test", "Engineer Mode Menu Caption String");
	#endif
...
#if defined(__GSM_RAT__) && defined(__WCDMA_RAT__)
	ADD_APPLICATION_MENUITEM((EM_NETWORK_PREFER_RAT_MENUID, EM_NETWORK_SETTING_MENUID, 0, 
							SHOW, NONMOVEABLE, DISP_LIST,	EM_NETWORK_PREFER_RAT_TEXT, 0));
#endif /* #if defined(__GSM_RAT__) && defined(__WCDMA_RAT__) */
...
#if (defined(MT6229) || defined(MT6227) || defined(MT6228) || defined(MT6225) || defined(MT6268T) || defined(MT6230)) 
    menu_item_count++;
#endif
...
#if (defined(__MMI_GPRS_PING_APP__) && defined(__TCPIP__) && defined(__GPRS_MODE__))
    menu_item_count ++;
#endif
#if 0
   ...
   /* Fixed Gain for Helios2 */
    ...
    ADD_APPLICATION_MENUITEM((EM_WAP_USER_AGENT_MENUID, EM_WAP_MENUID, 6,
    ...
    ADD_APPLICATION_MENUITEM((EM_WAP_USER_AGENT_MAUI_E800_MENUID, EM_WAP_USER_AGENT_MENUID, 0, 
							SHOW, NONMOVEABLE, DISP_LIST,	EM_WAP_USER_AGENT_MAUI_E800_TEXT, EM_WAP_USER_AGENT_MAUI_E800_ICON));

    ADD_APPLICATION_MENUITEM((EM_WAP_USER_AGENT_SONY_P800_MENUID, EM_WAP_USER_AGENT_MENUID, 0, 
							SHOW, NONMOVEABLE, DISP_LIST,	EM_WAP_USER_AGENT_SONY_P800_TEXT, EM_WAP_USER_AGENT_SONY_P800_ICON));

    ADD_APPLICATION_MENUITEM((EM_WAP_USER_AGENT_NOKIA_7250i_MENUID, EM_WAP_USER_AGENT_MENUID, 0, 
							SHOW, NONMOVEABLE, DISP_LIST,	EM_WAP_USER_AGENT_NOKIA_7250i_TEXT, EM_WAP_USER_AGENT_NOKIA_7250i_ICON));

    ADD_APPLICATION_MENUITEM((EM_WAP_USER_AGENT_SHARP_GX21_MENUID, EM_WAP_USER_AGENT_MENUID, 0, 
							SHOW, NONMOVEABLE, DISP_LIST,	EM_WAP_USER_AGENT_SHARP_GX21_TEXT, EM_WAP_USER_AGENT_SHARP_GX21_ICON));

    ADD_APPLICATION_MENUITEM((EM_WAP_USER_AGENT_SONY_T610_MENUID, EM_WAP_USER_AGENT_MENUID, 0, 
							SHOW, NONMOVEABLE, DISP_LIST,	EM_WAP_USER_AGENT_SONY_T610_TEXT, EM_WAP_USER_AGENT_SONY_T610_ICON));

    ADD_APPLICATION_MENUITEM((EM_WAP_USER_AGENT_SAMSUNG_MENUID, EM_WAP_USER_AGENT_MENUID, 0, 
							SHOW, NONMOVEABLE, DISP_LIST,	EM_WAP_USER_AGENT_SAMSUNG_TEXT, EM_WAP_USER_AGENT_SAMSUNG_ICON));
...
/* END OF IPERF */
    ...
    /******************** Bluetooth ******************/
#ifdef __MMI_BT_HP_SUPPORT__
	ADD_APPLICATION_MENUITEM((EM_BT_MENUID, ENGINEER_MODE_MENUID, 4,
	...
	ADD_APPLICATION_MENUITEM((EM_BT_ENTRY_TSMOD_MENUID, EM_BT_MENUID, 0,
    			             SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_ENTRY_TSMOD_STR_ID, EM_BT_ENTRY_TSMOD_IMG_ID));

	ADD_APPLICATION_MENUITEM((EM_BT_ENTRY_FW_VERSION_MENUID, EM_BT_MENUID, 0,
    			             SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_ENTRY_FW_VERSION_STR_ID, EM_BT_ENTRY_FW_VERSION_IMG_ID));

	ADD_APPLICATION_MENUITEM((EM_BT_ENTRY_ADD_SCO_LNK_MENUID, EM_BT_MENUID, 0,
    			             SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_ADD_SCO_LNK_STR_ID, EM_BT_ADD_SCO_LNK_IMG_ID));

	ADD_APPLICATION_MENUITEM((EM_BT_ENTRY_RMV_SCO_LNK_MENUID, EM_BT_MENUID, 0,
    			             SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_RMV_SCO_LNK_STR_ID, EM_BT_RMV_SCO_LNK_IMG_ID));
    ...
    /******************** Profiling ******************/
#if 0
	ADD_APPLICATION_MENUITEM(( MENU_ID_EM_PROFILING, ENGINEER_MODE_MENUID, 1, 
    ...
    /********************** VOIP *********************/
#if defined(__VOIP__)
    ADD_APPLICATION_MENUITEM((EM_VOIP_MENNUID, ENGINEER_MODE_MENUID, 3,
	...
	SetMenuItem(EM_BT_MENUID, ENGINEER_MODE_MENUID, menu_item_count,
...
/* General test */
    ...
    SetMenuItem(EM_BT_GENERNAL_TEST_MENUID, EM_BT_MENUID, menu_item_count,
    ...
    SetMenuItem(EM_BT_ENTRY_TEST_MENUID, EM_BT_GENERNAL_TEST_MENUID, 0,
    			             SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_ENTRY_TEST_STR_ID, EM_BT_ENTRY_TEST_IMG_ID);

    SetMenuItem(EM_BT_REMOVE_AUDIO_CONNECTION_MENUID, EM_BT_GENERNAL_TEST_MENUID, 0,
    			             SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_REMOVE_AUDIO_CONNECTION_STR_ID, EM_BT_DEBUG_TRACE_IMG_ID);

    SetMenuItem(EM_BT_ADD_AUDIO_CONNECTION_MENUID, EM_BT_GENERNAL_TEST_MENUID, 0,
    			             SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_ADD_AUDIO_CONNECTION_STR_ID, EM_BT_REMOVE_AUDIO_CONNECTION_IMG_ID);

	SetMenuItem(EM_BT_ENTRY_LOOPBACK_MENUID, EM_BT_GENERNAL_TEST_MENUID, 0,
    			             SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_LOOKBACK_STR_ID, 0);

#if defined(__MMI_BT_COOLSAND_SUPPORT__)
	SetMenuItem(EM_BT_EXIT_TEST_MODE_MENUID, EM_BT_GENERNAL_TEST_MENUID, 0,
    			     SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_EXIT_TEST_MODE_STR_ID, 0);
#endif
#if defined(__MMI_BT_COOLSAND_SUPPORT__) && defined(__MMI_AVRCP_DEBUG__) && defined(__MMI_AVRCP_CT_SUPPORT__)
    SetMenuItem(EM_BT_AVRCP_CMD_LIST_MENUID, EM_BT_GENERNAL_TEST_MENUID, 0,
    			     SHOW, NONMOVEABLE, DISP_LIST,	EM_BT_AVRCP_CMD_LIST_STR_ID, 0);
#endif

/* BT RF Test */
#ifdef __MMI_EM_BT_RF_TEST__
    SetMenuItem(EM_DEVICE_BT_RF_TEST_MENUID, EM_BT_MENUID, 
                                   #ifdef __BT_RDA5868__
						 5,
					#else
					        4,
		    ...
		    SetMenuItem(EM_DEVICE_RDA_BT_TEST_VCO, EM_DEVICE_BT_RF_TEST_MENUID, 0,
									  SHOW, NONMOVEABLE, DISP_LIST, EM_DEVICE_RDA_BT_TEST_VCO_TEXT, 0);

		    SetMenuItem(EM_DEVICE_RDA_BT_TEST_SINGLEHOP, EM_DEVICE_BT_RF_TEST_MENUID, 0,
									  SHOW, NONMOVEABLE, DISP_LIST, EM_DEVICE_RDA_BT_TEST_SINGLEHOP_TEXT, 0);

		    SetMenuItem(EM_DEVICE_RDA_BT_TEST_CMU200, EM_DEVICE_BT_RF_TEST_MENUID, 0,
							 		 SHOW, NONMOVEABLE, DISP_LIST, EM_DEVICE_RDA_BT_TEST_CMU200_TEXT, 0);
		    SetMenuItem(EM_DEVICE_RDA_BT_TEST_TC3000, EM_DEVICE_BT_RF_TEST_MENUID, 0,
									  SHOW, NONMOVEABLE, DISP_LIST, EM_DEVICE_RDA_BT_TEST_TC3000_TEXT, 0);

		    SetMenuItem(EM_DEVICE_RDA_BT_TEST_N4010, EM_DEVICE_BT_RF_TEST_MENUID, 0,
									  SHOW, NONMOVEABLE, DISP_LIST, EM_DEVICE_RDA_BT_TEST_N4010_TEXT, 0);

	#else
	    SetMenuItem(EM_DEVICE_BT_RF_TEST_TX_MENUID, EM_DEVICE_BT_RF_TEST_MENUID, 0,
							  SHOW, NONMOVEABLE, DISP_LIST, EM_DEV_BT_RF_TEST_TX_TEXT, 0);
	    SetMenuItem(EM_DEVICE_BT_RF_TEST_RX_MENUID, EM_DEVICE_BT_RF_TEST_MENUID, 0,
								  SHOW, NONMOVEABLE, DISP_LIST, EM_DEV_BT_RF_TEST_RX_TEXT, 0);

	    SetMenuItem(EM_DEVICE_BT_RF_TEST_BD_ADDR_MENUID, EM_DEVICE_BT_RF_TEST_MENUID, 0,
								  SHOW, NONMOVEABLE, DISP_LIST, EM_DEV_BT_RF_TEST_BD_ADDR_TEXT, 0);

	    SetMenuItem(EM_DEVICE_BT_RF_TEST_MODE_MENUID, EM_DEVICE_BT_RF_TEST_MENUID, 0,
...
/* BT Get Chip Version */
#ifdef __MMI_EM_BT_GET_CHIP_VERION__
	SetMenuItem(EM_BT_GET_CHIP_VERSION_MENUID, EM_BT_MENUID, 0,
