...
//	ADD_APPLICATION_IMAGE2(SERVICES_TITLE_IMAGE_ID,CUST_IMG_PATH"/MainLCD/TitleBar/TB_SV.gif","Title Icon for Services Menu");
//	ADD_APPLICATION_IMAGE2(SERVICES_WAP_IMAGE_ID,CUST_IMG_PATH"/MainLCD/WAP/SB_WAP.gif","WAP Menu Item Icon");
	...
	ADD_APPLICATION_IMAGE2(SAT_TITLE_IMAGE_ID_SIM1,CUST_IMG_PATH"/MainLCD/SubMenu/Services/SIMToolKit/SB_SIM1.gif","SAT Menu Item Icon");
	ADD_APPLICATION_IMAGE2(SAT_TITLE_IMAGE_ID_SIM2,CUST_IMG_PATH"/MainLCD/SubMenu/Services/SIMToolKit/SB_SIM2.gif","SAT Menu Item Icon");
	ADD_APPLICATION_IMAGE2(SAT_TITLE_IMAGE_ID_SIM3,CUST_IMG_PATH"/MainLCD/SubMenu/Services/SIMToolKit/SB_SIM3.gif","SAT Menu Item Icon");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(SAT_ABORT_STRING_ID,"Abort","Abort String for SS & USSD");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(SAT_SEND_SMS_STRING_ID,"Sending Short Message ....","Default String displayed when Sending SMS.");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(SAT_DTMF_ABORT_STRING_ID,"SAT DTMF Abort","SAT DTMF Abort.");
...
//	ADD_APPLICATION_IMAGE2(SAT_HELP_IMAGE_ID,CUST_IMG_BASE_PATH"/EmptyImage.gif","Icon for Help Button");
//del by reslim v0.1	ADD_APPLICATION_STRING2(SAT_HELP_STRING_ID,"Help","Text of Help Button");
//micha1217
