...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_MARATHI,"Multitap Marathi","Input methods list Option Multitap Mara");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_POLISH,"Multitap PO","Input methods list Option Multitap Po");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_POLISH,"Multitap po","Input methods list Option Multitap po");
#endif
 
 

#if defined(__MMI_T9_POLISH__)||defined(__MMI_ZI_POLISH__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_POLISH,"Smart PO","Input methods list Option Smart PO");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_POLISH,"Smart po","Input methods list Option Smart po");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_HUNGARIAN,"Multitap HG","Input methods list Option Multitap HG");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_HUNGARIAN,"Multitap hg","Input methods list Option Multitap hg");
#endif

#if defined(__MMI_T9_HUNGARIAN__)||defined(__MMI_ZI_HUNGARIAN__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_HUNGARIAN,"Smart HG","Input methods list Option Smart HG");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_HUNGARIAN,"Smart hg","Input methods list Option Smart hg");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_ARABIC,"Multitap Arabic","Input methods list Option Multitap AR");
#endif
 
#if defined(__MMI_MULTITAP_PERSIAN__) 
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_PERSIAN,"Multitap Persian","Input methods list Option Multitap FA");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_BULGARIAN,"Multitap BG","Input methods list Option Multitap BG");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_BULGARIAN,"Multitap bg","Input methods list Option Multitap bg");
#endif
#if defined(__MMI_T9_BULGARIAN__)|| defined (__MMI_ZI_BULGARIAN__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_BULGARIAN,"Smart BG","Input methods list Option Smart BG");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_BULGARIAN,"Smart bg","Input methods list Option Smart bg");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_HEBREW,"Smart Hebrew","Input methods list Option Smart HEBREW");
#endif	
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_HEBREW,"Multitap Hebrew","Input methods list Option Multitap Hebrew");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_CZECH,"Smart CZECH","Input methods list Option Smart CZECH");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_CZECH,"Smart czech","Input methods list Option Smart czech");
#endif	
#if defined(__MMI_MULTITAP_CZECH__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_CZECH,"Multitap CZECH","Input methods list Option Multitap CZECH");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_CZECH,"Multitap czech","Input methods list Option Multitap czech");
#endif
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_FINNISH,"Multitap FI","Input methods list Option Multitap FI");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_FINNISH,"Multitap fi","Input methods list Option Multitap fi");
#endif	
#if defined(__MMI_T9_FINNISH__)||defined(__MMI_ZI_FINNISH__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_FINNISH,"Smart FI","Input methods list Option Smart FI");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_FINNISH,"Smart fi","Input methods list Option Smart fi");
#endif
#if defined(__MMI_ZI_HUNGARIAN__)||defined(__MMI_T9_HUNGARIAN__)  
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_HUNGARIAN,"Smart HUNGARIAN","Input methods list Option Smart HUNGARIAN");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_HUNGARIAN,"Smart hungarian","Input methods list Option Smart hungarian");
#endif	
#if defined(__MMI_MULTITAP_HUNGARIAN__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_HUNGARIAN,"Multitap HUNGARIAN","Input methods list Option Multitap HUNGARIAN");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_HUNGARIAN,"Multitap hungarian","Input methods list Option Multitap hungarian");
#endif
 
 
 
#if defined(__MMI_T9_NORWEGIAN__)  ||defined(__MMI_ZI_NORWEGIAN__)  
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_NORWEGIAN,"Smart NO","Input methods list Option Smart NO");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_NORWEGIAN,"Smart no","Input methods list Option Smart no");
#endif	
 
#if defined(__MMI_MULTITAP_NORWEGIAN__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_NORWEGIAN,"Multitap NO","Input methods list Option Multitap NO");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_NORWEGIAN,"Multitap no","Input methods list Option Multitap no");
#endif
//Norwegian end
#if defined(__MMI_MULTITAP_SLOVAK__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_SLOVAK,"Multitap SK","Input methods list Option Multitap SK");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_SLOVAK,"Multitap sk","Input methods list Option Multitap sk");
#endif	
#if defined(__MMI_T9_SLOVAK__)||defined(__MMI_ZI_SLOVAK__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_SLOVAK,"Smart SK","Input methods list Option Smart SK");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_SLOVAK,"Smart sk","Input methods list Option Smart sk");
#endif
#if defined(__MMI_ZI_DUTCH__)||defined(__MMI_T9_DUTCH__)  
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_DUTCH,"Smart NL","Input methods list Option Smart VI");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_DUTCH,"Smart nl","Input methods list Option Smart vi");
#endif	
#if defined(__MMI_MULTITAP_DUTCH__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_DUTCH,"Multitap NL","Input methods list Option Multitap VI");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_DUTCH,"Multitap nl","Input methods list Option Multitap vi");
#endif
 
 
#if defined(__MMI_MULTITAP_SWEDISH__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_SWEDISH,"Multitap SV","Input methods list Option Multitap SV");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_SWEDISH,"Multitap sv","Input methods list Option Multitap sv");
#endif	
#if defined(__MMI_T9_SWEDISH__)||defined(__MMI_ZI_SWEDISH__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_SWEDISH,"Smart SV","Input methods list Option Smart SV");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_SWEDISH,"Smart sv","Input methods list Option Smart sv");
#endif
 

 
#if defined(__MMI_MULTITAP_CROATIAN__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_CROATIAN,"Multitap HR","Input methods list Option Multitap HR");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_CROATIAN,"Multitap hr","Input methods list Option Multitap hr");
#endif	
#if defined(__MMI_T9_CROATIAN__)||defined(__MMI_ZI_CROATIAN__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_CROATIAN,"Smart HR","Input methods list Option Smart HR");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_CROATIAN,"Smart hr","Input methods list Option Smart hr");
#endif
 
#if defined(__MMI_ZI_ROMANIAN__)||defined(__MMI_T9_ROMANIAN__)
 
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_ROMANIAN,"Smart RO","Input methods list Option Smart RM");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_ROMANIAN,"Smart ro","Input methods list Option Smart rm");
#endif	
#if defined(__MMI_MULTITAP_ROMANIAN__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_ROMANIAN,"Multitap RO","Input methods list Option Multitap RM");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_ROMANIAN,"Multitap ro","Input methods list Option Multitap rm");
#endif
#if defined(__MMI_MULTITAP_SLOVENIAN__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_SLOVENIAN,"Multitap SL","Input methods list Option Multitap SL");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_SLOVENIAN,"Multitap sl","Input methods list Option Multitap sl");
#endif	
#if defined(__MMI_T9_SLOVENIAN__)||defined(__MMI_ZI_SLOVENIAN__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_SLOVENIAN,"Smart SL","Input methods list Option Smart SL");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_SLOVENIAN,"Smart sl","Input methods list Option Smart sl");
#endif
 

 
#if defined(__MMI_MULTITAP_GREEK__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_U_GREEK,"Multitap EL","Input methods list Option Multitap EL");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_L_GREEK,"Multitap el","Input methods list Option Multitap el");
#endif	
#if defined(__MMI_T9_GREEK__)||defined(__MMI_ZI_GREEK__)
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_U_GREEK,"Smart EL","Input methods list Option Smart EL");
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_L_GREEK,"Smart el","Input methods list Option Smart el");
#endif
...
#if 0
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_APPMEM_WAITING_FOR_STOP, "Please Wait...", "Waiting for stopping an application");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_APPMEM_ATTR_STOPPING, " (Stopping)", "Attribute of an application being stopped");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_APPMEM_PROMPT_STOP_APP, "Stop other applications to release memory", "help text");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_APPMEM_STOP, "Stop", "Stop text "); 
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_APPMEM_WAIT, "Wait", "Wait text in Softkey");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_APPMEM_OUT_OF_MEMORY, "Out of Memory", "Out of Memory");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_APPMEM_NOTIFY_STARTING_NEW, "Starting New Application", "Dialog message");        
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_APPMEM_NOTIFY_STOPPED, "Application Stopped", "Dialog message");
//del by reslim v0.1    ADD_APPLICATION_STRING2(STR_ID_APPMEM_NOTIFY_STOP_FAILED, "Failed to Stop Application", "Dialog message");    
#endif    
}
