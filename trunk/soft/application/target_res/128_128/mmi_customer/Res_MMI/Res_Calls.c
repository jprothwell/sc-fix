...
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_ID_CHIST_OPTION_SENDMMS, "Send MMS",
//del cont.	                         "Send MMS message to caller" );
*/
	...
	ADD_APPLICATION_STRING2( STR_SCR8069_CAPTION1, "Call Info",
	                         "Recd. call list options title string" );
	ADD_APPLICATION_IMAGE2( IMG_SCR8069_CAPTION, CUST_IMG_PATH"/MainLCD/TitleBar/TB_CA.gif",
...
*/
	...
	ADD_APPLICATION_IMAGE2( IMG_SCR8070_CAPTION, CUST_IMG_PATH"/MainLCD/TitleBar/TB_CA.gif",
...
*/
	...
	ADD_APPLICATION_IMAGE2( IMG_SCR8071_CAPTION, CUST_IMG_PATH"/MainLCD/TitleBar/TB_CA.gif",
...
*/
	...
	ADD_APPLICATION_IMAGE2( IMG_SCR8008_CAPTION,
	                         CUST_IMG_PATH"/MainLCD/TitleBar/TB_CA.gif",
	                         "IMG_SCR8008_CAPTION" );
   ...
   ADD_APPLICATION_STRING2(STR_MISSED_CALL,"Missed Call!",
	...
	ADD_APPLICATION_IMAGE2( IMG_NAME_ENTRY,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/CallInfo/CI_NAME.gif",
	                        "Call Info Name Image" );
	ADD_APPLICATION_IMAGE2( IMG_NUMBER_ENTRY,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/CallInfo/CI_PHONE.gif",
	                        "Call Info Number Image" );
	ADD_APPLICATION_IMAGE2( IMG_TIME_ENTRY,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/CallInfo/CI_TIME.gif",
	                        "Call Info Time Image" );
	ADD_APPLICATION_IMAGE2( IMG_DATE_ENTRY,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/CallInfo/CI_DATE.gif",
	                        "Call Info Date Image" );
	ADD_APPLICATION_IMAGE2( IMG_COUNT_ENTRY,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/CallInfo/CI_IRP.gif",
	                        "Call Info number of times Image" );

   ADD_APPLICATION_IMAGE2(IMG_ID_CHIST_DURATION	,	
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/CallInfo/CI_Duration.gif",
   ...
   ADD_APPLICATION_IMAGE2(IMG_CM_STATE_MISSED	,	
	...
	ADD_APPLICATION_IMAGE2( IMG_CALL_SIM_SELECT_CAPTION, CUST_IMG_PATH"/MainLCD/TitleBar/TB_CA_SIM.gif","CALL SELECT SIM  CAPTION IMG" );
#endif
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD2_MENU_RECEIVED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD2/RECVED_CALL_2.gif", "Image for recd Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD1_MENU_RECEIVED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD1/RECVED_CALL_1.gif", "Image for recd Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD2_MENU_DIALED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD2/DIALED_CALL_2.gif", "Image for Dialed Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD1_MENU_DIALED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD1/DIALED_CALL_1.gif", "Image for Dialed Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD2_MENU_MISSED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD2/MISSED_CALL_2.gif", "Image for Missed Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD1_MENU_MISSED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD1/MISSED_CALL_1.gif", "Image for Missed Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD2_MENU_REJECTED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD2/REJECTED_CALL_2.gif", "Image for Rejected Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD1_MENU_REJECTED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD1/REJECTED_CALL_1.gif", "Image for Rejected Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_SCR_RESETCALLS, CUST_IMG_PATH "/MainLCD/Call/SubMenu/SB_CRSET.gif", "RESET CALLS CONFIRM SCR  RSK IMG ");
	...
	#if (MMI_SIM_NUMBER >= 3)
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD3_MENU_RECEIVED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD2/RECVED_CALL_3.gif", "Image for recd Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD3_MENU_DIALED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD2/DIALED_CALL_3.gif", "Image for Dialed Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD3_MENU_MISSED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD2/MISSED_CALL_3.gif", "Image for Missed Calls option");
	ADD_APPLICATION_IMAGE2(IMG_MTPNP_CARD3_MENU_REJECTED_CALLS, CUST_IMG_PATH "/MainLCD/DualSIM/CHIS/CARD2/REJECTED_CALL_3.gif", "Image for Rejected Calls option");
	#endif
	#if (MMI_SIM_NUMBER >=4)
...
#ifdef __MMI_VOIP__
//del by reslim v0.1   ADD_APPLICATION_IMAGE2(IMG_ID_CHIST_VOIP_RECEIVED_CALLS	,	
//del cont.	                        CUST_IMG_PATH"/MainLCD/VOIP/Call/CallLog/VoIP_CREC.gif",
//del cont.	                        "Received Call icon" );
//del by reslim v0.1   ADD_APPLICATION_IMAGE2(IMG_ID_CHIST_VOIP_DIALED_CALLS	,	
//del cont.	                        CUST_IMG_PATH"/MainLCD/VOIP/Call/CallLog/VoIP_CDIA.gif",
//del cont.	                        "Dialed Call icon" );
//del by reslim v0.1   ADD_APPLICATION_IMAGE2(IMG_ID_CHIST_VOIP_MISSED_CALLS	,	
//del cont.	                        CUST_IMG_PATH"/MainLCD/VOIP/Call/CallLog/VoIP_CMIS.gif",
//del cont.	                        "Missed Call icon" );
#endif /* __MMI_VOIP__ */
}
...
//del by reslim v0.1	ADD_APPLICATION_STRING2( STR_RESET_ALL_CALL_TIME, "Deleted",
//del cont.	                         "ALL CALL TIMES RESETED " );
	...
	ADD_APPLICATION_IMAGE2( IMG_MENU_CALL_TIMES,
		...
		ADD_APPLICATION_IMAGE2( IMG_CALL_TIMES_MAIN_MENU,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/SB_CTIME.gif",
	                        "RESET CALLS CONFIRM SCR  RSK IMG " );

	ADD_APPLICATION_IMAGE2( IMG_QUICK_END_MAIN_MENU,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/SB_CEND.gif",
	                        "AUTO QUICK END IMG " );
#endif
	return;
}
...
void PopulateCallCost(void )
{
	...
	ADD_APPLICATION_IMAGE2( IMG_SCR_CALL_COST_MAIN_CAP,
		...
		ADD_APPLICATION_IMAGE2( IMG_CALL_COST_MAIN_MENU,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/SB_COAST.gif",
	                        "RESET CALLS CONFIRM SCR  RSK IMG " );
#endif
	        /*  Add Rejected call image  Kenneth     */
#ifdef __MMI_MULTI_SIM__
	 ADD_APPLICATION_IMAGE2( IMG_SI_CARD1REJECTED_CALL_INDICATOR, CUST_IMG_PATH"/MainLCD/IdleScreen/Statusicons/SI_MCA_SIM1.gif", "RESET CALLS CONFIRM SCR  RSK IMG " );
	...
	ADD_APPLICATION_IMAGE2( IMG_MENU8104_REJECTED_CALLS,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/SB_REJ.gif",
	                        "RESET CALLS CONFIRM SCR  RSK IMG " );
#endif		
...
void AddSMSCounterApplicationRes( void )
{
	...
	ADD_APPLICATION_IMAGE2( IMG_SMS_COUNTER_MENU,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/SB_CSMS.gif",
...
void PopulateResetCallRes()
{
	...
	ADD_APPLICATION_IMAGE2( IMG_SCR_RESETCALLS,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/SB_CRSET.gif",
	                        "RESET CALLS CONFIRM SCR  RSK IMG " );
#endif		
//del by reslim v0.1	ADD_APPLICATION_IMAGE2( IMG_SCR_RESETCALLS_CONFIRM,
//del cont.	                        CUST_IMG_PATH"/MainLCD/Warningpage/PopUpPage/PP_DEL.gif",
//del cont.	                        "RESET CALLS CONFIRM SCR  RSK IMG " );
...
void AddGPRSCounterApplicationRes( void )
{
	...
	ADD_APPLICATION_IMAGE2( IMG_GPRS_COUNTER_MENU,
	                        CUST_IMG_PATH"/MainLCD/Call/SubMenu/SB_CGPRS.gif",
	                        "DELETE ALL entry image" );
