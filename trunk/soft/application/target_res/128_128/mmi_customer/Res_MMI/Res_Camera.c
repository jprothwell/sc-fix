...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_CAMERA_DSC_MODE,					"DSC Mode",			"[Menu-Shot Mode]");	
	#endif
	ADD_APPLICATION_STRING2(STR_ID_CAMERA_WB,							"White Balance",		"[Menu-White Balance]");
	#if 0
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_CAMERA_WB_HELP,					"Manual help",			"Please take a white paper to config manual white balance setting.");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_CAMERA_CLOSEUP,					"Closeup Mode",		"[Menu-Closeup Mode]");
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_CAMERA_EFFECT_CUSTOM_FX_EDIT_RESTORE_DEFAULT,	"Restore Default",	"[Menu-Restore Default]");	
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_CAMERA_ADD_FRAME_NORMAL,		"Wall Paper Frame",	"[Sub Menu-Wall Paper Frame]");
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_TILESHOT__	
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_CAMERA_ADD_FRAME_TILESHOT,	"Tile Shot Frame",	"[Sub Menu-Tile Shot Frame]");
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX__
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_CAMERA_ADD_FRAME_COLOR_IDX,	"Color Index Frame",	"[Sub Menu-Color Idx Frame]");
#endif
#endif
...
//#endif	/* __CAMERA_FEATURE_STORAGE__ */
	...
	#endif	
/*
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_WB_LEFT_ARROW_UP,		
//del cont.		CAMERA_OSD_PATH"CAM_wb_left_arrow.gif", "IMG_ID_CAMERA_OSD_WB_LEFT_ARROW_UP" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_WB_RIGHT_ARROW_UP,		
//del cont.		CAMERA_OSD_PATH"CAM_wb_right_arrow.gif", "IMG_ID_CAMERA_OSD_WB_RIGHT_ARROW_UP" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_WB_LEFT_ARROW_DOWN,		
//del cont.		CAMERA_OSD_PATH"CAM_wb_left_arrow_sel.gif", "IMG_ID_CAMERA_OSD_WB_LEFT_ARROW_DOWN" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_WB_RIGHT_ARROW_DOWN,		
//del cont.		CAMERA_OSD_PATH"CAM_wb_right_arrow_sel.gif", "IMG_ID_CAMERA_OSD_WB_RIGHT_ARROW_DOWN" );
*/
...
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_FLASH_OFF,		
//del cont.			CAMERA_OSD_PATH"CAM_flash_off.pbm", "IMG_ID_CAMERA_OSD_FLASH_OFF" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_FLASH_ON,		
//del cont.			CAMERA_OSD_PATH"CAM_flash_on.pbm", "IMG_ID_CAMERA_OSD_FLASH_ON" );

	#ifdef __CAMERA_FEATURE_FLASH_AUTO__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_FLASH_AUTO,		
//del cont.			CAMERA_OSD_PATH"CAM_flash_auto.pbm", "IMG_ID_CAMERA_OSD_FLASH_AUTO" );
	#endif

	#ifdef __CAMERA_FEATURE_FLASH_REDEYE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_FLASH_REDEYE,		
//del cont.			CAMERA_OSD_PATH"CAM_flash_redeye.pbm", "IMG_ID_CAMERA_OSD_FLASH_REDEYE" );
	#endif	
...
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_OFF,		
//del cont.			CAMERA_OSD_PATH"CAM_led_off.gif", "IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_OFF" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_ON,		
//del cont.			CAMERA_OSD_PATH"CAM_led_on.gif", "IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_ON" );
...
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_WHITE,		
//del cont.			CAMERA_OSD_PATH"CAM_led_white.gif", "IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_WHITE" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_RED,		
//del cont.			CAMERA_OSD_PATH"CAM_led_red.gif", "IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_RED" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_GREEN,		
//del cont.			CAMERA_OSD_PATH"CAM_led_green.gif", "IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_GREEN" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_BLUE,		
//del cont.			CAMERA_OSD_PATH"CAM_led_blue.gif", "IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_BLUE" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_PURPLE,		
//del cont.			CAMERA_OSD_PATH"CAM_led_purple.gif", "IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_PURPLE" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_YELLOW,		
//del cont.			CAMERA_OSD_PATH"CAM_led_yellow.gif", "IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_YELLOW" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_CYAN,
//del cont.			CAMERA_OSD_PATH"CAM_led_cyan.gif", "IMG_ID_CAMERA_OSD_LED_HIGHLIGHT_CYAN" );
	...
	#ifdef __CAMERA_FEATURE_EV_4__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EV_P4,		
//del cont.			CAMERA_OSD_PATH"CAM_ev_p4.gif", "IMG_ID_CAMERA_OSD_EV_P4" );
	#endif 
	
	#ifdef __CAMERA_FEATURE_EV_3__	
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EV_P3,		
//del cont.			CAMERA_OSD_PATH"CAM_ev_p3.pbm", "IMG_ID_CAMERA_OSD_EV_P3" );
	#endif 


//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_BRIGHT_5,		
//del cont.			CAMERA_OSD_PATH"CAM_ev_p2.pbm", "IMG_ID_CAMERA_OSD_EV_P2" );

	
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_BRIGHT_4,		
//del cont.			CAMERA_OSD_PATH"CAM_ev_p1.pbm", "IMG_ID_CAMERA_OSD_EV_P1" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_BRIGHT_3,		
//del cont.			CAMERA_OSD_PATH"CAM_ev_0.pbm", "IMG_ID_CAMERA_OSD_EV_0" );

//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_BRIGHT_2,		
//del cont.			CAMERA_OSD_PATH"CAM_ev_n1.pbm", "IMG_ID_CAMERA_OSD_EV_N1" );
	...
	#ifdef __CAMERA_FEATURE_EV_3__		
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EV_N3,		
//del cont.			CAMERA_OSD_PATH"CAM_ev_n3.pbm", "IMG_ID_CAMERA_OSD_EV_N3" );
	#endif

	#ifdef __CAMERA_FEATURE_EV_4__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EV_N4,		
//del cont.			CAMERA_OSD_PATH"CAM_ev_n4.pbm", "IMG_ID_CAMERA_OSD_EV_N4" );
	#endif 
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_NIGHT_OFF,		
//del cont.		CAMERA_OSD_PATH"CAM_night_off.pbm", "IMG_ID_CAMERA_OSD_NIGHT_OFF" );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_NIGHT_ON,		
//del cont.		CAMERA_OSD_PATH"CAM_night_on.pbm", "IMG_ID_CAMERA_OSD_NIGHT_ON" );
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_CLOSEUP_OFF,		
//del cont.		CAMERA_OSD_PATH"CAM_close_off.gif", "IMG_ID_CAMERA_OSD_CLOSEUP_OFF" );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_CLOSEUP_ON,		
//del cont.		CAMERA_OSD_PATH"CAM_close_on.gif", "IMG_ID_CAMERA_OSD_CLOSEUP_ON" );
	
#endif /* __CAMERA_FEATURE_CLOSEUP__ */

	/*********** Image Size *************/
#if defined(MEM_ULC_3216) && ! defined(__MMI_CAMERA_NO_OSD__)
#ifdef __CAMERA_FEATURE_IMAGE_SIZE_SS__
	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_IMAGE_SIZE_SS,
		CAMERA_OSD_PATH"CAM_imgsize_128x160.gif", "IMG_ID_CAMERA_OSD_IMAGE_SIZE_SS" );
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_SIZE_S__
	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_IMAGE_SIZE_S,
		CAMERA_OSD_PATH"CAM_imgsize_176x220.gif", "IMG_ID_CAMERA_OSD_IMAGE_SIZE_S" );
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_SIZE_M__
	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_IMAGE_SIZE_M,
		CAMERA_OSD_PATH"CAM_imgsize_320x240.gif", "IMG_ID_CAMERA_OSD_IMAGE_SIZE_M" );
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_SIZE_L__
	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_IMAGE_SIZE_L,
		CAMERA_OSD_PATH"CAM_imgsize_640x480.gif", "IMG_ID_CAMERA_OSD_IMAGE_SIZE_L" ); 
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_SIZE_LL__
	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_IMAGE_SIZE_LL,
		CAMERA_OSD_PATH"CAM_imgsize_1280x1024.gif", "IMG_ID_CAMERA_OSD_IMAGE_SIZE_LL" );
#endif 
#endif
	...
	/*********** Iamge Qty *************/
#ifdef __CAMERA_FEATURE_IMAGE_QTY_LOW__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_IMAGE_QTY_LOW,		
//del cont.		CAMERA_OSD_PATH"CAM_imgqty_low.pbm", "IMG_ID_CAMERA_OSD_IMAGE_QTY_LOW" );
#endif

#ifdef __CAMERA_FEATURE_IMAGE_QTY_NORMAL__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_IMAGE_QTY_NORMAL,		
//del cont.		CAMERA_OSD_PATH"CAM_imgqty_normal.pbm", "IMG_ID_CAMERA_OSD_IMAGE_QTY_NORMAL" );
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_QTY_HIGH__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_IMAGE_QTY_HIGH,		
//del cont.		CAMERA_OSD_PATH"CAM_imgqty_high.pbm", "IMG_ID_CAMERA_OSD_IMAGE_QTY_HIGH" );
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_QTY_FINE__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_IMAGE_QTY_FINE,		
//del cont.		CAMERA_OSD_PATH"CAM_imgqty_fine.pbm", "IMG_ID_CAMERA_OSD_IMAGE_QTY_FINE" );
#endif 
...
#ifdef __CAMERA_AUTOFOCUS_METERING__
	#ifdef __CAMERA_AUTOFOCUS_1_ZONE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AUTOFOCUS_1_ZONE,			
//del cont.			CAMERA_OSD_PATH"CAM_af_1_zone.gif", "IMG_ID_CAMERA_OSD_AUTOFOCUS_1_ZONE" );	
	#endif
	#ifdef __CAMERA_AUTOFOCUS_3_ZONE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AUTOFOCUS_3_ZONE,			
//del cont.			CAMERA_OSD_PATH"CAM_af_3_zone.gif", "IMG_ID_CAMERA_OSD_AUTOFOCUS_3_ZONE" );	
	#endif
	#ifdef __CAMERA_AUTOFOCUS_5_ZONE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AUTOFOCUS_5_ZONE,			
//del cont.			CAMERA_OSD_PATH"CAM_af_5_zone.gif", "IMG_ID_CAMERA_OSD_AUTOFOCUS_5_ZONE" );	
	#endif
#endif

#ifdef __CAMERA_AUTOFOCUS_MODE__
	#ifdef __CAMERA_AUTOFOCUS_MODE_AUTO__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AUTOFOCUS_MODE_AUTO,			
//del cont.			CAMERA_OSD_PATH"CAM_af_mode_auto.gif", "IMG_ID_CAMERA_OSD_AUTOFOCUS_MODE_AUTO" );	
	#endif
	#ifdef __CAMERA_AUTOFOCUS_MODE_MACRO__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AUTOFOCUS_MODE_MACRO,			
//del cont.			CAMERA_OSD_PATH"CAM_af_mode_macro.gif", "IMG_ID_CAMERA_OSD_AUTOFOCUS_MODE_MACRO" );	
	#endif
	#ifdef __CAMERA_AUTOFOCUS_MODE_INFINITE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AUTOFOCUS_MODE_INFINITE,			
//del cont.			CAMERA_OSD_PATH"CAM_af_mode_infinite.gif", "IMG_ID_CAMERA_OSD_AUTOFOCUS_MODE_INFINITE" );	
	#endif
	#ifdef __CAMERA_AUTOFOCUS_MODE_MANUAL__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AUTOFOCUS_MODE_MANUAL,			
//del cont.			CAMERA_OSD_PATH"CAM_af_mode_manual.gif", "IMG_ID_CAMERA_OSD_AUTOFOCUS_MANUAL_MODE_MANURL" );	
	#endif

//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_NORMAL_WHITE,			
//del cont.		CAMERA_OSD_PATH"CAM_af_white_normal.gif", "IMG_ID_CAMERA_AUTOFOCUS_NORMAL_WHITE" );	
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_NORMAL_RED,			
//del cont.		CAMERA_OSD_PATH"CAM_af_red_normal.gif", "IMG_ID_CAMERA_AUTOFOCUS_NORMAL_RED" );	
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_NORMAL_GREEN,
//del cont.		CAMERA_OSD_PATH"CAM_af_green_normal.gif", "IMG_ID_CAMERA_AUTOFOCUS_NORMAL_GREEN" );	
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_SMALL_WHITE,
//del cont.		CAMERA_OSD_PATH"CAM_af_white_small.gif", "IMG_ID_CAMERA_AUTOFOCUS_SMALL_WHITE" );	
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_SMALL_RED,
//del cont.		CAMERA_OSD_PATH"CAM_af_red_small.gif", "IMG_ID_CAMERA_AUTOFOCUS_SMALL_RED" );	
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_SMALL_GREEN,
//del cont.		CAMERA_OSD_PATH"CAM_af_green_small.gif", "IMG_ID_CAMERA_AUTOFOCUS_SMALL_GREE" );	
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_SMALL_GRAY,
//del cont.		CAMERA_OSD_PATH"CAM_af_gray_small.gif", "IMG_ID_CAMERA_AUTOFOCUS_SMALL_GRAY" );	
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_LARGE_WHITE,
//del cont.		CAMERA_OSD_PATH"CAM_af_white_large.gif", "IMG_ID_CAMERA_AUTOFOCUS_LARGE_WHITE" );	
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_LARGE_RED,
//del cont.		CAMERA_OSD_PATH"CAM_af_red_large.gif", "IMG_ID_CAMERA_AUTOFOCUS_LARGE_RED" );	
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_AUTOFOCUS_LARGE_GREEN,
//del cont.		CAMERA_OSD_PATH"CAM_af_green_large.gif", "IMG_ID_CAMERA_AUTOFOCUS_LARGE_GREEN" );	
	#endif 
...
#ifdef __CAMERA_DSC_MODE__
	#ifdef __CAMERA_DSC_MODE_AUTO__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DSC_MODE_AUTO,		
//del cont.			CAMERA_OSD_PATH"CAM_DSCmode_auto.gif", "IMG_ID_CAMERA_OSD_DSC_MODE_AUTO" );	
	#endif 
	#ifdef __CAMERA_DSC_MODE_SHUTTER_PRI__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DSC_MODE_SHUTTER_PRI,		
//del cont.			CAMERA_OSD_PATH"CAM_DSCmode_shutter.gif", "IMG_ID_CAMERA_OSD_DSC_MODE_SHUTTER_PRI" );		
	#endif 
	#ifdef __CAMERA_DSC_MODE_APERTURE_PRI__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DSC_MODE_APERTURE_PRI,		
//del cont.			CAMERA_OSD_PATH"CAM_DSCmode_aperture.gif", "IMG_ID_CAMERA_OSD_DSC_MODE_APERTURE_PRI" );		
	#endif 
	#ifdef __CAMERA_DSC_MODE_PORTRAIT__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DSC_MODE_PORTRAIT,		
//del cont.			CAMERA_OSD_PATH"CAM_DSCmode_portrait.gif", "IMG_ID_CAMERA_OSD_DSC_MODE_PORTRAIT" );		
	#endif 
	#ifdef __CAMERA_DSC_MODE_LANDSCAPE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DSC_MODE_LANDSCAPE,		
//del cont.			CAMERA_OSD_PATH"CAM_DSCmode_landscape.gif", "IMG_ID_CAMERA_OSD_DSC_MODE_LANDSCAPE" );		
	#endif 
	#ifdef __CAMERA_DSC_MODE_SPORT__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DSC_MODE_SPORT,		
//del cont.			CAMERA_OSD_PATH"CAM_DSCmode_spot.gif", "IMG_ID_CAMERA_OSD_DSC_MODE_SPORT" );		
	#endif 
	#ifdef __CAMERA_DSC_MODE_FLOWER__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DSC_MODE_FLOWER,		
//del cont.			CAMERA_OSD_PATH"CAM_DSCmode_flower.gif", "IMG_ID_CAMERA_OSD_DSC_MODE_FLOWER" );		
	#endif 
	#ifdef __CAMERA_DSC_MODE_NIGHT__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DSC_MODE_NIGHT,		
//del cont.			CAMERA_OSD_PATH"CAM_DSCmode_night.gif", "IMG_ID_CAMERA_OSD_DSC_MODE_NIGHT" );		
	#endif 
	...
	#ifdef __CAEMRA_FEATURE_ISO_AUTO__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ISO_AUTO,		
//del cont.			CAMERA_OSD_PATH"CAM_iso_auto.gif", "IMG_ID_CAMERA_OSD_ISO_AUTO" );			
	#endif 

	#ifdef __CAEMRA_FEATURE_ISO_100__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ISO_100,		
//del cont.			CAMERA_OSD_PATH"CAM_iso_100.gif", "IMG_ID_CAMERA_OSD_ISO_100" );			
	#endif 

	#ifdef __CAEMRA_FEATURE_ISO_200__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ISO_200,		
//del cont.			CAMERA_OSD_PATH"CAM_iso_200.gif", "IMG_ID_CAMERA_OSD_ISO_200" );			
	#endif 

	#ifdef __CAEMRA_FEATURE_ISO_400__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ISO_400,		
//del cont.			CAMERA_OSD_PATH"CAM_iso_400.gif", "IMG_ID_CAMERA_OSD_ISO_400" );			
	#endif 
	...
	#ifdef __CAMERA_FEATURE_AE_METER_AUTO__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AE_METER_AUTO,		
//del cont.			CAMERA_OSD_PATH"CAM_ae_meter_auto.gif", "IMG_ID_CAMERA_OSD_AE_METER_AUTO" );		
	#endif 

	#ifdef __CAMERA_FEATURE_AE_METER_SPOT__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AE_METER_SPOT,		
//del cont.			CAMERA_OSD_PATH"CAM_ae_meter_spot.gif", "IMG_ID_CAMERA_OSD_AE_METER_SPOT" );		
	#endif 

	#ifdef __CAMERA_FEATURE_AE_METER_CENTER__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AE_METER_CENTER,		
//del cont.			CAMERA_OSD_PATH"CAM_ae_meter_center.gif", "IMG_ID_CAMERA_OSD_AE_METER_CENTER" );		
	#endif 

	#ifdef __CAMERA_FEATURE_AE_METER_AVERAGE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_AE_METER_AVERAGE,		
//del cont.			CAMERA_OSD_PATH"CAM_ae_meter_average.gif", "IMG_ID_CAMERA_OSD_AE_METER_AVERAGE" );		
	#endif 
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_1,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_1" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_2__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_2,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_2" );
#endif 

#ifdef __CAMERA_FEATURE_ADD_FRAME_3__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_3,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_3" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_4__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_4,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_4" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_5__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_5,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_5" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_6__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_6,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_6" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_7__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_7,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_7" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_8__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_8,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_8" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_9__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_9,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_9" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_10__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_ADD_FRAME_10,		
//del cont.		CAMERA_OSD_PATH"CAM_add_frame.JPG", "IMG_ID_CAMERA_OSD_ADD_FRAME_10" );
#endif 
	...
	/*********** Add Frame *************/
#ifdef __CAMERA_FEATURE_ADD_FRAME_1__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_1,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_01.gif", "IMG_ID_CAMERA_ADD_FRAME_1" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_2__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_2,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_02.gif", "IMG_ID_CAMERA_ADD_FRAME_2" );
#endif 

#ifdef __CAMERA_FEATURE_ADD_FRAME_3__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_3,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_03.gif", "IMG_ID_CAMERA_ADD_FRAME_3" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_4__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_4,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_04.gif", "IMG_ID_CAMERA_ADD_FRAME_4" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_5__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_5,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_05.gif", "IMG_ID_CAMERA_ADD_FRAME_5" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_6__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_6,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_06.gif", "IMG_ID_CAMERA_ADD_FRAME_6" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_7__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_7,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_07.gif", "IMG_ID_CAMERA_ADD_FRAME_7" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_8__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_8,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_08.gif", "IMG_ID_CAMERA_ADD_FRAME_8" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_9__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_9,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_09.gif", "IMG_ID_CAMERA_ADD_FRAME_9" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_10__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ADD_FRAME_10,		
//del cont.		CAMERA_OSD_PATH"CAM_frame_10.gif", "IMG_ID_CAMERA_ADD_FRAME_10" );
#endif 
...
#if !defined(MMI_ULC)
#ifdef __CAMERA_FEATURE_ADD_FRAME_1__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_1,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_01.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_1" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_2__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_2,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_02.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_2" );
#endif 

#ifdef __CAMERA_FEATURE_ADD_FRAME_3__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_3,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_03.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_3" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_4__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_4,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_04.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_4" );
#endif
#endif	//!defined(MMI_ULC)
#ifdef __CAMERA_FEATURE_ADD_FRAME_5__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_5,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_05.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_5" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_6__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_6,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_06.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_6" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_7__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_7,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_07.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_7" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_8__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_8,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_08.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_8" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_9__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_9,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_09.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_9" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_10__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_TILE_ADD_FRAME_10,		
//del cont.		CAMERA_OSD_PATH"CAM_tile_frame_10.gif", "IMG_ID_CAMERA_TILE_ADD_FRAME_10" );
#endif 

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_1__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_1,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_01.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_1" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_1,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_01.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_1" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_2__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_2,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_02.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_2" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_2,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_02.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_2" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_3__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_3,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_03.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_3" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_3,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_03.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_3" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_4__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_4,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_04.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_4" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_4,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_04.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_4" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_5__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_5,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_05.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_5" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_5,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_05.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_5" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_6__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_6,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_06.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_6" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_6,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_06.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_6" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_7__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_7,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_07.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_7" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_7,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_07.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_7" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_8__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_8,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_08.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_8" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_8,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_08.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_8" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_9__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_9,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_09.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_9" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_9,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_09.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_9" );
#endif

#ifdef __CAMERA_FEATURE_ADD_FRAME_COLOR_IDX_10__
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_10,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx_frame_10.gif","IMG_ID_CAMERA_COLOR_IDX_ADD_FRAME_10" );
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_10,
//del cont.		CAMERA_OSD_PATH"CAM_color_idx2_frame_10.gif","IMG_ID_CAMERA_COLOR_IDX2_ADD_FRAME_10" );
#endif

	/********** Cont Shot **********/
#ifdef __CAMERA_FEATURE_CONT_SHOT__

//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_CONT_SHOT_OFF,		
//del cont.		CAMERA_OSD_PATH"CAM_cshot_off.gif", "IMG_ID_CAMERA_OSD_CONT_SHOT_OFF" );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_CONT_SHOT_1,		
//del cont.		CAMERA_OSD_PATH"CAM_cshot_1.gif", "IMG_ID_CAMERA_OSD_CONT_SHOT_1" );
...
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_CONT_SHOT_2,		
//del cont.			CAMERA_OSD_PATH"CAM_cshot_2.gif", "IMG_ID_CAMERA_OSD_CONT_SHOT_2" );
...
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_CONT_SHOT_3,		
//del cont.			CAMERA_OSD_PATH"CAM_cshot_3.gif", "IMG_ID_CAMERA_OSD_CONT_SHOT_3" );	
	...
	#ifdef __CAMERA_FEATURE_CONT_SHOT_BURST__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_CONT_SHOT_BURST,		
//del cont.			CAMERA_OSD_PATH"CAM_cshot_burst.gif", "IMG_ID_CAMERA_OSD_CONT_SHOT_BURST" );	
	#endif

	#ifdef __CAMERA_FEATURE_CONT_SHOT_TILE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_CONT_SHOT_TILE,	
//del cont.			CAMERA_OSD_PATH"CAM_cshot_tile.gif", "IMG_ID_CAMERA_OSD_CONT_SHOT_TILE" );	
	#endif		
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DELAY_TIMER_OFF,		
//del cont.		CAMERA_OSD_PATH"CAM_dtime_off.gif", "IMG_ID_CAMERA_OSD_DELAY_TIMER_OFF" );

//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DELAY_TIMER_1,		
//del cont.		CAMERA_OSD_PATH"CAM_dtime_1.gif", "IMG_ID_CAMERA_OSD_DELAY_TIMER_1" );

	#ifdef __CAMERA_FEATURE_DELAY_TIMER_2__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DELAY_TIMER_2,		
//del cont.			CAMERA_OSD_PATH"CAM_dtime_2.gif", "IMG_ID_CAMERA_OSD_DELAY_TIMER_2" );
	#endif

	#ifdef __CAMERA_FEATURE_DELAY_TIMER_3__	
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_DELAY_TIMER_3,		
//del cont.			CAMERA_OSD_PATH"CAM_dtime_3.gif", "IMG_ID_CAMERA_OSD_DELAY_TIMER_3" );
	#endif
...

	{
		...
		{
			char tmp[200]; 
			sprintf (tmp,"%sCAM_zoom_%d.gif",CAMERA_OSD_PATH,g_camera_feature_zoom[i-1]);
	...
	#ifdef __CAMERA_FEATURE_EFFECT_GRAYSCALE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_GRAYSCALE,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_grayscale.gif", "IMG_ID_CAMERA_OSD_EFFECT_GRAYSCALE" );
	#endif 
				
	#ifdef __CAMERA_FEATURE_EFFECT_SEPIA__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_SEPIA,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_sepia.gif", "IMG_ID_CAMERA_OSD_EFFECT_SEPIA" );
	#endif 

	#ifdef __CAMERA_FEATURE_EFFECT_SEPIA_GREEN__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_SEPIA_GREEN,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_sepia_g.gif", "IMG_ID_CAMERA_OSD_EFFECT_SEPIA_GREEN" );
	#endif  

	#ifdef __CAMERA_FEATURE_EFFECT_SEPIA_BLUE__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_SEPIA_BLUE,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_sepia_b.gif", "IMG_ID_CAMERA_OSD_EFFECT_SEPIA_BLUE" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_COLOR_INVERT__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_COLOR_INVERT,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_color_inv.gif", "IMG_ID_CAMERA_OSD_EFFECT_COLOR_INVERT" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_GRAY_INVERT__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_GRAY_INVERT,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_gray_inv.gif", "IMG_ID_CAMERA_OSD_EFFECT_GRAY_INVERT" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_BLACKBOARD__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_BLACKBOARD,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_blackboard.gif", "IMG_ID_CAMERA_OSD_EFFECT_BLACKBOARD" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_WHITEBOARD__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_WHITEBOARD,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_whiteboard.gif", "IMG_ID_CAMERA_OSD_EFFECT_WHITEBOARD" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_COPPER_CARVING__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_COPPER_CARVING,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_copper_carv.gif", "IMG_ID_CAMERA_OSD_EFFECT_COPPER_CARVING" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_BLUE_CARVING__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_BLUE_CARVING,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_blue_carv.gif", "IMG_ID_CAMERA_OSD_EFFECT_BLUE_CARVING" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_EMBOSSMENT__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_EMBOSSMENT,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_emobss.gif", "IMG_ID_CAMERA_OSD_EFFECT_EMBOSSMENT" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_CONTRAST__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_CONTRAST,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_contrast.gif", "IMG_ID_CAMERA_OSD_EFFECT_CONTRAST" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_JEAN__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_JEAN,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_jean.gif", "IMG_ID_CAMERA_OSD_EFFECT_JEAN" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_SKETCH__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_SKETCH,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_sketch.gif", "IMG_ID_CAMERA_OSD_EFFECT_SKETCH" );
	#endif	

	#ifdef __CAMERA_FEATURE_EFFECT_OIL__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_OIL,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_oil.gif", "IMG_ID_CAMERA_OSD_EFFECT_OIL" );
	#endif

	#ifdef __CAMERA_FEATURE_EFFECT_CUSTOM_FX_1__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_CUSTOM_FX_1,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_cust1.gif", "IMG_ID_CAMERA_OSD_EFFECT_CUSTOM_FX_1" );
	#endif		

	#ifdef __CAMERA_FEATURE_EFFECT_CUSTOM_FX_2__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_CUSTOM_FX_2,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_cust2.gif", "IMG_ID_CAMERA_OSD_EFFECT_CUSTOM_FX_2" );
	#endif		

	#ifdef __CAMERA_FEATURE_EFFECT_CUSTOM_FX_3__
//del by reslim v0.1		ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_OSD_EFFECT_CUSTOM_FX_3,		
//del cont.			CAMERA_OSD_PATH"CAM_fx_cust3.gif", "IMG_ID_CAMERA_OSD_EFFECT_CUSTOM_FX_3" );
	#endif		
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ICONBAR_LEFT_ARROW_SEL,		
//del cont.		CAMERA_OSD_PATH"CAM_IB_left_arrow_sel.gif", "IMG_ID_CAMERA_ICONBAR_LEFT_ARROW_SEL" );	
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_CAMERA_ICONBAR_RIGHT_ARROW_SEL,		
//del cont.		CAMERA_OSD_PATH"CAM_IB_right_arrow_sel.gif", "IMG_ID_CAMERA_ICONBAR_RIGHT_ARROW_SEL" );	
...
//Modified by Kenneth 2008-12-11
...
#endif				
	ADD_APPLICATION_MENUITEM((MENU_ID_CAMERA_OPTION, 0,
	4
#ifndef __MMI_DISABLE_DUAL_SENSOR__
				+1
#endif
	...
	ADD_APPLICATION_MENUITEM((MENU_ID_CAMERA_STORAGE,MENU_ID_CAMERA_OPTION,2,
...
//del by reslim v0.1	ADD_APPLICATION_STRING2(STR_ID_CAMERA_DOUBLE_SENSOR,				"Sensor select",				"[Sensor select]");
...
//del by reslim v0.1	ADD_APPLICATION_IMAGE2(IMG_ID_IMAGEVIEWER_MAIN_ICON,
//del cont.		CUST_IMG_PATH"/MainLCD/Camera/ImageViewer/SB_Viewer.JPG",	"ImageViewer icon" );
	...
	ADD_APPLICATION_MENUITEM((MENU_ID_IMGVIEW_FILE_OPTION,0,8,
	...
	ADD_APPLICATION_MENUITEM((MENU_ID_IMGVIEW_FILE_OPTION_NO_SIM,0,8,	
				MENU_FMGR_GEN_OPTION_FORWARD,
				MENU_ID_IMGVIEW_VIEW_DETAIL,
				MENU_ID_IMGVIEW_VIEW_STYLE,
				MENU_FMGR_GEN_OPTION_RENAME,
				...
				MENU_ID_IMGVIEW_STORAGE,
				0,0,1,STR_GLOBAL_OPTIONS,IMG_ID_IMGVIEW_MAIN_ICON));
	ADD_APPLICATION_MENUITEM((MENU_ID_IMGVIEW_EMPTY_FOLDER_OPTION,0,2,
				MENU_ID_IMGVIEW_VIEW_STYLE,
				MENU_ID_IMGVIEW_STORAGE,
				0,0,1,STR_GLOBAL_OPTIONS,IMG_ID_IMGVIEW_MAIN_ICON));
	ADD_APPLICATION_MENUITEM((MENU_ID_IMGVIEW_VIEW_DETAIL, MENU_ID_IMGVIEW_FILE_OPTION,0,
				SHOW,NONMOVEABLE,1,STR_GLOBAL_VIEW,0));
	ADD_APPLICATION_MENUITEM((MENU_ID_IMGVIEW_STORAGE,MENU_ID_IMGVIEW_FILE_OPTION,2,
