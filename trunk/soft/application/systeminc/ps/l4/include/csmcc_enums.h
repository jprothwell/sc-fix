...
typedef enum
{
   ...
   CSMCC_INVALID_BEARER_CE = 255 /*CSD00924: remove warning C2874W may be used before being set*/
...
}csmcc_cpi_msg_type_enum; /*CSD00924 add 041210 for +ECPI*/
