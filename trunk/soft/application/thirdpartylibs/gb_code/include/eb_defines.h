...
#define EB_FAULT_TOLERANT           101 //容错匹配
...
#define EB_DIALECT_DATA_MISSMATCH	-37 //方言数据与引擎主数据不匹配
#define EB_INVALID_SYLLABLE_TABLE	-38	//错误的拼音表数据，主要多拼音方式的引擎里面使用

#define EB_ERR_CLOSE_PHRASE_FUNC	-39 //词组功能已经关闭, 在EBFindFirstPageC里面返回，
...
#define EB_INPUT_METHOD_NUM			6 //输入法数量
...
#define EB_INPUT_METHOD_BPMF        5 //注音
#define EB_INPUT_METHOD_JYUTPING    6 //广东拼音
