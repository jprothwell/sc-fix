 ...
 *  
 *****************************************************************************/
U8 EMS_load(bytestream *file, char *filename)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
#ifndef __CYGWIN__
    sprintf(cmdbuf, "%s %s %s", "../../mmi_customer/ResGenerator/convert", filename, "temp.rgb");
#else
    sprintf(cmdbuf, "%s %s %s", "../../mmi_customer/ResGenerator/convert.exe", filename, "temp.rgb");
#endif
    system(cmdbuf);
