...
//PMT END HU_FI 20050825
	...
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_MYANMAR, "Multitap My", "Input methods list Option Multitap Myanmar");
#endif
...
//PMT START PERSIAN
	...
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_MULTITAP_URDU,"Multitap Urdu","Input methods list Option Multitap urdu");
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MULTITAP_URDU,"Multitap Urdu","Input methods list Option Multitap urdu");
#endif
...
//PMT START PERSIAN
	...
	ADD_APPLICATION_STRING2(STR_INPUT_METHOD_MENU_SMART_BENGALI, "Smart Bengail", "Input methods list Option Smart Bengali")
#endif
...
#endif
//PMT CZ_PO_TU START 20050812
#if defined(__MMI_ZI_CZECH__)||defined(__MMI_T9_CZECH__) // Gurdev 20050713
...
#endif
#if defined(__MMI_ZI_HUNGARIAN__)||defined(__MMI_T9_HUNGARIAN__) // Gurdev 20050713
