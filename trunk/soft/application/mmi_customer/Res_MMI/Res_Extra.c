...
{	
	...
	ADD_APPLICATION_IMAGE2(ORGANIZER_MENU_CURRENCYCONVERTOR_IMAGEID,CUST_IMG_PATH"/MainLCD/Currency/SB_OCUR.PBM","Icon for Currency Convertor Menu.");
...
void PopulateUnitConvertor()
{
	...
	ADD_APPLICATION_IMAGE2(ORGANIZER_MENU_UNITSCONVERTOR_IMAGEID,CUST_IMG_PATH"/MainLCD/UnitsConverter/SB_OUNIT.PBM","Icon for Calculator Units Converter.");
...
void PopulateShortcutsRes(void)
{
	...
	ADD_APPLICATION_IMAGE2(SHORTCUTS_TITLE_IMAGE_ID,CUST_IMG_PATH"/MainLCD/TitleBar/TB_SC.PBM","Icon for Title displayed in Shortcuts Application.");
