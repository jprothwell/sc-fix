 ...
 *------------------------------------------------------------------------------
 * $Log: resource_fmschedulerec_skins.c,v $
 * Revision 1.1.1.1  2006/10/24 08:14:38  huangjiwei
 * BASELINE VERSION
 *
 *
 * Jan 16 2006 CSD00676
 * [MAUI_00218649] schdule fm_pic has afterimage
 * 
 *
 * Oct 3 2005 CSD00676
 * [MAUI_00126881] [FM Record] Update files for fix bug after 6227 platform testing.
 * 
 *
 *------------------------------------------------------------------------------
