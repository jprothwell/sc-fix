...
extern void mmiapi_sms_get_incoming_msg_timestamp_req(mmiapi_sms_get_incoming_msg_timestamp_req_struct *msg,module_type mod_src);
extern void mmiapimsg_sms_get_incoming_msg_timestamp_rsp(module_type mod_dest,kal_uint8 *scts);

extern void mmiapi_sms_get_incoming_msg_address_req(mmiapi_sms_get_incoming_msg_address_req_struct *msg,module_type mod_src);
...
void mmiapimsg_sms_ind(void* msg, module_type mod_dest, kal_uint16 serial);

#endif

#ifdef MMIAPI_USING_UI
extern void mmiapi_ui_enter_fullscreen_editor_req(mmiapi_ui_enter_fullscreen_editor_req_struct* msg,module_type mod_src);
