...
S32 gdi_image_get_virtual_filename(S8* image_buffer, S8* virtual_fname)
{
	...
	image_file_size = (U8)image_buffer[2];
	image_file_size = (image_file_size << 8) | (U8)image_buffer[3];
	image_file_size = (image_file_size << 8) | (U8)image_buffer[4];
	...
	UCS2Strcat((S8*)virtual_fname,(const S8*)gdi_image_ext_name[image_buffer[0]]);
...
{
	/*wuzc Modify Start For GDI/GUI Portting Ver:    on 2008-3-11 11:38 */
	#ifdef __MMI_DOWNLOADABLE_THEMES_SUPPORT__
	...
	return gdi_image_codec_draw(
	       ...
	       return GDI_FAILED;
	#endif
	/*wuzc Modify End  For GDI/GUI Portting Ver:    on 2008-3-11 11:38 */
}
...
GDI_RESULT gdi_image_virtualfile_get_pos_info_handler(U32 flag,U8* data_ptr,U32 img_size,BOOL quick_mode, S32 *total_pos,gdi_anim_pos_type_enum *pos_type)
{
	...
	//return GDI_SUCCEED;
	/*wuzc Modify Start For GDI/GUI Portting Ver:    on 2008-3-11 11:39 */
	#ifdef __MMI_DOWNLOADABLE_THEMES_SUPPORT__
	...
	*pos_type = GDI_ANIM_POS_TYPE_INDEX;
	...
	return gdi_image_codec_get_frame_count(
	        ...
	        return GDI_FAILED;
	#endif
	/*wuzc Modify End  For GDI/GUI Portting Ver:    on 2008-3-11 11:39 */
}
