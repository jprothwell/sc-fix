        ...
        BOOL dotted)
{
    ...
    if (dotted == 0)
    {
        ...
        else
        {
            ...
            do
            {
                dstImageReg[(temprate >> 20) * tempWidth] = color_t;
                dstImageReg++;
                temprate += rate;
            } while (dstImageReg < endAddrReg);
        }
        ...
        BOOL dotted)
{
    ...
    if (dotted == 0)
    {
        ...
        if (clipsides == 0)
        {
            gdi_memset16((U8*) dstImageReg, (U16) color_t, width);
            dstImageReg += destWidth;
            while (dstImageReg < dstImageEndReg)
            {
                dstImageReg[0] = color_t;
                dstImageReg[widthTemp] = color_t;
                dstImageReg += destWidth;
            }
            gdi_memset16((U8*) dstImageEndReg, (U16) color_t, width);
        }
        else
        {
    ...
    else
    {
        ...
        if (clipsides == 0)
        {
            ...
            {
                dstImageReg[tempx] = color_t;
            }
            dstImageReg[width] = color_t;
            while (dstImageReg <= dstImageEndReg)
            {
                dstImageReg[0] = color_t;
                dstImageReg[widthTemp] = color_t;
            ...
            for (tempx = 0; tempx <= width; tempx += 2)
            {
                dstImageEndReg[tempx] = color_t;
            }
            dstImageEndReg[width] = color_t;
        }
        else
        {
            if ((clipsides & 1) == 0)
        ...
        gdi_color color_t)
{
    ...
    GD_CLIP_RECT_TEST(x1, y1, x2, y2, clipx1, clipy1, clipx2, clipy2);
    {
        ...
        while (y2--)
        {
            gdi_memset16(dest, (U16) color_t, x2);
            dest += x1;
        }
    }
}
    ...
    height = height_;
    {
        ...
        for (i = 1; i <= arcHeight; i++)
        {
            ...
            else
            {
                ...
                {
                    gdi_memset16((U8*) (dstPtr + x_ + y_ * destWidth), (U16) color_t, (pre_x1 - x_) << 1);
                    if (x2_ != pre_x2)
                    {
                        gdi_memset16(
                ...
                if ((((pre_x1 - x_) > 1) || ((x2_ - pre_x2) > 1)) && (y2_ != clipy1) && (y2_ != clipy2))
                {
                    ...
                    gdi_memset16((U8*) (dstPtr + x_ + y2_ * destWidth), (U16) color_t, (pre_x1 - x_) << 1);
                }
            }   /* end if(dotted) */
        ...
        if (dotted)
        {
            ...
            if ((x_ != clipx1) && (x_ != clipx2) && (y_ != clipy1) && (y_ != clipy2))
            {
                *(dstPtr + (y_ * destWidth) + x_) = color_t;  /* draw top_center point */
            }
            if ((y2_ != clipy1) && (y2_ != clipy2))
            {
                *(dstPtr + y2_ * destWidth + x_) = color_t;   /* draw bottom_center point */
            }
            ...
            for (i = 1; i < (width - arcWidth); i++)
            {
                ...
                if ((x_ != clipx1) && (x_ != clipx2) && (y_ != clipy1) && (y_ != clipy2))
                {
                    *(dstPtr + y_ * destWidth + x_) = color_t;    /* top_left_half_line */
                }
                if ((x_ != clipx1) && (x_ != clipx2) && (y2_ != clipy1) && (y2_ != clipy2))
                {
                    *(dstPtr + y2_ * destWidth + x_) = color_t;   /* bottom_left_half_line */
                }
                if ((x2_ != clipx1) && (x2_ != clipx2) && (y_ != clipy1) && (y_ != clipy2))
                {
                    *(dstPtr + y_ * destWidth + x2_) = color_t;   /* top_right_half_line */
                }
                if ((x2_ != clipx1) && (x2_ != clipx2) && (y2_ != clipy1) && (y2_ != clipy2))
                {
                    *(dstPtr + y2_ * destWidth + x2_) = color_t;  /* bottom_right_half_line */
                }
        ...
        else
        {
            ...
            {
                gdi_memset16((U8*) (dstPtr + x2_ + y_ * destWidth), (U16) color_t, (x_ - x2_) << 1);
            }
            if ((y2_ != clipy1) && (y2_ != clipy2) && (x_ - x2_) > 0)
            {
                gdi_memset16((U8*) (dstPtr + x2_ + y2_ * destWidth), (U16) color_t, (x_ - x2_) << 1);
            }
        }
        ...
        for (i = 1; i <= (height - arcHeight); i++)
        {
            ...
            if ((x_ != clipx1) && (x_ != clipx2) && (y_ != clipy1) && (y_ != clipy2))
            {
                *(dstPtr + y_ * destWidth + x_) = color_t;    /* draw right_top_half_line */
            }
            if ((x_ != clipx1) && (x_ != clipx2) && (y2_ != clipy1) && (y2_ != clipy2))
            {
                *(dstPtr + y2_ * destWidth + x_) = color_t;   /* draw right_bottom_half_line */
            }
            if ((x2_ != clipx1) && (x2_ != clipx2) && (y_ != clipy1) && (y_ != clipy2))
            {
                *(dstPtr + y_ * destWidth + x2_) = color_t;   /* draw left_top_half_line */
            }
            if ((x2_ != clipx1) && (x2_ != clipx2) && (y2_ != clipy1) && (y2_ != clipy2))
            {
                *(dstPtr + y2_ * destWidth + x2_) = color_t;  /* draw left_bottom_half_line */
            }
        ...
        BOOL dotted)
{
    ...
    if ((x_ != clipx1) && (x_ != clipx2) && (y_ != clipy1) && (y_ != clipy2))
    {
        *(dstPtr + y_ * destWidth + x_ - 1) = color_t;
    }
    if ((x2_ != clipx1) && (x2_ != clipx2) && (y_ != clipy1) && (y_ != clipy2))
    {
        *(dstPtr + y_ * destWidth + x2_ + 1) = color_t;
    }
        ...
        if (dotted)
        {
            ...
            if (((pre_x1 - x_) > 3) || ((x2_ - pre_x2) > 3))
            {
                ...
                if ((mid_x1 != clipx1) && (mid_x1 != clipx2) && ((y_ + 1) != clipy1) && ((y_ + 1) != clipy2))
                    if ((y_ > clipy1) && (x_ < clipx2))
                    {
                        *(dstPtr + (y_ + 1) * destWidth + mid_x1) = color_t;
                    }
                if ((mid_x1 != clipx1) && (mid_x1 != clipx2) && ((y2_ - 1) != clipy1) && ((y2_ - 1) != clipy2))
                    if ((y2_ < clipy2) && (x_ < clipx2))
                    {
                        *(dstPtr + (y2_ - 1) * destWidth + mid_x1) = color_t;
                    }
                if ((mid_x2 != clipx1) && (mid_x2 != clipx2) && ((y_ + 1) != clipy1) && ((y_ + 1) != clipy2))
                    if ((y_ > clipy1) && (x2_ > clipx1))
                    {
                        *(dstPtr + (y_ + 1) * destWidth + mid_x2) = color_t;
                    }
                if ((mid_x2 != clipx1) && (mid_x2 != clipx2) && ((y2_ - 1) != clipy1) && ((y2_ - 1) != clipy2))
                    if ((y2_ < clipy2) && (x2_ > clipx1))
                    {
                        *(dstPtr + (y2_ - 1) * destWidth + mid_x2) = color_t;
                    }
        ...
        else
        {
            ...
            if ((((pre_x1 - x_) > 1) || ((x2_ - pre_x2) > 1)) && (y_ != clipy1) && (y_ != clipy2))
            {
                ...
                if (x2_ != pre_x2)
                {
                    if ((i < arcHeight))
                    {
                        gdi_memset16((U8*) (dstPtr + 1 + pre_x2 + y_ * destWidth), (U16) color_t, (x2_ - pre_x2) << 1);
                    }
                    else
                    {
                        if ((1 + x2_) <= clipx2)
            ...
            if ((((pre_x1 - x_) > 1) || ((x2_ - pre_x2) > 1)) && (y2_ != clipy1) && (y2_ != clipy2))
            {
                if (x2_ != pre_x2)
                {
                    if (i < arcHeight)
                    {
                        gdi_memset16((U8*) (dstPtr + 1 + pre_x2 + y2_ * destWidth), (U16) color_t, (x2_ - pre_x2) << 1);
                    }
                    else
                    {
                        if ((1 + x2_) <= clipx2)
        ...
        for (i = 1; i <= arcHeight; i++)
        {
            ...
            else
            {
                if ((x_ - pre_x1 > 1) && (y_ != clipy1) && (y_ != clipy2))
                {
                    if (i < arcHeight)
                    {
                        gdi_memset16((U8*) (dstPtr + 1 + pre_x1 + y_ * destWidth), (U16) color_t, (x_ - pre_x1) << 1);
                    }
                    else
                    {
                        if ((1 + x_) <= clipx2)
            ...
            switch (i)
            {
                case 1:
                    ...
                    if (height == 5)
                    {
                        ...
                        {
                            *(dstPtr + (tempy * destWidth + tempx)) = color_t;
                        }
                    }
                ...
                int arcCase)
{
    ...
    else if (arcCase == 3)
    {
        ...
        {
            x_ = (x - arcWidth + 1 < clipx1) ? clipx1 : ((x - arcWidth + 1 > clipx2) ? clipx2 : x - arcWidth + 1);
            gdi_memset16((U8*) (dstPtr + x_ + y_ * destWidth), (U16) color_t, (x2_ - x_) << 1);
        }
        ...
        BOOL dotted)
{
    ...
    if ((Drawing == 0) || (Drawing == 1))
    {
        ...
        for (i = yStart; i < yStop; i++)
        {
            ...
            {
                /* int len = (xf2-xf1)<<1; */
                gdi_memset16((U8*) (imgp + xf1 + i * destWidth), (U16) color_t, (xf2 - xf1) << 1);
                /*          MEMSET_16_((dst_->data + xf1 + j * destWidth)  ,color, (xf2-xf1)); */
            }
            else if (xf2 < xf1)
            {
                gdi_memset16((U8*) (imgp + xf2 + i * destWidth), (U16) color_t, (xf1 - xf2) << 1);
            }
        }
