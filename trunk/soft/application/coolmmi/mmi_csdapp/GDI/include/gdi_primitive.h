...
#define GDI_ASSERT(exp)       MMI_ASSERT(exp)
#ifndef __PRODUCTION_RELEASE__
#define GDI_DEBUG_ASSERT(exp) MMI_ASSERT(exp)
#else 
...
#define GDI_ASSERT(exp)       MMI_ASSERT(exp)
#define GDI_DEBUG_ASSERT(exp) MMI_DBG_ASSERT(exp)
...
#define GDI_TRY                                \
   {                                           \
      int jmpret;                              \
      int backup_gdi_mutex_cnt;                \
      backup_gdi_mutex_cnt= (int)gdi_mutex.cnt;     \
...
#define GDI_CATCH(N) if(jumpret == N)
