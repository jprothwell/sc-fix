...
typedef enum
{
    ...
    STR_ID_VOBJ_RECEIVE_FALL,
    STR_ID_VOBJ_EMPTY_FILENAME,
    STR_ID_VOBJ_ABORT,
    STR_ID_VOBJ_ENUM_TOTAL
} vobj_str_id_enum;
...
typedef enum
{
    ...
    SCR_ID_VCARD_EXPORT_OPTION,
    SCR_ID_VCARD_IMPORT_FROM_OPTION
} vcard_scr_id_enum;
...
typedef enum
{
    ...
    STR_ID_VCARD_FILE_TO_LARGE,
    STR_ID_VCARD_VCARD_DETAILS,
    STR_ID_VCARD_ENUM_TOTAL
} vcard_str_id_enum;
...
typedef enum
{
    STR_ID_VBKM_ENUM_START = VBOOKMARK_BASE + 1,
#if defined(__MMI_FILE_MANAGER__)
