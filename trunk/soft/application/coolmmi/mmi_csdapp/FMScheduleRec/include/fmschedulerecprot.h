...
extern U8 mmi_fmsr_battery_status_interrupt_hdlr(void* inMsg);
extern U8 mmi_fmsr_post_interrupt_hdlr(void* inMsg);


/*FMScheduleRecScreen.c*/
extern void mmi_fmsr_init_screen(void);
extern void mmi_fmsr_show_main(U16 title,U16 title_icon,U16 left_softkey,U16 left_softkey_icon,U16 right_softkey,U16 right_softkey_icon,U8* history_buffer);
extern void mmi_fmsr_hide_main( void );
extern void mmi_fmsr_redraw_main_all( void );
//extern void mmi_fmsr_show_msg(U16 title,U16 title_icon,U16 left_softkey,U16 left_softkey_icon,U16 right_softkey,U16 right_softkey_icon,U8* buffer,S32 buffer_size,U8* history_buffer);
//extern void mmi_fmsr_hide_msg( void );
//extern void mmi_fmsr_redraw_msg_all( void );
...
extern void mmi_fmsr_util_get_time_from_int(S8* str_hour1, S8* str_min1, S8* str_hour2, S8* str_min2, U8 hour1, U8 min1, U8 hour2, U8 min2);
extern void mmi_fmsr_util_get_time_from_str(S8* str_hour1, S8* str_min1, S8* str_hour2, S8* str_min2, U8 *hour1, U8 *min1, U8 *hour2, U8 *min2);
...
extern BOOL mmi_fmsr_util_check_time_overlap(U8 shour1, U8 smin1, U8 shour2, U8 smin2, U8 dhour1, U8 dmin1, U8 dhour2, U8 dmin2);
extern BOOL mmi_fmsr_util_check_repeat_overlap(U8 repeat1, U16 year1, U8 mon1, U8 day1, U8 weekday1, U8 repeat2,U16 year2, U8 mon2, U8 day2, U8 weekday2);
...
extern BOOL mmi_fmsr_start_record(UI_string_type filename, U8 format);
