...
typedef struct {
	U8 FdlStatus[MMI_SIM_NUMBER];
	U8 BdlStatus[MMI_SIM_NUMBER];	
	U8 SimLockStatus[MMI_SIM_NUMBER];
	U8 PhoneLockStatus;
	U8 AutoKeyPadLockTime;
	U8 CurrentPassword;
	U8 PINBlocked[MMI_SIM_NUMBER];
	U8 CHV1Count[MMI_SIM_NUMBER];
	U8 CHV2Count[MMI_SIM_NUMBER];
	U8 UBCHV1Count[MMI_SIM_NUMBER];
	U8 UBCHV2Count[MMI_SIM_NUMBER];
