...
enum STR_LIST_EXTDEV_FTP
{
	...
	STR_FTP_SETTING, //文件传输设置
	STR_FTP_SHARED_FOLDER, // 共享文件夹
	STR_FTP_ACCESS_RIGHT, //访问权限
	STR_FTP_RECEIVE_FOLDER, // 共享文件夹	
	STR_FTP_OPTION_FULLY_CONTROL, //读写
	STR_FTP_OPTION_READ_ONLY, //只读
	STR_FTP_CON_AUTH,   /* Ask for user's permission to be connected via FTP profile */ //连接认证
	STR_FTP_RECV_FILE_IND, //是否接收文件
	STR_FTP_SERVER_BUSY,//服务器忙
    ...
    STR_FTP_OPTION_GET,
    STR_FTP_OPTION_REFRESH,
    STR_FTP_OPTION_DETAIL,
    STR_FTP_OPTION_BACK_TO_ROOT_DIR,
    STR_FTP_OPTION_DISCONNECT,
    STR_FTP_STATUS_CONNECTING,
    STR_FTP_STATUS_DISCONNECTING,
    STR_FTP_STATUS_RECEIVING,
    STR_FTP_CON_EXIT,           /* Ask for exit FTP connection ? */
    STR_FTP_NOTY_RECV_FILE_BROWSE,
    STR_FTP_NOTY_RECV_FILE_HED,
	...
	STR_FTP_CON_DISCONNECTED,   /* BCHS FTP profile disconnected *///断开连接
	STR_FTP_RECV_DISK_FULL, //接收磁盘满
	STR_FTP_RECV_ROOT_DIR_FULL, //文件夹满
	STR_FTP_WRITE_FILE_FAIL,//写文件失败	
    STR_OBEX_INPUT_AUTHPWD,
    STR_OBEX_NOTIFY_CANNOT_SWITCH_APPLICATION,
    STR_EXTDEV_FTP_LAST
};
