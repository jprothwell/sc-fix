...
const U8 color_slider_arrow_image[] = 
{
    0x04, 0x00, 0x3D, 0x00, 0x00, 0x00,
    0x06, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x0C, 0x0C, 0x00, 0x00, 0x00,
    0x34, 0x12, 0x34, 0x12, 0x00, 0x00, 0x00, 0x00, 0x34, 0x12, 0x34, 0x12, 0x34, 0x12, 0x00, 0x00,
    0xF8, 0x00, 0xF8, 0x00, 0x00, 0x00, 0x34, 0x12, 0x00, 0x00, 0xF8, 0x00, 0xF8, 0x00, 0xF8, 0x00,
...
void gui_color_slider_create(color_slider *s, S32 x, S32 y, S32 width, S32 height)
{
    ...
    s->simage = (PU8) color_slider_arrow_image;
    gui_measure_image(s->simage, &s->swidth, &s->sheight);
    s->shide = NULL;
}
...
void gui_color_slider_show(color_slider *s)
{
    ...
    gdi_image_draw(s->sx1, s->sy1, (U8*) s->simage);
}
