...
#define MAX_INLINE_ITEMS   32
    ...
    void SetInlineItemColorSelect(InlineItem *item, S32 n_color, U16 highlighted_index, color_t *list_of_color,
                                  void (*color_highlighted) (U16 index));
    ...
    extern void EnableInlineInputMethodHints(void);
...
#define MAX_IMAGES_IN_INLINE_ATTACHMENT         3
    ...
    extern S32 AppendInlineItemTextEditString(
                S16 input_type,
                U8 *buffer,
                InlineItem *list_of_items,
                S32 number_of_items,
