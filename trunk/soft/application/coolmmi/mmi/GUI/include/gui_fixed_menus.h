...
/**********************************************************************************
   Filename:      gui_fixed_menus.h
   Date Created:  August-13-2002
   Contains:      UI routines header for Fixed Menus
**********************************************************************************/
...
#include "touchscreengprot.h"
    ...
    void gui_set_fixed_list_menu_item_functions(fixed_list_menu *m,
                                                void (*item_display_function) (void *item, void *common_item_data,
                                                                               S32 x, S32 y),
                                                void (*item_measure_function) (void *item, void *common_item_data,
                                                                               S32 *width, S32 *height),
                                                void (*item_highlight_function) (void *item, void *common_item_data),
                                                void (*item_remove_highlight_function) (void *item,
                                                                                        void *common_item_data),
                                                void (*item_hide_function) (void *item, void *common_item_data, S32 x,
                                                                            S32 y), void (*item_resize_function) (S32 x,
                                                                                                                  S32
                                                                                                                  y));
    ...
    extern void gui_show_menu_background_in_layer(S32 x1, S32 y1, S32 x2, S32 y2, UI_filled_area *f);
#endif 

    /* UI fixed matrix menu structure               */
...
#define SYMBIAN_IDLE_SHORTCUT_NUM 6
#define SYMBIAN_TOTAL_LINES 3
#elif defined (__MMI_BLACK_BERRY_IDLE_STYLE__)
#define SYMBIAN_IDLE_SHORTCUT_NUM 6
#define SYMBIAN_TOTAL_LINES 2
#else
#define SYMBIAN_IDLE_SHORTCUT_NUM 6
#define SYMBIAN_TOTAL_LINES 4
#endif
	typedef struct _symbian_idle_style{
		S32 			x,y;
		S32 			item_width,item_height;
		S32 						columns;
		S32 						prev_columns;
		S32 			current_total_items;
		U32 					flags;
	}Symbian_idle_info;
#endif
/*- zhouqin 2011-02-16 modify for q6 320X240 */
    ...
    extern void gui_fixed_matrix_menu_auto_configure(fixed_matrix_menu *m);
    ...
    extern void CSD_UI_show_fixed_matrix_menu(fixed_matrix_menu *m);
    ...
    void gui_set_fixed_matrix_menu_item_functions(fixed_matrix_menu *m,
                                                  void (*item_display_function) (void *item, void *common_item_data,
                                                                                 S32 x, S32 y),
                                                  void (*item_measure_function) (void *item, void *common_item_data,
                                                                                 S32 *width, S32 *height),
    ...
    extern void gui_reset_fiexed_menu_bg_id(void);
     

    /* UI drop down control structure   */
...
#define UI_DROP_DOWN_CONTROL_SHOW_BUTTON_ON_FOCUS  0x00000400
    ...
    /* UI horizontal select structure   */
