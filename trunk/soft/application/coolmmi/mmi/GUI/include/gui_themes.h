...
extern "C"
{
    ...
    extern color_t default_gradient_color_list[];
    ...
    /* UI colors                           */
    extern CONST_HARDWARE color_t UI_COLOR_LIGHT_GREY;
    extern CONST_HARDWARE color_t UI_COLOR_WHITE;
    extern CONST_HARDWARE color_t UI_COLOR_DARK_GREY;
    extern CONST_HARDWARE color_t UI_COLOR_BLACK;
    extern CONST_HARDWARE color_t UI_COLOR_NONE;
    extern CONST_HARDWARE color_t UI_COLOR_RED;
    extern CONST_HARDWARE color_t UI_COLOR_3D_FILLER;
    extern CONST_HARDWARE color_t UI_COLOR_GREY;
    extern CONST_HARDWARE color_t UI_COLOR_GREEN;
