...
/**********************************************************************************
   ...
   Contains:      UI wrapper routines header for Date and Time input / display
**********************************************************************************/
...
#if defined(__MMI_MAINLCD_240X320__) ||defined(__MMI_MAINLCD_220X176__) 
#define DATE_INPUT_HEIGHT                 22
#define DATE_INPUT_DAY_WIDTH              28 //gdm adjust the size for bug12582 CS2324 090616
#define DATE_INPUT_MONTH_WIDTH         28 //gdm 090616
#define DATE_INPUT_YEAR_WIDTH             44 //gdm 090616
...
#define TIME_INPUT_HOURS_WIDTH               30 //gdm adjust the size for bug12582 CS2324 090616
#define TIME_INPUT_MINUTES_WIDTH           30 //gdm 090616
#define TIME_INPUT_SECONDS_WIDTH           30 //gdm 090616
#else /* defined(__MMI_MAINLCD_240X320__) */ 
#define TIME_INPUT_HEIGHT                 16
...
#endif /* defined(__MMI_MAINLCD_240X320__) */ 
#define TIME_INPUT_SEPERATOR_WIDTH           2
...
#define DOW_CELL_GAP       1
    ...
    typedef struct _DOW_select
    {
        ...
        color_t normal_highlighted_text_color;
        color_t selected_highlighted_text_color;
...
#define TIME_PERIOD_INPUT_HOURS_WIDTH              26  //gdm adjust the size for bug12582 CS2324 090616
#define TIME_PERIOD_INPUT_MINUTES_WIDTH               26  //gdm 090616
#else /* defined(__MMI_MAINLCD_240X320__) */ 
#define TIME_PERIOD_INPUT_HEIGHT                16
#define TIME_PERIOD_INPUT_HOURS_WIDTH              22
#define TIME_PERIOD_INPUT_MINUTES_WIDTH               22
#endif /* defined(__MMI_MAINLCD_240X320__) */ 
#define TIME_PERIOD_INPUT_SEPERATOR_WIDTH1            2
#if defined(__MMI_MAINLCD_220X176__)
#define TIME_PERIOD_INPUT_SEPERATOR_WIDTH2            10
#else
