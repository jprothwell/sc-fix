...
typedef enum
{
    ...
    AV_BT_CALLBACK_EVENT_INQUIRY_ORCONHFP_START_IND,
    AV_BT_CALLBACK_EVENT_INQUIRY_ORCONHFP_STOP_IND,
    AV_BT_CALLBACK_EVENT_OPEN_SCO,
    AV_BT_CALLBACK_EVENT_SECURITY_BLOCK
