...
#elif defined(__MMI_BT_COOLSAND_SUPPORT__)
#include "btmmicm.h"
#endif 
...
static void fill_uibuffer(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    UCS2Strcpy((S8*) btmmi_obexauth_cntx.authpwd_ui_buf, (const S8*)GetString(STR_OBEX_INPUT_AUTHPWD));

    UCS2Strcat((S8*) btmmi_obexauth_cntx.authpwd_ui_buf, (const S8*)lbracket_str);

    UCS2Strcat((S8*) btmmi_obexauth_cntx.authpwd_ui_buf, (const S8*)btmmi_obexauth_cntx.rem_BTdev_name);

    UCS2Strcat((S8*) btmmi_obexauth_cntx.authpwd_ui_buf, (const S8*)rbracket_str);
    UCS2Strcat((S8*) btmmi_obexauth_cntx.authpwd_ui_buf, (const S8*)colon_str);
...
static void mmi_bt_entry_authpwd_input(void)
{
    ...
    {
        UCS2Strcpy((S8*) btmmi_obexauth_cntx.authpwd_input_buf, (S8*) inputBuffer);
    }
    ...
    if (UCS2Strlen((S8*) (btmmi_obexauth_cntx.authpwd_input_buf)) < 1)
    {
...
static void mmi_bt_exit_authpwd_input(void)
{
    ...
    UCS2Strcpy((S8*) Scr.inputBuffer, (S8*) btmmi_obexauth_cntx.authpwd_input_buf);
...
static void send_auth_res_msg(U8 rsp)
{
    ...
    ilm_send->msg_id = (kal_uint32) MSG_ID_GOEP_AUTH_RES;
