...
#if defined(__MMI_BT_COOLSAND_SUPPORT__) && (defined(__MMI_AVRCP_SUPPORT__) || defined(__MMI_AVRCP_CT_SUPPORT__))
/***************************************************************************** 
* Included files
*****************************************************************************/
#include "stdc.h"
...
static AVRCPCmdFuncPtr mmi_bt_avrcp_get_cmd_hdlr_func_ptr(void)
{
    ...
    mmi_trace(1,"mmi_bt_avrcp_get_cmd_hdlr_func_ptr: func number %d", i);
...
U8 mmi_bt_is_avrcp_connect(void)
{
	...
	if((g_mmi_avrcp_cntx[BT_AVRCP_TG].avrcp_state==MMI_AVRCP_CONNECTED)||(g_mmi_avrcp_cntx[BT_AVRCP_CT].avrcp_state==MMI_AVRCP_CONNECTED))
		return 1;
	return 0;
}
/*****************************************************************************
...
void mmi_bt_avrcp_activate_tg_req(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_activate_tg_req");
...
void mmi_bt_avrcp_activate_ct_req(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_activate_ct_req");    
...
void mmi_bt_avrcp_activate_req(U8 avrcp_role)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_activate_req");    
...
void mmi_bt_avrcp_activate_cnf_hdlr(void *msg)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_activate_cnf_hdlr");
...
void mmi_bt_avrcp_deactivate_tg_req(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_deactivate_tg_req");
...
void mmi_bt_avrcp_deactivate_ct_req(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_deactivate_ct_req");
...
void mmi_bt_avrcp_deactivate_req(U8 avrcp_chnl)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_deactivate_req");
    ...
    {
  //    rda_bt_avrcp_send_deactivate_req(avrcp_chnl);
...
void mmi_bt_avrcp_deactivate_cnf_hdlr(void *msg)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_deactivate_cnf_hdlr");
    MMI_AVRCP_ASSERT(msg_p->chnl_num < BT_AVRCP_MAX_CHANNEL);
    avrcp_chnl = msg_p->chnl_num;
...
void mmi_bt_avrcp_connect_tg_req(mmi_bth_bt_addr dev_addr)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_connect_tg_req");
...
void mmi_bt_avrcp_connect_ct_req(mmi_bth_bt_addr dev_addr)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_connect_ct_req");
...
void mmi_bt_avrcp_connect_req(U8 avrcp_chnl, mmi_bth_bt_addr dev_addr)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_connect_req");
    MMI_AVRCP_ASSERT(avrcp_chnl < BT_AVRCP_MAX_CHANNEL);
...
void mmi_bt_avrcp_connect_cnf_hdlr(void *msg)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_connect_cnf_hdlr");
    MMI_AVRCP_ASSERT(msg_p->chnl_num < BT_AVRCP_MAX_CHANNEL);
    avrcp_chnl = msg_p->chnl_num;
...
void mmi_bt_avrcp_connect_ind_hdlr(void *msg)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(g_sw_BT,"mmi_bt_avrcp_connect_ind_hdlr");
    MMI_AVRCP_ASSERT(msg_p->chnl_num < BT_AVRCP_MAX_CHANNEL);
    avrcp_chnl = msg_p->chnl_num;
...
void mmi_bt_avrcp_disconnect_tg_req(mmi_bth_bt_addr dev_addr, U32 connect_id)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_disconnect_tg_req");
...
void mmi_bt_avrcp_disconnect_ct_req(mmi_bth_bt_addr dev_addr, U32 connect_id)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_disconnect_ct_req");
...
void mmi_bt_avrcp_disconnect_req(U8 avrcp_chnl, mmi_bth_bt_addr dev_addr, U32 connect_id)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_disconnect_req");
    MMI_AVRCP_LOG_STATE(avrcp_chnl);
...
void mmi_bt_avrcp_disconnect_cnf_hdlr(void *msg)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_disconnect_cnf_hdlr");
    MMI_AVRCP_ASSERT(msg_p->chnl_num < BT_AVRCP_MAX_CHANNEL);
    avrcp_chnl = msg_p->chnl_num;
...
void mmi_bt_avrcp_disconnect_ind_hdlr(void *msg)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_disconnect_ind_hdlr");
...
void mmi_bt_avrcp_cmd_frame_req(U8 avrcp_chnl, U8 op_code, U8 op_id, U8 key_down)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_cmd_frame_req");
    MMI_AVRCP_LOG_STATE(avrcp_chnl);
...
void mmi_bt_avrcp_cmd_frame_cnf_hdlr(void *msg)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"mmi_bt_avrcp_cmd_frame_cnf_hdlr");
    MMI_AVRCP_ASSERT(msg_p->chnl_num < BT_AVRCP_MAX_CHANNEL);
    avrcp_chnl = msg_p->chnl_num;
    MMI_AVRCP_LOG_STATE(avrcp_chnl);
 ...
 *  void
 *****************************************************************************/
  extern void rda_bt_avrcp_send_cmd_frame_ind_res(kal_uint8 chnl_num, kal_uint8 seq_id, kal_uint16 profile_id,kal_uint8 result, kal_uint8 subunit_type, kal_uint8 subunit_id, kal_uint16 data_len, kal_uint8* frame_data );
void mmi_bt_avrcp_cmd_frame_ind_hdlr(void *msg)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(g_sw_BT,"mmi_bt_avrcp_cmd_frame_ind_hdlr, g_mmi_avrcp_frm_blocked=%d",g_mmi_avrcp_frm_blocked);
    MMI_AVRCP_ASSERT(msg_p->chnl_num < BT_AVRCP_MAX_CHANNEL);    
    avrcp_chnl = msg_p->chnl_num;
    MMI_AVRCP_LOG_STATE(avrcp_chnl);
   ...
   mmi_trace(g_sw_BT, "avrcp_chnl=%d, cmd_type=0x%x", avrcp_chnl, cmd_type);
    ...
    switch (cmd_type)
    {
        case BT_AVRCP_OP_UNIT_INFO:
        {
            ...
            rda_bt_avrcp_send_cmd_frame_ind_res(
              //  MOD_MMI,
                avrcp_chnl,                
                msg_p->seq_id,
                msg_p->profile_id,
        ...
        case BT_AVRCP_OP_PASS_THROUGH:
		   ...
		   mmi_trace(g_sw_BT, "command=%d, g_mmi_avrcp_last_pressed_cmd=%d,msg_p->frame_data[1] & 0x80=%d", \
		   	command, g_mmi_avrcp_last_pressed_cmd,(msg_p->frame_data[1] & 0x80));		
...
void mmi_bt_avrcp_set_cmd_hdlr(AVRCPCmdFuncPtr callback_func)
{
    ...
    /*----------------------------------------------------------------*/
    /* Already registered */
    mmi_trace(1,"mmi_bt_avrcp_set_cmd_hdlr");
...
//    mmi_trace(1,"mmi_bt_avrcp_set_cmd_hdlr: total %d",g_mmi_avrcp_cmd_func_ptr_count);
}
...
//            mmi_trace(1,"mmi_bt_avrcp_clear_cmd_hdlr 2: %d",g_mmi_avrcp_cmd_func_ptr_count);            
        }
    }
...
void mmi_bt_avrcp_auto_release_cmd(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_trace(1,"AVRCP: auto release1\n");

    if ((func_ptr = mmi_bt_avrcp_get_cmd_hdlr_func_ptr()) != NULL && g_mmi_avrcp_last_pressed_cmd != 0xff)
    {
        mmi_trace(1,"AVRCP: auto release2\n");
...
void mmi_bt_avrcp_frm_sync_calllback(BOOL is_blocked)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
//    mmi_trace(1,"AVRCP: framwork sync, is_blocked=%d",is_blocked);
    ...
    if(is_blocked && (func_ptr = mmi_bt_avrcp_get_cmd_hdlr_func_ptr()) != NULL && g_mmi_avrcp_last_pressed_cmd != 0xff)
    {
        ...
        {
            mmi_trace(1,"AVRCP: framwork sync, cmd canceled\n");
            func_ptr(g_mmi_avrcp_last_pressed_cmd, MMI_AVRCP_KEY_CANCELED);
        }
        else
        {
            mmi_trace(1,"AVRCP: framework sync, key up\n");
            func_ptr(g_mmi_avrcp_last_pressed_cmd, MMI_AVRCP_KEY_UP);
        }
        StopTimer(BT_AVRCP_AUTO_RELEASE_TIMER);
        g_mmi_avrcp_last_pressed_cmd = 0xff;
...
//    mmi_trace(1,"AVRCP: mmi_bt_avrcp_frm_sync_touch_calllback, Event : %d\n", Touch_event);
...
void mmi_bt_avrcp_ct_cmd_confirm(U16 op_code, U8 command_type, BOOL key_press)
{
    ...
    {
        case BT_AVRCP_OP_UNIT_INFO:
            UCS2Strcpy((S8*)display_buffer, (S8*) GetString(STR_BT_AVRCP_CMD_UNIT_COMMAND));
            break;

        case BT_AVRCP_OP_SUBUNIT_INFO:
            UCS2Strcpy((S8*)display_buffer, (S8*) GetString(STR_BT_AVRCP_CMD_SUBUNIT_COMMAND));
            break;

        case BT_AVRCP_OP_PASS_THROUGH:
            UCS2Strcpy((S8*)display_buffer, (S8*) GetString(mmi_bt_avrcp_util_get_cmd_string(command_type)));
            break;

        default:
            UCS2Strcpy((S8*)display_buffer, (S8*) GetString(STR_GLOBAL_ERROR));        
            break;
    }

    UCS2Strcat((S8*)display_buffer, (S8*)L"\n Response\0");
...
pBOOL mmi_bt_avrcp_ct_main_list_item(S32 item_index, UI_string_type str_buff, PU8 *img_buff_p, U8 str_img_mask)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    UCS2Strcpy((S8*) str_buff, (S8*) GetString(g_mmi_bt_avrcp_cmd[item_index].str_id
));
    img_buff_p = NULL;
...
void mmi_bt_avrcp_tst_different_down_cmd()
{
    ...
    /*send msg*/
    {
       ...
       ilm_ptr->msg_id = (msg_type_t)MSG_ID_BT_AVRCP_CMD_FRAME_IND;
...
#endif /* defined(__MMI_BT_COOLSAND_SUPPORT__) && (defined(__MMI_AVRCP_SUPPORT__) || defined(__MMI_AVRCP_CT_SUPPORT__)) */
