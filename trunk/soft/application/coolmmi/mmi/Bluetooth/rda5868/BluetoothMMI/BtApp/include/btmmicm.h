...
typedef enum
{
    ...
    MMI_BTH_SIMAP_CONNECTION,  
    MMI_BTH_FAX_CONNECTION,    
...
typedef struct
{
    ...
    void (*mmi_bt_scr_cb_Cant_inquiry_cfm)(void);
...
typedef void (*mmi_bth_headset_connect_callback) (MMI_BOOL b_success);

typedef enum
{
    MMI_BTH_HS_CONNECTING_STATE_IDLE = 0,
    MMI_BTH_HS_CONNECTING_STATE_HFP_CONNECTING,
    MMI_BTH_HS_CONNECTING_STATE_HSP_CONNECTING,

    MMI_BTH_HS_CONNECTING_STATE_LAST
} mmi_bth_hs_conn_state_enum;

typedef enum
{
    MMI_BTH_HS_NOT_SHOW_CONNECT_SCR = 0,
    MMI_BTH_HS_SHOW_CONNECT_SCR,
    MMI_BTH_HS_CONNECT_SCR_SHOW_last
}mmi_bth_hs_connect_scr_show_enum;
...
typedef struct
{
	...
	/* for A2DP */
	mmi_bth_headset_connect_callback hs_conn_req_cb;
	mmi_bth_hs_conn_state_enum hs_conn_state;
...
extern void mmi_bth_cm_be_bond_cnf_hdler(void *msg);
