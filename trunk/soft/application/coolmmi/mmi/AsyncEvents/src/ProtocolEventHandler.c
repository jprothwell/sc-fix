 ...
 * Description:
 * ------------
 *   This file is intends for Handles the Events Sent from Protocol queue.
 *
 * Author:
 * -------
 * -------
...
/**************************************************************
	...
	FILENAME	: ProtocolHandler.c
  	...
  	PURPOSE		: Handles the Events Sent from Protocol queue.
...
#include "protocoleventhandler.h"
...
/**********************************************************
	...
	FUNCTION NAME:			InitProtocolEvents
