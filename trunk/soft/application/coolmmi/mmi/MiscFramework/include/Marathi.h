...
typedef enum
{
    ...
    MARATHI_L_DYA				= 0xE948,     
    MARATHI_L_DVA				= 0xE94E,     
    MARATHI_L_DDYA				= 0xE94d,    
...
extern const UI_character_type default_marathimatra3_multitap_strings[MAX_MULTITAPS][32];
