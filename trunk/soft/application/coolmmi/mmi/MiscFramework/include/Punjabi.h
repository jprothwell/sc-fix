...
#define IRE_PUNJABI_LANG_END_RANGE        		0x0A7F

#define IRE_PUNJABI_PROPRIETRY_START_RANGE   	0xEAFF
#define IRE_PUNJABI_PROPRIETRY_END_RANGE     	0xEB15
...
typedef enum
{
    ...
    PUNJABI_L_TIPPI = 0xEB11,
    PUNJABI_L_CBINDU = 0xEB12,
    PUNJABI_L_BINDI = 0xEB13,
    PUNJABI_L_IV_I_BINDI = 0xEB14,
    PUNJABI_L_IV_I_CBINDI = 0xEB15,
