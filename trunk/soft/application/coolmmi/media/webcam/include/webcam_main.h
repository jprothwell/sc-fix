...
extern HANDLE g_WebcamSem;
#define WEBCAM_WAIT_EVENT(evt_) COS_WaitForSemaphore(g_WebcamSem, COS_WAIT_FOREVER)
#define WEBCAM_SET_EVENT(evt_) COS_ReleaseSemaphore(g_WebcamSem)
