...
#define ID3_TAG_POOL_SIZE 550 // number of bytes
...
#define MAX_ID3_COMMMENT_LEN 30
...
typedef struct
{
	...
	unsigned short filename[MAX_SUBMENU_CHARACTERS];
...
kal_int8 id3_tag_parse_v2_frame_header( kal_uint8* data, kal_int32 size, id3_tag_frame_header_struct* frame_header, id3_tag_struct* id3_tag );

kal_bool id3_tag_parse_v2_frame_data( kal_uint8* data, id3_tag_frame_header_struct* frame_header, id3_tag_struct* id3_tag );

kal_int8 id3_tag_match_v2_frame_id_from_list( kal_uint8* id, const char* const id_list[], kal_uint8 size );

kal_bool id3_tag_parse_v2_tag( audio_input_stream_struct *input_streame, id3_tag_struct* id3_tag );
