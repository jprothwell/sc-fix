...
const applib_mime_type_struct g_applib_mime_tbl[] = 
{
    ...
    {"application/vnd.oma.drm.ro"              ,"oro"      ,MIME_TYPE_APPLICATION, MIMI_SUBTYPE_PROTECTED_RO         , 0},
#endif
#endif
#if defined(__J2ME__)
...
#endif
    {"application/vnd.mtk.ems", "ems", MIME_TYPE_IMAGE, MIME_SUBTYPE_EMS, 0},
    {"application/vnd.mtk.anm", "anm", MIME_TYPE_IMAGE, MIME_SUBTYPE_ANM, 0},
