 ...
 *
 * DESCRIPTION
 *   Set original key for cipher or hash function
 *
 * PARAMETERS
 *   che_context         [IN] : one context created from CHE AP
 *   key                 [IN] : the original key
 *   key_len             [IN] : original key length
 *
 * RETURNS
 *   None
 *****************************************************************************/
 ...
 * PARAMETERS
 *   che_context       [IN] : one context created from CHE AP
 *   iv                [IN] : the original iv
 *   iv_len            [IN] : original iv length
 *
 * RETURNS
 *   None
 *****************************************************************************/
 ...
 *   source              [IN] : input data source
 *   dest                [OUT] : output dest data
 *   source_length       [IN] : input data source length
 *   isLastBlock         [IN] : KAL_TRUE is last block. KAL_FLASE is none.
 *
 * RETURNS
 *   KAL_TRUE : if CHE process successful
